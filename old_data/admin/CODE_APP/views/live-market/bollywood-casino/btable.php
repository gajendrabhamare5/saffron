                    ...
                    <div>
                        <div class="card-content aaa-content m-t-10">
                            ...
                            <div class="row">
                                <div class="col-4 text-center">
                                    <div><span class="d-block"><b><span class="text-danger">A.</span> DON</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_1_row">
                                        <button class="back market_1_b_btn"><span class="odd">15.00</span></button>
                                        <button class="lay market_1_l_btn"><span class="odd">17.00</span></button>
                                    </div>
                                    <div>
                                ...
                                <div class="col-4 text-center">
                                    <div><span class="d-block"><b><span class="text-danger">B.</span> Amar Akbar Anthony</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_2_row">
                                        <button class="back market_2_b_btn"><span class="odd">5.15</span></button>
                                        <button class="lay  market_2_l_btn"><span class="odd">5.50</span></button>
                                    </div>
                                    <div>
                                ...
                                <div class="col-4 text-center ">
                                    <div><span class="d-block"><b><span class="text-danger">C.</span> Sahib Bibi Aur Ghulam</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_3_row">
                                        <button class="back market_3_b_btn"><span class="odd">5.15</span></button>
                                        <button class="lay market_3_l_btn"><span class="odd">5.50</span></button>
                                    </div>
                                    <div>
                            ...
                            <div class="row m-t-10">
                                <div class="col-4 text-center">
                                    <div><span class="d-block"><b><span class="text-danger">D.</span> Dharam Veer</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_4_row">
                                        <button class="back market_4_b_btn"><span class="odd">7.65</span></button>
                                        <button class="lay market_4_l_btn"><span class="odd">8.35</span></button>
                                    </div>
                                    <div>
                                ...
                                <div class="col-4 text-center">
                                    <div><span class="d-block"><b><span class="text-danger">E.</span> Kis KisKo Pyaar Karoon</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_5_row">
                                        <button class="back market_5_b_btn"><span class="odd">3.85</span></button>
                                        <button class="lay market_5_l_btn"><span class="odd">4.15</span></button>
                                    </div>
                                    <div>
                                        <div class="ubook m-t-5 market_5_b_exposure market_exposure"><b>0</b></div>
                                    </div>
                                </div>
                                <div class="col-4 text-center ">
                                    <div><span class="d-block"><b><span class="text-danger">F.</span> Ghulam</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_6_row">
                                        <button class="back market_6_b_btn"><span class="odd">5.15</span></button>
                                        <button class="lay market_6_l_btn"><span class="odd">5.50</span></button>
                                    </div>
                                    <div>
                                        <div class="ubook m-t-5 market_6_b_exposure market_exposure"><b>0</b></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="aaa-content">
                                    ...
                                    <div class="text-center row">
                                        <div class="col-12">
                                            ...
                                            <div class="aaa-button clearfix suspended market_7_row">
                                                <button class="back market_7_b_btn"><span class="odd">1.31</span></button>
                                                <button class="lay market_7_l_btn"><span class="odd">1.36</span></button>
                                            </div>
                                            <div>
                                                <div class="ubook m-t-5 market_7_b_exposure market_exposure"><b>0</b></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="text-center m-t-5">
                                                ...
                                                <div class="m-b-5 m-t-5">
                                                    <button class="text-uppercase btn-theme suspended market_14_b_btn market_14_row"> Dulha Dulhan K-Q </button>
                                                </div>
                                                <div>
                                                    <div class="ubook m-t-5 market_14_b_exposure market_exposure"><b>0</b></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="text-center m-t-5">
                                                <div><b>1.97</b></div>
                                                <div class="m-b-5 m-t-5">
                                                    <button class="text-uppercase btn-theme suspended market_15_b_btn market_15_row"> Barati J-A </button>
                                                </div>
                                                <div>
                                                    <div class="ubook m-t-5 market_15_b_exposure market_exposure"><b>0</b></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row m-t-10">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="text-center">
                                                <div><b>1.97</b></div>
                                                <div class="m-b-5 m-t-5">
                                                    <button class="text-uppercase btn-theme  suspended market_8_b_btn market_8_row">
                                                ...
                                                <div>
                                                    <div class="ubook m-t-5 market_8_b_exposure market_exposure"><b>0</b></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-center ">
                                                <div><b>1.97</b></div>
                                                <div class="m-b-5 m-t-5">
                                                    <button class="text-uppercase btn-theme suspended market_9_b_btn market_9_row">
                                                ...
                                                <div>
                                                    <div class="ubook m-t-5 market_9_b_exposure market_exposure"><b>0</b></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 p-l-5">
                                <div class="aaa-content">
                                    <div class="row">
                                        <div class="col-8 text-right"><b>Cards 3.75</b></div>
                                        <div class="col-4">
                                            <div class="text-right">
