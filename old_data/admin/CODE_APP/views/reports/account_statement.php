                                        ...
                                        <div class="col-12">
                                            <div id="match_all" role="radiogroup" tabindex="-1">
                                                <div class="custom-control custom-control-inline custom-radio">
                                                    <input id="all" type="radio" name="match_all" autocomplete="off" value="0" class="custom-control-input" checked>
                                                    <label for="all" class="custom-control-label"><span>All</span></label>
                                                </div>
                                                <div class="custom-control custom-control-inline custom-radio">
                                                    <input id="matched" type="radio" name="match_all" autocomplete="off" value="1" class="custom-control-input">
...
function view_bets(bet_type){
            ...
            $.ajax({
                 ...
                 type: 'POST',
                 dataType: 'json',
                 data: {id: id,type:game_type,event_type:event_type,market_type:market_type,market_id:market_id,client_name:client_name,bet_type:bet_type},
                     ...
                     if (data.status) {
                         ...
                         if(data.result.length > 0){
                             ...
                             for (var i in data.result){
                                 ...
                                 html += '   <td class="text-right"> <span style="color: '+pl_span_class+'">'+ bet_wl +'</span> </td>';
