...
class Baccarat2 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Baccarat 2';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/baccarat/baccarat2', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'baccarat2', $event_id = '') {
        ...
        $shortcodeArr = array('baccarat2' => 'BACCARAT2');
    ...
    public function view_more_matched($game = 'baccarat2', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'baccarat2', $event_id = '') {
