...
class War extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Casino War';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/war/war', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'war', $event_id = '') {
        ...
        $shortcodeArr = array('war' => 'CASINO_WAR');
    ...
    public function view_more_matched($game = 'war', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'war', $event_id = '') {
