											...
											<div class="video-overlay">
												<div class="videoCards">
													<div>
														...
														<img id="card_c7" src="storage/front/img/cards_new/1.png"></div>
													</div>
													<div>
														...
														<div><img id="card_c2" src="storage/front/img/cards_new/1.png">
														 ...
														 <img id="card_c8" src="storage/front/img/cards_new/1.png"></div>
													</div>
													<div>
														<h3 class="text-white">Dragon</h3>
														<div><img id="card_c3" src="storage/front/img/cards_new/1.png"> 
														<img id="card_c6" src="storage/front/img/cards_new/1.png"> 
														<img id="card_c9" src="storage/front/img/cards_new/1.png"></div>
													</div>
												</div>
											</div>
										</div>
