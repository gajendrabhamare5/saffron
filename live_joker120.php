                    ...
                    <div class="row row5">
                        ...
                        <div class="col-md-10 featured-box">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".JOKER120_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                                            ...
                                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                            echo JOKER120_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                        ...
                                        <div class="casino-container teenpatti-1day">
                                            ...
                                            <div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a
                                                     href="casinoresults?game_type=joker120" class="">View All</a></span></div>
