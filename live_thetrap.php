                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">The Trap
                                                ...
                                                <!----></span>
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('thetrap')"
                                        ...
                                        <div class="video-container">
                                            ...
                                            if (!empty(IFRAME_URL_SET)) {
                                                ...
                                                <iframe class="iframedesign"
                                                    src="<?php echo IFRAME_URL . "" . TRAP_CODE; ?>" width="100%"
                                                ...
                                                <div class="casino-table-left-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row ">
                                                            ...
                                                            <div
                                                                class="casino-odds-box back back-1 market_1_row  market_1_b_btn">
                                                                1.56</div>
                                                            <div
                                                                class="casino-odds-box lay lay-1  market_1_row  market_1_l_btn">
                                                                1.61</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="casino-table-right-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row">
                                                            ...
                                                            <div
                                                                class="casino-odds-box back back-1 market_2_row  market_2_b_btn">
                                                                0</div>
                                                            <div
                                                                class="casino-odds-box lay lay-1 market_2_row  market_2_l_btn">
                                                                0</div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                                    href="casinoresults?game_type=trap">View All</a></span></div>
                                        <div class="casino-last-results" id="last-result"></div>
                                        <div class="trap-number-icon d-xl-none"><img
                                                src="storage/front/img/trap/trap13.png"><img
                                                src="storage/front/img/trap/trap14.png"><img
                                                src="storage/front/img/trap/trap15.png"></div>
                                    </div>
                                </div>
                                <?php
