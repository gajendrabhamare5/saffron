<div class="sidebar col-md-2">
  ...
  <div class="sidebar-title" data-toggle="collapse" data-target="#racingSports" aria-expanded="true">
 ...
 /*  if (CASINO_PLAY) { */
  ?>
    <div class="sidebar-title" data-toggle="collapse" data-target="#others" aria-expanded="true">
    ...
    <nav id="others" class="collapse show">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a href="live-slot" class="nav-link">Slot Game</a>
        </li>
        <li class="nav-item">
          <a href="live_fantasy" class="nav-link">Fantasy Game</a>
          <!-- live_fantasy -->
        </li>
      </ul>
    </nav>
 ...
 /*  } */
  ...
  <div class="sidebar-title">
    <h5 class="m-b-0" data-toggle="collapse" data-target="#allSports" aria-expanded="true">
      All Sports
    </h5>
  </div>
  <nav id="allSports" class="collapse show">
    <ul class="nav flex-column">
      <li class="nav-item">
        <a href="#PoliticsNested" class="nav-link toggle-nested" data-toggle="collapse" role="button"
        ...
        <ul id="PoliticsNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#PoliticsNested2" class="nav-link toggle-nested" data-toggle="collapse" role="button"
      ...
      <li class="nav-item">
        <a href="#cricketNested" class="nav-link toggle-nested" data-toggle="collapse" role="button"
        ...
        <ul id="cricketNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#cricketNested2" class="nav-link toggle-nested" data-toggle="collapse" role="button"
