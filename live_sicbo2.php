                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Sic Bo 2
                                                ...
                                                <small role="button" class="teenpatti-rules"  onclick="view_rules('sicbo2')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small>  
                                        ...
                                        <div class="video-container">
                                                ...
                                                ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL."".SICBO2_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                                <?php
                                            ...
                                            <div class="d-none d-xl-block w-100">
                                                ...
                                                <div class="sicbo-middle-small d-flex justify-content-between mt-2 flex-nowrap">
                                                    ...
                                                    <div class="sicbo-middle-midle d-flex flex-wrap w-auto justify-content-between">
                                                        <div class="sicbo-middle-top-row d-flex flex-wrap justify-content-between w-100" style="font-size: 18px;">
                                        ...
                                        <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=sicbo2">View All</a></span></div>
