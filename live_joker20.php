                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Teenpatti Joker 20-20
                                                ...
                                                <!---->
                                            </span> <small role="button" class="teenpatti-rules"  onclick="view_rules('joker20')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> <span class="float-right">
                                                Round ID:
                                        ...
                                        <div class="casino-detail">
                                            ...
                                            <div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a
                                                     href="casinoresults?game_type=joker20" class="">View All</a></span></div>
