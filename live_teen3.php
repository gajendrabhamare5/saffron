                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Instant Teenpatti
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('teen3')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN3_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                            ...
                                            <div class="casino-table-box">
                                                <div class="casino-table-left-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row suspended-row market_1_row">
                                                ...
                                                <div class="casino-table-right-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row suspended-row market_2_row">
                                                            <div class="casino-nation-detail">
                                                                <div class="casino-nation-name">Main</div>
