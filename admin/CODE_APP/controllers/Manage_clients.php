    ...
    public function get_user_list($offset = '', $user_status = '1', $user2 = 'hide')
    {
        ...
        if ($users_list) {
            ...
            ")->result_array();
                ...
                /*  $balances_dw = $this->db->query("
                 SELECT user_id, SUM(amount) AS account_balance
                 FROM " . ACCOUNT_DATABASE_NAME . "
                 WHERE user_id IN ($all_ids_str) and entry_type in (1,2)
                 GROUP BY user_id
             ")->result_array();
                 $balances_map_dw = array_column($balances_dw, 'account_balance', 'user_id'); */
            ...
            foreach ($users_list as $key => $ul) {
                ...
                $account_balance = $account_balance1 = $betting_liability = $master_betting_liability = $account_balance_dw = 0;
                ...
                if ($user2 == 'show') {
                    ...
                    foreach ($down_ids as $did) {
                        ...
                        /* $account_balance_dw += isset($balances_map_dw[$did]) ? $balances_map_dw[$did] : 0; */
                    ...
                    /* $client_pl = $account_balance - $account_balance_dw; */
