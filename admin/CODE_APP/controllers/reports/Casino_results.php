             ...
             <div class="col-md-12">
                 <div class="board-result-inner">
                     <div class="casino-result-desc" style="display: flex; flex-wrap: wrap; padding: 6px; box-shadow: 0 0 4px     -1px;">
                         <div class="casino-result-desc-item flex-column text-center" style="display: flex; justify-content: center; width: 100%;">
                             <div><span style="color:gray">Winner </span>' . $rdesc_array[0] . '</div>
                             <div><span style="color:gray">Others </span>' . $rdesc_array[1] . '</div>
...
<div class="container-fluid">
    ...
    <div class="players-row">';
        ...
        foreach ($playerIndexes as $i => $index) {
            ...
            /* <img src="'. MASTER_URL .'/assets/common/images/cards_new/' . $card1 . '.png">
                <img src="' . MASTER_URL . '/assets/common/images/cards_new/' . $card2 . '.png">
                <img src="' . MASTER_URL . '/assets/common/images/cards_new/' . $card3 . '.png">'; */
      
            $m_body_html .= '<div class="player-column">
                <div class="player-label">'. $playerLabel.'</div>
                
                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $card1 . '.png">
                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $card2 . '.png">
                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $card3 . '.png">';
    ...
    $m_body_html .= '
         ...
         <div class="row board-result m-t-10">
            ...
            } elseif ($result_data['game_type'] == 'teenjoker' || $result_data['game_type'] == 'joker20') {
...
.winner-icon {
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                                            ...
                                            <div class="col-sm text-center">
                                                ...
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[12] . '.png">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[13] . '.png">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[14] . '.png" class="m-r-10">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[15] . '.png" class="m-r-10">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[16] . '.png">
                                            </div>
                                            <div class="col-sm-3 text-center">
                                                <div class="c-title  text-center">6</div>
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[5] . '.png">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[11] . '.png">
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                                            ...
                                            <div class="col-sm-3 text-center">  
                                                ...
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[4] . '.png">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[10] . '.png">
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                                            ...
                                            <div class="col-sm text-center">
                                                ...
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[3] . '.png">
                                                <img src="' . WEB_URL . '/storage/front/img/cards_new/' . $cardsArr[9] . '.png">
...
<div class="row mt-2 justify-content-center">
    ...
    display: inline-grid !important;
            ...
            }else if ($result_data['game_type'] == 'goal2') {
                $result_status = $result_data['result_status'];
                $cards = json_decode($result_data['cards']);
                $descText = $result_data['desc_remakrs'];
                $rdesc_array = explode("#", $descText);
...
.owl-carousel .owl-item img {
    ...
    padding: 5px;
                        ...
                        <div class="owl-item active" style="width: 65.225px; margin-right: 2px;">
                            <div class="item"> <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $andar_card . '.png"> </div>
                        </div>';
                ...
                foreach ($bahar_cards as $bahar_card) {
                    $bahar_html .= '
                        <div class="owl-item active" style="width: 65.225px; margin-right: 2px;">
                            <div class="item"> <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $bahar_card . '.png"> </div>
                        </div>';
                }
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row player-container m-t-10">
                            <div class="player-number">
                                ...
                                <div class="player-image-container row">
                                    <div class="col-md-12 text-center">
                                        ' . (($cards[4] != 1) ? '<img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[4] . '.png" class="lrotate mr-2 m-r-15">' : '') . '
                                        <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[2] . '.png" class="mr-2 m-r-15">
                                        <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[0] . '.png" class="mr-2 m-r-15">
                                    </div>
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                            ...
                            <div class="player-number">
                                ...
                                <div class="player-image-container row">
                                    <div class="col-md-12 text-center">
                                        <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[1] . '.png" class="mr-2 m-r-15 ">
                                        <img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[3] . '.png" class="mr-2 m-r-15">
                                        ' . (($cards[5] != 1) ? '<img src="' . WEB_URL . 'storage/front/img/cards_new/' . $cards[5] . '.png" class="rrotate mr-2 m-r-15">' : '') . '
                                    </div>
                                    <div class="col-md-12 text-center win-cup-pos">
                                        ' . (($result_status == '2') ? '<div class="casino-result-cards-item">
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                  ...
                  if ($result_data['game_type'] == 'baccarat') {
                         $m_body_html .= '<div class="row mt-2 justify-content-center">
                        <div class="col-md-6">
                            <div class="casino-result-desc"
                                style="display: -webkit-flex;flex-wrap: wrap;padding: 6px;box-shadow: 0 0 4px -1px;margin-top:10px">
                                <div class="casino-result-desc-item  flex-column text-center"
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <span style="color:gray">Winner Pair  </span>
                                        <span>' . $desc_remakrs[1] . '</span>
                                    </div>
                                    <div>
                                        <span style="color:gray">Perfect  </span>
                                        <span>' . $desc_remakrs[2] . '</span>
                                    </div>
                                    <div>
                                        <span style="color:gray">Either  </span>
                                        <span>' . $desc_remakrs[3] . '</span>
                                    </div>
                                    <div>
                                        <span style="color:gray">Big/Small  </span>
                                        <span>' . $desc_remakrs[4] . '</span>
                                    </div>
                                </div>
                            </div>
...
<div class="row mt-2 justify-content-center" style="padding: 46px;">
			<div class="col-md-6">
				<div class="casino-result-desc"
					...
					<div class="casino-result-desc-item  flex-column text-center"
                       ...
                       ';
                       }else if (strtolower($result_data['game_type']) == 'mogambo') {
                ...
                $m_body_html .= '
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-10">
                            <div class="col-md-4">
                                <h4 class="text-center">Daga / Teja</h4>
                                <div class="player-image-container d-flex align-items-center justify-content-center">
                                    ' . (( $result_status == '2') ?
                                        '<div class="casino-result-cards-item">
                                            <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                            ...
                            <div class="col-md-4">
                                <h4 class="text-center">Mogambo</h4>
                                <div class="player-image-container d-flex align-items-center justify-content-center">
                                    ' . (( $result_status == '1') ?
                                        '<div class="casino-result-cards-item">
                                            <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
            ...
            }else if ($result_data['game_type'] == 'teenunique') {
                $cards = $result_data['cards'];
                $cards = json_decode($cards);
...
.unique-teen20-cardpopup img {
    ...
    /* border: 3px solid; */
                 ...
                 ';
            }elseif ($result_data['game_type'] == 'joker120' || $result_data['game_type'] == 'joker1') {
               ...
               $cards = $result_data['cards'];
                ...
                $m_body_html .= '</div>';
            }elseif ($result_data['game_type'] == 'poison20' || $result_data['game_type'] == 'poison') {
                $cards = $result_data['cards'];
                $result_status = $result_data['result_status'];
                $desc_remakrs = $result_data['desc_remakrs'];
                $rdesc_array = explode("#", $desc_remakrs);
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                ...
                $m_body_html .= '</div>
                    ...
                    ';
            }elseif ($result_data['game_type'] == 'teen62') {
    ...
    <img src="' . WEB_URL . '/storage/front/img/winner.png" class="winner-icon">
                ...
                $m_body_html .= '</div>
                     ...
                     ';
            }else if ($result_data['game_type'] == 'dolidana') {
            ...
            }  else if ($result_data['game_type'] == 'ourroullete') {
            ...
            } else if ($result_data['game_type'] == 'roulette11' || $result_data['game_type'] == 'roulette12' || $result_data['game_type'] == 'roulette13') {
        ...
        /* if ($market_type == 'MATCH_ODDS' || $market_type == 'BOOKMAKER_ODDS' || $market_type == 'BOOKMAKERSMALL_ODDS' || strpos($market_type, 'GAME_WINNER') !== false) { */
        $skipMarkets = [
    'FANCY_ODDS',
    'METER_ODDS',
    'KHADO_ODDS',
    ...
    'EVEN_ODD'
        ...
        if (!in_array($market_type, $skipMarkets) && $game_type1 == 0) {
            $this->db->where('market_type', $market_type);
        } else if ($game_type1 == 0) {
            $this->db->where_in('market_id', $market_id);
            $this->db->where('market_type', $market_type);
        }
    ...
    {
        $cards = array(
            'ASS' => array('type' => 'spade', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'ADD' => array('type' => 'diamond', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'AHH' => array('type' => 'heart', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'ACC' => array('type' => 'club', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'ass' => array('type' => 'spade', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'add' => array('type' => 'diamond', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'ahh' => array('type' => 'heart', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            'acc' => array('type' => 'club', 'name' => 'A', 'rank' => 1, 'priority' => 14),
            '2SS' => array('type' => 'spade', 'name' => '2', 'rank' => 2, 'priority' => 2),
            '2DD' => array('type' => 'diamond', 'name' => '2', 'rank' => 2, 'priority' => 2),
            '2HH' => array('type' => 'heart', 'name' => '2', 'rank' => 2, 'priority' => 2),
            '2CC' => array('type' => 'club', 'name' => '2', 'rank' => 2, 'priority' => 2),
            '3SS' => array('type' => 'spade', 'name' => '3', 'rank' => 3, 'priority' => 3),
            '3DD' => array('type' => 'diamond', 'name' => '3', 'rank' => 3, 'priority' => 3),
            '3HH' => array('type' => 'heart', 'name' => '3', 'rank' => 3, 'priority' => 3),
            '3CC' => array('type' => 'club', 'name' => '3', 'rank' => 3, 'priority' => 3),
            '4SS' => array('type' => 'spade', 'name' => '4', 'rank' => 4, 'priority' => 4),
            '4DD' => array('type' => 'diamond', 'name' => '4', 'rank' => 4, 'priority' => 4),
            '4HH' => array('type' => 'heart', 'name' => '4', 'rank' => 4, 'priority' => 4),
            '4CC' => array('type' => 'club', 'name' => '4', 'rank' => 4, 'priority' => 4),
            '5SS' => array('type' => 'spade', 'name' => '5', 'rank' => 5, 'priority' => 5),
            '5DD' => array('type' => 'diamond', 'name' => '5', 'rank' => 5, 'priority' => 5),
            '5HH' => array('type' => 'heart', 'name' => '5', 'rank' => 5, 'priority' => 5),
            '5CC' => array('type' => 'club', 'name' => '5', 'rank' => 5, 'priority' => 5),
            '6SS' => array('type' => 'spade', 'name' => '6', 'rank' => 6, 'priority' => 6),
            '6DD' => array('type' => 'diamond', 'name' => '6', 'rank' => 6, 'priority' => 6),
            '6HH' => array('type' => 'heart', 'name' => '6', 'rank' => 6, 'priority' => 6),
            '6CC' => array('type' => 'club', 'name' => '6', 'rank' => 6, 'priority' => 6),
            '7SS' => array('type' => 'spade', 'name' => '7', 'rank' => 7, 'priority' => 7),
            '7DD' => array('type' => 'diamond', 'name' => '7', 'rank' => 7, 'priority' => 7),
            '7HH' => array('type' => 'heart', 'name' => '7', 'rank' => 7, 'priority' => 7),
            '7CC' => array('type' => 'club', 'name' => '7', 'rank' => 7, 'priority' => 7),
            '8SS' => array('type' => 'spade', 'name' => '8', 'rank' => 8, 'priority' => 8),
            '8DD' => array('type' => 'diamond', 'name' => '8', 'rank' => 8, 'priority' => 8),
            '8HH' => array('type' => 'heart', 'name' => '8', 'rank' => 8, 'priority' => 8),
            '8CC' => array('type' => 'club', 'name' => '8', 'rank' => 8, 'priority' => 8),
            '9SS' => array('type' => 'spade', 'name' => '9', 'rank' => 9, 'priority' => 9),
            '9DD' => array('type' => 'diamond', 'name' => '9', 'rank' => 9, 'priority' => 9),
            '9HH' => array('type' => 'heart', 'name' => '9', 'rank' => 9, 'priority' => 9),
            '9CC' => array('type' => 'club', 'name' => '9', 'rank' => 9, 'priority' => 9),
            '10SS' => array('type' => 'spade', 'name' => '10', 'rank' => 10, 'priority' => 10),
            '10DD' => array('type' => 'diamond', 'name' => '10', 'rank' => 10, 'priority' => 10),
            '10HH' => array('type' => 'heart', 'name' => '10', 'rank' => 10, 'priority' => 10),
            '10CC' => array('type' => 'club', 'name' => '10', 'rank' => 10, 'priority' => 10),
            'JSS' => array('type' => 'spade', 'name' => 'J', 'rank' => 11, 'priority' => 11),
            'JDD' => array('type' => 'diamond', 'name' => 'J', 'rank' => 11, 'priority' => 11),
            'JHH' => array('type' => 'heart', 'name' => 'J', 'rank' => 11, 'priority' => 11),
            'JCC' => array('type' => 'club', 'name' => 'J', 'rank' => 11, 'priority' => 11),
            'QSS' => array('type' => 'spade', 'name' => 'Q', 'rank' => 12, 'priority' => 12),
            'QDD' => array('type' => 'diamond', 'name' => 'Q', 'rank' => 12, 'priority' => 12),
            'QHH' => array('type' => 'heart', 'name' => 'Q', 'rank' => 12, 'priority' => 12),
            'QCC' => array('type' => 'club', 'name' => 'Q', 'rank' => 12, 'priority' => 12),
            'KSS' => array('type' => 'spade', 'name' => 'K', 'rank' => 13, 'priority' => 13),
            'KDD' => array('type' => 'diamond', 'name' => 'K', 'rank' => 13, 'priority' => 13),
            'KHH' => array('type' => 'heart', 'name' => 'K', 'rank' => 13, 'priority' => 13),
