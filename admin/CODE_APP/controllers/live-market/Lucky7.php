...
class Lucky7 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Live Lucky 7';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky7/list', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function lucky7a() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Lucky7';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky7/lucky7a', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function lucky7eu() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - lucky-7 A';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky7/lucky7eu', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function lucky7eu2() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - lucky-7 C';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky7/lucky7eu2', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'lucky7', $event_id = '') {
        ...
        $shortcodeArr = array('lucky7' => 'LUCKY7', 'lucky7eu' => 'LUCKY7B', 'lucky7eu2' => 'LUCKY7C');
        $html = '';
    ...
    public function view_more_matched($game = 'lucky7', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'lucky7', $event_id = '') {
