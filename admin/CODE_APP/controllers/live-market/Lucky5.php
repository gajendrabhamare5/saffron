...
class lucky5 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Lucky5';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky5/lucky5', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

   

    public function active_bets($type = 'lucky6', $event_id = '') {
        ...
        $shortcodeArr = array('lucky6' => 'LUCKY6');
        $html = '';
    ...
    public function view_more_matched($game = 'lucky6', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'lucky6', $event_id = '') {
