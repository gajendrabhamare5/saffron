...
class lucky15 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Lucky15';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/lucky15/lucky15', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'lucky15', $event_id = '') {
        ...
        $shortcodeArr = array('lucky15' => 'LUCKY15');
        $html = '';
    ...
    public function view_more_matched($game = 'lucky15', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'lucky15', $event_id = '') {
