...
class Ballbyball extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Ball by ball';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/ballbyball/ballbyball', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'ballbyball', $event_id = '') {
        ...
        $shortcodeArr = array('ballbyball' => 'BALLBYBALL');
    ...
    public function view_more_matched($game = 'ballbyball', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'ballbyball', $event_id = '') {
