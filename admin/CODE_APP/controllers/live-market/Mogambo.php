...
class Mogambo extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Mogambo';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/mogambo/mogambo', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'mogambo', $event_id = '') {
        ...
        $shortcodeArr = array('mogambo' => 'MOGAMBO');
    ...
    public function view_more_matched($game = 'mogambo', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'mogambo', $event_id = '') {
