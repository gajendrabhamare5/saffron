...
class Card32 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('live-market/card32/list', array('handler' => $this));
    ...
    public function a() {
        ...
        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/card32/card32a', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function eu() {
        ...
        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/card32/card32eu', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'card32', $event_id = '') {
        ...
        $shortcodeArr = array('card32' => '32CARDS', 'card32eu' => '32CARDSB');
    ...
    public function view_more_matched($game = 'card32', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'card32', $event_id = '') {
...
//            $this->db->where(array('b.event_id' => $event_id, 'b.event_type' => $shortcodeArr[$type]));
            ...
            if ($bets_data) {
                ...
                if ($type == 'card32eu') {
                    ...
                    $exposure_player = $this->get_market_exposure($all_markets, $bets_data, array(1, 2, 3, 4), $my_partnership);
                    $exposure_any_3_b = $this->get_market_exposure($all_markets, $bets_data, array(13), $my_partnership);
                    $exposure_any_3_r = $this->get_market_exposure($all_markets, $bets_data, array(14), $my_partnership);
                    $exposure_2_b_2_r = $this->get_market_exposure($all_markets, $bets_data, array(27), $my_partnership);


                    $market_pl = array_merge($exposure_player, $exposure_any_3_b, $exposure_any_3_r, $exposure_2_b_2_r);

                    foreach ($bets_data as $bet_data) {

                        if (in_array($bet_data['market_id'], array(1, 2, 3, 4, 13, 14, 27))) {
                            continue;
                        }
                    ...
                    $market_pl = $this->get_market_exposure($all_markets, $bets_data, array(1, 2, 3, 4), $my_partnership);
                }
            }
        }
