...
class goal extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Goal';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/goal/goal', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'goal', $event_id = '') {
    ...
    public function view_more_matched($game = 'goal', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'goal', $event_id = '') {
