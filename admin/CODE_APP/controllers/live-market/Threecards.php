...
class Threecards extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('live-market/threecards/threecards', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = '3cardj', $event_id = '') {
        ...
        $shortcodeArr = array('3cardj' => '3_CARD_J');
    ...
    public function view_more_matched($game = '3cardj', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = '3cardj', $event_id = '') {
