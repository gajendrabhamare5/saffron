...
class Dt extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('live-market/dt/list', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function dtl20() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 20-20 DRAGON TIGER LION';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/dt/dtl20', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function dt20() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 20-20 DRAGON TIGER';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/dt/dt20', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function dt6() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 1 DAY DRAGON TIGER';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/dt/dt6', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function dt202() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 20-20 DRAGON TIGER 2';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/dt/dt202', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'dtl20', $event_id = '') {
        ...
        $shortcodeArr = array('dtl20' => 'DTL20', 'dt20' => '2020_DRAGON_TIGER', 'dt6' => 'ODI_DRAGON_TIGER', 'dt202' => '2020_DRAGON_TIGER2');
    ...
    public function view_more_matched($game = 'dtl20', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'dtl20', $event_id = '') {
