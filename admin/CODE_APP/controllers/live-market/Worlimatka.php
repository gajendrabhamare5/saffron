...
class worlimatka extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Worli matka';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/worli/worlimatka', array('handler' => $this));
    ...
    public function active_bets($type = 'worli', $event_id = '') {
        ...
        $shortcodeArr = array('worli' => 'WORLI_MATKA');
    ...
    public function view_more_matched($game = 'worli', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'worli', $event_id = '') {
