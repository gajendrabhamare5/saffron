...
class teenunique extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Teenunique';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/teenunique/teenunique', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

   

    public function active_bets($type = 'teenunique', $event_id = '') {
        ...
        $shortcodeArr = array('teenunique' => 'TEENUNIQUE');
        $html = '';
    ...
    public function view_more_matched($game = 'teenunique', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'teenunique', $event_id = '') {
