...
class Andarbahar extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Live Andarbahar';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/andarbahar/list', array('handler' => $this));
    ...
    public function ab() {
        ...
        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/andarbahar/ab', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function ab4() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - ANDAR BAHAR 150 CARDS ';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/andarbahar/ab4', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function abj() {
        ...
        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/andarbahar/abj', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
      ...
      public function ab3() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - ANDAR BAHAR 50 CARDS';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/andarbahar/ab3', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'ab20', $event_id = '') {
        ...
        $shortcodeArr = array('ab20' => 'AB20', 'abj' => 'ABJ','ab4' => 'AB204','ab3' => 'AB3');
        $html = '';
        if (array_key_exists($type, $shortcodeArr)) {
            ...
            foreach ($bets_data as $bet_data) {
                ...
                $tr_stype = ($bet_data['event_type'] == 'AB20') ? 'background:lightsalmon' : 'background:lightgreen';
                $html .= '<tr class="' . $tr_stype . '">';
    ...
    public function market_analysis($type = 'ab20', $event_id = '') {
