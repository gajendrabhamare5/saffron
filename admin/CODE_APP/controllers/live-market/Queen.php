...
class Queen extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - CASINO QUEEN';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/queen/queen', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'queen', $event_id = '') {
        ...
        $shortcodeArr = array('queen' => 'QUEEN');
    ...
    public function view_more_matched($game = 'queen', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'queen', $event_id = '') {
