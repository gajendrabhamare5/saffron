...
class goal2 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Goal 2';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/goal2/goal2', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'goal2', $event_id = '') {
        ...
        $shortcodeArr = array('goal2' => 'GOAL2');
    ...
    public function view_more_matched($game = 'goal2', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'goal2', $event_id = '') {
