...
class worli3 extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Worli3';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/worli/worli3', array('handler' => $this));
    ...
    public function active_bets($type = 'worli3', $event_id = '') {
        ...
        $shortcodeArr = array('worli3' => 'WORLI3');
    ...
    public function view_more_matched($game = 'worli3', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'worli3', $event_id = '') {
