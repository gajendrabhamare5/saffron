...
class Cmeter extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - CASINO METER';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/cmeter/cmeter', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'meter', $event_id = '') {
        ...
        $shortcodeArr = array('meter' => 'CASINO_METER');
    ...
    public function view_more_matched($game = 'meter', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'meter', $event_id = '') {
        ...
        if (array_key_exists($type, $shortcodeArr)) {
            ...
            $this->db->select('SUM(b.bet_stack) as total_stack, b.market_name, b.bet_type,b.market_id');
