            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">Worli Matka</span>
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . WORLI_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . WORLI_CODE; ?>" style="border:0px"></iframe> -->
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/worli/' + event_id,
            dataType: 'json',
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/worlimatka/active_bets/worli/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/worlimatka/view_more_matched/worli/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/worlimatka/market-analysis/worli/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
