    ...
    <div class="listing-grid casino-grid">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">Unique Teenpatti &nbsp;
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEENUNIQUE_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . TEENUNIQUE_CODE; ?>" style="border:0px"></iframe> -->
                        <div class="video-overlay">
                            <div id="game-cards">
                                <div class="card-inner">
                                    <!-- <h3 class="text-white">Card</h3> -->
                                    <div style="display: flex; flex-direction: column;">
                                        <img id="card_c1" class="teenuni_card1" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                        <img id="card_c2" class="teenuni_card2" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                        <img id="card_c3" class="teenuni_card3" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                        <img id="card_c4" class="teenuni_card4" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                        <img id="card_c5" class="teenuni_card5" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                        <img id="card_c6" class="teenuni_card6" src="<?php echo WEB_URL; ?>/storage/front/img/cards/1.png">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teenunique" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Unique Teenpatti Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teenunique/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/teenunique/active_bets/teenunique/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/teenunique/view_more_matched/teenunique/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/teenunique/market_analysis/teenunique/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
