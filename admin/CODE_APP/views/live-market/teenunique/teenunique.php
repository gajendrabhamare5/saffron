            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN20C_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . TEEN20C_CODE; ?>" style="border:0px"></iframe> -->
