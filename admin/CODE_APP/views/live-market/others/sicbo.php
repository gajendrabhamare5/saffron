                ...
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        <?php
                                            ...
                                            ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".SICBO_CODE;?>" width="100%"
                    ...
                    <div class="casino-last-result-title"><span>Last Result</span><span><a
                                href="<?php echo MASTER_URL; ?>/reports/casino-results?q=sicbo">View All</a></span>
                    </div>
            ...
            <div class="modal-dialog" style="min-width: 650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Sic Bo Result</h4>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/sicbo/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    ...
    if (xhr && xhr.readyState != 4)
        xhr.abort();
    xhr = $.ajax({
        url: MASTER_URL + '/live-market/others/active_bets/sicbo/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_view_more_bets() {
    ...
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/others/view_more_matched/sicbo/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    ...
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/others/market_analysis/sicbo/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
