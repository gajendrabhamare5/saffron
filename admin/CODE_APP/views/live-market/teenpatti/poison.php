    ...
    <div class="listing-grid casino-grid">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">Teenpatti Poison One Day
                        ...
                        <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('poison')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>  -->
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . POISON_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe>
                        <?php
                                        ...
                                        <div class="rules-body">
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <p>Welcome to Teenpatti Poison ONE DAY, a new variation of Teenpatti.</p>
                                                    <p>As Teenpatti games are becoming more and more famous and popular on our platforms, we are excited to introduce you to Teenpatti Poison ONE DAY. The game follows the same standard rules of Teenpatti but at the beginning of the round the dealer draws a Poison card before dealing to the players. The Poison card is toxic and makes the player lose as soon as any player gets it. If no Poison card is dealt then the game continues as per Teenpatti standard rules.
                                                    </p>
                                                    <p>For Example:</p>
                                                    <img src="/storage/front/img/rules/joker3.jpg" class="img-fluid">
                                                    <p>Player A wins because Player B is dealt with THE POISON card.</p>
                        ...
                        <div class="teen1daycasino-container mt-2">
                            ...
                            <div class="teen1dayright joker-other">
                                ...
                                <div class="mt-1">
                                    ...
                                    <div class="casino-box-row">
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item casino-box-odd casino-odds-box suspended-box market_7_row back-1 market_7_b_btn"><span class=" casino-odds market_7_b_val">0</span><span class="book-red">0</span></div>
                                        <div class="text-right casino-rb-box-player-range w-100 mt-1">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item casino-box-odd casino-odds-box suspended-box market_8_row back-1 market_8_b_btn"><span class=" casino-odds market_8_b_val">0</span><span class="book-red">0</span></div>
                                        <div class="text-right casino-rb-box-player-range w-100 mt-1">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item casino-box-odd casino-odds-box suspended-box market_9_row back-1 market_9_b_btn"><span class=" casino-odds market_9_b_val">0</span><span class="book-red">0</span></div>
                                        <div class="text-right casino-rb-box-player-range w-100 mt-1">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item casino-box-odd casino-odds-box suspended-box back-1 market_10_row market_10_b_btn"><span class=" casino-odds market_10_b_val">0</span><span class="book-red">0</span></div>
                                        <div class="text-right casino-rb-box-player-range w-100 mt-1">
                            ...
                            <!----> 
                            <div class="casino-last-result-title"><span>Last Result</span><span><a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=poison">View All</a></span></div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Teenpatti Poison One Day Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/poison/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        if (get_round_no() > 0) {
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: MASTER_URL + '/live-market/teenpatti/active_bets/poison/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/view_more_matched/poison/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/market_analysis/poison/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
