...
<div class="col-md-12 main-container">
        ...
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <!-- <div class="game-heading"><span class="card-header-title">Instant Teenpatti
                     ...
                     <div class="casino-video-title">
                            <span class="casino-name">Instant Teenpatti</span>
                    ...
                    <div class="video-container">
                        <?php
                                            ...
                                            ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN3_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                                    echo TEEN3_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                            ...
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <ul class="pl-4 pr-4 list-style">
                                                        <li>Instant Teenpatti is a shorter version of Indian origin game
                                                            teenpatti.
                                                        </li>
                                                        <li>This game is played with a regular 52 cards deck between
                                                            Player A and Player B .</li>
                                                        <li>In Instant Teenpatti all the three cards of Player A and the
                                                            first two cards of Player B will be pre-defined for all the
                                                            games .These five cards will be permanentley placed on the
                                                            table .</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="rules-section">
                                                    ...
                                                    <ul class="pl-4 pr-4 list-style">
                                                        ...
                                                        <li>Instant Teenpatti is a one card game. one card will be dealt
                                                            to Player B that will be the third and the last card of
                                                            player B which will decide the result of the game. Hence
                                                            that particular game will be
                                                            over.
                                                        </li>
                                                        <li>Now always the last drawn card of player B will be removed
                                                            and kept aside. Thereafter a new game will commence from the
                                                            remaining 46 cards then the same process will continue till
                                                            both the players have winning
                                                            chances or otherwise upto 35 cards or so.</li>
                                                        <li>The objective of the game is to make the best three card
                                                            hands as per the hand rankings and therefor win.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="rules-section">
                                                    <h6 class="rules-highlight">Rankings of card hands from Highest to
                                                        Lowest :
                                                    </h6>
                                                    <ul class="pl-4 pr-4 list-style">
                ...
                <div class="casino-table teenpatti2">
                    <div class="casino-table-box">
                                ...
                                <div class="casino-table-row ">
                                    <div class="casino-nation-detail"  style="display: flex;height: 48px;text-align: center;vertical-align: bottom;">
                                        ...
                                        <span class="d-flex justify-content-end align-items-baseline">
                                            <b class="casino-nation-book w-100 market_1_b_exposure market_exposure text-danger">0</b>
                                    ...
                                    <div class="casino-odds-box back back-1 market_1_b_btn suspended-row market_1_row">
                                        <span class="casino-odds">0</span></div>
                                    <div class="casino-odds-box lay lay-1 market_1_l_btn suspended-row market_1_row">
                                        <span class="casino-odds">0</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="casino-table-right-box">
                            <div class="casino-table-header" style="display: flex;height: 48px;text-align: center;vertical-align: bottom;">
                            ...
                            <div class="casino-table-body">
                                <div class="casino-table-row">
                                    <div class="casino-nation-detail">
                                        <div class="casino-nation-name d-flex justify-content-between align-items-baseline" style="width: 100%;background-color: #ddd;">Main
                                        <span  class="d-flex justify-content-end align-items-baseline">
                                            <b class="casino-nation-book w-100 market_2_b_exposure market_exposure text-danger">0</b>
                                             <div class="info-block m-t-5">
                                    ...
                                    <div class="casino-odds-box back back-1 market_2_b_btn suspended-row market_2_row">
                                        <span class="casino-odds">0</span></div>
                                    <div class="casino-odds-box lay lay-1 market_2_l_btn suspended-row market_2_row">
                                        <span class="casino-odds">0</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="casino-last-result-title"><span>Last Result</span><span><a
                            href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen3">View All</a></span></div>
    ...
    <div id="modalpokerresult" class="modal fade show" tabindex="-1">
        <div class="modal-dialog" style="min-width: 650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Instant Teenpatti Result</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen3/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    if (get_round_no() > 0) {
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/active_bets/teen3/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
...
function call_view_more_bets() {
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/view_more_matched/teen3/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/market_analysis/teen3/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
