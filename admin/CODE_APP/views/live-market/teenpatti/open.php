...
<script type="text/javascript">
    ...
    function clearCards() {
        // refresh(markettype);
        $("#card0").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card1").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card2").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card3").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card4").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card5").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card6").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card7").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card8").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card9").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card10").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card11").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card12").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card13").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card14").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card15").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card16").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card17").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card18").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card19").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card20").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card21").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card22").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card23").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card24").attr("src", site_url + "storage/front/img/cards_new/1.png");
        $("#card25").attr("src", site_url + "storage/front/img/cards_new/1.png");
