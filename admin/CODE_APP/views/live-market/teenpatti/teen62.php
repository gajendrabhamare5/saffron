        ...
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">V VIP Teenpatti 1-day
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN62_CODE; ?>" width="100%"
                        ...
                        <!--  <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
											<iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                                echo TEEN62_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                    ...
                    <div class="casino-detail">
                                    ...
                                    <div class="casino-table-body">
                                        ...
                                        <div class="casino-table-row">
                                            ...
                                            <div class="casino-odds-box back back-1 market_17_b_btn  market_17_row">
                                                <span class="casino-odds market_17_b_val">0</span>
                                            </div>
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen62">View All</a></span>
                        </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex='-1'>
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">V VIP Teenpatti 1-day Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script type="text/javascript">
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen62/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
...
<script>
    ...
    function call_active_bets() {
        ...
        if (get_round_no() !== 0) {
            ...
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: '<?php echo MASTER_URL; ?>/live-market/teenpatti/active_bets/teen62/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: '<?php echo MASTER_URL; ?>/live-market/teenpatti/view_more_matched/teen62/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: '<?php echo MASTER_URL; ?>/live-market/teenpatti/market_analysis/teen62/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results) {
