            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div class="casino-video-title">
                            <span class="casino-name">Instant Teenpatti 2.0</span>
                    ...
                    <div class="video-container">
                        ...
                        <?php
                                                        ...
                                                        ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".TEEN32_CODE;?>" width="100%"
...
<div class="rules-section">
                    ...
                    <div class="casino-detail">
                                        ...
                                        <div class="casino-table-row  ">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                <div class="casino-nation-name   d-flex justify-content-between vertical-align: baseline;" style="width: 100%;">Main
                                                    <span>
                                                        <b class="casino-nation-book text-center market_1_b_exposure market_exposure text-danger"></b>
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                <div class="casino-nation-name  d-flex justify-content-between vertical-align: baseline;" style="width: 100%;">Main
                                                    <span>
                                                        <b class="casino-nation-book text-center market_2_b_exposure market_exposure text-danger"></b>
                                            ...
                                            <div
                                                class="casino-odds-box back  market_2_row back-1 market_2_b_btn suspended-box">
                                                <span class="casino-odds">1.76</span></div>
                                            <div
                                                class="casino-odds-box lay  market_2_row lay-1 market_2_l_btn suspended-box">
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen32">View All</a></span>
                        </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Instant Teenpatti 2.0 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
    ...
    if (data && data[0]) {
        ...
        data.forEach((runData) => {
            ...
            html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type +
                ')"  class="result ml-1 ' + (parseInt(runData.win) == 1 ? 'result-b' : 'result-a') + '">' + (
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen32/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    if (get_round_no() > 0) {
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/active_bets/teen32/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
...
function call_view_more_bets() {
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/view_more_matched/teen32/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/market_analysis/teen32/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
