...
<div class="col-md-12 main-container">
    ...
    border-top: 1px solid #c7c8ca; */
        ...
        .casino-nation-detail-a {
            color: #fc4242;
        }

        .casino-nation-detail-b {
            color: #ef910f;
        }
    ...
    <div class="listing-grid casino-grid">
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span>20-20 Teenpatti C

                            <!---->
                        </span>
                        <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('teen20c')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>  -->
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN20C_CODE; ?>" width="100%"
                    ...
                    <div class="casino-table">
                        <div class="casino-table-box">
                            <div class="casino-table-left-box">
                                <div class="casino-table-header">
                                    <div class="casino-nation-detail-a p-1">Player A</div>
                                </div>
                                <div class="casino-table-body">
                                    <div class="casino-table-row">
                                        <div class="casino-odds-box">Player <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                        ...
                                        <div class="casino-odds-box">3 Baccarat <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                        ...
                                        <div class="casino-odds-box">Total <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                        ...
                                        <div class="casino-odds-box">Pair Plus <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                    ...
                                    <div class="casino-table-row">
                                        <div style="width: 24%;">
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_1_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        ...
                                        <div style="width: 24%;">
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_5_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        <div style="width: 24%;">
                                            <div
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_11_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        <div style="width: 25%;">
                                            <div
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_3_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="teenpatti20-other-oods d-md-none">
                                <div class="casino-table-left-box">
                                    <div class="casino-odds-box back suspended-box market_7_row back-1 market_7_b_btn">
                                        <div><img src="/storage/front/img/cards/1.png"><img
                                                src="/storage/front/img/cards/1.png"></div>
                                        <div><span class="casino-odds market_7_b_value">0</span>
                                            <div
                                                class="casino-nation-book text-center market_7_b_exposure market_exposure text-danger">
                                                0</div>
                                        </div>
                                    </div>
                                    <div class="casino-odds-box back suspended-box market_8_row back-1 market_8_b_btn">
                                        <div><img src="/storage/front/img/cards/1.png"><img
                                                src="/storage/front/img/cards/1.png"></div>
                                        <div><span class="casino-odds market_8_b_value">0</span>
                                            <div
                            ...
                            <div class="casino-table-right-box">
                                <div class="casino-table-header">
                                    <div class="casino-nation-detail-b p-1">Player B</div>
                                </div>
                                <div class="casino-table-body">
                                    <div class="casino-table-row">
                                        <div class="casino-odds-box">Player <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                        ...
                                        <div class="casino-odds-box">Pair Plus
                                    ...
                                    <div class="casino-table-row">
                                        <div style="width: 24%;">
                                            <div
                                                class="casino-odds-box back suspended-box market_2_row back-1 market_2_b_btn" style="width: 100%;">
                                                <span class="casino-odds market_2_b_value">0</span>

                                            </div>
                                            <div
                                                class="casino-nation-book text-center market_2_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        <div style="width: 24%;">
                                            <div
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_6_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        <div style="width: 24%;">
                                            <div
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_12_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                        <div style="width: 25%;">
                                            <div
                                            ...
                                            <div
                                                class="casino-nation-book text-center market_4_b_exposure market_exposure" style="color: red;">
                                                0</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="teenpatti20-other-oods d-md-none">
                                <div class="casino-table-right-box">
                                    <div class="casino-odds-box back suspended-box market_9_row back-1 market_9_b_btn">
                                        <div><img src="/storage/front/img/cards/1.png"><img
                                                src="/storage/front/img/cards/1.png"></div>
                                        <div><span class="casino-odds market_9_b_value">0</span>
                                            <div
                                    ...
                                    <div
                                        ...
                                        <div><img src="/storage/front/img/cards/1.png"><img
                                                src="/storage/front/img/cards/1.png"></div>
                                        <div><span class="casino-odds market_10_b_value">0</span>
                                            <div
                        ...
                        <div class="teenpatti20-other-oods d-none d-md-flex">
                            ...
                            <div class="casino-table-right-box">
                                ...
                                <div style="width: 49%;">
                                    <div class="casino-odds-box back suspended-box market_10_row back-1 market_10_b_btn" style="width: 100%;">
                                        <div><img src="/storage/front/img/cards/heart.png"><img
                                                src="/storage/front/img/cards/diamond.png"></div>
                                        <div><span class="casino-odds market_10_b_value">0</span>
                    ...
                    <div class="casino-last-result-title"><span>Last Result</span><span><a
                                href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen20c">View All</a></span>
                    </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">20-20 Teenpatti C Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script type="text/javascript">
    ...
    function websocket(type) {
        ...
        socket.on('gameResult', function(args) {
            console.log("update result", args);
            if (args.data) {
        ...
        if (data && data[0]) {
            ...
            data.forEach((runData) => {
                ...
                html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type +
                    ')"  class="casino-last-results result ' + ab + '">' + ab1 + '</span>';
            });
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen20c/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        if (get_round_no() > 0) {
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: MASTER_URL + '/live-market/teenpatti/active_bets/teen20c/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/view_more_matched/teen20c/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/market_analysis/teen20c/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
