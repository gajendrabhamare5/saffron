                ...
                <div class="coupon-card">
                    <!-- <div class="game-heading"><span class="card-header-title">Instant Teenpatti 3.0
                     ...
                     <div class="casino-video-title">
                            <span class="casino-name">Instant Teenpatti 3.0</span>
                    ...
                    <div class="video-container">
                        <?php
                                                    ...
                                                    ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".TEEN33_CODE;?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                            echo TEEN33_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                        ...
                        <div class="video-overlay" style="top: 15%;">
                                ...
                                <div class="tooltip-box">
                                    ...
                                    <div class="tooltip-content">
                                        <div class="rules-body">
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <ul class="pl-4 pr-4 list-style">
                                                        <li>Instant Teenpatti-3.0 is a shorter version of Indian origin
                                                            game teenpatti.</li>
                                                        <li>This game is played with a regular 52 cards deck between
                                                            player A and Player B.</li>
                                                        <li>In Instant Teenpatti 3.0 all three cards of Player A and
                                                            first two cards of Player B will be pre-defined for all the
                                                            games. These five cards will be permanently placed on the
                                                            table</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="rules-section">
                                                    ...
                                                    <ul class="pl-4 pr-4 list-style">
                                                        ...
                                                        <li>Instant Teenpatti-3.0 is a one card game. One card will be
                                                            dealt to Player B that will be the third and last card of
                                                            player B which will decide the result of the game. Hence
                                                            that particular game will be over.</li>
                                                        <li>Now always the last drawn card of player B will be removed
                                                            and kept aside. Thereafter a new game will commence for the
                                                            remaining 46 cards then the same process will continue till
                                                            both the player have winning chances or otherwise upto 35
                                                            cards or so.</li>
                                            ...
                                            <div>
                                                <div class="rules-section">
                                                    <h6 class="rules-highlight">Rankings of cards hands from Highest to
                                                        lowest:</h6>
                                                    <ul class="pl-4 pr-4 list-style">
                    ...
                    <div class="casino-detail">
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row">
                                            ...
                                            <div
                                                ...
                                                <span class="casino-odds">1.76</span></div>
                                            <div
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen33">View All</a></span>
                        </div>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen33/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    if (get_round_no() > 0) {
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/active_bets/teen33/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
...
function call_view_more_bets() {
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/view_more_matched/teen33/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/market_analysis/teen33/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
