    ...
    <div class="listing-grid casino-grid">
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">Unlimited Joker 20-20

                            <!---->
                        </span> 
                        <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('joker120')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>  -->
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . JOKER120_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe>
                        <?php
                        ...
                        <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                echo JOKER120_CODE; ?>" width="100%" height="400"
                        ...
                        <div class="teen1daycasino-container mt-2">
                            <div class="teen1dayleft">
                                <div class="casino-box-row">
                                    ...
                                    <img src="/storage/front/img/cards/A.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range1" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                    ...
                                    <div class="back casino-bl-box-item suspended-box"><span class="casino-box-odd">0</span></div>
                                    <div class="lay casino-bl-box-item suspended-box"><span class="casino-box-odd">0</span></div>
                                    </div>
                                </div>
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range10" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/2.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range2" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range20" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range20" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/3.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range3" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range30" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range30" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/4.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range4" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range40" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range40" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/5.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range5" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range50" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range50" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/6.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range6" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range60" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range60" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/7.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range7" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range70" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range70" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/8.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range8" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range80" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range80" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/9.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range9" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range90" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range90" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/10.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range101" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range101" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range100" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range100" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/J.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range11" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range110" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range110" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/Q.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range12" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range120" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range120" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/K.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range13" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range13" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range130" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range130" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    <div class="casino-nation-name">
                                    <img src="/storage/front/img/cards/14.png"> <b>Player A</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range14" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range14" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <!----> <b>Player B</b> 
                                    <div class="float-right">
                                        <span class="mr-2 book-red">0</span> <i data-toggle="collapse" data-target="#range140" aria-expanded="false" class="fas fa-info-circle collapsed"></i> 
                                        <div id="range140" class="icon-range collapse">
                                            R:<span>100</span>-<span>300K</span>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <!----> 
                            <div class="casino-last-result-title"><span>Last Result</span><span><a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=joker120">View All</a></span></div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Unlimited Joker 20-20 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
/*             refresh(markettype); */
            ...
            var ab = "";
            var ab1 = "";
            casino_type = "'joker120'";
            data.forEach((runData) => {
              
                eventId = runData.mid == 0 ? 0 : typeof runData.mid == "string" ? runData.mid.split(".")[1] : runData.mid;
                html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type + ')"  class="ball-runs  ' + ab + ' result">R</span>';
            });
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/joker120/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        if (get_round_no() > 0) {
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: MASTER_URL + '/live-market/teenpatti/active_bets/joker120/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/view_more_matched/joker120/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/market_analysis/joker120/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
