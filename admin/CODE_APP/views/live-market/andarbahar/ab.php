                ...
                for (var j in data['t3']) {
                    ...
                    if (aall != "") {
                        for (ac in aall) {
                            ...
                            acards_html_array.push('  <div class="owl-item " id="owl_ac_img_id' + ac + '" style=""><div class="item"><img id="ab_cards_21" src="/storage/front/img/cards_new/' + aall[ac] + '.png"></div></div>');
