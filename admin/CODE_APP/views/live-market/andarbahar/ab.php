            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">ANDAR BAHAR </span>
                    ...
                    <div class="video-container">
                        ...
                        if (!empty(IFRAME_URL_SET)) {
                            ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ANDARBAHAR_CODE; ?>" width="100%"
                        ...
                        echo ANDARBAHAR_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                    ...
                    <div class="casino-detail">
                        <div class="casino-table">
                            <!-- <div class="casino-table-box">
                                                    <div class="andar-box suspended-box">
                                                        <div class="ab-title">ANDAR</div>
                                                        <div class="ab-cards">
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div class=""><img src="/storage/front/img/andar_bahar/0.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div class=""><img src="/storage/front/img/andar_bahar/0.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                    ...
                                                    <div class="bahar-box">
                                                        ...
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/1.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/2.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/3.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/4.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/5.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/6.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/7.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/8.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/9.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/10.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/11.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">3</div>
                                                            <div><img src="/storage/front/img/andar_bahar/12.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        <div class="card-odd-box">
                                                            <div class="casino-odds">4</div>
                                                            <div><img src="/storage/front/img/andar_bahar/13.jpg"></div>
                                                            <div class="casino-nation-book"></div>
                                                        </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-12">
                                <div class="ab-2-box">
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-6 text-center andar-cards-box me-2"
                                            ...
                                            <div class=" m-r-5 card-image ">
                                                ...
                                                <div class="market_1_l_btn lay-1 "><img  id="ab_cards_1"
                                                        src="/storage/front/img/andar_bahar/0.jpg"> </div>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_2_l_btn back-1"><img id="ab_cards_2"
                                                        src="/storage/front/img/andar_bahar/0.jpg"></div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_3_l_btn back-1"><img id="ab_cards_3"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_4_l_btn back-1"><img id="ab_cards_4"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_5_l_btn back-1"><img id="ab_cards_5"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_6_l_btn back-1"><img  id="ab_cards_6"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_7_l_btn back-1"><img id="ab_cards_7"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_8_l_btn back-1"><img id="ab_cards_8"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_8_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_9_l_btn back-1"><img id="ab_cards_9"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_10_l_btn back-1"><img id="ab_cards_10"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_11_l_btn back-1"><img id="ab_cards_11"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_12_l_btn back-1"><img id="ab_cards_12"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_13_l_btn back-1"><img id="ab_cards_13"
                                        ...
                                        <div class="col-6 text-center bahar-cards-box" style=" display: inline-block;">
                                            <h3 style="color: #ef910f">Bahar</h3>
                                            <div class=" m-r-5 card-image ">
                                                <!-- <div class="casino-odds market_21_l_value">1</div> -->
                                                <div class=" market_21_l_btn back-1"><img id="ab_cards_21"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_22_l_btn back-1"><img id="ab_cards_22"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_23_l_btn back-1"><img id="ab_cards_23"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_24_l_btn back-1"><img id="ab_cards_24"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_25_l_btn back-1"><img id="ab_cards_25"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_26_l_btn back-1"><img id="ab_cards_26"
                                                        src="/storage/front/img/andar_bahar/6.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_27_l_btn back-1"><img id="ab_cards_27"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_28_l_btn back-1"><img id="ab_cards_28"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_29_l_btn back-1"><img id="ab_cards_29"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_30_l_btn back-1"><img id="ab_cards_30"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_31_l_btn back-1"><img id="ab_cards_31"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_32_l_btn back-1"><img id="ab_cards_32"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_33_l_btn back-1"><img id="ab_cards_33"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                        ...
                        <marquee style="color: #17a2b8;">Payout : Bahar 1st Card 25% and All Other Andar-Bahar Cards 100%.</marquee>
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=ab20">View All</a></span>
                        </div>
                        <!-- <div class="casino-last-results"><span class="result result-b">R</span><span
                                class="result result-b">R</span><span class="result result-b">R</span><span
                                class="result result-b">R</span><span class="result result-b">R</span><span
                                class="result result-b">R</span><span class="result result-b">R</span><span
                                class="result result-b">R</span><span class="result result-b">R</span><span
                                class="result result-b">R</span></div> -->
            ...
            <div class="modal-dialog" style="min-width: 650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Andar Bahar Result</h4>
                ...
                for (var j in data['t3']) {
                    ...
                    if (aall != "") {
                        for (ac in aall) {
                            ...
                            acards_html_array.push('  <div class="owl-item " id="owl_ac_img_id' + ac + '" style=""><div class="item"><img id="ab_cards_21" src="/storage/front/img/cards/' + aall[ac] + '.png"></div></div>');
                    ...
                    if (ball != "") {
                        for (bc in ball) {
                            ...
                            bcards_html_array.push('  <div class="owl-item " id="owl_bc_img_id_' + bc + '"  style=""><div class="item"><img id="ab_cards_21" src="/storage/front/img/cards/' + ball[bc] + '.png"></div></div>');
                    ...
                    /* if(aall && aall.length){
                        if(aall.length != current_andar_number + 1 && current_andar_number == -1){
                            
                            current_andar_number = -1;
                            for(ac in aall){
                                acards_html = "";
                            
                                if(ac >= 6){
                                    new_ac = ac - 6;
                                    $("#owl_ac_img_id"+new_ac).removeClass("active");
                                }
                                acards_html ='  <div class="owl-item active" id="owl_ac_img_id'+ac+'" style="width: 31.667px; margin-left: 2px;"><div class="item"><img src="/storage/front/img/cards/'+aall[ac]+'.png"></div></div>';
                                if(ac == 0){
                                    $("#cards_1").html(acards_html);
                                }
                                else{
                                    app_ac = ac -1;
                                    $("#owl_ac_img_id"+app_ac).after(acards_html);
                                }
                                current_andar_number++;
                                
                            }
                        
                        }
                        else if(aall.length != (parseInt(current_andar_number) + 1)){
                            
                            if(current_andar_number == -1){
                                current_andar_number++;
                                acards_html ='  <div class="owl-item active" id="owl_ac_img_id'+current_andar_number+'" style="width: 31.667px; margin-left: 2px;"><div class="item"><img src="/storage/front/img/cards/'+aall[current_andar_number]+'.png"></div></div>';
                                $("#cards_1").html(acards_html);
                                
                            }
                            else if(current_andar_number >= 5){
                                current_andar_number++;
                                ac = current_andar_number - 6;
                                $("#owl_ac_img_id"+ac).removeClass("active");
                                acards_html ='  <div class="owl-item active" id="owl_ac_img_id'+current_andar_number+'" style="width: 31.667px; margin-left: 2px;"><div class="item"><img src="/storage/front/img/cards/'+aall[current_andar_number]+'.png"></div></div>';
                                $("#owl_ac_img_id"+current_andar_number).after(acards_html);
