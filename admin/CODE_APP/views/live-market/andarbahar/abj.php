                                        ...
                                        <div class="card-inner">
                                            ...
                                            <div class="row row5">
                                                <div class="col-2"><img id="card_1st_andar"
                                                        src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png"></div>
                                                <div class="col-8">
                                                    <div id="andar-cards"
            ...
            var desc = data.t1[0].cards || data.t1[0].Cards;
                ...
                for (var i in desc) {
                    if (i == 0) {
                        ...
                        $("#card_1st_andar").attr("src", site_url + "storage/front/img/cards/" + desc[i] +
                            ".png");
                    } else if (i == 1) {
                        $("#card_1st_bahar").attr("src", site_url + "storage/front/img/cards/" + desc[i] +
                            ".png");
                    } else {
                        if (desc[i] != 1) {
                            if (i % 2 == 0) {
                ...
                if (aall != "") {
                    for (ac in aall) {
                        ...
                        acards_html_array.push('  <div class="owl-item " id="owl_ac_img_id' + ac +
                            ...
                            'storage/front/img/cards/' + aall[ac] + '.png"></div></div>');
                ...
                if (ball != "") {
                    for (bc in ball) {
                        ...
                        bcards_html_array.push('  <div class="owl-item " id="owl_bc_img_id_' + bc +
                            '"  style=""><div class="item"><img src="' + site_url +
                            'storage/front/img/cards/' + ball[bc] + '.png"></div></div>');
