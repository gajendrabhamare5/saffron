            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">Andar Bahar 2 &nbsp;
                    ...
                    <div style="position: relative;">
                        ...
                        if(!empty(IFRAME_URL_SET)){
                               ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".ANDARBAHAR2_CODE;?>" width="100%"
                        ...
                        <div class="video-overlay">
                            <div id="game-cards">
                                <div class="row row5 align-items-center">
                                    ...
                                    <div class="col-2"><img id="card_joker"
                                            src="<?php echo WEB_URL; ?>storage/front/img/cards_new/1.png"
                                            class="card-right"></div>
                                    <div class="col-10">
                                        <div class="card-inner">
                                            <p class="text-white m-b-0"><b>Andar</b></p>
                                            <div class="row row5">
                                                <div class="col-2"><img id="card_1st_andar"
                                                        src="<?php echo WEB_URL; ?>storage/front/img/cards_new/1.png"></div>
                                                <div class="col-8">
                                                    <div id="andar-cards"
                                        ...
                                        <div class="card-inner">
                                            ...
                                            <div class="row row5">
                                                <div class="col-2"><img id="card_1st_bahar"
                                                        src="<?php echo WEB_URL; ?>storage/front/img/cards_new/1.png"></div>
                                                <div class="col-8">
                                                    <div id="bahar-cards"
                                                        class="ab-rtlslider owl-carousel owl-theme owl-rtl owl-loaded owl-drag">
                                            ...
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    ...
                                                    <ul class="pl-4 pr-4 list-style">
                                                        <li>
                                                            Andar Bahar is a very simple game that involves the use of a
                                                            single pack of cards.Game is played between the House and
                                                            the Player. The dealer deals a single card face up on the
                                                            Joker place and then proceeds to deal cards face up on A
                                                            (ANDAR) and B (BAHAR)
                                                            spots. When a card appears that matches the value of the
                                                            Joker card then the game ends. Before the start of the game,
                                                            players bet on which side they think the game will end.
                                                        </li>
                                                        <li>
                                                            Before dealer starts dealing/opening cards from the deck,
                                                            he/she also offers a side bet to the players who have
                                                            estimated time to bet if the card/joker will be dealt as the
                                                            1st card.
                                                        </li>
                                                        <li>
                                                            If the 1st placed card doesn't match the value of the
                                                            Joker's card, the game continues and the dealer then offers
                                                            the option to players to put their 2nd bet on the same joker
                                                            card to be dealt either on ANDAR or on BAHAR. The players
                                                            again have estimated
                                                            time to decide if they want to place a 2nd bet. Dealer deals
                                                            the cards one at a time alternating between two spots.
                                                        </li>
                                                        <li>
                                                            If the 1st dealt card in 1st bet matches the joker’s card,
                                                            Bahar side wins with payout 1:0,5
                                                        </li>
                                                        <li>
                                                            If the 1st dealt card in 1st bet matches the joker’s card,
                                                            Andar side wins with payout 1:0,5
                                                        </li>
                                                        <li>
                                                            If the 2nd dealt card in 1st bet matches the joker’s card,
                                                            Bahar side wins with payout 1:0,5
                                                        </li>
                                                        <li>
                                                            If the 2nd dealt card in 1st bet matches the joker’s card,
                                                            Andar side wins with payou 1:0,5
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="ab-2-container"> 
                            <div class="bet-a">
                                ...
                                <div class="sa">
                                    ...
                                    <div class="book market_1_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="first-bet">
                                    ...
                                    <div class="book market_2_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="second-bet">
                                    ...
                                    <div class="book market_3_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="a-title">A</div>
                            </div>
                            <div class="bet-a">
                                ...
                                <div class="sa">
                                    ...
                                    <div class="book market_4_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="first-bet">
                                    ...
                                    <div class="book market_5_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="second-bet">
                                    ...
                                    <div class="book market_6_b_exposure market_exposure" style="color: red;">0</div>
                                </div>
                                <div class="a-title">B</div>
                            </div>
                        </div>
                                ...
                                <div class="ab-2-box">
                                    <div class="row row5">
                                        <div class="col-6 text-center">
                                            ...
                                            <div class="back mt-1 blbox suspended market_24_row market_24_b_btn back-1">
                                                <span class="odd market_24_b_value">1.83</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_24_b_exposure market_exposure">0</span></div>
                                        </div>
                                        <div class="col-6 text-center">
                                            <div class="bltitle"><b>Even</b></div>
                                            <div class="back mt-1 blbox suspended market_25_row market_25_b_btn back-1">
                                                <span class="odd market_25_b_value">2.12</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_25_b_exposure market_exposure">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="ab-2-box">
                                    <div class="row row5">
                                        <div class="col-3 text-center">
                                            <div class="bltitle"><img
                                                    src="<?php echo WEB_URL; ?>storage/front/img/cards/spade_race.png">
                                            </div>
                                            <div class="back mt-1 blbox suspended market_20_row market_20_b_btn back-1">
                                                <span class="odd market_20_b_value">3.83</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_20_b_exposure market_exposure">0</span></div>
                                        </div>
                                        <div class="col-3 text-center">
                                            <div class="bltitle"><img
                                                    src="<?php echo WEB_URL; ?>storage/front/img/cards/heart_race.png">
                                            </div>
                                            <div class="back mt-1 blbox suspended market_22_row market_22_b_btn back-1">
                                                <span class="odd market_22_b_value">3.83</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_22_b_exposure market_exposure">0</span></div>
                                        </div>
                                        <div class="col-3 text-center">
                                            <div class="bltitle"><img
                                                    src="<?php echo WEB_URL; ?>storage/front/img/cards/club_race.png">
                                            </div>
                                            <div class="back mt-1 blbox suspended market_21_row market_21_b_btn back-1">
                                                <span class="odd market_21_b_value">3.83</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_21_b_exposure market_exposure">0</span></div>
                                        </div>
                                        
                                        <div class="col-3 text-center">
                                            <div class="bltitle"><img
                                                    src="<?php echo WEB_URL; ?>storage/front/img/cards/diamond_race.png">
                                            </div>
                                            <div class="back mt-1 blbox suspended market_23_row market_23_b_btn back-1">
                                                <span class="odd market_23_b_value">3.83</span></div>
                                            <div class="mt-1"><span style="color: red;"
                                                    class="market_23_b_exposure market_exposure">0</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row5 mt-2">
                            <div class="col-12">
                                <div class="ab-2-box">
                                    <div class="row"></div>
                                    <div class="row">
                                        <div class="col-12 text-center market_7_b_value" style="background-color: rgb(221, 221, 221);padding: 5px;" >
                                            0
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-12 text-center">
                                            <div class=" m-r-5 card-image ">
                                                <div class="suspended market_7_row market_7_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/1.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_7_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_8_row market_8_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/2.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_8_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_9_row market_9_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/3.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_9_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_10_row market_10_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/4.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_10_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_11_row market_11_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/5.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_11_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_12_row market_12_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/6.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_12_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_13_row market_13_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/7.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_13_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_14_row market_14_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/8.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_14_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_15_row market_15_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/9.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_15_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_16_row market_16_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/10.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_16_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_17_row market_17_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/11.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_17_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_18_row market_18_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/12.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_18_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class=" m-r-5 card-image">
                                                <div class="suspended market_19_row market_19_b_btn back-1"><img
                                                        src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/13.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: red;"
                                                        class="market_19_b_exposure market_exposure">0</b></div>
                                            </div>
                                            <div class="text-right casino-min-max">R:<span>10</span>-<span>1L</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=abj"
...
var CARDS_IMG_URL = site_url + "storage/front/img/cards_new";
            ...
            var desc = data.t1[0].cards || data.t1[0].Cards;
                ...
                for (var i in desc) {
                    if (i == 0) {
                        ...
                        $("#card_1st_andar").attr("src", site_url + "storage/front/img/cards_new/" + desc[i] +
                            ".png");
                    } else if (i == 1) {
                        $("#card_1st_bahar").attr("src", site_url + "storage/front/img/cards_new/" + desc[i] +
                            ".png");
                    } else {
                        if (desc[i] != 1) {
                            if (i % 2 == 0) {
                ...
                if (aall != "") {
                    for (ac in aall) {
                        ...
                        acards_html_array.push('  <div class="owl-item " id="owl_ac_img_id' + ac +
                            '" style=""><div class="item"><img src="' + site_url +
                            'storage/front/img/cards_new/' + aall[ac] + '.png"></div></div>');
                ...
                if (ball != "") {
                    for (bc in ball) {
                        ...
                        bcards_html_array.push('  <div class="owl-item " id="owl_bc_img_id_' + bc +
                            '"  style=""><div class="item"><img src="' + site_url +
                            'storage/front/img/cards_new/' + ball[bc] + '.png"></div></div>');
...
function clearCards() {
    ...
    $("#card_joker").attr(site_url + "storage/front/img/cards_new/1.png");
    $("#card_1st_andar").attr(site_url + "storage/front/img/cards_new/1.png");
    $("#card_1st_bahar").attr(site_url + "storage/front/img/cards_new/1.png");
