...
<div class="col-md-12 main-container">
    ...
    <style>
        ...
        .casino-last-results .ball-runs.result-b {
            color: #ffff33;
        }
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <!-- <div class="game-heading">
                        <span class="card-header-title">ANDAR BAHAR 150 CARDS</span>
                      ...
                      <div class="casino-video-title">
                            <span class="casino-name">ANDAR BAHAR 150 CARDS</span>
                    ...
                    <div class="video-container">
                        ...
                        if (!empty(IFRAME_URL_SET)) {
                            ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . AB4_CODE; ?>" width="100%"
                        ...
                        echo AB4_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
...
<div class="rules-section">
                    ...
                    <div class="casino-detail">
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-6 text-center andar-cards-box me-2 market_1_row"
                                            ...
                                            <div class=" m-r-5 card-image ">
                                                ...
                                                <div class="market_1_b_btn lay-1 "><img  id="ab_cards_1"  class="a_cards_blank"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_2_b_btn back-1"><img  id="ab_cards_2"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg"></div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_3_b_btn back-1"><img  id="ab_cards_3"  class="a_cards_blank"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_4_b_btn back-1"><img  id="ab_cards_4"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_5_b_btn back-1"><img  id="ab_cards_5"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_6_b_btn back-1"><img  id="ab_cards_6"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_7_b_btn back-1"><img  id="ab_cards_7"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_8_b_btn back-1"><img  id="ab_cards_8"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_9_b_btn back-1"><img  id="ab_cards_9"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_10_b_btn back-1"><img  id="ab_cards_10"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_11_b_btn back-1"><img  id="ab_cards_11"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_12_b_btn back-1"><img  id="ab_cards_12"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_13_b_btn back-1"><img  id="ab_cards_13"  class="a_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                        ...
                                        <div class="col-6 text-center bahar-cards-box market_21_row" style=" display: inline-block;">
                                            <h3 style="color: #ef910f">Bahar</h3>
                                            <div class=" m-r-5 card-image ">
                                                <div class="casino-odds market_21_b_value">1</div>
                                                <div class=" market_21_b_btn back-1"><img  id="ab_cards_21"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_22_b_btn back-1"><img  id="ab_cards_22"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_8_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_23_b_btn back-1"><img  id="ab_cards_23"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_9_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_24_b_btn back-1"><img  id="ab_cards_24" class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_10_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_25_b_btn back-1"><img  id="ab_cards_25" class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_11_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_26_b_btn back-1"><img  id="ab_cards_26" class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_12_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_27_b_btn back-1"><img  id="ab_cards_27"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_13_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_28_b_btn back-1"><img  id="ab_cards_28"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_14_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_29_b_btn back-1"><img  id="ab_cards_29"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_15_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_30_b_btn back-1"><img  id="ab_cards_30"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_16_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class="market_31_b_btn back-1"><img  id="ab_cards_31"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_17_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_32_b_btn back-1"><img  id="ab_cards_32"  class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_18_b_exposure market_exposure text-danger">0</b>
                                            ...
                                            <div class=" m-r-5 card-image">
                                                ...
                                                <div class=" market_33_b_btn back-1"><img  id="ab_cards_33" class="b_cards_blank"
                                                        src="/storage/front/img/andar_bahar/0.jpg">
                                                </div>
                                                <div class="ubook text-center m-t-5"><b style="color: rgb(0, 0, 0);"
                                                        class="market_19_b_exposure market_exposure text-danger">0</b>
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=ab4">View All</a></span>
                        </div>
                        <!-- <div class="casino-last-results"><span class="result result-b">R</span></div> -->
            ...
            <div class="modal-dialog" style="min-width: 650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ANDAR BAHAR 150 CARDS Result</h4>
        ...
        for (let i = 0; i < bcards_html_array.length; i++) {
          ...
          $bahar.trigger('refresh.owl.carousel');
                    ...
                    for (var j in data['t3']) {
                       ...
                       // $(".b_cards_blank").attr("src", "/storage/front/img/andar_bahar/0.jpg");
                        console.log("count_non_ones=",count_non_ones_new);
                        if (count_non_ones_new % 2 === 0) {
                            ...
                            $("#ab_cards_" + selectionid).attr("src", "/storage/front/img/andar_bahar/" + selectionid + ".jpg");
                             ...
                             $(".a_cards_blank").attr("src", "/storage/front/img/andar_bahar/0.jpg");
                             $("#ab_cards_" + selectionid).attr("src", "/storage/front/img/andar_bahar/" + selectionid + ".jpg");
...
(function ( $ ) { 
  ...
  jQuery("#andar-cards").owlCarousel({
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/ab4/' + event_id,
            dataType: 'json',
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/andarbahar/active_bets/ab4/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/andarbahar/view_more_matched/ab4/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/andarbahar/market_analysis/ab4/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function (data) {
                if (data.results == 0) {
