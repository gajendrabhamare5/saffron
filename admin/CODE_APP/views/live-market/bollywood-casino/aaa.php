                ...
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">Amar Akbar Anthony
                            <!-- <small class="teenpatti-rules" data-toggle="modal"
                                data-target="#modalrulesteenpatti"><u>Rules</u></small> -->
                            </span>
                    ...
                    <div style="position: relative;">
                        ...
                        <?php
                               ...
                               ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".AAA_CODE;?>" width="100%"
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL."".AAA_CODE; ?>" style="border:0px"></iframe> -->
                        <div class="video-overlay right">
                            <div>
                                <h5 class="text-white">Cards</h5>
                            ...
                            <!-- <div class="row">
                                <div class="col-12 text-right">
                                    <div class="info-block"><a href="#" data-toggle="collapse"
                                            data-target="#min-max-info1" class="info-icon"><i
                                                class="fas fa-info-circle m-l-10"></i></a>
                                        <div id="min-max-info1" class="collapse min-max-info"><span
                                                class="m-r-5"><b>Min:</b>100</span> <span
                                                class="m-r-5"><b>Max:</b>300000</span></div>
                                    </div>
                                </div>
                            </div> -->
                            <div class="row">
                                <div class="col-4 p-r-5 text-center">
                                    <div><span class="d-block"><b>A. Amar</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_1_row">
                                        <button class="back market_1_b_btn"><span
                                                class="odd market_1_b_value">0</span></button>
                                        <button class="lay market_1_l_btn"><span
                                                class="odd market_1_l_value">0</span></button>
                                    </div>
                                    <div>
                                        <div class="ubook m-t-5"><b
                                                class="market_1_b_exposure market_exposure  text-danger">0</b></div>
                                    </div>
                                </div>
                                <div class="col-4 p-l-5 p-r-5 text-center">
                                    <div>
                                        <span class="d-block"><b>B. Akbar</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_2_row">
                                        <button class="back market_2_b_btn"><span
                                                class="odd market_2_b_value">0</span></button>
                                        <button class="lay market_2_l_btn"><span
                                                class="odd market_2_l_value">0</span></button>
                                    </div>
                                    <div>
                                        <div class="ubook m-t-5"><b
                                                class="market_2_b_exposure market_exposure  text-danger">0</b></div>
                                    </div>
                                </div>
                                <div class="col-4 p-l-5 text-center ">
                                    <div><span class="d-block"><b>C. Anthony</b>
                                        </span>
                                    </div>
                                    <div class="aaa-button clearfix suspended market_3_row">
                                        <button class="back market_3_b_btn"><span
                                                class="odd market_3_b_value">0</span></button>
                                        <button class="lay market_3_l_btn"><span
                                                class="odd market_3_l_value">0</span></button>
                                    </div>
                                    <div>
                                        <div class="ubook m-t-5"><b
                                                class="market_3_b_exposure market_exposure  text-danger">0</b></div>
                                    </div>
                                </div>
                                <div class="col-12"><div class="teen1daycasino-container casino-min-max" style="
    text-align: end;
"><div>R:<span>100</span> - <span>3L</span></div></div></div>
                            </div>
                        </div>
                        ...
                        <div class="card-content aaa-content m-t-10">
                            <div class="row">
                                <div class="col-4 p-r-5 text-center">
                                    <div class="market-button-group">
                                        <!-- Even Market -->
                                        <div class="market-item">
                                            <div class="market-value market_4_b_value">0</div>
                                            <button
                                                class="back suspended market_4_b_btn market_4_row casino-bl-box-item"><b>Even</b></button>
                                            <div class="market-exposure market_4_b_exposure text-danger">0</div>
                                        </div>

                                        <!-- Odd Market -->
                                        <div class="market-item">
                                            <div class="market-value market_5_b_value">0</div>
                                            <button
                                                class="back suspended market_5_b_btn market_5_row casino-bl-box-item "><b>Odd</b></button>
                                            <div class="market-exposure market_5_b_exposure text-danger">0</div>
                                ...
                                <div class="col-4 p-r-5 text-center">
                                    <div class="market-button-group">
                                        <!-- Even Market -->
                                        <div class="market-item">
                                            <div class="market-value market_6_b_value">0</div>
                                            <!-- <button
                                                class="back suspended market_4_b_btn market_4_row casino-bl-box-item"><b>Even</b></button> -->
                                                 <button
                                                class="back suspended market_6_b_btn market_6_row casino-bl-box-item">
                                            ...
                                            <div class="market-exposure market_6_b_exposure text-danger">0</div>
                                           
                                        </div>

                                        <!-- Odd Market -->
                                        <div class="market-item">
                                            <div class="market-value market_7_b_value">0</div>
                                            <!-- <button
                                                class="back suspended market_5_b_btn market_5_row casino-bl-box-item "><b>Odd</b></button> -->
                                                 <button
                                                class=" back suspended market_7_b_btn market_7_row casino-bl-box-item">
                                                <div class="color-card"></div> <span class="card-icon"><span
                                                        class="card-black">]</span></span> <span class="card-icon"><span
                                                        class="card-black">}</span></span>
                                            </button>
                                            <div class="market-exposure market_7_b_exposure text-danger">0</div>
                                             <div class="casino-min-max text-right">
                                R:<span>100</span>-<span>25k</span></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-4 p-r-5 text-center">
                                    <div class="market-button-group">
                                        <!-- Even Market -->
                                        <div class="market-item">
                                            <div class="market-value market_21_b_value">0</div>
                                            <!-- <button
                                                class="back suspended market_4_b_btn market_4_row casino-bl-box-item"><b>Even</b></button> -->
                                                <button
                                                class="back suspended market_21_b_btn market_21_row casino-bl-box-item"><b>Under
                                                    7</b></button>
                                            <div class="market-exposure market_21_b_exposure text-danger">0</div>
                                        </div>

                                        <!-- Odd Market -->
                                        <div class="market-item">
                                            <div class="market-value market_22_b_value">0</div>
                                            <!-- <button
                                                class="back suspended market_5_b_btn market_5_row casino-bl-box-item "><b>Odd</b></button> -->
                                                 <button
                                                class="back suspended market_22_b_btn market_22_row casino-bl-box-item"><b>Over
                                                    7</b></button>
                                            <div class="market-exposure market_22_b_exposure text-danger">0</div>
                                            <div class="casino-min-max text-right">
                        ...
                        <!-- <div class="row m-t-10">
                            <div class="col-4 p-r-5 ">
                                <div class="aaa-content">
                                    <div class="text-right">
                                        <div class="info-block"><a href="#" data-toggle="collapse"
                                                data-target="#min-max-info3" class="info-icon"><i
                                                    class="fas fa-info-circle m-l-10"></i></a>
                                            <div id="min-max-info3" class="collapse min-max-info"><span
                                                    class="m-r-5"><b>Min:</b>100</span> <span
                                                    class="m-r-5"><b>Max:</b>100000</span></div>
                                        </div>
                                    </div>
                                    <div class="text-center">
                                        <div><b class="market_4_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_4_b_btn market_4_row"><b>Even</b></button>
                                        </div>
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_4_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                    <div class="text-center m-t-10">
                                        <div><b class="market_5_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_5_b_btn market_5_row"><b>Odd</b></button>
                                        </div>
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_5_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 p-r-5 p-l-5">
                                <div class="aaa-content">
                                    <div class="text-right">
                                        <div class="info-block"><a href="#" data-toggle="collapse"
                                                data-target="#min-max-info5" class="info-icon"><i
                                                    class="fas fa-info-circle m-l-10"></i></a>
                                            <div id="min-max-info5" class="collapse min-max-info"><span
                                                    class="m-r-5"><b>Min:</b>100</span> <span
                                                    class="m-r-5"><b>Max:</b>100000</span></div>
                                        </div>
                                    </div>
                                    <div class="text-center">
                                        <div><b class="market_6_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_6_b_btn market_6_row">
                                                <div class="color-card"></div> <span class="card-icon"><span
                                                        class="card-red">[</span></span> <span class="card-icon"><span
                                                        class="card-red">{</span></span>
                                            </button>
                                        ...
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_6_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                    <div class="text-center m-t-10">
                                        <div><b class="market_7_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_7_b_btn market_7_row">
                                                <div class="color-card"></div> <span class="card-icon"><span
                                                        class="card-black">]</span></span> <span class="card-icon"><span
                                                        class="card-black">}</span></span>
                                            </button>
                                        ...
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_7_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 p-l-5">
                                <div class="aaa-content">
                                    <div class="text-right">
                                        <div class="info-block"><a href="#" data-toggle="collapse"
                                                data-target="#min-max-info20" class="info-icon"><i
                                                    class="fas fa-info-circle m-l-10"></i></a>
                                            <div id="min-max-info20" class="collapse min-max-info"><span
                                                    class="m-r-5"><b>Min:</b>100</span> <span
                                                    class="m-r-5"><b>Max:</b>100000</span></div>
                                        </div>
                                    </div>
                                    <div class="text-center">
                                        <div><b class="market_21_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_21_b_btn market_21_row"><b>Under
                                                    7</b></button>
                                        </div>
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_21_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                    <div class="text-center m-t-10">
                                        <div><b class="market_22_b_value">0.00</b></div>
                                        <div class="m-b-5 m-t-5">
                                            <button
                                                class="text-uppercase btn-theme suspended market_22_b_btn market_22_row"><b>Over
                                                    7</b></button>
                                        </div>
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_22_b_exposure market_exposure">0</b></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-content aaa-content m-t-10">
                            <!-- <div class="row">
                                <div class="col-12">
                                    <div class="text-right">
                                        <div class="info-block"><a href="#" data-toggle="collapse"
                                                data-target="#min-max-info" class="info-icon"><i
                                                    class="fas fa-info-circle m-l-10"></i></a>
                                            <div id="min-max-info" class="collapse min-max-info"><span
                                                    class="m-r-5"><b>Min:</b>100</span> <span
                                                    class="m-r-5"><b>Max:</b>50000</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            <div class="row">
                                <div class="col-12 text-center"><b class="market_8_b_value">0</b></div>
                            </div>
                            <div class="row m-t-10">
                                <div class="col-12 text-center">
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_8_b_btn market_8_row"><img
                                                src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/1.jpg"></div>
                                        <div>
                                            <div class="ubook m-t-5 text-danger"><b
                                                    class="market_8_b_exposure market_exposure text-danger">0</b></div>
                                        </div>
                                    </div>
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_9_b_btn market_9_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_10_b_btn market_10_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_11_b_btn market_11_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_12_b_btn market_12_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_13_b_btn market_13_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_14_b_btn market_14_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_15_b_btn market_15_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_16_b_btn market_16_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_17_b_btn market_17_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_18_b_btn market_18_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_19_b_btn market_19_row"><img
                                    ...
                                    <div class=" m-r-5 card-image">
                                        <div class="suspended market_20_b_btn market_20_row"><img
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=aaa"
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 800px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Amar Akbar Anthony Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/aaa/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    ...
    if (xhr && xhr.readyState != 4)
        xhr.abort();
    xhr = $.ajax({
        url: MASTER_URL + '/live-market/bollywood-casino/active_bets/aaa/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_view_more_bets() {
    ...
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/bollywood-casino/view_more_matched/aaa/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    ...
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/bollywood-casino/market_analysis/aaa/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
