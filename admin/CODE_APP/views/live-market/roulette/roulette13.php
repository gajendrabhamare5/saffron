...
<div class="col-md-12 main-container">
    ...
    <div class="listing-grid casino-grid">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ROULETTE13_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                                echo ROULETTE13_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
        ...
        <div id="modalroullete13result" class="modal fade show" tabindex="-1">
            ...
            <div class="modal-dialog" style="min-width: 1000px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Roulette Result </h4>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/roulette13/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
            ...
            success: function(response) {
                ...
                $('#modalroullete13result').modal('show');
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/roullete13/active_bets/roullete13/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/roullete13/view_more_matched/roullete13/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/roullete13/market_analysis/roullete13/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
