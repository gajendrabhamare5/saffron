            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ROULETTE12_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                                echo ROULETTE12_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
...
<div class="rules-section">
 ...
 <tr>
        ...
        <div id="modalroullete12result" class="modal fade show" tabindex="-1">
            ...
            <div class="modal-dialog" style="min-width: 1000px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Beach Roulette Result </h4>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/roulette12/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
