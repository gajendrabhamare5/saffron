        ...
        <div class="coupon-card row">
                ...
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        <?php
										if(!empty(IFRAME_URL_SET)){
																?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".SUPEROVER2_CODE;?>" width="100%"
                        ...
                        <!--<iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
											 <iframe class="iframedesign" src="<?php echo IFRAME_URL . SUPEROVER2_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                        <div class="clock clock2digit flip-clock-wrapper" style="left: 262px;top: 101px;">
                            <ul class="flip play">
                                        ...
                                        <div class="rules-body">
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <ul>
                                                        <li>1.Two wickets are allowed for each batting team in the Super
                                                            over. If the batting team loses both wickets, then their
                                                            innings ends.
                                                        </li>
                                                        <li>2.If scores of the team are same, then the match will be
                                                            considered as Tie (No Result), Difference of wickets between
                                                            the team doesn't count.
                                                        </li>
                                                        <li>3.Session and fancy markets will be considered valid, though
                                                            the match ends in Tie
                                                        </li>
                                                        <li>4.Team scoring maximum run in the allocated super over will
                                                            be considered as winner
                                                        </li>
                                                        <li>5.Odds will be available for every ball</li>
                                                        <li>6. Results are Based on Stream Only. Streams Played By RNG.
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <div class="casino-detail detail-page-container position-relative">
                            ...
                            <div class="market-body " data-title="OPEN">
                                <div class="market-row suspended-row market_1_row" data-title="SUSPENDED">
                                    <div class="market-nation-detail">
                                        ...
                                        <div class="market-nation-book market_1_b_exposure market_exposure text-danger">
                                        </div>
                                    </div>
                                ...
                                <div class="market-row suspended-row market_2_row" data-title="SUSPENDED">
                                    <div class="market-nation-detail">
                                        <span class="market-nation-name">ENG</span>
                                        <div class="market-nation-book market_2_b_exposure market_exposure text-danger">
                                        </div>
                                    </div>
                        ...
                        <div class="game-market market-6 fancy-market fancyMarket1 bookmaker-market"
                            style="display:none;">
                            <div class="market-title country-name"><span>Fancy1</span>
                        <span class="float-right"><a href="javascript:void(0)" class="btn btn-back">Bet Lock</a></span>
                        </div>
                            <div class="row row10">
                                <!-- <div class="col-md-6">
                                    <div class="market-header">
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=superover2">View
                                    All</a></span></div>
            ...
            <div class="col-md-4 sidebar-right" id="sidebar-right">
                ...
                <!-- <div class="card m-b-10">
                    <div class="cc-rules">
                        <div data-toggle="collapse" data-target=".video-tv" class="card-header">
                            <h6 class="card-title text-center">ENG VS RSA<br>INNING'S CARD RULES</h6>
                        </div>
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/A.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball1.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/2.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball2.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/3.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball3.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/4.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball4.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/6.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball6.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/10.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><img src="<?php echo WEB_URL; ?>storage/front/img/superover/ball0.png"></div>
                                </div>
                                <div class="row row5 mt-1">
                                    <div class="col-4"><img src="<?php echo WEB_URL; ?>storage/front/img/cricketv/K.jpg"> <span class="ml-2">X</span></div>
                                    <div class="col-2 text-center">5</div>
                                    <div class="col-6 text-right value"><span class="mr-2"> WICKET</span> <img src="<?php echo WEB_URL; ?>storage/front/img/superover/wicket1.png"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    socket.on('game', function(data) {
        if (data && data['t1'] && data['t1'][0]) {
            ...
            for (var j in data['t2']) {
                ...
                back_html = '<span class="odd d-block"><b>' + b1 + '</b></span><span class="d-block">' + bs1 +
                    'k</span>';
                ...
                lay_html = '<span class="odd d-block"><b>' + l1 + '</b></span><span class="d-block">' + ls1 +
                    'k</span>';
            ...
            if (data['t3'] != null) {
                ...
                for (var f in data['t3']) {
                    ...
                    back_html = '<span class="odd d-block market-odd">' + b1 +
                        '</span><span class="market-volume">' + bs1 + '</span>';
                    lay_html = '<span class="odd d-block market-odd">' + l1 +
                        '</span><span class="market-volume">' + ls1 + '</span>';
                    ...
                    if ($("#five_fancy_" + selectionid) && $("#five_fancy_" + selectionid).length > 0) {
                        ...
                        fancy_data += `<div>
												<div class="fancy-market " data-title="ACTIVE">
													<div id="five_fancy_'${selectionid}'" data-title="'${is_suspended}'" class="table-row '${is_suspended}' market_'${selectionid}'_row market-row">
														<div class="market-nation-detail">
															<span class="market-nation-name pointer">${runner}</span>
															<div class="market-nation-book class="market_'${selectionid}'_b_exposure market_exposure text-danger""></div>
														</div>
														<div class="market-odd-box lay betting-disabled market_'${selectionid}'_l_btn '${lay_class}'">${lay_html}</div>
														<div class="market-odd-box back betting-disabled market_'${selectionid}'_b_btn '${back_class}'">${back_html}</div>
            ...
            if (data['t4'] != null) {
                ...
                for (var f in data['t4']) {
                    ...
                    if (runner.toLowerCase() == "tie") {
                        if ($("#five_fancy_tie_" + selectionid) && $("#five_fancy_tie_" + selectionid).length >
                            0) {
                            ...
                            fancy_tie_data += `<div class="row row10">
														<div class="col-md-12">
															<div class="fancy-market " data-title="ACTIVE">
																<div id="five_fancy_tie_${selectionid}" data-title="${is_suspended}" class="market-row table-row ${is_suspended} market_${selectionid}_row">
																	<div class="market-nation-detail">
																		<span class="market-nation-name">${runner}</span>
																		<div class="market-nation-book market_${selectionid}_b_exposure market_exposure text-danger"></div>
																	</div>
																	<div class="market-odd-box back betting-disabled market_${selectionid}_b_btn ${back_class}">${back_html}</div>
																	<div class="market-odd-box lay betting-disabled market_${selectionid}_l_btn ${lay_class}">${lay_html}</div>
																	<div class="fancy-min-max-box">
                        ...
                        if ($("#five_fancy_" + selectionid) && $("#five_fancy_" + selectionid).length > 0) {
                            ...
                            fancy_data += `<div class="col-md-12">
															<div class="fancy-market " data-title="ACTIVE">
																<div id="five_fancy_${selectionid}" data-title="${is_suspended}" class="market-row table-row ${is_suspended} market_${selectionid}_row">
																	<div class="market-nation-detail">
																		<span class="market-nation-name">${runner}</span>
																		<div class="market-nation-book market_${selectionid}_b_exposure market_exposure  text-danger"></div>
																	</div>
...
function call_active_bets() {
    if (get_round_no() > 0) {
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/sports-casino/active_bets/superover2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
...
function call_view_more_bets() {
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/sports-casino/view_more_matched/superover2/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/sports-casino/market_analysis/superover2/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/superover2/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
