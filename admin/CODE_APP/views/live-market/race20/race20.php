                    ...
                    <div style="position: relative;">
                         <?php
  							if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".RACE20_CODE;?>" width="100%" height="400px" style="border: 0px;"></iframe>
                               <?php
                       ...
                       <!--  <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . RACE20_CODE; ?>" style="border:0px"></iframe> -->
                        <div class="casino-video-title">
                            <span class="casino-name">Race 20</span>
...
<div class="rules-section">
                        ...
                        <div class="casino-odds-box-wrapper">
                            <div class="casino-odds-box-container casino-odds-box-container-double">
                                ...
                                <div class="casino-odds-box">
                                    <div class="back-border market_1_b_btn back-1 suspended market_1_row"><span class="casino-odds-box-odd market_1_b_value">0.00</span></div>
                                    <div class="lay-border market_1_l_btn lay-1 suspended market_1_row"><span class="casino-odds-box-odd market_1_l_value">0.00</span> </div>
                                </div>
                            ...
                            <div class="casino-odds-box-container casino-odds-box-container-double">
                                ...
                                <div class="casino-odds-box">
                                    <div class="back-border market_2_b_btn  suspended market_2_row back-1"><span class="casino-odds-box-odd market_2_b_value">0.00</span> <span>0</span></div>
                                    <div class="lay-border market_2_l_btn  suspended market_2_row lay-1"><span class="casino-odds-box-odd market_2_l_value">0.00</span> <span>0</span></div>
                                </div>
                                <div class="casino-odds-book">
                            ...
                            <div class="casino-odds-box-container casino-odds-box-container-double">
                                ...
                                <div class="casino-odds-box">
                                    <div class="back-border market_3_b_btn back-1  suspended market_3_row"><span class="casino-odds-box-odd market_3_b_value">0.00</span> <span>0</span></div>
                                    <div class="lay-border market_3_l_btn lay-1  suspended market_3_row"><span class="casino-odds-box-odd market_3_l_value">0.00</span> <span>0</span></div>
                                </div>
                                <div class="casino-odds-book">
                            ...
                            <div class="casino-odds-box-container casino-odds-box-container-double">
                                ...
                                <div class="casino-odds-box">
                                    <div class="back-border market_4_b_btn back-1 suspended market_4_row"><span class="casino-odds-box-odd market_4_b_value">0.00</span> <span>0</span></div>
                                    <div class="lay-border market_4_l_btn lay-1 suspended market_4_row"><span class="casino-odds-box-odd market_4_l_value">0.00</span> <span>0</span></div>
                                </div>
                                <div class="casino-odds-book">
                        ...
                        <div class="col-4">
                            <div class="card-content">
                                <div class="casino-odds-box-container casino-odds-box-container-extra">
                                    ...
                                    <div class="casino-odds-book">
                                        <div class="casino-odds-book market_5_b_exposure market_exposure text-danger">0</div>
                                    </div>
                                </div>
                                <div class="casino-odds-box-container casino-odds-box-container-extra">
                                    <div class="casino-yn">
                                    ...
                                    <div class="casino-odds-book">
                                        <div class="casino-odds-book market_6_b_exposure market_exposure text-danger">0</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row row5">
                                    <div class="col-4">
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_7_b_exposure market_exposure  text-danger">0</div>
                                        </div>
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_10_b_exposure market_exposure text-danger">0</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_8_b_exposure market_exposure text-danger">0</div>
                                        </div>
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_11_b_exposure market_exposure text-danger">0</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_9_b_exposure market_exposure text-danger">0</div>
                                        </div>
                                        <div class="casino-odds-box-container casino-odds-box-container-extra">
                                            ...
                                            <div class="casino-odds-book market_12_b_exposure market_exposure text-danger">0</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Race 20 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
        ...
        console.log("Data",data);
            ...
            if (data && data['t1'] && data['t1'][0]) {
                ...
                if (data.t1[0].mid != 0 && data.t1[0].mid != "0" && oldGameId != resultGameLast) {
                    ...
                    /* desc = desc.split(","); */
                    desc = Array.isArray(desc) ? desc : desc.split(",");
                ...
                for(var j in data['t2']){
                    ...
                    if (selectionid <= 6) {
                        ...
                        // <span>' + bs1 + '</span>
                         ...
                         if (selectionid == 5 || selectionid == 6) {
                                back_html = '<span class="casino-odds-box-odd market_' + selectionid + '_b_value">' 
                                            + b1 + '</span><span>' + bs1 + '</span>';
                            } else {
                                back_html = '<span class="casino-odds-box-odd market_' + selectionid + '_b_value">' 
                                            + b1 + '</span>';
                            }
                    ...
                    if (selectionid <= 6) {
                        if (selectionid == 5) {
                         ...
                         if (selectionid == 5 || selectionid == 6) {
                                ...
                                lay_html = '<span class="casino-odds-box-odd market_' + selectionid + '_l_value">' 
                                            + l1 + '</span>';
                            }
