...
<div class="col-md-12 main-container">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="https://stream.trubets365.com/?id=goal2" width="100%"
                    ...
                    <div class="casino-detail detail-page-container position-relative">
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=goal2">View All</a></span></div>
    ...
    <div id="modalpokerresult" class="modal fade show" tabindex="-1">
        <div class="modal-dialog modal-md modal-dialog-centered" style="min-width: 650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Goal 2 Result</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
        ...
        socket.on('game', function(data) {
            ...
            if (data && data['t1'] && data['t1'][0]) {
                ...
                for (var j in data['t1'][0]['sub']) {
                    ...
                    lay_html = '<div class="market-odd-box"><span class="market-odd">' + l1 +
                        '</span><span class="market-volume">' + ls1 + 'k</span></div>';
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/goal2/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/goal2/active_bets/goal2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/goal2/view_more_matched/goal2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/goal2/market_analysis/goal2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
