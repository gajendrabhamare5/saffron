        ...
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <!-- <div class="game-heading"><span class="card-header-title">Instant Teenpatti 3.0
                    ...
                    <div class="casino-video-title">
                        <span class="casino-name">Mogambo</span>
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . MOGAMBO_CODE; ?>" width="100%"
                        ...
                        <div class="video-overlay" style="top: 20%;">
                            <div class="videoCards">
                                <div class="race-total text-white">Total: <span class="tot_count">0</span></div>
                                <div>
...
<div>
                                                        <img src="https://sitethemedata.com/casino-rules/mogambo/img1.jpg" alt="">
                                                    </div>
                                              </li>
                                                <li>5.Card Deal:
                    ...
                    <div class="casino-detail">
                            ...
                            <div class="casino-table-box">
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row mini-baccarat">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                <div class="casino-nation-name  d-flex justify-content-between vertical-align: baseline;" style="width: 100%;">Daga / Teja
                                                    <span style="display: ruby;text-align: end;">
                                            ...
                                            <div
                                                ...
                                                <span class="casino-odds market_2_b_val">0</span>
                                            </div>

                                        </div>
                                    </div>
                                    <div class="text-right casino-min-max"> R:<span>100</span>-<span>5L</span></div>
                                </div>
                                ...
                                <div class="casino-table-right-box">
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row mini-baccarat">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                <div class="casino-nation-name  d-flex justify-content-between vertical-align: baseline;" style="width: 100%;">Mogambo
                                            ...
                                            <div
                                                ...
                                                <span class="casino-odds market_1_b_val">1.76</span>
                                            </div>
                                            <!-- <div
                                                class="casino-odds-box lay lay-1 market_1_row market_1_l_btn suspended-box">
                                                <span class="casino-odds market_1_l_val">1.79</span></div> -->
                                        </div>
                                    </div>
                                    <div class="text-right casino-min-max"> R:<span>100</span>-<span>5L</span></div>
                                </div>
                            </div>
                            <div class="casino-table-box three-card-total" style="justify-content: center;margin-top: 5px;">
                                <div class="casino-table-left-box">
                                    <div class="casino-table-body">
                                        <div class="casino-table-row">
                                            <div class="casino-nation-detail">
                                                <div class="casino-nation-name  d-flex justify-content-between vertical-align: baseline;" style="width: 100%;" >3 Card Total
                                                   <span style="display: ruby;text-align: end;"  style="width: 100%;">
                                                        <b class="market_3_b_exposure market_exposure text-danger">0</b>

                                                    </span>
                                                    </div>
                                            </div>
                                            <div class="casino-odds-box lay suspended-box market_3_l_btn"><span class="casino-odds market_3_l_val">30</span><span class="casino-volume market_3_l_volume">120</span></div>
                                            <div class="casino-odds-box back suspended-box market_3_b_btn"><span class="casino-odds market_3_b_val">30</span><span class="casino-volume market_3_b_volume">100</span></div>
                                        </div>
                                    </div>
                                    <div class="text-right casino-min-max"> R:<span>100</span>-<span>1L</span></div>
                                </div>
                            </div>
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=mogambo">View All</a></span>
                        </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Mogambo Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/mogambo/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        if (get_round_no() > 0) {
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: MASTER_URL + '/live-market/mogambo/active_bets/mogambo/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/mogambo/view_more_matched/mogambo/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/mogambo/market_analysis/mogambo/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
