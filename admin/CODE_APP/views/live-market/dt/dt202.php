    ...
    <div class="listing-grid lucky7-container casino-grid">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">20-20 DRAGON TIGER 2 &nbsp;
                    ...
                    <div id="tableData">
                        <div class="dt-container">
                            <!-- <div class="d-t-box m-b-10">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-5 text-center onecard20player">
                                                ...
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase dt-button showbet-action market_1_b_btn market_1_row casino-odds-box-theme1"
                                                        data-index="0">
                                                        <b>Dragon</b>
                                                        <b>2</b>
                                            ...
                                            <div class="col-md-2 text-center">
                                                ...
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase  dt-button showbet-action market_3_b_btn market_3_row casino-odds-box-theme2"
                                                        data-index="2">
                                                        <b>Tie</b>
                                                        <b>50</b>
                                            ...
                                            <div class="col-md-5 text-center">
                                                ...
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase dt-button showbet-action market_2_b_btn market_2_row casino-odds-box-theme3"
                                                        data-index="1">
                                                        <b>Tiger</b>
                                                        <b>2</b>
                                                        <div class="ubook m-t-5 text-danger">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="m-t-10">
                                            <button
                                                class="suspended-box text-uppercase dt-button showbet-action market_4_b_btn market_4_row casino-odds-box-theme4"
                                                data-index="3">
                                                <b>Pair</b>
                                                <b>12</b>
                                                <div class="ubook m-t-5 text-danger">
                            ...
                            <div class="text-right w-100 pr"><div class="float-right"><i data-toggle="collapse" data-target="#demo1" class="fas fa-info-circle" aria-expanded="true"></i> <div id="demo1" class="icon-range collapse show" style="">
                                    Range:<span>100</span>-<span>1L</span></div></div></div>
                                ...
                                <div class="suspended-box dragon-box market_1_b_btn market_1_row">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <span
                                            class="d-block casino-book book-red market_1_b_exposure market_exposure text-danger" style="left:0;position:absolute;bottom:-20px;">0</span>
                                    </div>
                                </div>
                                ...
                                <div class="tiebox suspended-box market_3_b_btn market_3_row">
                                    ...
                                    <div class="text-center"><span class="d-block"><b>50</b> </span>
                                        <span
                                            class="d-block casino-book book-red market_3_b_exposure market_exposure text-danger"  style="left:50%;position:absolute;bottom:-13px;    transform: translateX(-50%);">0</span>
                                    </div>
                                </div>
                                ...
                                <div class="tiger-box suspended-box market_2_b_btn market_2_row">
                                    ...
                                    <div class="text-center"><span class="d-block"><b>2</b></span>
                                        <span
                                            class="d-block casino-book book-red market_2_b_exposure market_exposure text-danger" style="right:0;position:absolute;bottom:-20px;">0</span>
                                    </div>
                                </div>
                                ...
                                <div class="pair-box suspended-box market_4_b_btn market_4_row">
                                    ...
                                    <div class="text-center"><span class="d-block"><b>12</b></span>
                                        <span
                                            class="d-block casino-book book-red market_4_b_exposure market_exposure text-danger"  style="right:0;position:absolute;bottom:-20px;">0</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 p-r-5 m-t-20">
                                    <div class="d-t-box m-b-10">
                                        <div class="row ">
                                            <div class="col-12">
                                                <h4 class="m-b-0 text-left" style="color: #fc4242;line-height: 29px;font-size: 14px;    padding-left: 7px;">Dragon</h4>
                                                <div class="info-block float-right" style="position: relative;display: inline-block;top: -25px;">
                                ...
                                <div class="col-md-6 p-l-5 m-t-20">
                                    <div class="d-t-box m-b-10">
                                        <div class="row ">
                                            <div class="col-12">
                                                <h4 class="m-b-0 text-left" style="color: #ef910f;line-height: 29px;font-size: 14px;    padding-left: 7px;">Tiger</h4>
                                                 <div class="info-block float-right"  style="position: relative;display: inline-block;top: -25px;">
                    ...
                    <div class="row">
                        <div class="col-md-6 p-r-5">
                            <div class="d-t-box m-b-10">
                                <div class="row ">
                                    <div class="col-md-12">
                                        <h4 class="m-b-0 text-center text-uppercase  market_9_b_value"> <span id="dcard-rate">12</span>
                                        </h4>
                                         <div class="info-block float-right"  style="position: relative;display: inline-block;top: -25px;">
                                    ...
                                    <div class="card-dt col-md-12 text-center m-t-10">
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="36">
                                            ...
                                            <div class="ubook m-t-5">
                                                <div class="ubook m-t-5"><b
                                                        class="market_20_b_exposure market_exposure text-danger">0</b>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="col-md-12 m-t-10 text-right" id="dcard-minmax"><span
                                            class="m-r-5"><b>Min:</b>100 </span><span
                                            class="m-r-5"><b>Max:</b>5000</span></div>-->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 p-l-5">
                            <div class="d-t-box m-b-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="m-b-0 text-center text-uppercase market_26_b_value"> <span id="tcard-rate">12</span>
                                        </h4>
                                        <div class="info-block float-right"  style="position: relative;display: inline-block;top: -25px;">
                                    ...
                                    <!-- <div class="col-md-12 m-t-10 text-right" id="tcard-minmax"><span
                                            class="m-r-5"><b>Min:</b>100 </span><span
                                            class="m-r-5"><b>Max:</b>5000</span></div> -->
                                </div>
                            </div>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=dt202"
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">20-20 Dragon Tiger 2 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
