            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">20-20 Dragon Tiger &nbsp;
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . A2020DT_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . A2020DT_CODE; ?>" style="border:0px"></iframe> -->
                        <div class="video-overlay">
                            <div>
                                <img id="card_c1" src="<?php echo WEB_URL; ?>/storage/front/img/cards_new/1.png">
                                <img id="card_c2" src="<?php echo WEB_URL; ?>/storage/front/img/cards_new/1.png">
                            </div>
                        </div>
                                        ...
                                        <div class="rules-body">
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <div>
                                                        <img src="/storage/front/img/rules/dt202.jpg"
                                                            class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="dt-container">
                            <!-- <div class="d-t-box m-b-10">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-5 text-center onecard20player">
                                               
                                                <div class="m-t-10">
                                                    <button class="suspended-box text-uppercase dt-button showbet-action market_1_b_btn market_1_row casino-odds-box-theme1" data-index="0">
                                                        <b>Dragon</b>
                                                         <b>2</b>
                                            ...
                                            <div class="col-md-2 text-center">
                                                ...
                                                <div class="m-t-10">
                                                    <button class="suspended-box text-uppercase  dt-button showbet-action market_3_b_btn market_3_row casino-odds-box-theme2" data-index="2">
                                                        <b>Tie</b>
                                                        <b>50</b>
                                                         <div class="ubook m-t-5 text-danger">
                                            ...
                                            <div class="col-md-5 text-center">
                                                ...
                                                <div class="m-t-10">
                                                    <button class="suspended-box text-uppercase dt-button showbet-action market_2_b_btn market_2_row casino-odds-box-theme3" data-index="1">
                                                        <b>Tiger</b>
                                                         <b>2</b>
                                                          <div class="ubook m-t-5 text-danger">
                                    ...
                                    <div class="col-md-3 text-center">
                                        ...
                                        <div class="m-t-10">
                                            <button class="suspended-box text-uppercase dt-button showbet-action market_4_b_btn market_4_row casino-odds-box-theme4" data-index="3">
                                                <b>Pair</b>
                                                 <b>12</b>
                                                  <div class="ubook m-t-5 text-danger">
                            ...
                            <div class="dtobx-top">
                                ...
                                <div class="suspended-box dragon-box market_1_b_btn market_1_row">
                                    <div><b>Dragon</b></div>
                                    <div class="text-center">
                                        <span class="d-block"><b>2</b></span>
                                        <span
                                            class="d-block casino-book book-red market_1_b_exposure market_exposure text-danger" style="position: absolute;bottom: -20px;left: 0;">0</span>
                                    </div>
                                </div>

                                <div class="tiebox suspended-box market_3_b_btn market_3_row">
                                    <div><b>Tie</b></div>
                                    <div class="text-center"><span class="d-block"><b>50</b> </span>
                                        <span
                                            class="d-block casino-book book-red market_3_b_exposure market_exposure text-danger"  style="position: absolute;bottom: -20px;left: 50%;transform: translateX(-50%);">0</span>
                                    </div>
                                </div>

                                <div class="tiger-box suspended-box market_2_b_btn market_2_row">
                                    <div><b>Tiger</b></div>
                                    <div class="text-center"><span class="d-block"><b>2</b></span>
                                        <span
                                            class="d-block casino-book book-red market_2_b_exposure market_exposure text-danger"  style="position: absolute;bottom: -20px;right: 0;">0</span>
                                    </div>
                                </div>

                                <div class="pair-box suspended-box market_4_b_btn market_4_row">
                                    <div><b>Pair</b></div>
                                    <div class="text-center"><span class="d-block"><b>12</b></span>
                                        <span
                                            class="d-block casino-book book-red market_4_b_exposure market_exposure text-danger" style="position: absolute;bottom: -20px;right: 0;">0</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-t-box m-b-10">
                                        <div class="row ">
                                            <div class="col-12">
                                                ...
                                                "><b>Dragon</b></h4>
                                                <div class="info-block m-t-5" style="position: relative; display: inline-block;left: 334px;top: -25px;">
                                            ...
                                            <div class="col-md-3 text-center">
                                                <b class="market_6_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase dt-button showbet-action market_6_b_btn market_6_row back"
                                                        data-index="5">
                                                        <b>Odd</b>
                                                    </button>
                                                    <div class="ubook m-t-5 text-danger">
                                            ...
                                            <div class="col-md-3 text-center">
                                                <b class="market_8_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase btn-theme market_8_b_btn market_8_row back"
                                                        data-index="7">
                                                        <div class="color-card"></div>
                                                        <span class="card-icon">
                                ...
                                <div class="col-md-6 p-l-5 m-t-20">
                                    <div class="d-t-box m-b-10">
                                        <div class="row ">
                                            ...
                                            <div class="col-md-3 text-center">
                                                <b class="market_22_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase dt-button showbet-action market_22_b_btn market_22_row back"
                                                        data-index="21">
                                                        <b>Even</b>
                                                    </button>
                                                    <div class="ubook m-t-5 text-danger">
                                                        <b class="market_22_b_exposure market_exposure text-danger">0</b>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 text-center">
                                                <b class="market_23_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase dt-button showbet-action market_23_b_btn market_23_row back"
                                                        data-index="22">
                                                        <b>Odd</b>
                                                    </button>
                                                    <div class="ubook m-t-5 text-danger">
                                                        <b class="market_23_b_exposure market_exposure text-danger">0</b>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-12 m-t-10 text-right">
                                            ...
                                            <div class="col-md-3 text-center">
                                                <b class="market_24_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase btn-theme market_24_b_btn market_24_row back"
                                                        data-index="23">
                                                        <div class="color-card"></div>
                                                        <span class="card-icon">
                                                            <span class="card-red">[</span>
                                                    ...
                                                    <div class="ubook m-t-5 text-danger">
                                                        <b class="market_24_b_exposure market_exposure  text-danger">0</b>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 text-center">
                                                <b class="market_25_b_value">0</b>
                                                <div class="m-t-10">
                                                    <button
                                                        class="suspended-box text-uppercase btn-theme market_25_b_btn market_25_row back"
                                                        data-index="24">
                                                        <div class="color-card"></div>
                                                        <span class="card-icon">
                                                            <span class="card-black">]</span>
                    ...
                    <div class="row">
                        <div class="col-md-6 p-r-5">
                            <div class="d-t-box m-b-10">
                                <div class="row ">
                                    <div class="col-md-12">
                                        <h4 class="m-b-0 text-center text-uppercase market_9_b_value"> <span id="dcard-rate">0</span>
                                        </h4>
                                         <div class="info-block m-t-5" style="position: relative; display: inline-block;left: 334px;top: -25px;">
                                    ...
                                    <div class="card-dt col-md-12 text-center m-t-10">
                                        <div class=" m-r-5 card-image showbet-action" data-index="25">
                                            <div class="suspended-box card market_9_b_btn market_9_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/1.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_9_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="26">
                                            <div class="suspended-box card market_10_b_btn market_10_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/2.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_10_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="27">
                                            <div class="suspended-box card market_11_b_btn market_11_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/3.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_11_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="28">
                                            <div class="suspended-box card market_12_b_btn market_12_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/4.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_12_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="29">
                                            <div class="suspended-box card market_13_b_btn market_13_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/5.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_13_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="30">
                                            <div class="suspended-box card market_14_b_btn market_14_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/6.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_14_b_exposure market_exposure text-danger">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="31">
                                            <div class="suspended-box card market_15_b_btn market_15_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="32">
                                            <div class="suspended-box card market_16_b_btn market_16_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="33">
                                            <div class="suspended-box card market_17_b_btn market_17_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="34">
                                            <div class="suspended-box card market_18_b_btn market_18_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="35">
                                            <div class="suspended-box card market_19_b_btn market_19_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="36">
                                            <div class="suspended-box card market_20_b_btn market_20_row" style="align-items: center;"> <img
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="37">
                                            <div class="suspended-box card market_21_b_btn market_21_row" style="align-items: center;"> <img
                        ...
                        <div class="col-md-6 p-l-5">
                            <div class="d-t-box m-b-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="m-b-0 text-center text-uppercase market_26_b_value">
                                            <span id="tcard-rate">0</span>
                                        </h4>
                                         <div class="info-block m-t-5" style="position: relative; display: inline-block;left: 334px;top: -25px;">
                                    ...
                                    <div class="card-dt col-md-12 text-center m-t-10">
                                        <div class=" m-r-5 card-image showbet-action" data-index="8">
                                            <div class="suspended-box card  market_26_b_btn market_26_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/1.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 "><b
                                                        class="market_26_b_exposure market_exposure text-danger">0</b>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="9">
                                            <div class="suspended-box card market_27_b_btn market_27_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/2.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 "><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="10">
                                            <div class="suspended-box card market_28_b_btn market_28_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/3.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_28_b_exposure market_exposure text-danger">0</b>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="11">
                                            <div class="suspended-box card market_29_b_btn market_29_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/4.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="12">
                                            <div class="suspended-box card market_30_b_btn market_30_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/5.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="13">
                                            <div class="suspended-box card market_31_b_btn market_31_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/6.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="14">
                                            <div class="suspended-box card market_32_b_btn market_32_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/7.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="15">
                                            <div class="suspended-box card market_33_b_btn market_33_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/8.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="16">
                                            <div class="suspended-box card market_34_b_btn market_34_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/9.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                                        class="market_34_b_exposure market_exposure text-danger">0</b>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="17">
                                            <div class="suspended-box card market_35_b_btn market_35_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/10.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="18">
                                            <div class="suspended-box card market_36_b_btn market_36_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/11.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="19">
                                            <div class="suspended-box card market_37_b_btn market_37_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/12.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="20">
                                            <div class="suspended-box card market_38_b_btn market_38_row" style="align-items: center;"> <img
                                                    src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/13.jpg">
                                            </div>
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=dt20"
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/dt20/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    ...
    if (xhr && xhr.readyState != 4)
        xhr.abort();
    xhr = $.ajax({
        url: MASTER_URL + '/live-market/dt/active_bets/dt20/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_view_more_bets() {
    ...
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/dt/view_more_matched/dt20/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    ...
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/dt/market_analysis/dt20/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
