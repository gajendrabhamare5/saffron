    ...
    <div class="listing-grid casino-grid">
            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">Lucky 6 &nbsp;
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . LUCKY5_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe> -->
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . LUCKY5_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . "" . LUCKY5_CODE; ?>" style="border:0px"></iframe> -->
                    ...
                    <div id="tableData">
                            ...
                            <div class="d-flex justify-between" style="justify-content: space-between;">
                                <div class="d-flex" style="gap: 7px;width: 40%;">
                                    <div class="text-center" style="width: 40%;">
                                        <button class="low-high-btn showbet-action market_1_row market_1_b_btn b1" data-index="0" side="Back" selectionid="1" marketid="1" eventid="251507130035" markettype="LUCKY6" event_name="LUCKY6" fullmarketodds="2.00" fullfancymarketrate="2.00">
                                            <div class="text-center"> <b>2</b> </div><b>Low Card</b>
                                        </button>
                                        <div class="ubook m-t-5 text-danger market_1_b_exposure market_exposure" style="color: rgb(0, 0, 0);">0</div>
                                    </div>
                                    <div class="text-center card-seven" style="width: 15%;"> <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/6.jpg"> </div>
                                    <div class="text-center" style="width: 40%;">
                                        <button class="low-high-btn showbet-action market_2_row market_2_b_btn b2" data-index="1" side="Back" selectionid="2" marketid="2" eventid="251507130035" markettype="LUCKY6" event_name="LUCKY6" fullmarketodds="2.00" fullfancymarketrate="2.00">
                                            <div class="text-center"> <b>2</b> </div><b>High Card</b>
                                        </button>
                                        <div class="ubook m-t-5 text-danger market_2_b_exposure market_exposure" style="color: rgb(0, 0, 0);">0</div>
                                    </div>
                                </div>
                                <div class="d-flex" style=" gap: 5px;width: 55%;">
                                    <div class="text-center" style="width: 25%;">
                                        <button class="suspended low-high-btn showbet-action market_3_row market_3_b_btn" data-index="2">
                                    ...
                                    <div class="text-center" style="width: 25%;">
                                        <button class="suspended low-high-btn showbet-action market_4_row market_4_b_btn" data-index="3">
                        ...
                        <div class="card-content lucky-seven-content m-t-10">
                            <div class="row">
                                <div class="col-12 text-center"> <b>12</b> </div>
                            </div>
                            <div class="row m-t-10">
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=lucky5" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Lucky 6 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/lucky5/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/lucky5/active_bets/lucky6/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/lucky5/view_more_matched/lucky6/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/lucky5/market_analysis/lucky6/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
