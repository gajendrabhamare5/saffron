                        ...
                        <div class="mt-2 previlages">
                            ...
                            <div class="previlage-box">
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="plist[]" class="custom-control-input"
                                                value="true" id="all">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="1" id="dashboard">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="2" id="manalysis">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="4" id="ulist">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="5" id="user">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="8" id="astmt">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="9" id="pwinloss">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="10" id="cbets">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="" id="glock">
                                ...
                                <?php if (CASINO_PLAY) { ?>
                                    <div class="previlage-item">
                                        <div>
                                            <div class="custom-control custom-checkbox">
                                                <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                    class="custom-control-input" value="13" id="cresult">
                                    ...
                                    <div class="previlage-item">
                                        <div>
                                            <div class="custom-control custom-checkbox">
                                                <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                    class="custom-control-input" value="14" id="lcresult">
                                                <label class="custom-control-label" for="lcresult">Live Casino
                                                    Result</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="previlage-item">
                                        <div>
                                            <div class="custom-control custom-checkbox">
                                                <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                    class="custom-control-input" value="15" id="casino">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="16" id="events">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="17" id="msanalysis">
                                            <label class="custom-control-label" for="msanalysis">Market Search
                                                Analysis</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="19" id="lucreation">
                                            <label class="custom-control-label" for="lucreation">Login User
                                                creation</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="54" id="withdraw">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="55" id="deposit">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="56" id="creference">
                                            <label class="custom-control-label" for="creference">Credit
                                                Reference</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="57" id="uinfo">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="58" id="pwdchange">
                                            <label class="custom-control-label" for="pwdchange">User Password
                                                Change</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="59" id="ulock">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="60" id="block">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="91" id="auser">
                                ...
                                <div class="previlage-item">
                                    <div>
                                        <div class="custom-control custom-checkbox">
                                            <input data-vv-as="Privileges" type="checkbox" name="plist[]"
                                                class="custom-control-input" value="104" id="asign">
                            ...
                            <div class="previlage-master mt-2">
                                <div class="form-group mb-0">
                                    <input type="password" name="mpass" placeholder="Transaction Code"
                                        class="form-control mpass-text" aria-required="true" aria-invalid="false">
