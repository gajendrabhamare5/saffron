                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#matched-bet2"
                                onclick="tab_view('sport')">Sports</a>
                        </li>
                        <?php if (CASINO_PLAY) { ?>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#matched-bet2"
                                    onclick="tab_view('casino')">Casino</a>
                            </li>
                        <?php } ?>
                    </ul>
                                    ...
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-md-12 hideshow">
                                            <div class="form-group">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="search-bet_type" value="matched"
                                                        id="matched" checked>
                                                    <label for="bet-matched">Matched</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="search-bet_type" value="deleted"
                                                        id="deleted">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="display: flex;justify-content: left;">
                                                ...
                                                <button type="submit" class="btn btn-diamond"
                                                    id="loaddata">Load</button>
                                            </div>

                                        </div>
                                        <div class="col-md-9 text-right">
                                            <h4 style="font-size: 1.1rem">Total Soda: <span
                                                    class=" mr-2 total_bet">0</span> Total Amount: <span
                                                    class=" total_pl">0.00</span></h4>
                                        </div>
                                    </div>
                                </div>
                            </form>
