...
<div class="col-md-12 main-container">
    <div>
        <div class="listing-grid">
                ...
                <form method="post" id="form-search">
                    <div class="m-t-20">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-2">
                                <div class="form-group">
                                    <label for="search-game_name" id="game_name">Game Name</label>
                            ...
                            <div class="col-sm-12 col-lg-2 client_name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="search-client_name"
                            ...
                            <div class="col-sm-12 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input id="search-from_date" class="form-control  datepicker1"
                                        ...
                                        style="font-family: 'Poppins', sans-serif;" placeholder="Choose Date">
                                    <i class="mx-icon-calendar"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-2" style="margin-bottom: 10px;">
            ...
            <table id="account_history_table" class="table table-striped table-bordered datatable mt-3"
                style="width:100%">
                <thead>
                    <tr>
                        <th width="15%">Date</th>
                    ...
                    <div class="row row5">
                        <div class="col-12">
                            <div id="match_all" role="radiogroup" tabindex="-1">
                                ...
                                <div class="custom-control custom-control-inline custom-radio">
                                    <input id="matched_back" type="radio" name="match_all" autocomplete="off"
                                        value="Back" class="custom-control-input">
                                    <label for="matched_back" class="custom-control-label"><span>Back</span></label>
                                </div>
                                <div class="custom-control custom-control-inline custom-radio">
                                    <input id="matched_lay" type="radio" name="match_all" autocomplete="off" value="Lay"
                                        class="custom-control-input">
                                ...
                                <div class="custom-control-inline float-right">
                                    <h5>Total Bets: <span class="text-success mr-2 total_bet">0</span> Total Win: <span
                                            class=" total_pl">0.00</span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
            ...
            },
            {
                ...
                "data": function (data) {
                    if (data.bid == 0 || data.remark == 'Opening') {
                        ...
                        var gameMap1 = JSON.parse('<?php echo json_encode(unserialize(GAME_LIST)); ?>');
                        var event_name_dis = data.event_name.toLowerCase();
                        /* if (gameMap1.hasOwnProperty(event_name_dis)) event_name_dis = gameMap1[event_name_dis]; */
                        if (gameMap1.hasOwnProperty(event_name_dis)) {
                            event_name_dis = gameMap1[event_name_dis];
                        }

                        console.log("event_name_dis", event_name_dis);
                        var remark = event_name_dis + ' Rno. ' + data.event_id + '/' + data.market_type + '-' + data.market_name;
    ...
    $(document).ready(function () {
        ...
        $('#search-report_type').on('change', function () {
            // $('#search-game_name').closest('.col-lg-2').hide();
            ...
            if (report_type == 5) {
                $('#game_name').text('Casino List');
                html_option += '<?php echo $casino_option; ?>';
            } else if (report_type == 4) {
                $('#game_name').text('Sport List');
            ...
            if (report_type == 6) {
                ...
                $('#search-game_name').closest('.col-lg-2').addClass('hidden-column');
            } else {
                $('#search-game_name').closest('.col-lg-2').removeClass('hidden-column');
            }
                   ...
                   /* if (total_pl1 == 0) {
                    ...
                    if (total_checked1 == 0) {
                        total_checked1 = response.result_bet.length;
                         ...
                         let displayPL = total_pl1;
                          $(".total_pl").text(displayPL);
