                    ...
                    <div class="row row5">
                        <div class="col-12">
                            <div id="match_all" role="radiogroup" tabindex="-1">
                                ...
                                <div class="custom-control custom-control-inline custom-radio">
                                    <input id="matched_back" type="radio" name="match_all" autocomplete="off" value="Back"
                                        class="custom-control-input">
                                ...
                                <div class="custom-control-inline float-right">
                                    <h5>Total Bets: <span class="text-success mr-2 total_bet">0</span> Total Win: <span class="text-success total_pl">0.00</span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
