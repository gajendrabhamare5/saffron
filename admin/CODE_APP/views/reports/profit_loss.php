    ...
    <div>
        <div class="listing-grid">
                ...
                <form method="post" id="form-search">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="search-client_name1" id="search-client_name1">
                    ...
                    <div class="row row5">
                        <div class="form-group col-md-3">
                            <select class="custom-select" name="search-client_name1" id="search-client_name1">
                                <option value="0">All</option>
                                <option value="1">User</option>
                            </select>
                        </div>
            ...
            <div id="page_contents" >
                <!-- <input type="text" id="search-common" class="form-control" placeholder="Search table..." /> -->
                 <div class="row"><div class="col-sm-12 col-md-12"><div id="tickets-table_filter" class="dataTables_filter text-md-right"><label class="d-inline-flex align-items-center">
                    Search:
                    <input type="search" placeholder="Search..." class="form-control ml-2 form-control" id="search-common"></label></div></div></div>
                <!-- <div class="pl-boxes">
                ...
                <table id="example" class="custom-table table table-bordered table-striped">
                    ...
                    <tfoot role="rowgroup" class="" style="height: 40px;">
                        <tr role="row" class="">
                            <th role="columnheader" scope="col" aria-colindex="1" class=""
                                style="border: 1px solid #dee2e6;">
                                <span></span>
                            </th>
                            <th role="columnheader" scope="col" aria-colindex="2" class="" style="border: 1px solid #dee2e6;"><span></span></th>
                            <th role="columnheader" scope="col" aria-colindex="3" class="" style="border: 1px solid #dee2e6;"><span></span></th>
                            <th role="columnheader" scope="col" aria-colindex="4" class="text-right" style="border: 1px solid #dee2e6;"><span></span></th>
                            <th role="columnheader" scope="col" aria-colindex="5" class="text-right" style="border: 1px solid #dee2e6;"><span></span></th>
                            <th role="columnheader" scope="col" aria-colindex="6" class="text-right" style="border: 1px solid #dee2e6;"><span></span></th>
                            <th role="columnheader" scope="col" aria-colindex="7" class="text-right" style="border: 1px solid #dee2e6;"><span></span></th>
                        </tr>
                    </tfoot>
                </table>
...
<script type="text/javascript">
    ...
    function preparesearch() {
        ...
        search_string += set_search_single("client_name", $('#search-client_name1').val());
        search_string += set_search_single("to_date", $('#search-to_date').val());
        search_string += set_search_single("search_text", $('#search-common').val()); 
    ...
    function call_page(limit_page, orderby) {
        ...
        // console.log("dsjdswf", preparesearch());
