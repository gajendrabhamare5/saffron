                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user-username" id="user-username" class="form-control"
                                        placeholder="Client Name" required="required" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="user-password" id="user-password" class="form-control"
                                        placeholder="User Password" required="required" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    <label for="user-cpassword">Retype Password:</label>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user-full-name" id="user-full-name" class="form-control"
                                        placeholder="Full Name" required="required" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select name="user-account_type" id="user-account_type" class="form-control"
                                        required="required">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user-credit_reference" id="user-credit_reference"
                                        class="form-control" placeholder="Credit Reference" value="" required="required"
                                        autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-12" id="div-exposure_limit">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user-exposure_limit" id="user-exposure_limit"
                                        class="form-control" placeholder="Exposure Limit" value="0" required="required"
                                        autocomplete="off" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="m-b-20 col-md-12 col-xs-12" id="div-commission_setting">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>Up Line</td>
                                    <td><input type="text" name="user-cricket_upline_commission"
                                            id="user-cricket_upline_commission" class="form-control"
                                            value="<?php echo (100 - $upline_commission); ?>" required="required"
                                ...
                                <tr>
                                    <td>Down Line</td>
                                    <td><input type="text" name="user-cricket_downline_commission"
                                            id="user-cricket_downline_commission"
                                            class="form-control downline_commission" data-sport="cricket" value=""
                                ...
                                <tr>
                                    <td>Our</td>
                                    <td><input type="text" name="user-cricket_our_commission"
                                            id="user-cricket_our_commission" class="form-control"
                                            value="<?php echo $upline_commission; ?>" required="required"
                                            autocomplete="off" disabled="" /></td>
                    ...
                    <div class="m-b-20 col-md-12 col-xs-12" id="div-partnership_setting">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>Up Line</td>
                                    <td><input type="text" name="user-cricket_upline_partnership"
                                            id="user-cricket_upline_partnership" class="form-control"
                                            value="<?php echo (100 - $upline_partnership); ?>" required="required"
                                            autocomplete="off" disabled="" /></td>
                                ...
                                <tr>
                                    <td>Down Line</td>
                                    <td><input type="text" name="user-cricket_downline_partnership"
                                            id="user-cricket_downline_partnership"
                                            class="form-control downline_partnership" data-sport="cricket" value=""
                                            required="required" autocomplete="off" /></td>
                                ...
                                <tr>
                                    <td>Our</td>
                                    <td><input type="text" name="user-cricket_our_partnership"
                                            id="user-cricket_our_partnership" class="form-control"
                                            value="<?php echo $upline_partnership; ?>" required="required"
                                            autocomplete="off" disabled="" /></td>
                    ...
                    <div class="m-b-20 col-md-12 col-xs-12" id="div-bet_limit_setting">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="number" name="user-minimum_limit_cricket"
                                            id="user-minimum_limit_cricket" class="form-control"
                                            value="<?php echo $min_cricket_stake; ?>"
                                            min="<?php echo $min_cricket_stake; ?>" required="required"
                                            autocomplete="off" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><input type="number" name="user-maximum_limit_cricket"
                                            id="user-maximum_limit_cricket" class="form-control"
                                            value="<?php echo $max_cricket_stake; ?>"
                                            min="<?php echo $min_cricket_stake; ?>"
                                            max="<?php echo $max_cricket_stake; ?>" required="required"
                                            autocomplete="off" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><input type="number" name="user-delay_cricket" id="user-delay_cricket"
                                            class="form-control" value="5" min="5" required="required"
                                            autocomplete="off" /></td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="m-b-20 col-md-12 col-xs-12" style="display:none;">
                        ...
                        <table class="table table-striped table-bordered">
                            <tbody>
                                <tr>
                                    <td>Minimum Odds</td>
                                    <td><input type="number" name="user-minimum_odds" id="user-minimum_odds"
                                            class="form-control" value="" min="" autocomplete="off"
                                            placeholder="Lay Odds" style="width: 200px;" /></td>
                                </tr>
                                <tr>
                                    <td>Maximum Odds</td>
                                    <td><input type="number" name="user-maximum_odds" id="user-maximum_odds"
                                            class="form-control" value="" min="" autocomplete="off"
                                            placeholder="Back Odds" style="width: 200px;" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row m-t-20">
                    <div class="col-md-12">
                        <div class="form-group col-md-3 float-right">
                            ...
                            <input required="required" maxlength="15" placeholder="Transaction Password"
                                name="form-master_pwd" id="master_pwd" value="" type="password" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row m-t-20">
...
<script type="text/javascript">
    ...
    $('#user-cricket_downline_commission').on('keypress blur', function (e) {
    ...
    $('#user-cricket_downline_partnership').on('keypress blur', function (e) {
        if (e.type === 'blur' || e.which === 13) { // Enter key
            e.preventDefault();
            var value = Number($(this).val());
            $('#user-cricket_downline_commission').val(value);
            cal_downline_commission($('#user-cricket_downline_commission'));
        }
    });
