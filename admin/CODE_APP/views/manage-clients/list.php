...
<div class="col-md-12 main-container">
    <div class="listing-grid">
        ...
        <div class='table-responsive tab-content'>
            ...
            <div id="active-user" class="tab-pane active d-flex flex-column ">
<div id="exportButtonsContainer" class="mb-2"></div>
  ...
  <label>
    ...
    <div class="col-sm-12 col-md-6 text-md-right mb-2 mb-md-0" id="customSearchContainer">
      <label class="d-inline-flex align-items-center mb-0">
        Search:
        <input type="text" id="search-common" placeholder="Search..."
                        ...
                        <div class="box-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row m-b-15">
                                    ...
                                    <div class="col-md-8">
                                        <textarea placeholder="Remark" class="form-control" id="withdrawal_remark" name="withdrawal_remark"></textarea>
                                    </div>
                                </div>
                                <div class="row m-b-15">
                                    <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function call_page(limit_page, orderby) {
        ...
        // Move export buttons to container (before length menu)
        if ($('#exportButtonsContainer').is(':empty')) {
            $('#exportButtonsContainer').append($('.dt-buttons'));
        }
