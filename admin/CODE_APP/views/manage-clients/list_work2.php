                ...
                if ($user_power != 6) {
                    ...
                    if (empty($agent_id)) { ?>
                        <div class="col-md-6 float-right m-b-10">
                            <p class="text-right">
                                <a href="<?php echo MASTER_URL; ?>/manage-clients3/add" class="btn btn-diamond">Add Account </a>
                            </p>
                        </div>
                <?php }
                }
...
<script type="text/javascript">
    ...
    function call_page(limit_page, orderby) {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/manage_clients3/get_user_list/' + limit+'/'+user_status+'/'+user2,
            type: 'POST',
            dataType: 'json',
            data: postdata,
...
$('#customLengthMenu').off('change').on('change', function() {
    ...
    $('#btn-reset').on('click', function () {
        ...
        $('#transfer-form').on('submit', function() {
            ...
            $.ajax({
                type: 'POST',
                url: 'manage_clients3/transfer_amount',
                data: transferData,
                dataType: 'JSON',
                success: function(data) {
                    // alert(data.text);
        ...
        $('#deposit_form').on('submit', function() {
            ...
            if (xhr_act && xhr_act.readyState != 4)
                xhr_act.abort();
            xhr_act = $.ajax({
                url: MASTER_URL + '/manage-clients3/account_transaction',
                type: 'POST',
                dataType: 'json',
                data: data,
        ...
        $('#generate_form').on('submit', function() {
            ...
            if (xhr_act && xhr_act.readyState != 4)
                xhr_act.abort();
            xhr_act = $.ajax({
                url: MASTER_URL + '/manage-clients3/generate_points',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(rdata) {
        ...
        $('#exposure_limit-modal').delegate('#exposure_limit-form', 'submit', function() {
            ...
            if (xhr_sel && xhr_sel.readyState != 4)
                xhr_sel.abort();
            xhr_sel = $.ajax({
                url: MASTER_URL + '/manage-clients3/set_exposure_limit',
                type: 'POST',
                dataType: 'json',
        ...
        $('#credit_reference-modal').delegate('#credit_reference-form', 'submit', function() {
            ...
            if (xhr_scr && xhr_scr.readyState != 4)
                xhr_scr.abort();
            xhr_scr = $.ajax({
                url: MASTER_URL + '/manage-clients3/set_credit_reference',
                type: 'POST',
                dataType: 'json',
                data: postdata,
                success: function(rdata) {
        ...
        $('#change_status-form').on('submit', function() {
            ...
            if (xhr_cs && xhr_cs.readyState != 4)
                xhr_cs.abort();
            xhr_cs = $.ajax({
                url: MASTER_URL + '/manage-clients3/change_status',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(data) {
        ...
        $('#change_access-form').on('submit', function() {
            ...
            if (xhr_cs && xhr_cs.readyState != 4)
                xhr_cs.abort();
            xhr_cs = $.ajax({
                url: MASTER_URL + '/manage-clients3/change_access',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(data) {
        ...
        $('#changepwd_form').on('submit', function() {
            ...
            if (xhr_cp && xhr_cp.readyState != 4)
                xhr_cp.abort();
            xhr_cp = $.ajax({
                url: MASTER_URL + '/manage-clients3/changepwd',
                type: 'POST',
                dataType: 'json',
                data: postdata,
                success: function(rdata) {
        ...
        $('#min_max_odds-form').on('submit', function() {
            ...
            if (xhr_cp && xhr_cp.readyState != 4)
                xhr_cp.abort();
            xhr_cp = $.ajax({
                url: MASTER_URL + '/manage-clients3/set_min_max_odds',
                type: 'POST',
                dataType: 'json',
                data: postdata,
                success: function(rdata) {
