        ...
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
               <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Race to 2nd
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . RACE2_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                                            <?php
                                            ...
                                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                                    echo RACE2_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                        ...
                                        <div class="casino-table">
                                            <div class="casino-table-box">
                                                <div class="casino-odd-box-container">
                                                    ...
                                                    <div class="casino-odds-box back suspended-box back-1 market_1_b_btn market_1_row"><span class="casino-odds">0</span></div>
                                                    <div class="casino-odds-box lay suspended-box lay-1 market_1_l_btn market_1_row"><span class="casino-odds">0</span></div>
                                                    <div class="casino-nation-book text-center w-100 market_1_b_exposure market_exposure text-danger"></div>
                                                </div>
                                                <div class="casino-odd-box-container">
                                                    <div class="casino-nation-name">Player B</div>
                                                    <div class="casino-odds-box back suspended-box market_2_row back-1 market_2_b_btn"><span class="casino-odds">0</span></div>
                                                    <div class="casino-odds-box lay suspended-box market_2_row lay-1 market_2_l_btn"><span class="casino-odds">0</span></div>
                                                    <div class="casino-nation-book text-center w-100 market_2_b_exposure market_exposure text-danger"></div>
                                                </div>
                                                <div class="casino-odd-box-container">
                                                    <div class="casino-nation-name">Player C</div>
                                                    <div class="casino-odds-box back suspended-box market_3_row back-1 market_3_b_btn"><span class="casino-odds">0</span></div>
                                                    <div class="casino-odds-box lay suspended-box market_3_row lay-1 market_3_l_btn"><span class="casino-odds">0</span></div>
                                                ...
                                                <div class="casino-odd-box-container">
                                                    ...
                                                    <div class="casino-odds-box back suspended-box market_4_row back-1 market_4_b_btn"><span class="casino-odds">0</span></div>
                                                    <div class="casino-odds-box lay suspended-box market_4_row lay-1 market_4_l_btn"><span class="casino-odds">0</span></div>
                                                    <div class="casino-nation-book text-center w-100 market_4_b_exposure market_exposure text-danger"></div>
                                                <div class="col-12 text-right casino-min-max">R:<span>100</span>-<span>50K</span></div>
                                                </div>
                                                
                                            </div>
                                        </div>

                                        <div class="casino-last-result-title"><span>Last Result</span><span><a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=race2">View All</a></span></div>
            ...
            <div class="modal-dialog" style="min-width: 650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Race to 2nd Result</h4>
    ...
    function updateResult(data) {
        if (data && data[0]) {
            ...
            data.forEach((runData) => {
                ...
                html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type + ')"  class="ball-runs last-result ml-1  ' + ab + '">' + ab1 + '</span>';
            });
...
<script>
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/race2/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/others/active_bets/race2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/others/view_more_matched/race2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/others/market_analysis/race2/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
