            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . A3CJ_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
                    ...
                    <div class="card-content m-t-5 m-b-5">
                        <table class="table main-table table-bordered">
                            <tbody>
                                ...
                                <tr style="border: 2px solid #72bbed;">
                                    <td width="10%">
                                ...
                                <tr style="border: 2px solid #faa9ba;">
                                    <td width="10%">
                                ...
                                <tr>
                                    <td colspan="2" style="padding:0;" data-title="SUSPENDED" class="market_1_row">
                                        <table style="width:100%; border:2px solid #72bbed; border-collapse:collapse;">
                                            <tr>
                                                <td colspan="2" class="text-center brate" style="padding:5px;">
                                                    <span class="market_1_b_value"><b>1.78</b></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="10%">
                                            ...
                                            <tr>
                                                <td colspan="2" class="text-right text-info remark" style="padding:5px;">
                                ...
                                <tr>
                                    <td colspan="2" style="padding:0;" data-title="SUSPENDED" class=" market_2_row">
                                        <table style="width:100%; border:2px solid #faa9ba; border-collapse:collapse;">
                                            <tr>
                                                <td colspan="2" class="text-center brate" style="padding:5px;">
                                                    <span class="market_2_l_value">1.84</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="10%">
                                                    <div id="nation2" class="p-title text-center">NO</div>
                                                    <span class="d-block text-center text-danger market_2_b_exposure market_exposure" style="color: black;"><b>0</b></span>
                                                </td>
                                                <td class="text-center" style="padding: 5px;">
                                                    <span class="game-section m-r-5"><img src="<?php echo WEB_URL; ?>storage/front/img/andar_bahar/1.jpg" class="card-image lay-1 market_2_l_btn" nat_1="A" side="Lay" selectionid="2" marketid="2" runner="No" marketname="No" eventid="201607173324" markettype="3_CARD_J" event_name="3_CARD_J" fullmarketodds="1.84" fullfancymarketrate="1.84"></span>
                                            ...
                                            <tr>
                                                <td colspan="2" id="remark2" class="text-right text-info remark" style="padding:5px;">
                    ...
                    <div class="text-right casino-min-max">R:<span>100</span>-<span>2L</span></div>
                        <div class="mt-1">
