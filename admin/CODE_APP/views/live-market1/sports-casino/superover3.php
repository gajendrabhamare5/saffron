            ...
            <div class="col-md-8 main-content new-casino race">
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . SUPEROVER3_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
                    ...
                    <div class="casino-detail detail-page-container position-relative">
                        ...
                        <div class="game-market market-6 fancy-market fancyTieMarket bookmaker-market">
                            <div class="market-title country-name">
                                <span>Tie</span>
                                <div class="float-right"><a href="javascript:void(0)" class="btn btn-back">Bet Lock</a></div>
                            </div>
                            <div class="row row10">
                                <div class="col-md-12">
                                    <div class="market-header">
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=superover3" class="">View All</a></span></div>
        ...
        socket.on('game', function(data) {
            if (data && data['t1'] && data['t1'][0]) {
                ...
                for (var j in data['t2']) {
                    ...
                    back_html = '<span class="odd d-block"><b>' + b1 + '</b></span><span class="d-block">' + bs1 + 'k</span>';
                    ...
                    lay_html = '<span class="odd d-block"><b>' + l1 + '</b></span><span class="d-block">' + ls1 + 'k</span>';
...
<script>
    ...
    function call_active_bets() {
        if (get_round_no() > 0) {
            if (xhr && xhr.readyState != 4)
                xhr.abort();
            xhr = $.ajax({
                url: MASTER_URL + '/live-market/sports-casino/active_bets/superover3/' + get_round_no(),
                type: 'POST',
                dataType: 'json',
    ...
    function call_view_more_bets() {
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/sports-casino/view_more_matched/superover3/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/sports-casino/market_analysis/superover3/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/superover3/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
