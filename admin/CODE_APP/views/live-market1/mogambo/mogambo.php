                    ...
                    <div class="video-container">
                        ...
                        <div class="video-overlay" style="top: 20%;">
                            <div class="videoCards">
                                <div class="race-total text-white">Total: 14</div>
                                <div>
...
<div>
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row mini-baccarat">
                                            ...
                                            <div
                                                ...
                                                <span class="casino-odds">1.76</span>
                                            </div>
                                            <!-- <div
                                                class="casino-odds-box lay lay-1 market_2_row market_2_l_btn suspended-box">
                                                <span class="casino-odds">1.79</span></div> -->
                                        </div>
                                    </div>
                                    <div class="text-right casino-min-max"> R:<span>100</span>-<span>5L</span></div>
                                </div>
                                ...
                                <div class="casino-table-left-box">
                                    <div class="casino-table-body">
                                        <div class="casino-table-row">
                                            ...
                                            <div class="casino-odds-box lay suspended-box"><span class="casino-odds">30</span><span class="casino-volume">120</span></div>
                                            <div class="casino-odds-box back suspended-box"><span class="casino-odds">30</span><span class="casino-volume">100</span></div>
                                        </div>
                                    </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Instant Teenpatti 3.0 Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
