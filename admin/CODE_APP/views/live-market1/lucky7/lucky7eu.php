            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card" style="background-color: #eee;">
                    ...
                    <div style="position: relative;">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . LUCKY7B_CODE; ?>" width="100%" height="400px" style="border: 0px;"></iframe>
                        <?php
...
<div>PAYOUT: 12.0</div>
                    ...
                    <div id="tableData">
                            ...
                            <div class="d-flex justify-between" style="justify-content: space-between;">
                                <div class="d-flex" style="gap: 7px;width: 40%;">
                                    <div class="text-center" style="width: 40%;">
                                        <button class="low-high-btn showbet-action market_1_row market_1_b_btn b1" data-index="0" side="Back" selectionid="1" marketid="1" eventid="251507130035" markettype="LUCKY7B" event_name="LUCKY7B" fullmarketodds="2.00" fullfancymarketrate="2.00">
                                    ...
                                    <div class="text-center card-seven" style="width: 15%;"> <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/7.jpg"> </div>
                                    <div class="text-center" style="width: 40%;">
                                        <button class="low-high-btn showbet-action market_2_row market_2_b_btn b2" data-index="1" side="Back" selectionid="2" marketid="2" eventid="251507130035" markettype="LUCKY7B" event_name="LUCKY7B" fullmarketodds="2.00" fullfancymarketrate="2.00">
                        ...
                        <div class="casino-table-box mt-3">
                            <div class="lucky7cards">
                                ...
                                <div class="card-odd-box-container suspended market_20_row back-1 market_20_b_btn" data-index="6">
                                ...
                                <div class="casino-nation-book text-center text-danger w-100 market_20_b_exposure market_exposure">
                                </div>
                                <div class="casino-min-max text-right">
                            ...
                            <div class="lucky7cards">
                                ...
                                <div class="card-odd-box-container suspended market_21_row back-1 market_21_b_btn" data-index="7">
                                    <div class="card-odd-box">
                                ...
                                <div class="casino-nation-book text-center text-danger w-100 market_21_b_exposure market_exposure">
                                </div>
                                <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                            </div>
                            <div class="lucky7cards">
                                ...
                                <div class="card-odd-box-container suspended market_22_row back-1 market_22_b_btn" data-index="8">
                                    <div class="card-odd-box">
                                ...
                                <div class="casino-nation-book text-center text-danger w-100 market_22_b_exposure market_exposure">
                                </div>
                                <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                            </div>
                            <div class="lucky7cards">
                                ...
                                <div class="card-odd-box-container suspended market_23_row back-1 market_23_b_btn" data-index="9">
                                    <div class="card-odd-box">
                                ...
                                <div class="casino-nation-book text-center text-danger w-100 market_23_b_exposure market_exposure">
                                </div>
                                <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                            </div>
                        ...
                        <div class="card-content lucky-seven-content m-t-10">
                            <div class="row">
                                <div class="col-12 text-center market_7_b_value"> <b>0</b> </div>
                            </div>
                            <div class="row m-t-10">
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Lucky 7 - B Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
