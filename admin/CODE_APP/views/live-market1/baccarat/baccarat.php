    ...
    <div class="listing-grid ddb-container casino-grid">
        <div class="coupon-card row dt6-container">
            <div class="col-md-8 main-content baccarat">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">Baccarat
                            <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('baccarat.jpg')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>  -->
                            <!---->
                        </span>
                        <!-- <small role="button" class="teenpatti-rules"
												onclick="view_rules('baccarat')" data-target="#rules_popup"
                    ...
                    <div class="video-container">
                        <?php
											if (!empty(IFRAME_URL_SET)) {
												?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . BACCARAT_CODE; ?>" width="100%"
			...
			<iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . BACCARAT_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                            ...
                                            <div>
                                                <div class="rules-section">
                                                    ...
                                                    <ul class="pl-2 pr-2 list-style">
                                                        ...
                                                        <li><b>Big</b> - Bet on the chance that the total number of
                                                            cards dealt between Player and Banker is 5 or 6.</li>
                                                        <li><b>Small</b> - Bet on the chance that the total number of
                                                            cards dealt between Player and Banker is 4.</li>
                                                        <li><b>Perfect Pair</b> - Bet on the chance that the first two
                                                            Player or Banker cards form a pair of the same suit.</li>
                                                        <li><b>Either Pair</b> - Bet on the chance that either the first
                                                            two cards of the Banker hand or the first two cards of the
                                                            Player hand (or both) form a pair.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="baccarat-container">
                        <div class="row row5">
													...
													<div>
														<div style="position: relative;">
															<div dir="ltr"
																...
																<div style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%;"
																	...
																	<svg width="183" height="160" aria-label="A chart."
																		...
																		<g>
																			...
																			<g column-id="Player">
																				<rect x="130" y="3" width="53"
																					...
																					fill="#ffffff"></rect>
																				<g>
																					<text text-anchor="start" x="142"
																						y="10.65" font-family="Arial"
																						font-size="9" stroke="none"
																						stroke-width="0"
																						fill="#222222">Player</text>
																				</g>
																		...
																		<g>
																			<path
																				d="M115,74.5L115,85.5A55,44,0,0,1,102.37822835266842,113.54665554894234L102.37822835266842,102.54665554894234A55,44,0,0,0,115,74.5"
																				stroke="#06518a" stroke-width="1"
																				fill="#06518a"></path>
																			<path
																				d="M60,74.5L60,85.5L102.37822835266842,113.54665554894234L102.37822835266842,102.54665554894234"
																				stroke="#06518a" stroke-width="1"
																				fill="#06518a"></path>
																			<path
																				d="M60,74.5L60,30.5A55,44,0,0,1,102.37822835266842,102.54665554894234L60,74.5A0,0,0,0,0,60,74.5"
																		...
																		<g>
																			<path
																				d="M60,74.5L60,85.5L33.503547924405616,46.942506078070025L33.503547924405616,35.942506078070025"
																				stroke="#1d7026" stroke-width="1"
																				fill="#1d7026"></path>
																			<path
																				d="M60,74.5L33.503547924405616,35.942506078070025A55,44,0,0,1,60,30.5L60,74.5A0,0,0,0,0,60,74.5"
																				stroke="#279532" stroke-width="1"
																				fill="#279532"></path>
																		</g>
																		<g>
																			<path
																				d="M102.37822835266842,102.54665554894234L102.37822835266842,113.54665554894234A55,44,0,0,1,5,85.5L5,74.5A55,44,0,0,0,102.37822835266842,102.54665554894234"
																				stroke="#831924" stroke-width="1"
																				fill="#831924"></path>
																			<path
																				d="M60,74.5L102.37822835266842,102.54665554894234A55,44,0,1,1,33.503547924405616,35.942506078070025L60,74.5A0,0,0,1,0,60,74.5"
																				stroke="#ae2130" stroke-width="1"
																				fill="#ae2130"></path>
																			<text text-anchor="start"
																				x="23.816029603949815"
																				y="94.76084267625984"
																				font-family="Arial" font-size="9"
																				stroke="none" stroke-width="0"
																				fill="#ffffff">56%</text>
															...
															<div aria-hidden="true"
																style="display: none; position: absolute; top: 170px; left: 193px; white-space: nowrap; font-family: Arial; font-size: 9px; font-weight: bold;">
																36 (36%)</div>
															<div></div>
														</div>
													</div>
                            ...
                            <div class="col-12">
                                <div class="row row5">
                                    <div class="col-3">
                                        <div class="bet-odds suspended market_6_b_btn market_6_row back-1">
                                            <p class="mb-1 uppercase">Perferct Pair 25:1</p>
                                            <p class="mb-1"></p>
                                        </div>
                                    ...
                                    <div class="col-3">
                                        <div class="bet-odds suspended market_7_b_btn market_7_row back-1">
                                            <p class="mb-1 uppercase">Big 0.54:1</p>
                                            <p class="mb-1"></p>
                                        </div>
                                    ...
                                    <div class="col-3">
                                        <div class="bet-odds suspended market_8_b_btn market_8_row back-1">
                                            <p class="mb-1 uppercase">Small 1.5:1</p>
                                            <p class="mb-1"></p>
                                        </div>
                                    ...
                                    <div class="col-3">
                                        <div class="bet-odds suspended market_9_b_btn market_9_row back-1">
                                            <p class="mb-1 uppercase">Either Pair 5:1</p>
                                            <p class="mb-1"></p>
                                        </div>
                                ...
                                <div class="bet-container mt-3">
                                    ...
                                    <div class="player">
                                        <div class="suspended market_1_b_btn market_1_row back-1"><b class="">Player 1:1</b>
                                    ...
                                    <div class="banker">
                                        <div class="suspended market_2_b_btn market_2_row back-1"><b class="">Banker</b>
                    ...
                    <div class="casino-last-result-title"><span>Last Result</span><span><a
                                href="<?php echo MASTER_URL; ?>/reports/casino-results?q=baccarat">View All</a></span>
                    </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Baccarat Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/baccarat/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    ...
    if (xhr && xhr.readyState != 4)
        xhr.abort();
    xhr = $.ajax({
        url: MASTER_URL + '/live-market/baccarat/active_bets/baccarat/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_view_more_bets() {
    ...
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/baccarat/view_more_matched/baccarat/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    ...
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/baccarat/market_analysis/baccarat/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
