...
<div class="col-md-12 main-container">
            ...
            <div class="col-md-8 main-content">
                <div class="game-heading m-b-5">
                    <span class="card-header-title event_name_heading"
                        id="spn_event_title" style="display: flex;justify-content: space-between;align-items: center;"><?php echo $event_name; ?>
                ...
                <div class="card-content">
                    ...
                    <div>
                        <div class="row row5 bookmaker-container" id="bookmaker_market_div" style="display: none;">
                            <div class="fancy-marker-title col-12" id="bm-head" style="">
                                ...
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Bookmaker Market</h4>

                                    <div>
                                        <!--  <li class="form-group active-button d-inline-block FancyActive" style="list-style:none;margin-top: 5px;margin-bottom: 5px;">
                                            <a href="javascript:void(0)" data-status="3" data-type="bookmaker" class="btn btn-back active" id="btn-fancy_bet_lock">Bet Lock</a>
                                            
                                        </li> -->
                                        <!-- <ul class="sub-button">
                                                <li><a href="javascript:void(0)" id="btn-bet_active_all" data-status="0">All Deactive</a></li>
                                                <li><a href="javascript:void(0)" id="btn-modal_userwisebetsttus">Userwise</a></li>
                                            </ul> -->
                                        <li class="form-group active-button d-inline-block" style="list-style:none;margin-top: 5px;margin-bottom: 5px;margin-right: 5px;">
                                            <a href="javascript:void(0)" class="btn btn-back active user_book"
                                                id="modal-btn_userbookmaker" style="text-transform: uppercase;font-size: 12px;">User Book</a>
                                        </li>
                                    </div>
                                </div>
                                ...
                                <div class="remark">"The King of All MATKA Market Open And Close Every Hour! LIVE
                                    RESULTS,100% TRUSTED.”</div>
                            </div>
                        </div>

                        <div class="row row5 bookmaker-container">
                            <div class="fancy-marker-title col-xl-12" id="bm1-market_div" style="display: none;">
                                <!-- <h4>Bookmaker Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Bookmaker 2 Market</h4>

                                    <div>
                                        <!-- <li class="form-group active-button d-inline-block BetActives" style="list-style:none;margin-top: 5px;margin-bottom: 5px;">
                                        <a href="javascript:void(0)" class="btn btn-back active" id="bet_lock">Bet Lock</a>
                                        <ul class="sub-button">
                                            <li><a href="javascript:void(0)" id="btn-bet_active_all" data-status="0">All Deactive</a></li>
                                            <li><a href="javascript:void(0)" id="btn-modal_userwisebetsttus">Userwise</a></li>
                                        ...
                                        <li class="form-group active-button d-inline-block" style="list-style:none;margin-top: 5px;margin-bottom: 5px;margin-right: 5px;">
                                            <a href="javascript:void(0)" class="btn btn-back active user_book"
                                                id="modal-btn_userbookmakersmall" style="text-transform: uppercase;font-size: 12px;">User Book</a>
                                        </li>
                        ...
                        <div class="row row5 bookmaker-container " id="bookmaker_tied_market_div"
                            style="display: none;">
                            <div class="fancy-marker-title col-12" id="bm-head" style=""> <!--  <h4>Bookmaker Tied Market</h4> -->

                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);cursor:pointer;" id="fancy_toggle">

                                    <!-- <h4 style="margin:0;background-color:unset">Bookmaker Tied Market</h4> -->
                                    <h4 style="margin:0;background-color:unset">Tied Match</h4>
                                    ...
                                    <div>
                                        ...
                                        <li class="form-group active-button d-inline-block" style="list-style:none;margin-top: 5px;margin-bottom: 5px;margin-right: 5px;">
                                            <a href="javascript:void(0)" class="btn btn-back active user_book"
                                                id="modal-btn_userbookmakertied" style="text-transform: uppercase;font-size: 12px;">User Book</a>
                                        </li>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 fancy-market" id="fancy-market" style="margin-bottom: 5px;">
                            <div class="fancy-marker-title">
                                <!-- <h4>Fancy Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);cursor:pointer;" id="fancy_toggle">

                                    <h4 style="margin:0;background-color:unset">Normal</h4>
                                    ...
                                    <div>
                                        <li class="form-group active-button m-l-20 d-inline-block FancyActive" style="padding-top: 5px;margin-bottom: 6px;text-transform: uppercase;margin-right: 5px;">
                                            <a href="javascript:void(0)" class="btn btn-back active" id="btn-fancy_bet_lock" data-type="fancy" data-market_type="FANCY_ODDS" data-block_type="2">Bet
                                                Lock</a>
                                            <!-- <ul class="sub-button">
                                                <li>
                                                    <a href="javascript:void(0)" id="btn-fancy_bet_active_all">All Deactive</a>
                        ...
                        <div class="col-md-12 fancy-market" id="overbyover-market" style="">
                            <div class="fancy-marker-title">

                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Over By Over</h4>
                            ...
                            <div id="div_fancy">
                                <table class="table coupon-table table table-bordered m-t-10 ">
                                    ...
                                    <tbody id="secure_over_by_over_market_tbody">
                                        <tr id="secure_over_by_over"></tr>
                                    </tbody>
                                </table>
                            </div>
                        </div>

                        <div class="col-md-12 fancy-market" id="ballbyball-market" style="">
                            <div class="fancy-marker-title">
                                <!-- <h4>Ball by Ball Session Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Ball by Ball Session Market</h4>
                        ...
                        <div class="col-md-12 fancy-market" id="fancy1-market" style="">
                            <div class="fancy-marker-title">
                                <!--  <h4>Fancy1 Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Fancy1 Market</h4>
                            ...
                            <div id="div_fancy">
                                <table class="table coupon-table table table-bordered m-t-10 ">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th class="text-center back box-w1">Back</th>
                                            <th class="text-center box-w1 lay">Lay</th>
                                            <th class="box-w2"></th>
                                        </tr>
                                    </thead>
                        ...
                        <div class="col-md-12 fancy-market" id="oddeven-market" style="">
                            <div class="fancy-marker-title">
                                <!--  <h4>Odd/Even Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Oddeven Market</h4>
                        ...
                        <div class="col-md-12 fancy-market" id="khado-market" style="">
                            <div class="fancy-marker-title">
                                <!--  <h4>Khado Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Khado Market</h4>
                        ...
                        <div class="col-md-12 fancy-market" id="meter-market" style="">
                            <div class="fancy-marker-title">
                                <!-- <h4>Meter Market</h4> -->
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: var(--theme2-bg70);">

                                    <h4 style="margin:0;background-color:unset">Meter Market</h4>
                    ...
                    <div id="other_odds_markets" class="match_odds_all_full_markets"></div>
                </div>
            </div>
                                ...
                                <form method="POST" id="form-view_more_bets">
                                    <div class="form-row align-items-end"
                                        ...
                                        <div class="form-group" style="position:relative;">
                                            ...
                                            <input type="text" id="search-client_name" name="search-client_name" class="form-control" placeholder="Search username..." style="width:160px;">
    ...
    <div class="modal fade show" id="userwisebet">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Bet Lock</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                    ...
                    <div class="usertypewiseactive-container">
                        <form action="" id="form_userwisebet" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input type="password" name="tpassword1" id="tpassword1" placeholder="Transaction Code" class="form-control ">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="usertypewiseactive-container">
                        <form action="form_userwisefancy" id="" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input type="password" name="tpassword" id="tpassword" placeholder="Transaction Code" class="form-control ">
                                    </div>
                                </div>
                            </div>
                            <table border="0" cellpadding="0" cellspacing="0" class="table table-diamond">
                                <thead>
                                    <tr>
                                        <!--  <th width="20%">Sr. No.</th> -->
                                        <th width="20%">
                                            <!-- <input type="checkbox" id="fancy_check_all"> -->
                                            <div class="form-check form-check-inline ">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" id="fancy_check_all" type="checkbox">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </th>
                                        <th width="60%">All Account</th>
                                    </tr>
                                </thead>
    ...
    <div class="modal fade show" id="fancy_book">
        <div class="modal-dialog modal-lg" style="width:25%;">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Run Amount</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                        ...
                        if (result > 0) {
                            ...
                            for (var i in gameList) {
                                ...
                                if (gameList[i].matchid == eventId) {
                                    ...
                                    var matchdate = gameList[i].matchdate;
                                    var marketTime1 = new Date(matchdate);

                                    // Format parts
                                    var day = ("0" + marketTime1.getDate()).slice(-2);
                                    var month = ("0" + (marketTime1.getMonth() + 1)).slice(-2);
                                    var year = marketTime1.getFullYear();

                                    var hours = ("0" + marketTime1.getHours()).slice(-2);
                                    var minutes = ("0" + marketTime1.getMinutes()).slice(-2);
                                    var seconds = ("0" + marketTime1.getSeconds()).slice(-2);

                                    // Final format: DD/MM/YYYY HH:mm:ss
                                    var market_full_date = day + "/" + month + "/" + year + " " + hours + ":" + minutes + ":" + seconds;


                                    /* var event_name_heading = matchName + ' -> MATCH_ODDS -> ' + market_full_date;
                                    $('.event_name_heading').text(event_name_heading); */
                                    var event_name_heading = matchName;

                                    $('.event_name_heading .left').text(event_name_heading);
                                    $('.event_name_heading .right').text(market_full_date);
                                    <?php if (!$handler->layout['marketId']) { ?>
            ...
            if (args.body == undefined) {
                ...
                if (args.body.data) {
                    if (args.body.data[0]) {
                        ...
                        for (k = 0; k < args.body.data.length; k++) {
                            ...
                            if (marketType == "MATCH_ODDS") {
                                ...
                                html_match_odds +=
                                    ...
                                    '    <table class="table coupon-table table table-bordered m-t-10 " border="0">' +
                                    '        <thead>' +
                                    '<tr class="fancy-marker-title">' +
                                    '                <th colspan="8">' +
                                    '                  <div style="display:flex; justify-content:space-between; align-items:center;background-color: var(--theme2-bg70);">' +

                                    '           <span style="color: white;padding-left: 5px;">' + marketType + '</span>' +

                                    '           <div>' +

                                    /*  '               <li class="form-group active-button d-inline-block BetActives" style="list-style:none;margin-top: 5px;margin-bottom: 5px;">' +
                                     '                   <a href="javascript:void(0)" class="btn btn-back active" id="bet_lock1">Bet Lock</a>' +
                                     '                   <ul class="sub-button">' +
                                     '                       <li><a href="javascript:void(0)" id="btn-bet_active_all" data-status="0">All Deactive</a></li>' +
                                     '                       <li><a href="javascript:void(0)" id="btn-modal_userwisebetsttus">Userwise</a></li>' +
                                     '                   </ul>' +
                                    ...
                                    '               <li class="form-group active-button d-inline-block" style="list-style:none;margin-top: 5px;margin-bottom: 5px;margin-right: 5px;">' +
                                    '                   <a href="javascript:void(0)" class="btn btn-back active" data-type="' + marketType + '" id="modal-btn_userbook" style="text-transform: uppercase;font-size: 12px;">User Book</a>' +
                                    '               </li>' +
                                ...
                                if (market_type_name == "Tied Match") {
                                    marketType1 = "TIED_MATCH";
                                } else if (market_type_name == "To Win the Toss") {
                                    marketType1 = "TOSS_ODDS";
                                }
                                other_odds_markets += '<div id="div_gamedata" class="table-responsive m-b-10 main-market">' +
                                    '    <table class="table coupon-table table table-bordered m-t-10 " border="0">' +
                                    '        <thead>' +
                                    '<tr class="fancy-marker-title">' +
                                    '                <th colspan="8">' +
                            ...
                            if (args.body.data[k].runners) {
                                for (j = 0; j < args.body.data[k].runners.length; j++) {
                                    ...
                                    status = args.body.data[k].runners[j].status;
                                    ...
                                    var exposureDis = 0;
                                    if ($("#live_match_points_" + selectionId + "_" + market_marketid).length > 0) {
                                        exposureDis = $("#live_match_points_" + selectionId + "_" + market_marketid).text();
                                    }
                                    if (marketType == "MATCH_ODDS") {
                                        html_match_odds +=
                                            '<tr class="bet-info sec-4297012 ' + suspended + '" data-title="' + status + '" class="table-row" id="fullSelection_' + selectionId + '_' + market_marketid + '"  eventtype="4" eventid="' + eventId + '" marketid="' + market_market_id + '" selectionid="' + selectionId + '" eventname="' + runnerName + '" status="' + status + '">' +
                                            '    <td>' +
                                            '        <span class="team-name">' + runnerName + '</span>' +
                                            '        <p class="box-w4">' +
                                            '            <span class="float-left profit live_match_points" id="live_match_points_' + selectionId + '_' + market_marketid + '">' + exposureDis + '</span>' +
                                            '        </p>' +
                                            '    </td>' +
                        ...
                        $('.event_name_heading .left').text(eventName);
                        $("#match_odds_all_full_markets").html(html_match_odds);
                        $("#other_odds_markets").html(other_odds_markets);
                    }
                }
                if (args.body.data[0]) {
                    ...
                    $("#bookmaker_min").html(args.body.data[0].min);
                    $("#bookmaker_max").html(args.body.data[0].max);
                    bookmaker_remarks = "";
                    html_bookmaker_odds = "";
                    ...
                    if (args.body.data[0].bookmaker && args.body.data[0].bookmaker != null) {
                        ...
                        for (var b in bookmaker1_data) {
                            ...
                            var exposureDis = 0;
                            if ($("#live_match_points_" + temp_selectionId + "_BOOKMAKER_ODDS").length > 0) {
                                exposureDis = $("#live_match_points_" + temp_selectionId + "_BOOKMAKER_ODDS").text();
                            }
                           ...
                           '    </td>' + */
                            html_bookmaker_odds +=
                                ...
                                '        <span class="team-name">' + runnerName + '</span>' +
                                '        <p class="box-w4">' +
                                '            <span class="float-left profit" id="live_match_points_' + temp_selectionId + '_BOOKMAKER_ODDS">' + exposureDis + '</span>' +
                                '        </p>' +
                                '    </td>' +
                    ...
                    if (args.body.data[0].bookmaker_tied && args.body.data[0].bookmaker_tied != null) {
                        //for(z=0;z<args.body.data[0].bookmaker.length;z++){
                        var bookmaker1_data = args.body.data[0].bookmaker_tied;
                        ...
                        for (var b in bookmaker1_data) {
                            ...
                            if (bookmaker1_data[b]['lay'][0]['size']) {
                                bookmaker1_lay_size = bookmaker1_data[b]['lay'][0]['size'] || "";
                                if (parseFloat(bookmaker1_lay_size) >= 100000) {
                                    bookmaker1_lay_size = parseInt(bookmaker1_lay_size / 100000) + "L";
                                } else if (parseFloat(bookmaker1_lay_size) >= 1000) {
                                    bookmaker1_lay_size = parseInt(bookmaker1_lay_size / 1000) + "K";
                                }
                                /*  bookmaker1_lay_size1 = parseFloat(bookmaker1_lay_size) >= 100000 ? parseInt(parseInt(bookmaker1_lay_size) / 100000) + "L" : bookmaker1_lay_size; */
                            } else {
                                bookmaker1_lay_size1 = "";
                            }
                            if (bookmaker1_data[b]['lay'][1]['price']) {
                                bookmaker1_lay_2_rate = bookmaker1_data[b]['lay'][1]['price'] || "";
                            } else {
                            ...
                            var temp_selectionId = ((runnerName).split(" ").join('_')).trim();
                            var exposureDis = 0;
                            if ($("#live_match_points_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS").length > 0) {
                                exposureDis = $("#live_match_points_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS").text();
                            }
                            ...
                            html_bookmaker_tied_odds +=
                                ...
                                '        <span class="team-name">' + runnerName + '</span>' +
                                '        <p class="box-w4">' +
                                '            <span class="float-left profit" id="live_match_points_' + temp_selectionId + '_BOOKMAKER_TIED_ODDS">' + exposureDis + '</span>' +
                                '        </p>' +
                                '    </td>' +
                                ...
                                '        <button class="lay">' +
                                '            <span class="odd">' + bookmaker1_lay_rate + '</span>' +
                                '            <span>' + bookmaker1_lay_size1 + '</span>' +
                                '        </button>' +
                                '    </td>' +
                ...
                if (args.body.data[0].bm1) {
                    ...
                    for (z = 0; z < bm_small1_datas.length; z++) {
                        ...
                        if (bm_small1_datas[z] && bm_small1_datas[z]) {
                            ...
                            var exposureDis = 0;
                            if ($("#live_match_points_" + temp_selectionId + "_BOOKMAKERSMALL_ODDS").length > 0) {
                                exposureDis = $("#live_match_points_" + temp_selectionId + "_BOOKMAKERSMALL_ODDS").text();
                            }
                            html_bookmaker_odds +=
                                ...
                                '        <span class="team-name">' + runnerName + '</span>' +
                                '        <p class="box-w4">' +
                                '            <span class="float-left profit" id="live_match_points_' + temp_selectionId + '_BOOKMAKERSMALL_ODDS">' + exposureDis + '</span>' +
                                '        </p>' +
                                '    </td>' +
                        ...
                        for (k = 0; k < args.body.cricket.length; k++) {
                            ...
                            if (args.body.cricket[0].bookmaker && args.body.cricket[0].bookmaker != null) {
                                ...
                                for (var b in bookmaker1_data) {
                                    ...
                                    if (parseFloat(bookmaker1_back_size) >= 100000) {
                                        bookmaker1_back_size = parseInt(bookmaker1_back_size / 100000) + "L";
                                    } else if (parseFloat(bookmaker1_back_size) >= 1000) {
                                        bookmaker1_back_size = parseInt(bookmaker1_back_size / 1000) + "K";
                                    }
                                    /* bookmaker1_back_size = parseFloat(bookmaker1_back_size) >= 100000 ? parseInt(parseInt(bookmaker1_back_size) / 100000) + "L" : bookmaker1_back_size; */
                                    if (bookmaker1_data[b]['back'][1]['price']) {
                                        bookmaker1_back_2_rate = bookmaker1_data[b]['back'][1]['price'] || "";
                                    } else {
                                        bookmaker1_back_2_rate = "-";
                                    ...
                                    /* bookmaker1_lay_size = parseFloat(bookmaker1_lay_size) >= 100000 ? parseInt(parseInt(bookmaker1_lay_size) / 100000) + "L" : bookmaker1_lay_size; */
                            ...
                            if (args.body.cricketcasino[0].value.session) {
                                ...
                                $.each(args.body.cricketcasino[0].value.session, function(key, val) {
                                    ...
                                    match_odds_numbers_markets += `<div class="fancy-market-number">
												<div class='fancy-marker-title'><h4>${market_odd_name}</h4></div>
                                    ...
                                    /* <tbody id="match_odds_numbers_market_${key}"></tbody> */
                                    ...
                                    for (z = 0; z < args.body.cricketcasino[0].value.session[key].length; z++) {
                                        ...
                                        match_odds_numbers_markets += `
                                                                                                <tr class='bet-info ${cricketcasino_suspended} cricketcasino-suspend-tr_${common_key}' style="width:149%"
                                            id='cricketcasino_${eventId}_${common_key}'>
                                            ...
                                            <td class='back box-w1'>
                                                <button class='back' 
                                                    id='cricketcasino_back_btn_${common_key}' 
                                                    side='Back'
                                                    selectionid='${selectionId}'
                                                    runner='${marketName}'
                                                    marketname='${marketName}'
                                                    markettype='${market_marketid}'
                                                    fullmarketodds='${cricketcasino_back_rate}'
                                                    ...
                                                    <span class='odd'>${cricketcasino_back_rate}</span>
                                                    <span>${cricketcasino_back_size}</span>
                                                </button>
                                            </td>

                                            <td class='text-right p-r-10 box-w2'>
                                                <span class='d-block text-info'>Min: ${min_stack}</span>
                                                <span class='d-block text-info'>Max: ${max_stack}</span>
                                            </td>
                                    ...
                                    match_odds_numbers_markets += `</table></div></div>`;
                                });
                            ...
                            if (args.body.session[0].value.session) {
                                ...
                                for (i = 0; i < args.body.session[0].value.session.length; i++) {
                                    ...
                                    if (marketId == "" || args.body.session[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.session[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
                                        ...
                                        /*  console.log("fancy market data=", remark); */
                                        ...
                                        /* max_stack = parseFloat(max_stack) >= 100000 ? parseInt(parseInt(max_stack) / 100000) + "L" : max_stack; */
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                var exposureDis = 0;
                                                if ($("#live_match_points_" + marketId + "_FANCY_ODDS").length > 0) {
                                                    exposureDis = $("#live_match_points_" + marketId + "_FANCY_ODDS").text();
                                                }

                                                html_fancy_market_new += "<tr data-title='' class='bet-info sec-3  suspended fancy-suspend-tr_" + marketId + "' id='fancyBetMarket_" + eventId + "_" + marketId + "'> <td> <a href='javascript:void(0)' class='modal-book' onclick='view_book(<?php echo $userdata['Id']; ?>,<?php echo $userdata['power'] ?>," + eventId + "," + marketId + ")' data-mid='" + oddsmarketId + "' data-sid='3' data-gametype='Fancy' data-run='6'>" + marketName + " </a>    <p class='client' id='live_match_points_" + marketId + "_FANCY_ODDS'>" + exposureDis + "</p> </td> <td class='lay box-w1'>    <button class='lay' id='fancy_market_lay_btn_" + marketId + "'> <span class='odd'>" + runsNo + "</span> <span>" + oddsNo + "</span> </button> </td> <td class='back box-w1'>    <button class='back' id='fancy_market_back_btn_" + marketId + "'> <span class='odd'>" + runsYes + "</span> <span>" + oddsYes + "</span> </button> </td> <td class='text-right p-r-10 box-w2'> <span class='d-block text-info'>Min:" + min_stack + "</span> <span class='d-block text-info'>Max:" + max_stack + "</span> </td> </tr>";
                                                html_fancy_market_new += "  <tr class='sec-remark' id='remark_" + eventId + "_" + marketId + "'><td>" + remark + "</td> </tr>";
                                                lastrunsNo = runsNo;
                                                lastrunsYes = runsYes;
                                ...
                                if (z) {
                                    for (i = 0; i < z.length; i++) {
                                        ...
                                        if ($("#fancyBetMarket_" + eventId + "_" + marketId).length > 0) {
                                            ...
                                            $("#remark_" + eventId + "_" + marketId).remove();
                                        }
                                    }
                                }
                            ...
                            if (args.body.session1[0].value.session) {
                                ...
                                for (i = 0; i < args.body.session1[0].value.session.length; i++) {
                                    ...
                                    if (marketId == "" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
                                        ...
                                        if (parseFloat(oddsYes) >= 1000) {
                                            oddsYes = parseInt(oddsYes / 1000) + "K";
                                        }

                                        if (parseFloat(oddsNo) >= 1000) {
                                            oddsNo = parseInt(oddsNo / 1000) + "K";
                                        }
                                        marketId = parseInt(marketId);
                                        n1 = smdlm_c.includes(marketId);
                                        n2 = mdlm_c.includes(marketId);
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                marketIdArrayNewFancy1[counter2] = marketId;
                                                counter2++;
                                                html_fancy_market_new1 += "<tr data-title='' class='bet-info sec-3 suspended fancy1-suspend-tr_" + marketId + "' id='fancy1BetMarket_" + eventId + "_" + marketId + "'> <td> <a href='javascript:void(0)' class='modal-book' data-mid='" + oddsmarketId + "' data-sid='3' data-gametype='Fancy' data-run='6'>" + marketName + " </a>    <p class='client'>0</p> </td>  <td class='back box-w1'>    <button class='back' id='fancy1_market_back_btn_" + marketId + "'> <span class='odd'>" + runsYes + "</span> <span>" + oddsYes + "</span> </button> </td><td class='lay box-w1'>    <button class='lay' id='fancy1_market_lay_btn_" + marketId + "'> <span class='odd'>" + runsNo + "</span> <span>" + oddsNo + "</span> </button> </td> <td class='text-right p-r-10 box-w2'> <span class='d-block text-info'>Min:" + min_stack + "</span> <span class='d-block text-info'>Max:" + max_stack + "</span> </td> </tr>";
                                                lastrunsNo = runsNo;
                                                lastrunsYes = runsYes;
                                ...
                                if (marketIdArrayNewFancy1.length > 0) {
                                    $("#fancy1-market").show();
                                } else {
                                    $("#fancy1-market").hide();
                                }
                    ...
                    if (args.body.khado[0]) {
                        if (args.body.khado[0].value) {
                            if (args.body.khado[0].value.session) {
                                    ...
                                    if (marketId == "" || args.body.khado[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.khado[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                counter2++;
                                                winning_zone = parseInt(runsYes) + parseInt(runsNo);
                                                html_khado_market_new += "<tr data-title='' class='bet-info sec-3 suspended khado-suspend-tr_" + marketId + "' id='khadoBetMarket_" + eventId + "_" + marketId + "'> <td> <a href='javascript:void(0)' class='modal-book' data-mid='" + oddsmarketId + "' data-sid='3' data-gametype='Fancy' data-run='6'>" + marketName + " </a>    <p class='client'>0</p> </td>  <td class='back box-w1'>    <button class='back' id='khado_market_back_btn_" + marketId + "'> <span class='odd'>" + runsYes + "</span> <span>" + oddsYes + "</span> </button> </td> <td class='text-right p-r-10 box-w2'> <span class='d-block text-info'>Min:" + min_stack + "</span> <span class='d-block text-info'>Max:" + max_stack + "</span> </td> </tr>";
                                                /*  <td class='lay box-w1'>    <button class='lay' id='khado_market_lay_btn_" + marketId + "'> <span class='odd'>" + runsNo + "</span> <span>" + oddsNo + "</span> </button> </td> */
                                                lastrunsNo = runsNo;
                                                lastrunsYes = runsYes;
                                ...
                                if (marketIdArrayNewKhado.length > 0) {
                                    $("#khado-market").show();
                                } else {
                                    $("#khado-market").hide();
                                }
                    ...
                    if (args.body.ballByBall[0]) {
                        if (args.body.ballByBall[0].value) {
                            if (args.body.ballByBall[0].value.session) {
                                ...
                                if (marketIdArrayNewBall.length > 0) {
                                    $("#ballbyball-market").show();
                                } else {
                                    $("#ballbyball-market").hide();
                                }
                            }
                            //end for
                        }
                    ...
                    if (args.body.meter[0]) {
                        if (args.body.meter[0].value) {
                            if (args.body.meter[0].value.session) {
                                ...
                                if (marketIdArrayNewMeter.length > 0) {
                                    $("#meter-market").show();
                                } else {
                                    $("#meter-market").hide();
                                }
                    ...
                    if (args.body.overByOver[0]) {
                        if (args.body.overByOver[0].value) {
                            if (args.body.overByOver[0].value.session) {
                                    ...
                                    if (marketId == "" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {} else {
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                marketIdArrayOverNew[counter2] = marketId;
                                                counter2++;
                                                back_attribute = " event_name='" + event_name + "' fullmarketodds='" + runsYes + "' side='Back' marketid='" + oddsmarketId + "' eventid='" + eventId + "' selectionid='" + marketId + "' market_odd_name='' runner='" + marketName + "' marketname='" + marketName + "' markettype='FANCY_ODDS' inplay='1' fullfancymarketrate='" + oddsYes + "'";
                                                ...
                                                html_fancy_market_new +=
                                                    "<tr data-title='SUSPENDED' class='bet-info sec-3 suspended fancy_over_by_over-suspend-tr_" + marketId + "' id='fancyOverBetMarket_" + eventId + "_" + marketId + "'>" +

                                                    "<td>" +
                                                    "<a href='javascript:void(0)' onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'>" + marketName + "</a>" +
                                                    "<p class='client' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color:black;'>0</span></p>" +
                                                    "</td>" +

                                                    "<td class='lay box-w1'>" +
                                                    "<button class='lay' id='fancy_market_lay_btn_" + marketId + "' " + lay_attribute + ">" +
                                                    "<span class='odd'>" + runsNo + "</span>" +
                                                    "<span>" + oddsNo + "</span>" +
                                                    "</button>" +
                                                    "</td>" +

                                                    "<td class='back box-w1'>" +
                                                    "<button class='back' id='fancy_market_back_btn_" + marketId + "' " + back_attribute + ">" +
                                                    "<span class='odd'>" + runsYes + "</span>" +
                                                    "<span>" + oddsYes + "</span>" +
                                                    "</button>" +
                                                    "</td>" +
                                                    ...
                                                    // ✅ keep remark section (important if used elsewhere)
                                                    "<tr class='table-remark' style='display:none;' id='remakrs_" + marketId + "'>" +
                                ...
                                if (marketIdArrayOverNew.length > 0) {
                                    $("#overbyover-market").show();
                                } else {
                                    $("#overbyover-market").hide();
                                }
                            }
                        }
                    }
                    ...
                    if (args.body.oddEven[0]) {
                        if (args.body.oddEven[0].value) {
                            if (args.body.oddEven[0].value.session) {
                                ...
                                if (marketIdArrayNewOddEven.length > 0) {
                                    $("#oddeven-market").show();
                                } else {
                                    $("#oddeven-market").hide();
                                }
    ...
    <script type="text/javascript">
        ...
        function call_fancy_analysis() {
            /*  $.get(MASTER_URL + '/events_analysis2/get_fancy_analysis/' + eid, function (data) {
                fancy_bet_data = data;
            }); */
        }
        ...
        function call_fancy_analysis_new(eid, downline_user_list, self_percentage_array) {
            ...
            $.post(MASTER_URL + '/events_analysis2/get_analysis_fancy/' + eid, requestData, function(data) {

                
                if (data.results) {
                    console.log("fancy data=", data.results);
        ...
        function call_analysis() {
            $.get(MASTER_URL + '/events_analysis2/get_analysis/' + eid, function(data) {
        ...
        function call_active_bets() {
            $.get(MASTER_URL + '/events_analysis2/get_active_bets/' + eid, function(responce) {
                if (responce) {
        ...
        function refresh_active_bets_users(fancy) {
            ...
            $.get(MASTER_URL + '/events_analysis2/get_active_bets_users/' + eid, data, function(responce) {
                if (responce.inactive == 0) {
                    $(btn_id).attr('data-status', 0);
                    $(btn_id).text('All Deactive');
                    /*  $('#fancy_check_all').prop('checked', true); */

                } else {
                    $(btn_id).attr('data-status', 1);
                    $(btn_id).text('All Active');
                    /* $('#fancy_check_all').prop('checked', false); */
                }
        ...
        function call_view_more_bets() {
            ...
            if (xhr_vm && xhr_vm.readyState != 4)
                xhr_vm.abort();
            xhr_vm = $.ajax({
                url: MASTER_URL + '/events_analysis2/view_more_matched/' + eid,
                type: 'POST',
                dataType: 'json',
        ...
        function update_user_bet_status(status, users) {
            $.post(MASTER_URL + '/events_analysis2/user_bet_status', {
                'status': status,
                users: users,
                event_id: eid
            }, function(responce) {
        ...
        function update_user_fancy_bet_status(status, users, tpassword) {
            $.post(MASTER_URL + '/events_analysis2/user_fancy_bet_status', {
                'status': status,
                users: users,
                event_id: eid,
                tpassword: tpassword,
        ...
        $(function() {
            ...
            $(document).on('click', '#btn-fancy_bet_lock,#btn-over_by_over_bet_lock,#btn-bookmaker_bet_lock, #btn-bookmaker1_bet_lock, #btn-tied_match_bet_lock,#btn-ball_by_ball_bet_lock,#btn-fancy1_bet_lock,#btn-oddeven_bet_lock,#btn-khado_bet_lock,#btn-meter_bet_lock', function() {
                selectedBlockType = $(this).data('block_type');
                selectedmarketType = $(this).data('market_type');
                ...
                if (id == 'btn-fancy_bet_lock' || id == 'fancy_bet_lock')
                    is_fancy = true; */
                $.get(MASTER_URL + '/events_analysis2/getusers_block_data/' + eid, function(responce) {
                    ...
                    $.each(responce.results, function(index, rowdata) {
                        ...
                        if (selectedType == 'fancy') {
                            ...
                            status = rowdata.bstatus;
                        } else if (selectedType == 'over_by_over') {
                            status = rowdata.ostatus;
                        } else if (selectedType == 'ball_by_ball') {
                            status = rowdata.bostatus;
                        } else if (selectedType == 'oddeven') {
                            status = rowdata.oe_status;
                        } else if (selectedType == 'khado') {
                            status = rowdata.khstatus;
                        } else if (selectedType == 'meter') {
                            status = rowdata.meter_status;
                        } else if (selectedType == 'bookmaker1') {
                            status = rowdata.b1status;
                        } else if (selectedType == 'tied_match') {
                            status = rowdata.tmstatus;
                        } else if (selectedType == 'fancy1') {
                            status = rowdata.f1status;
                        }
            ...
            function setFancyCheckAll() {
                var total = $('.check-users_bet_active').length;
                var checked = $('.check-users_bet_active:checked').length;

                $('#fancy_check_all').prop('checked', total > 0 && total === checked);
            }
            ...
            $(document).on('change', '#fancy_check_all', function() {
            ...
            $(document).on('click', '#modal-btn_userbook', function() {
                ...
                $.get(MASTER_URL + '/events_analysis2/get_userbook/' + eid + '/' + typee, function(data) {
            ...
            $(document).on('click', '#modal-btn_userbookmaker', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis2/get_userbook/' + eid + '/BOOKMAKER_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $(document).on('click', '#modal-btn_userbookmakertied', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis2/get_userbook/' + eid + '/BOOKMAKER_TIED_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $(document).on('click', '#modal-btn_userbookmakersmall', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis2/get_userbook/' + eid + '/BOOKMAKERSMALL_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $('#modal-btn_max_limit').on('click', function() {
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis2/max_limit/' + eid + '', function(data) {
                    $('#max-book').modal('show');
                    $('#divLoading').removeClass('show');
        ...
        function get_down_level_book(event_id, market_type, user_id, $this) {
            ...
            if ($($this).attr('data-is_open') == 1) {
                ...
                $.get(MASTER_URL + '/events_analysis2/get_userbook/' + eid + '/' + market_type + '/' + user_id, function(data) {
        ...
        function view_book(bid, btype, event_id, market_id) {
            $('#divLoading').addClass('show');
            $.ajax({
                url: MASTER_URL + '/events_analysis2/fancy_bet_book_master/' + event_id + '/' + market_id,
                type: 'POST',
                dataType: 'json',
                data: {},
        ...
        function set_max_limit() {
            ...
            if (xhr_act && xhr_act.readyState != 4)
                xhr_act.abort();
            xhr_act = $.ajax({
                url: MASTER_URL + '/events_analysis2/set_max_limit',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(rdata) {
    ...
    <script>
        /*    $(document).on('click', '#fancy_toggle', function (e) {

    if ($(e.target).closest('#btn-fancy_bet_lock').length) return;

    $('#div_fancy').slideToggle(200);
}); */
    </script>
