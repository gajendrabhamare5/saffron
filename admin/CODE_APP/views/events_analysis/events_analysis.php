...
.suspended-box::after {
    ...
    <script type="text/javascript">
        ...
        function call_fancy_analysis() {
            /*  $.get(MASTER_URL + '/events_analysis/get_fancy_analysis/' + eid, function (data) {
                fancy_bet_data = data;
            }); */
        }
        ...
        function call_fancy_analysis_new(eid, downline_user_list, self_percentage_array) {
            ...
            $.post(MASTER_URL + '/events_analysis/get_analysis_fancy/' + eid, requestData, function(data) {
        ...
        function call_analysis() {
            $.get(MASTER_URL + '/events_analysis/get_analysis/' + eid, function(data) {
        ...
        function call_active_bets() {
            $.get(MASTER_URL + '/events_analysis/get_active_bets/' + eid, function(responce) {
                if (responce) {
        ...
        function refresh_active_bets_users(fancy) {
            ...
            $.get(MASTER_URL + '/events_analysis/get_active_bets_users/' + eid, data, function(responce) {
        ...
        function call_view_more_bets() {
            ...
            if (xhr_vm && xhr_vm.readyState != 4)
                xhr_vm.abort();
            xhr_vm = $.ajax({
                url: MASTER_URL + '/events_analysis/view_more_matched/' + eid,
                type: 'POST',
                dataType: 'json',
        ...
        function update_user_bet_status(status, users) {
            $.post(MASTER_URL + '/events_analysis/user_bet_status', {
                'status': status,
                users: users,
                event_id: eid
            }, function(responce) {
        ...
        $(function() {
           ...
           /*  $('#search-client_name').select2({
            ...
            $(document).on('click', '#modal-btn_userbook', function() {
                ...
                $.get(MASTER_URL + '/events_analysis/get_userbook/' + eid + '/'+typee, function(data) {
            ...
            $(document).on('click', '#modal-btn_userbookmaker', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis/get_userbook/' + eid + '/BOOKMAKER_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $(document).on('click', '#modal-btn_userbookmakertied', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis/get_userbook/' + eid + '/BOOKMAKER_TIED_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $(document).on('click', '#modal-btn_userbookmakersmall', function() {
                $('#book_title').text("User Book");
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis/get_userbook/' + eid + '/BOOKMAKERSMALL_ODDS', function(data) {
                    $('#user-book').modal('show');
                    $('#divLoading').removeClass('show');
                    $('.userBookContainer').html(data.results);
                });
            ...
            $('#modal-btn_max_limit').on('click', function() {
                $('#divLoading').addClass('show');
                $.get(MASTER_URL + '/events_analysis/max_limit/' + eid + '', function(data) {
                    $('#max-book').modal('show');
                    $('#divLoading').removeClass('show');
        ...
        function get_down_level_book(event_id, market_type, user_id, $this) {
            ...
            if ($($this).attr('data-is_open') == 1) {
                ...
                $.get(MASTER_URL + '/events_analysis/get_userbook/' + eid + '/' + market_type + '/' + user_id, function(data) {
        ...
        function view_book(bid, btype, event_id, market_id) {
            $('#divLoading').addClass('show');
            $.ajax({
                url: MASTER_URL + '/events_analysis/fancy_bet_book_master/' + event_id + '/' + market_id,
                type: 'POST',
                dataType: 'json',
                data: {},
        ...
        function set_max_limit() {
            ...
            if (xhr_act && xhr_act.readyState != 4)
                xhr_act.abort();
            xhr_act = $.ajax({
                url: MASTER_URL + '/events_analysis/set_max_limit',
                type: 'POST',
                dataType: 'json',
                data: data,
                success: function(rdata) {
