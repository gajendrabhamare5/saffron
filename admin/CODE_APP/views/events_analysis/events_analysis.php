                    ...
                    <div>
                        <div class="row row5 bookmaker-container" id="bookmaker_market_div" style="display: none;">
                            <div class="fancy-marker-title col-12" id="bm-head" style="">
                                ...
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: #B97242B3;">
                        ...
                        <div class="row row5 bookmaker-container " id="bookmaker_tied_market_div"
                            ...
                            <div class="fancy-marker-title col-12" id="bm-head" style=""> <!--  <h4>Bookmaker Tied Market</h4> -->
                                ...
                                <div style="display:flex;justify-content:space-between;align-items:center;background-color: #B97242B3;cursor:pointer;" id="fancy_toggle">
                    ...
                    if (args.body.data[0]) {
                        ...
                        for (k = 0; k < args.body.data.length; k++) {
                            ...
                            html_match_odds +=
                                ...
                                '           <span style="color: white;padding-left: 5px;">' + marketType1 + '</span>' +
