<style>
    ...
    .btn-outline-success{
        color: black !important;
        border-color: #eff2f7 #eff2f7 #ced4da !important;
    }
...
<div class="col-md-12 main-container">
    <div>
         <div class="">
                    ...
                    ?>
                    <div class="col-md-12 report-main-content m-t-5">
                                ...
                                <div class="card-body security-auth">
                                    <div class="row justify-content-center mt-5 mb-5">
                                        <div class="col-12">
                                            ...
                                            ?>
                                                ...
                                                <div class="text-center mt-3"><!---->
                                                    ...
                                                    ?>
                                                        ...
                                                        <h6 class="mb-2 mt-3">Using this app you will receive auth code during login authentication</h6> 
                                                        <!-- <a href="/apk/allpenalexch9_v1.apk" class="btn btn-download btn-lg mt-3">
                                                        ...
                                                        <a href="/apk/allpenalexch9_v1.apk">
                                                            <button class="btn btn-primary"><i class="fab fa-android"></i> <span>Download on the Android</span></button></a>
                                                    <?php } ?>
                                            ...
                                            ?>
                                                <div class="setting-box">
                                                    <b style="padding-right: 4px;">Secure Auth Verification Status:</b>

                                                    <span class="badge badge-danger p-2"><? echo ucfirst(strtolower($user_verification_status)); ?></span>
...
<script>
    ...
    jQuery(document).on("click", ".disabled_click", function() {
        ...
        if(userVrificationType == 'Telegram'){
            $.ajax({
                type: 'POST',
                url:  MASTER_URL + '/SecurityAuth/telegram_otp_generation',
                dataType: 'json',
                data: {},
        ...
        $(".sec_code").html(`<div class="mt-2 mb-3">
                                                            <h3 class="text-center" style="font-size: 1.421875rem;">Security Code Verification</h3>
        ...
        inputs.forEach((input, index1) => {
            input.addEventListener("keyup", (e) => {
                ...
                if (!inputs[5].disabled && inputs[5].value !== "") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url:MASTER_URL + '/SecurityAuth/auth_disable_verification',
                        dataType: 'json',
                        data: {code:otp},
                        success: function(response) {
                            var check_status = response['status'];
    ...
    jQuery(document).on("click", ".enable_click", function() {
        ...
        if (auth_type == "telegram") {
            ...
            $(".otpbox").html(`<div class="text-center mt-3">
                                    <div class="mt-2"><b>Please enter your login password to continue</b></div>
                                    <div class="login-password mt-2">
                                        ...
                                        <button class="btn btn-primary ml-2 password-btn enable_click" data-val="telegram_block" disabled="">Get Connection ID</button>
                                    </div>
                                </div>`);
            ...
            $.ajax({
                type: 'POST',
                url:  MASTER_URL + '/SecurityAuth/auth_enable_verification_telegram',
                dataType: 'json',
            ...
            $.ajax({
                type: 'POST',
                url: MASTER_URL + '/SecurityAuth/auth_enable_verification_mobile',
                dataType: 'json',
                data: {},
                success: function(response) {
    ...
    socket.on('authDisableVerifiedSuccessfully', function (data) {
        if(data.status == "DISABLED"){
            location.href = MASTER_URL+"/logout";
        }
   ...
   function chkStatus() {
        var auth_status = '<? echo $auth_status; ?>';
            ...
            $.ajax({
                type: 'POST',
                url: MASTER_URL + '/SecurityAuth/chkStatusAuth',
                dataType: 'json',
