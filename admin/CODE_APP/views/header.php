...
/*if ($admin) {
    ...
    $logo = $handler->db->get_where('logo', ['id' => 1])->row_array();
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo MASTER_URL; ?>/assets/css/style.css?12373">
                ...
                <div class="header-bottom">
                    <div class="container-fluid">
                        <a href="<?php echo MASTER_URL; ?>/manage-clients/listing2" class="logo">
                            <img src="<?php echo WEB_URL . '/' . $logo['logo_image']; ?>">
                        </a>
                                ...
                                <ul class="list-unstyled navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <?php }  if (game60 == true) { ?>
                                            <li>
                                                <a class="dropdown-item" href="<?php echo MASTER_URL; ?>/live-market/sports-casino/superover2">
                                             ...
                                             <li>
                                                <a class="dropdown-item" href="<?php echo MASTER_URL; ?>/live-market/goal2">
                                                    <span><b>Goal 2</b></span>
                                                </a>
                                            </li>
                                             <? }?>
                                             <li>
