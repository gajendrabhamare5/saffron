...
$whereArr = array('Id' => $auth_uid);
$user_query = $this->db->get_where('user_master', $whereArr, 1);
                        ...
                        <div class="">
                            <div class="text-center mt-3">
                                <div class="mt-2 mb-3">
                                    ...
                                    ?>
                                   <h3 class="text-center" style="font-size: 1.421875rem;">Security Code Verification Using Telegram App</h3>
                                    <div class="mt-3 text-center">Enter 6-digit code from your telegram bot</div>
                                    <?
                                    }else{
                                        ?>
