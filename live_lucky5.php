...
.casino-table-full-box.lucky7acards {
                            ...
                            <div class="row row5 lucky7">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Lucky 6
											...
											<!----></span> 
											<small role="button" class="teenpatti-rules"  onclick="view_rules('lucky5')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
										...
										<?php
											if(!empty(IFRAME_URL_SET)){
																		?>
																		<iframe class="iframedesign" src="<?php echo IFRAME_URL."".LUCKY5_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
																		<?php
																		...
																		?>
											<!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL; echo LUCKY5_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                            ...
                                            <div class="video-overlay">
                                                <div class="card-inner">
                                                    <h3 class="text-white">Card</h3> <img id="card_c1" src="storage/front/img/cards/1.png"></div>
                                            </div>
                                        </div>
                                        <div class="casino-detail">
											<div class="casino-table">
												<div class="casino-table-full-box">
													<div class=" lucky7low">
														...
														<div class="casino-odds-box back casino-odds-box-theme market_1_row back-1 market_1_b_btn"><span class="casino-odds">Low Card</span></div>
														<div class="casino-nation-book text-center market_1_b_exposure market_exposure"></div>
													</div>
													<div class="lucky7"><img src="storage/front/img/cards/6.png"></div>
													<div class=" lucky7high">
														<div class="casino-odds text-center market_2_b_value">0</div>
														<div class="casino-odds-box back casino-odds-box-theme market_2_row back-1 market_2_b_btn"><span class="casino-odds">High Card</span></div>
												...
												<div class="casino-table-box mt-3">
													<div class="casino-table-left-box">
														...
														<div class="casino-odds-box back casino-odds-box-theme market_3_row back-1 market_3_b_btn"><span class="casino-odds">Even</span></div>
														...
														<div class="casino-odds-box back casino-odds-box-theme market_4_row back-1 market_4_b_btn"><span class="casino-odds">Odd</span></div>
													...
													<div class="casino-table-right-box">
														...
														<div class="casino-odds-box back casino-odds-box-theme market_5_row back-1 market_5_b_btn"><span class="casino-odds"><span class="card-icon ms-1"><span class="card-red ">{</span></span><span class="card-icon ms-1"><span class="card-red ">[</span></span></span></div>
														...
														<div class="casino-odds-box back casino-odds-box-theme market_6_row back-1 market_6_b_btn"><span class="casino-odds"><span class="card-icon ms-1"><span class="card-black ">}</span></span><span class="card-icon ms-1"><span class="card-black ">]</span></span></span></div>
												...
												<div class="casino-table-full-box lucky7acards mt-3">
													...
													<div class="card-odd-box">
														<div class="market_7_row back-1 market_7_b_btn"><img src="storage/front/img/cards/A.png"></div>
														<div class="casino-nation-book market_7_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_8_row back-1 market_8_b_btn"><img src="storage/front/img/cards/2.png"></div>
														<div class="casino-nation-book market_8_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_9_row back-1 market_9_b_btn"><img src="storage/front/img/cards/3.png"></div>
														<div class="casino-nation-book market_9_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_10_row back-1 market_10_b_btn"><img src="storage/front/img/cards/4.png"></div>
														<div class="casino-nation-book market_10_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_11_row back-1 market_11_b_btn"><img src="storage/front/img/cards/5.png"></div>
														<div class="casino-nation-book market_11_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_12_row back-1 market_12_b_btn"><img src="storage/front/img/cards/6.png"></div>
														<div class="casino-nation-book market_12_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_13_row back-1 market_13_b_btn"><img src="storage/front/img/cards/7.png"></div>
														<div class="casino-nation-book market_13_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_14_row back-1 market_14_b_btn"><img src="storage/front/img/cards/8.png"></div>
														<div class="casino-nation-book market_14_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_15_row back-1 market_15_b_btn"><img src="storage/front/img/cards/9.png"></div>
														<div class="casino-nation-book market_15_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_16_row back-1 market_16_b_btn"><img src="storage/front/img/cards/10.png"></div>
														<div class="casino-nation-book market_16_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="market_17_row back-1 market_17_b_btn"><img src="storage/front/img/cards/J.png"></div>
											...
											<div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a
                                                     href="casinoresults?game_type=lucky5" class="">View All</a></span></div>
                                            <div id="last-result" class="casino-last-results"></div>
										</div>
                                    </div>
                                </div>
                                <?php
...
<script type="text/javascript" src='footer-js.js?201'></script>
 ...
 jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBetLoader").addClass('show');
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: 'ajaxfiles/bet_place_lucky5_teenpatti.php',
				 dataType: 'json',
