                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Lucky 7 - C
                                                ...
                                                <!----></span> 
                                                <small role="button" class="teenpatti-rules"  onclick="view_rules('lucky7eu2')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <iframe class="iframedesign" src="<?php echo IFRAME_URL."".LUCKY7EU2_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                        ...
                                        <div class="casino-detail">
                                            <div class="casino-table">
                                                ...
                                                <div class="casino-table-full-box lucky7acards mt-3">
                                                    ...
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_7_row back-1 market_7_b_btn"><img src="storage/front/img/cards/A.png"></div>
                                                        <div class="casino-nation-book market_7_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_8_row back-1 market_8_b_btn"><img src="storage/front/img/cards/2.png"></div>
                                                        <div class="casino-nation-book market_8_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_9_row back-1 market_9_b_btn"><img src="storage/front/img/cards/3.png"></div>
                                                        <div class="casino-nation-book market_9_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_10_row back-1 market_10_b_btn"><img src="storage/front/img/cards/4.png"></div>
                                                        <div class="casino-nation-book market_10_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_11_row back-1 market_11_b_btn"><img src="storage/front/img/cards/5.png"></div>
                                                        <div class="casino-nation-book market_11_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_12_row back-1 market_12_b_btn"><img src="storage/front/img/cards/6.png"></div>
                                                        <div class="casino-nation-book market_12_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_13_row back-1 market_13_b_btn"><img src="storage/front/img/cards/7.png"></div>
                                                        <div class="casino-nation-book market_13_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_14_row back-1 market_14_b_btn"><img src="storage/front/img/cards/8.png"></div>
                                                        <div class="casino-nation-book market_14_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_15_row back-1 market_15_b_btn"><img src="storage/front/img/cards/9.png"></div>
                                                        <div class="casino-nation-book market_15_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_16_row back-1 market_16_b_btn"><img src="storage/front/img/cards/10.png"></div>
                                                        <div class="casino-nation-book market_16_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_17_row back-1 market_17_b_btn"><img src="storage/front/img/cards/J.png"></div>
                                                        <div class="casino-nation-book market_17_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_18_row back-1 market_18_b_btn"><img src="storage/front/img/cards/Q.png"></div>
                                                        <div class="casino-nation-book market_18_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="card-odd-box">
                                                        <div class="suspended-box market_19_row back-1 market_19_b_btn"><img src="storage/front/img/cards/K.png"></div>
