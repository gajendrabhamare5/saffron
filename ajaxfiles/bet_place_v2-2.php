...
foreach ($data as $match_data) {
	if ($market_odd_name == $data_event_name || $market_odd_name == "MATCH_ODDS" || $data_event_name == "Most Points" || $market_odd_name == "BOOKMAKER_ODDS" || $market_odd_name == "BOOKMAKER_TIED_ODDS") {
