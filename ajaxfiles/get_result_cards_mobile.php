...
<?php
	...
	$carda1  = WEB_URL . "/storage/front/img/cards_new/" . $cards[0] . ".png";
	$carda2  = WEB_URL . "/storage/front/img/cards_new/" . $cards[3] . ".png";
	$carda3  = WEB_URL . "/storage/front/img/cards_new/" . $cards[6] . ".png";

	$cardb1  = WEB_URL . "/storage/front/img/cards_new/" . $cards[1] . ".png";
	$cardb2  = WEB_URL . "/storage/front/img/cards_new/" . $cards[4] . ".png";
	$cardb3  = WEB_URL . "/storage/front/img/cards_new/" . $cards[7] . ".png";

	$cardc1  = WEB_URL . "/storage/front/img/cards_new/" . $cards[2] . ".png";
	$cardc2  = WEB_URL . "/storage/front/img/cards_new/" . $cards[5] . ".png";
	$cardc3  = WEB_URL . "/storage/front/img/cards_new/" . $cards[8] . ".png";
...
?>
	...
	<div class="row flex-column align-items-center">
		...
		<div class="result-image">
			...
			<?php
			if ($result_status == "T" || $result_status == "1" ) {
			?>
			<div class="winner-label">
				<i class="fas fa-trophy text-success"></i>
			</div>
	...
	<div class="row flex-column align-items-center">
		...
		<div class="result-image">
			...
			<?php
			if ($result_status == "L" || $result_status == "2") {
			?>
			<div class="winner-label">
				<i class="fas fa-trophy text-success"></i>
			</div>
	...
	<div class="row flex-column align-items-center">
		...
		<div class="col-12 d-flex flex-row justify-content-center gap-2 mt-1" style="align-items: center;">
			...
			<div class="result-image">
				...
				<?php
				if ($result_status == "D"  || $result_status == "3") {
				?>
				<div class="winner-label">
					<i class="fas fa-trophy text-success"></i>
				</div>
	...
	<div class="row row5 oepn-teen-result">
		<div class="col-12 text-center flex-column text-center"
			...
			<div><span style="color:gray">Others </span>
