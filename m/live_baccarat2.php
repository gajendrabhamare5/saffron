...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Baccarat 2</span><span class="d-block"><a href="#" onclick="view_rules('baccarat2')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
...
?>
	...
	<?php 
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".BACCARAT2_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
	...
	<!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
         <iframe src="<?php echo IFRAME_URL."".BACCARAT2_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
    ...
    <div class="casino-container container-fluid-5 baccarat-container">
        <div class="row row5">
            <div class="col-12 statistics-title">Statistics<i class="fas ml-2 fa-angle-down"></i><span class="ml-2">Click here for open statistics</span></div>
        ...
        <div class="row row5 mt-1">
            ...
            <div class="col pr-1 pl-2">
                <div class="bet-odds suspended  market_10_b_btn market_10_row back-1">
                    <p class="mb-1">Score 9</p>
                    <p class="mb-1">2.5:1</p>
                </div>
                <div class="book market_10_b_exposure market_exposure" style="color: black;">0</div>
            </div>
        </div>
        <div class="row row5 mt-1">
            <div class="col-12">
                <div class="bet-container">
                    ...
                    <div class="player">
                        <div class="suspended  market_1_b_btn market_1_row back-1">
                            <b class="text-uppercase">Player</b> <span class="d-block">1:1</span>
                    ...
                    <div class="banker">
                        <div class="suspended  market_2_b_btn market_2_row back-1">
                            <b class="text-uppercase">Banker</b> <span class="d-block">1:1</span>
                            <div class="player-card">
		...
		<div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=baccarat2" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?49' defer></script>
