	...
	<div id="app">
		...
		<div>
			...
			<div class="main-content">
				...
				<!---->
				<div>
					<div class="casino-title"><span class="casino-name">Mogambo</span><span class="d-block"><a href="#" onclick="view_rules('mogambo')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
					...
					<div class="tab-content">
						<div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".MOGAMBO_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
							 ...
							 <iframe src="<?php echo IFRAME_URL;
													echo MOGAMBO_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
								...
								<div class="video-overlay">
									<div>
                                        <h5 class="mogambo-total" style="font-size: 12px;">TOTAL: <span class="tot_count">0</span></h5>
										<div>
										...
										<div>
											<h3 class="text-white" style="line-height: 1;">MOGAMBO</h3>
									...
									<div class="casino-table-left-box">
										...
										<div class="casino-table-body">
											<div class="casino-table-row mini-baccarat">
												...
												<div class="casino-odds-box back back-1 market_2_b_btn suspended"><span class="casino-odds market_2_b_val">0</span></div>
									...
									<div class="casino-table-right-box">
										...
										<div class="casino-table-body">
											<div class="casino-table-row  mini-baccarat">
												...
												<div class="casino-odds-box back back-1 market_1_b_btn suspended"><span class="casino-odds market_1_b_val">1.84</span></div>
                                                    ...
                                                    <div class="casino-table-left-box">
                                                        <div class="casino-table-body">
                                                            <div class="casino-table-row">
                                                                ...
                                                                <div class="casino-odds-box lay lay-1 market_3_l_btn suspended"><span class="casino-odds market_3_l_val"></span><span class="casino-volume market_3_l_volume"></span></div>
                                                                <div class="casino-odds-box back back-1 market_3_b_btn suspended"><span class="casino-odds market_3_b_val"></span><span class="casino-volume market_3_b_volume"></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript" src='footer-js.js?66' defer></script>
