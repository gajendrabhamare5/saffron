<div class="sidebar">
  <div class="d-xl-none p-2 sidebar-search search-box-container">
    <div class="form-group"><input type="search" placeholder="Search here" class="form-control" value="">
      <div class="search-box"></div>
    </div>
    <div class="close-sidebar"><i class="far fa-times-circle"></i></div>
  </div>
  <!-- Racing Sports Section -->
  <div class="sidebar-title" data-bs-toggle="collapse" data-bs-target="#racingSports" aria-expanded="true">
  ...
  if (CASINO_PLAY && 1 != 1) {
    ?>
    <!-- Others Section -->
    <div class="sidebar-title" data-bs-toggle="collapse" data-bs-target="#others" aria-expanded="true">
    ...
    <nav id="others" class="collapse show">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a href="live_casino" class="nav-link">Live Casino</a>
        </li>
        <li class="nav-item">
          <a href="slotgame" class="nav-link">Slot Game</a>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link">Fantasy Game</a>
        </li>
      </ul>
    </nav>
  <?php } ?>
  ...
  <div class="sidebar-title">
    <h5 class="m-b-0" data-bs-toggle="collapse" data-bs-target="#allSports" aria-expanded="true">
      All Sports
    </h5>
  </div>
  <nav id="allSports" class="collapse show">
    <ul class="nav flex-column">
      <li class="nav-item">
        <a href="#PoliticsNested" class="nav-link toggle-nested" data-bs-toggle="collapse" role="button"
          aria-expanded="false" aria-controls="PoliticsNested">
        ...
        <ul id="PoliticsNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#PoliticsNested2" class="nav-link toggle-nested" data-bs-toggle="collapse" role="button"
              aria-expanded="false" aria-controls="PoliticsNested2">
      ...
      <li class="nav-item">
        <a href="#cricketNested" class="nav-link toggle-nested" data-bs-toggle="collapse" role="button"
          aria-expanded="false" aria-controls="cricketNested">
          <span class="toggle-icon">
            <i class="far fa-plus-square me-1"></i>
          </span>
          Cricket
        ...
        <ul id="cricketNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#cricketNested2" class="nav-link toggle-nested" data-bs-toggle="collapse" role="button"
              aria-expanded="false" aria-controls="cricketNested2"><span class="toggle-icon">
                <i class="far fa-plus-square me-1"></i>
              </span>T10 XI
            </a>
...
<script>
  ...
  function renderCricketMatches(responseData) {
    ...
    if (responseData && responseData.sport && responseData.sport.body) {
    ...
    if (data && Object.keys(data).length > 0) {
      ...
      Object.entries(groupedMatches).forEach(([cname, matches]) => {
        ...
        cnameLink.setAttribute("data-bs-toggle", "collapse");
