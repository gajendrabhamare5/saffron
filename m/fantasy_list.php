...
">
                   ...
                   // if ($user_id  != LOGINDEMOID) {
                    ...
                    <li class="nav-item"><a href="fantasy_list" class="type nav-link newclass router-link-exact-active router-link-active active"> Fantasy </a></li>
                    <?
                   // }
                    ?>
                ...
                $aviator_casino = $conn->query("SELECT * FROM live_casino_list where game_category='fantasy'");
