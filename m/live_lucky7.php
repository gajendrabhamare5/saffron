...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Lucky 7 - A</span><span class="d-block"><a href="#" onclick="view_rules('lucky7')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".LUCKY7A_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
...
<script type="text/javascript" src='footer-js.js?41' defer></script>
