<head>
    ...
    <link href="../storage/mobile/css/style_new_casino.css?98" rel="stylesheet">
    <!-- <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed&amp;display=swap" rel="stylesheet">  -->
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&display=swap" rel="stylesheet">
    <link href="../storage/mobile/css/custom_new_casino.css?6" rel="stylesheet">
    <link rel="stylesheet" href="../storage/mobile/css/flipclock.css">
    <style type="text/css">
    	.stop-site{
    		display : none !important;
    	}
        .m-t-15[data-v-7edc2d48] {
            margin-top: 10px !important;
        } 
    </style>
    <style type="text/css">
        .game-icon[data-v-40844b0f] { 
            width: 20px;
        }
        
        .game-col a[data-v-40844b0f] {
            cursor: pointer;
            width: 16%;
        }
        
        .fade-enter-active[data-v-40844b0f],
        .fade-leave-active[data-v-40844b0f] {
            transition: opacity .5s;
        }
        
        .fade-enter[data-v-40844b0f],
        .fade-leave-to[data-v-40844b0f]
    ...
    <style type="text/css">
        .video-overlay .card-inner[data-v-0590de8b] {
            margin-bottom: 3px;
        }
    </style>
    <style type="text/css">
