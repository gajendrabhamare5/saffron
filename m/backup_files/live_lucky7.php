                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            <div class="casino-title"><span class="casino-name">Lucky 7</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                            ...
                            <div class="casino-video">
                               <iframe src="<?php echo IFRAME_URL; echo LUCKY7A_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe>
                            ...
                            <div class="casino-container lucky7">
                                <div class="light-bg container-fluid mt-2">
                                    <div class="row row5">
                                        <div class="col-5">
                                            <p class="d-block mb-0 text-center"><b>2.00</b></p>
                                    ...
                                    <div class="row row5">
                                        <div class="col-12 text-right"><span class="min-max">Min:100 Max:100000</span></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row5">
                                        <div class="col-6">
                                            <div class="light-bg pl-1 pr-1">
                                                <div class="row row5">
                                                    <div class="col-6">
                                                        <p class="d-block mb-0 text-center"><b>2.12</b></p>
                                                    ...
                                                    <div class="col-6">
                                                        <p class="d-block mb-0 text-center"><b>1.83</b></p>
                                        ...
                                        <div class="col-6">
                                            <div class="light-bg pl-1 pr-1">
                                                <div class="row row5">
                                                    <div class="col-6">
                                                        <p class="d-block mb-0 text-center"><b>1.97</b></p>
                                ...
                                <div class="light-bg container-fluid mt-2">
                                    <div class="row row5">
                                        <div class="col-12 text-center"><b>12.00</b>
                      ...
                      20000
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=lucky7" class="">View All</a></span></div>
