                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            <div class="casino-container teenpatti-20">
                                <div class="table-responsive mb-1">
                                    <table class="table table-bordered mb-0">
                                        <thead>
                                            <tr>
                                                <th class="box-5 min-max">Min:100 Max:500000</th>
                                                <th colspan="2" class="box-5 text-center back">BACK</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="">
                                                <td class="box-5"><b>Player A</b></td>
                                                <td class="box-2 back market_1_row text-center suspendedtd back-1 market_1_b_btn"><span class="odds d-block"><b class="market_1_b_value">1.98</b></span> <span style="color: black;" class="market_1_b_exposure market_exposure">0</span></td>
                                                <td class="box-3 back market_2_row text-center suspendedtd back-1 market_2_b_btn"><span class="odds d-block"><b class="market_2_b_value">Pair plus A</b></span> <span style="color: black;" class="market_2_b_exposure market_exposure">0</span></td>
                                            </tr>
                                            <tr class=" ">
                                                <td class="box-5"><b>Player B</b></td>
                                                <td class="box-2 back market_3_row text-center suspendedtd back-1 market_3_b_btn"><span class="odds d-block"><b class="market_3_b_value">1.98</b></span> <span style="color: black;" class="market_3_b_exposure market_exposure">0</span></td>
                                                <td class="box-3 back market_4_row text-center suspendedtd back-1 market_4_b_btn"><span class="odds d-block"><b class="market_4_b_value">Pair plus B</b></span> <span style="color: black;" class="market_4_b_exposure market_exposure">0</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
