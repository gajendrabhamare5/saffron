...
?>
   ...
   <div  id="bhav" class="tab-pane active">
      <div  class="casino-title"><span  class="casino-name">Andar Bahar 2</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
         ...
         <div  class="video-overlay" style="">
            <div  id="game-cards">
               <div  class="row row5 align-items-center">
                  ...
                  <div  class="col-2"><img id="card_joker" src="../storage/front/img/cards/1.png" class="card-right"></div>
                  <div  class="col-9">
                     <div  class="card-inner">
                        <div  class="row row5">
                           <div  class="col-2"><img id="card_1st_andar"  src="../storage/front/img/cards/1.png"></div>
                           <div  class="col-10">
                     ...
                     <div  class="card-inner">
                        <div  class="row row5">
                           <div  class="col-2"><img id="card_1st_bahar" src="../storage/front/img/cards/1.png"></div>
                           <div  class="col-10">
      ...
      <div  class="casino-container ab-2">
         ...
         <div  class="ab-2-box mt-2">
            <div  class="row row5">
               <div  class="col-6 text-center">
                  <div  class="bltitle"><b >Odd</b></div>
                  <div  class="back mt-1 blbox suspended  market_24_row market_24_b_btn back-1"><span  class="odd">1.83</span></div>
               ...
               <div  class="col-6 text-center">
                  ...
                  <div  class="back mt-1 blbox suspended  market_25_row market_25_b_btn back-1"><span  class="odd">2.12</span></div>
         ...
         <div  class="ab-2-box mt-2">
            <div  class="row row5">
               <div  class="col-3 text-center">
                  ...
                  <div  class="back mt-1 blbox suspended  market_20_row market_20_b_btn back-1"><span  class="odd">3.83</span></div>
               ...
               <div  class="col-3 text-center">
                  ...
                  <div  class="back mt-1 blbox suspended  market_21_row market_21_b_btn back-1"><span  class="odd">3.83</span></div>
               ...
               <div  class="col-3 text-center">
                  ...
                  <div  class="back mt-1 blbox suspended  market_22_row market_22_b_btn back-1"><span  class="odd">3.83</span></div>
               ...
               <div  class="col-3 text-center">
                  ...
                  <div  class="back mt-1 blbox suspended  market_23_row market_23_b_btn back-1"><span  class="odd">3.83</span></div>
         ...
         <div  class="last-result-tiele"><span >Last Result</span> <span  class="float-right"><a  href="/m/reports/casinoresults/abj" class="">View
            All</a></span>
         </div>
		  	...
		  	oldGameId = data.t1[0].mid;
				...
				if(aall != ""){
					for(ac in aall){
						...
						acards_html_array.push('  <div class="owl-item " id="owl_ac_img_id'+ac+'" style=""><div class="item"><img src="../storage/front/img/cards/'+aall[ac]+'.png"></div></div>');
...
function clearCards(){
	...
	$("#card_joker").attr("storage/front/img/cards/1.png");
	$("#card_1st_andar").attr("storage/front/img/cards/1.png");
	$("#card_1st_bahar").attr("storage/front/img/cards/1.png");
