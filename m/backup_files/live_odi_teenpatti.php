                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            <div class="casino-title"><span class="casino-name">1 Day Teenpatti</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                            ...
                            <div class="casino-container teenpatti-1day">
                                <div class="table-responsive mb-1">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            <tr data-title="SUSPENDED" class="suspended market_1_row">
                                                <td class="box-6"><b>Player A</b>
                                                    <p class="mb-0"><span style="color: black;" class="market_1_b_exposure market_exposure">0</span> </p>
                                                </td>
                                                <td class="box-2 back text-center back-1 market_1_b_btn"><span class="odds d-block"><b>82</b></span> <span>1000000</span></td>
                                                <td class="box-2 lay text-center lay-1 market_1_l_btn"><span class="odds d-block"><b>86</b></span> <span>1000000</span></td>
                                            </tr>
                                            <tr data-title="SUSPENDED" class="suspended market_2_row">
                                                <td class="box-6"><b>Player B</b>
                                                    <p class="mb-0"><span style="color: black;" class="market_2_b_exposure market_exposure">0</span> </p>
                                                </td>
                                                <td class="box-2 back text-center back-1 market_2_b_btn"><span class="odds d-block"><b>0</b></span> <span>0</span></td>
                                                <td class="box-2 lay text-center lay-1 market_2_l_btn"><span class="odds d-block"><b>0</b></span> <span>0</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=teenOdi" class="">View All</a></span></div>
 ...
 <script type="text/javascript">
		...
		socket.on('game', function (data) {
			...
			if (data && data && data[0]) {
             if(oldGameId != data1.t1[0].mid && data1.t1[0].mid != 0 && data1.t1[0].mid != "0"){
				...
				$(".round_no").text(data1.t1[0].mid == 0 ? 0 : data1.t1[0].mid.split(".")[1]);
				$("#casino_event_id").val(data1.t1[0].mid == 0 ? 0 : data1.t1[0].mid.split(".")[1]);
				eventId = data1.t1[0].mid == 0 ? 0 : data1.t1[0].mid.split(".")[1];
				for (var j in data) {
					selectionid = data[j].sectionId;
					runner = data[j].nation || data[j].nat;
					b1 = data[j].b1;
					bs1 = data[j].bs1;
					l1 = data[j].l1;
					ls1 = data[j].ls1;
	...
	function updateResult(data) {
		...
		if(data && data[0]){
			...
			data.forEach((runData) => {
				...
				html += '<span onclick="view_casiono_result('+eventId+','+casino_type+')"  class="last-result ml-1 '+ (parseInt(runData.result) == 1 ? 'playera' : 'playerb') +'">'+(parseInt(runData.result) == 1 ? 'A' : 'B')+'</span>';
			});
	...
	jQuery(document).on("click", ".back-1", function () {			$("#popup_color").removeClass("back");			$("#popup_color").removeClass("lay");			$("#popup_color").addClass("back");
		...
		if (fullmarketodds != "") {
			...
			runs_lable = 'Runs';
			runs_lable = 'Odds';
			fullfancymarketrate = fullmarketodds;fullmarketodds = (fullmarketodds / 100 )+1;			fullfancymarketrate = (fullfancymarketrate / 100 )+1;			fullfancymarketrate = fullfancymarketrate.toFixed(2);			fullmarketodds = fullmarketodds.toFixed(2);
		...
		if (fullmarketodds != "") {
			...
			runs_lable = 'Runs';
			runs_lable = 'Odds';
			fullfancymarketrate = fullmarketodds;			fullfancymarketrate = (fullfancymarketrate / 100 )+1;				fullmarketodds = (fullmarketodds / 100 )+1;				fullfancymarketrate = fullfancymarketrate.toFixed(2);				fullmarketodds = fullmarketodds.toFixed(2);
			eventId = $(this).attr("eventid");
			marketId = $(this).attr("marketid");
			event_name = $(this).attr("event_name");
			$(".select").removeClass("select");
