                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            <div class="casino-title"><span class="casino-name">Instant Worli</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                            ...
                            <div class="worli-matka">
                                    ...
                                    <div id="single" class="tab-pane active">
                                        <div class="table-responsive">
                                            <table class="table table-bordered mb-0">
                                                <thead>
                                                    <tr>
                                                        <th colspan="5" class="box-10 text-center">9</th>
                                                    </tr>
                                                </thead>
                                        ...
                                        <div class="table-responsive mt-2 mb-1">
                                            <table class="table table-bordered mb-0">
                                                <thead>
                                                    <tr>
                                                        <th colspan="4" class="box-10 text-center">9</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="suspended market_1_row">
                                                    <tr>
                                ...
                                <div class="remark text-right pr-2">
                                    <marquee scrollamount="3">
                                        <p class="mb-0">welcome single</p>
                                    </marquee>
                                </div>
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=worli2" class="">View All</a></span></div>
