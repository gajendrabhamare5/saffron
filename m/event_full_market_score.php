							...
							<?php } else if($eventType == 1 || $eventType == 2){ ?>
								<div class="col-xl-12" style="border: 3px solid #000;padding: 0px;">
										...
										<div id="scoreboard-box" style="background: black;">
												...
												<img id="iframe-tracker-1" width="100%" height="230px" src="/storage/img/animation_banner.png" style="overflow: hidden; border: 0px; height: 230px;" class="visible"></iframe>
												</div>
												
								</div>
							<?php }?>
                            <?php if (IPL_EVENT_ID != $event_id){ ?>
...
function openTV(){
	var name = "collapseTV";
	if($("#" + name).length == 0) {
		$("#matchDate1" ).append('<div data-v-68a8f00a="" id="collapseTV"><iframe data-v-68a8f00a="" src="https://starexch11.com/Media%20Player.html?eventId=<?php echo $event_id;?>/250" width="100%" height="250" class="video-iframe"></iframe></div>');
                                    ...
                                    */
									...
									if(args.body.data[k].runners){
										...
										for(j=0;j<args.body.data[k].runners.length;j++){
											...
											$(".expo_market_"+runner_len).show();
											$(".expo_team_name_"+runner_len).text(runnerName);
											$(".on_change_expo_team_"+runner_len).addClass("live_match_points_"+selectionId+"_"+market_marketid);
											runner_len++;
                                ...
                                if(args.body1.body.cricket[0].bookmaker && args.body1.body.cricket[0].bookmaker != null){
                                    ...
                                    for(z=0;z<args.body1.body.cricket[0].bookmaker.length;z++){
                                        ...
                                        if(args.body1.body.cricket[0].bookmaker[z] && args.body1.body.cricket[0].bookmaker[z]){                                       
											...
											$(".on_change_expo_team_"+runner_len).addClass("live_match_points_"+selectionId+"_BOOKMAKER_ODDS");
											runner_len++;
...
<script>	
    ...
    jQuery(document).on("click", ".back-1", function () {        
		...
		if (fullmarketodds != "") {
				...
				$(".on_change_expo_team").text("0.00");
				$(".on_change_expo_team").addClass("text-danger");
				...
				//$('.modal').show();
				$(".match_odds_expo_onlive").hide();
				if(markettype == "MATCH_ODDS" || markettype == "BOOKMAKER_ODDS" || markettype == "BOOKMAKERSMALL_ODDS"){
					$(".match_odds_expo_onlive").show();
				}
    ...
    jQuery(document).on("input", "#inputStake", function () {
        ...
        if(bet_markettype == "MATCH_ODDS" || bet_markettype == "BOOKMAKER_ODDS" || bet_markettype == "BOOKMAKERSMALL_ODDS"){
			$(".on_change_expo_team").text(parseInt(inputStake).toFixed(2));
            $(".on_change_expo_team").addClass("text-danger");
			
			$(".live_match_points_"+bet_marketId+"_"+bet_markettype).removeClass("text-danger");
			$(".live_match_points_"+bet_marketId+"_"+bet_markettype).removeClass("text-success");
			
			$(".live_match_points_"+bet_marketId+"_"+bet_markettype).addClass("text-success");
			$(".live_match_points_"+bet_marketId+"_"+bet_markettype).text(profit.toFixed(2));
    ...
    jQuery(document).on("click", ".label_stake", function () {
       ...
       eventId = $("#fullMarketBetsWrap").attr("eventid");
        ...
        if(bet_markettype == "MATCH_ODDS" || bet_markettype == "BOOKMAKER_ODDS" || bet_markettype == "BOOKMAKERSMALL_ODDS"){
			...
			$(".on_change_expo_team").removeClass("text-success");
			$(".on_change_expo_team").removeClass("text-danger");
			
			
			if(bet_stake_side == "Lay"){
				$(".on_change_expo_team").addClass("text-success");
				$(".live_match_points_"+bet_marketId+"_"+bet_markettype).removeClass("text-success");
				$(".live_match_points_"+bet_marketId+"_"+bet_markettype).removeClass("text-danger");
				$(".live_match_points_"+bet_marketId+"_"+bet_markettype).addClass("text-danger");
				$(".live_match_points_"+bet_marketId+"_"+bet_markettype).text("-"+profit.toFixed(2));
			}
			else{
				$(".on_change_expo_team").addClass("text-danger");
...
<input type='hidden' id='bet_stake_side' value=''/><input type='hidden' id='bet_event_id' value=''/><input type='hidden' id='bet_marketId' value=''/><input type='hidden' id='bet_event_name' value=''/><input type='hidden' id='bet_market_name' value=''/><input type='hidden' id='bet_markettype' value=''/><input type='hidden' id='fullfancymarketrate' value=''/> <input type='hidden' id='oddsmarketId' value=''/><input type='hidden' id='market_runner_name' value=''/><input type='hidden' id='market_odd_name' value=''/> 
				  ...
				  <div class="match_odds_expo_onlive" style="display:none;">
					  
					  <div class="row row5 mt-2 expo_market_1" style="display:none;">
						<div class="col-4">
							<span class="expo_team_name_1"></span>
						</div>
						<div class="col-4 text-center text-success">
							<b>
								<span style="color: black;" class="old_expo_team_1">0</span>
							</b>
						</div>
						<div class="col-4 text-right">
							<span class="text-danger">
								<b class="on_change_expo_team on_change_expo_team_1">0.00</b>
							</span>
						</div>
					</div>
					
					 <div class="row row5 mt-2 expo_market_2" style="display:none;">
						<div class="col-4">
							<span class="expo_team_name_2"></span>
						</div>
						<div class="col-4 text-center text-success">
							<b>
								<span style="color: black;" class="old_expo_team_2">0</span>
							</b>
						</div>
						<div class="col-4 text-right">
							<span class="text-danger">
								<b class="on_change_expo_team on_change_expo_team_2">0.00</b>
							</span>
						</div>
					</div>
					
					 <div class="row row5 mt-2 expo_market_3" style="display:none;">
						<div class="col-4">
							<span class="expo_team_name_3"></span>
						</div>
						<div class="col-4 text-center text-success">
							<b>
								<span style="color: black;" class="old_expo_team_3">0</span>
							</b>
						</div>
						<div class="col-4 text-right">
							<span class="text-danger">
								<b class="on_change_expo_team on_change_expo_team_3">0.00</b>
							</span>
						</div>
					</div>
