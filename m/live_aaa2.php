...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Amar Akbar Anthony 2</span><span class="d-block"><a href="#" onclick="view_rules('aaa2')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".AAA2_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                               <iframe src="<?php echo IFRAME_URL."".AAA2_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                                ...
                                <div class="casino-table">
                                    <div class="casino-table-box">
                                        <div class="casino-odd-box-container">
                                            ...
                                            <div class="casino-odds-box back suspended back-1 market_1_b_btn market_1_row"><span class="casino-odds market_1_b_value">0</span></div>
                                            <div class="casino-odds-box lay suspended lay-1 market_1_l_btn market_1_row"><span class="casino-odds market_1_l_value">0</span></div>                                           
                                        </div>
                                        <div class="casino-odd-box-container">
                                            <div class="casino-nation-name">
                                                B. Akbar
                                            ...
                                            <div class="casino-odds-box back suspended market_2_row back-1 market_2_b_btn"><span class="casino-odds market_2_b_value">0</span></div>
                                                    <div class="casino-odds-box lay suspended market_2_row lay-1 market_2_l_btn"><span class="casino-odds market_2_l_value">0</span></div>
                                        ...
                                        <div class="casino-odd-box-container">
                                            <div class="casino-nation-name">
                                                ...
                                                <div class="casino-nation-book d-md-none market_3_b_exposure market_exposure"></div>
                                                    ...
                                                    <div class="casino-odds-box back suspended market_3_row back-1 market_3_b_btn"><span class="casino-odds market_3_b_value">0</span></div>
                                                    <div class="casino-odds-box lay suspended market_3_row lay-1 market_3_l_btn"><span class="casino-odds market_3_l_value">0</span></div>
                                    ...
                                    <div class="casino-table-box mt-3">
										...
										<div class="aaa-odd-box">
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended market_21_b_btn market_21_row back-1"><span class="casino-odds">Under 7</span></div>
                                                    ...
                                                    <div class="aaa-odd-box">
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended market_22_b_btn market_22_row back-1"><span class="casino-odds">Over 7</span></div>
                                    ...
                                    <div class="casino-table-full-box aaacards mt-3">
                                                <h4 class="w-100 text-center mb-2 market_8_b_value"><b>0</b></h4>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_8_b_btn market_8_row back-1"><img src="../storage/front/img/cards/A.png"></div>
                                                    <div class="casino-nation-book market_8_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_9_b_btn market_9_row back-1"><img src="../storage/front/img/cards/2.png"></div>
                                                    <div class="casino-nation-book market_9_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_10_b_btn market_10_row back-1"><img src="../storage/front/img/cards/3.png"></div>
                                                    <div class="casino-nation-book market_10_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_11_b_btn market_11_row back-1"><img src="../storage/front/img/cards/4.png"></div>
                                                    <div class="casino-nation-book market_11_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_12_b_btn market_12_row back-1"><img src="../storage/front/img/cards/5.png"></div>
                                                    <div class="casino-nation-book market_12_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_13_b_btn market_13_row back-1"><img src="../storage/front/img/cards/6.png"></div>
                                                    <div class="casino-nation-book market_13_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_14_b_btn market_14_row back-1"><img src="../storage/front/img/cards/7.png"></div>
                                                    <div class="casino-nation-book market_14_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_15_b_btn market_15_row back-1"><img src="../storage/front/img/cards/8.png"></div>
                                                    <div class="casino-nation-book market_15_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_16_b_btn market_16_row back-1"><img src="../storage/front/img/cards/9.png"></div>
                                                    <div class="casino-nation-book market_16_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_17_b_btn market_17_row back-1"><img src="../storage/front/img/cards/10.png"></div>
                                                    <div class="casino-nation-book market_17_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_18_b_btn market_18_row back-1"><img src="../storage/front/img/cards/J.png"></div>
                                                    <div class="casino-nation-book market_18_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_19_b_btn market_19_row back-1"><img src="../storage/front/img/cards/Q.png"></div>
                                                    <div class="casino-nation-book market_19_b_exposure market_exposure "></div>
                                                </div>
                                                <div class="card-odd-box">
                                                    <div class="suspended market_20_b_btn market_20_row back-1"><img src="../storage/front/img/cards/K.png"></div>
                                                    <div class="casino-nation-book market_20_b_exposure market_exposure"></div>
                                                </div>
                                            </div>
                                </div>

                                <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=aaa2">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?13' defer></script>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
	...
	jQuery(document).on("click", "#placeBet", function () {
		...
		setTimeout(function () {
			$.ajax({
				type: 'POST',
				url: '../ajaxfiles/bet_place_aaa2.php',
				dataType: 'json',
				data: {
