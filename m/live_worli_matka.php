...
<script src="../storage/front/js/flipclock.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src='footer-js.js' defer></script>
                    ...
                    <div id="__BVID__30___BV_modal_body_" class="modal-body" style="    padding: 0px;">
                        <div class="place-bet1 pt-2 pb-2 back place-bet-modal" id="popup_color">
                            ...
                            <div class="mt-1 place-bet-btn-box">
                                <button class="btn btn-link stackclear"
                                    style="text-decoration: underline;">Clear</button>
                                <button class="btn btn-info" data-target="#set_btn_value"
