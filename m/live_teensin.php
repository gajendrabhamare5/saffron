...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">29Card Baccarat</span> <span class="d-block"><a href="#" onclick="view_rules('teensin')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEENSIN_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                           ...
                           <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                <iframe src="<?php echo IFRAME_URL."".TEENSIN_CODE;?>" width="100%" height="200px"
                                ...
                                <div class="casino-table">
                                    <div class="casino-table-box">
                                        <div class="casino-table-left-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                    <div
                                                        class="casino-odds-box back back-1 market_1_row market_1_b_btn suspended">
                                                        <span class="casino-odds">1.98</span>
                                                        <div class="casino-nation-book market_1_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box back back-1 market_3_row market_3_b_btn suspended">
                                                        <span class="casino-odds">1.98</span>
                                                        <div class="casino-nation-book market_3_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box back back-1 market_5_row market_5_b_btn suspended">
                                                        <span class="casino-odds">3.25</span>
                                                        <div class="casino-nation-book market_5_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box back back-1 market_7_row market_7_b_btn suspended">
                                        ...
                                        <div class="casino-table-right-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                    <div
                                                        class="casino-odds-box back back-1 market_2_row market_2_b_btn suspended">
                                                        <span class="casino-odds">1.98</span>
                                                        <div class="casino-nation-book market_2_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box back back-1 market_4_row market_4_b_btn suspended">
                                                        <span class="casino-odds">1.98</span>
                                                        <div class="casino-nation-book market_4_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box back back-1 market_6_row market_6_b_btn suspended">
                                                        <span class="casino-odds">3.25</span>
                                                        <div class="casino-nation-book market_6_b_exposure market_exposure"></div>
                                                    </div>
                                                    
                                                    <div
                                                        class="casino-odds-box back back-1 market_8_row market_8_b_btn suspended">
                                                        <span class="casino-odds">2</span>
                                    ...
                                    <div class="casino-table-full-box mt-3">
                                        ...
                                        <div class="casino-odd-box-container">
                                            <div
                                                class="casino-odds-box back back-1 market_9_row market_9_b_btn suspended">
                                                <span class="casino-odds">4.7</span>
                                            </div>
                                            <div
                                                class="casino-odds-box lay lay-1 market_9_row market_9_l_btn suspended">
                                                <span class="casino-odds">5.1</span>
                                            </div>
                                            <div class="casino-nation-book text-center w-100  market_9_b_exposure market_exposure"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a
                                            href="casinoresults?game_type=teensin" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?23' defer></script>
...
jQuery(document).on("click", "#placeBet", function() {
    ...
    setTimeout(function() {
        $.ajax({
            type: 'POST',
            url: '../ajaxfiles/bet_place_teensin.php',
            dataType: 'json',
            data: {
