...
<style>
    ...
    .casino-table-left-box .aaa-odd-box,
    .casino-table-right-box .aaa-odd-box {
        width: 49%;
    }

    .casino-table-left-box .aaa-odd-box .casino-odds-box,
    .casino-table-right-box .aaa-odd-box .casino-odds-box {
        width: 100%;
    }
    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                    <div class="casino-title"><span class="casino-name">Bollywood Casino 2</span><span class="d-block"><a href="#" onclick="view_rules('btable2')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            <div class="casino-video">
                                ...
                                ?>
                                    <iframe src="<?php echo IFRAME_URL . "" . BTABLE2_CODE; ?>" width="100%" height="250px" style="border: 0px;"></iframe>
                                <?php
                                ...
                                <!--	<iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL . "" . BTABLE2_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                <div class="casino-table">
                                    ...
                                    <div class="casino-table-box mt-3">
                                        ...
                                        <div class="casino-table-right-box right-cards">
                                            <h4 class="w-100 text-center mb-2 h4-font"><b class=" market_10_b_value">3.75</b></h4>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=btable2" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?75' defer></script>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function() {
        ...
        setTimeout(function() {
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_btable2.php',
                dataType: 'json',
                data: {
