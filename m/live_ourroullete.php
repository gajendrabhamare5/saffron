                ...
                <div>
                    <div class="casino-title">
                        <div class="row row5">
                            ...
                            <span class="casino-name">Unique Roulette</span>
                            <span class="d-block"><a href="#" onclick="view_rules('ourroullete')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span>
                        </div>
                            ...
                            <div class="position-relative">
                                <div class="casino-videoo full">
                                    <div class="video-box-container">
                                        <div class="casino-video-box">
                                            ...
                                            ?>
                                                <iframe src="<?php echo IFRAME_URL . "" . OURROULLETE_CODE; ?>" width="100%" height="250px" style="border: 0px;"></iframe>
                                            <?php
                                ...
                                <div class="casino-detail">
                                    ...
                                    <div class="casino-last-result-title">
                                        ...
                                        <span><a href="casinoresults?game_type=ourroullete">View All</a></span>
                                    </div>
...
for (let i = 1; i <= 36; i++) {
    ...
    function updateResult(data) {
        ...
        if (data && data[0]) {
            ...
            html += `<a href="casinoresults?game_type=ourroullete">
    ...
    function fetch_bets(){
        $.ajax({
				 ...
				 dataType: 'json',
				 data: {eventId:eventId,eventType:'OURROULLETE'},
    ...
    function rolette_button_action(action_type){
        ...
        $.ajax({
				 ...
				 dataType: 'json',
				 data: {eventId:eventId,eventType:'OURROULLETE',action_type:action_type,all_old_bet:all_old_bet},
				 success: function(response) {
                    var message="";
    ...
    jQuery(document).on("click", ".back-1", function() {
        ...
        if (fullmarketodds != "") {
            ...
            $.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_ourroullete',
				 dataType: 'json',
