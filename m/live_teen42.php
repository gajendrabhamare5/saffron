...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Jack Top Open Teenpatti</span><span class="d-block"><a href="#" onclick="view_rules('teen42')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN42_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
							 ...
							 <!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                <iframe src="<?php echo IFRAME_URL; echo TEEN42_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
...
<script type="text/javascript" src='footer-js.js?64' defer></script>
