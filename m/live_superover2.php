...
<style>
    @media screen and (orientation: portrait) {
        ...
        .fancyTieMarket .box-1 ,.fancyMarket .box-1 ,.fancyMarket1 .box-1{
            width: 15% !important;
    ...
    .bookmaker-market .suspended:before, .bookmaker-tied-market .suspended:before, .fancy-market .suspended:before, .fancyMarket1 .suspended:before {
    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">SUPER OVER2</span><span class="d-block"><a href="#" onclick="view_rules('superover2')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".SUPEROVER2_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                <iframe src="<?php echo IFRAME_URL . SUPEROVER2_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                                ...
                                <div class="bookmaker-market">
                                    ...
                                    <div>
                                        <div class="table-header">
                                            <div class="float-left country-name box-7 min-max"><b>Min:100 Max:3L</b></div>
                                        ...
                                        <div class="table-body">
                                            <div data-title="SUSPENDED" class="table-row suspended market_1_row">
                                                <div class="float-left country-name box-7">
                                                    ...
                                                    <p><span class="float-left market_1_b_exposure market_exposure" style="color: black;"></span></p>
                                                </div>
                                            ...
                                            <div data-title="SUSPENDED" class="table-row suspended market_2_row">
                                                <div class="float-left country-name box-7">
                                                    ...
                                                    <p><span class="float-left market_2_b_exposure market_exposure" style="color: black;"></span></p>
                                                </div>
                            ...
                            <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=superover2" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?67' defer></script>
                ...
                if (data['t3'] != null) {
                    ...
                    for (var f in data['t3']) {
                        ...
                        if ($("#five_fancy_" + selectionid) && $("#five_fancy_" + selectionid).length > 0) {
                            ...
                            fancy_data += '			<span>' + runner + '</span> ';
                            fancy_data += '			<p><span class="float-left market_' + selectionid + '_b_exposure market_exposure" style="color: black;"></span></p>';
                            fancy_data += '		 </div>';
                            fancy_data += `
                                        <div class="box-1 lay float-left text-center market_${selectionid}_l_btn ${lay_class}" side="Lay" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="${markettype}" event_name="${markettype}" fullmarketodds="${l1}" fullfancymarketrate="${l1}">${lay_html}</div>
                                        <div class="box-1 back float-left text-center market_${selectionid}_b_btn ${back_class}" side="Back" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="${markettype}" event_name="${markettype}" fullmarketodds="${b1}" fullfancymarketrate="${b1}">${back_html}</div>
                                        `;
                    ...
                    for (var f in data['t4']) {
                        ...
                        if (runner.toLowerCase() == "tie") {
                            if ($("#five_fancy_tie_" + selectionid) && $("#five_fancy_tie_" + selectionid).length > 0) {
                                ...
                                fancy_tie_data += '			<span>' + runner + '</span> ';
                                fancy_tie_data += '			<p><span class="float-left market_' + selectionid + '_b_exposure market_exposure" style="color: black;"></span></p>';
                                fancy_tie_data += '		 </div>';
                                fancy_tie_data += `
                                       
                                      
                                         <div class="box-1 back float-left text-center market_${selectionid}_b_btn back-1" side="Back" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="FANCY1_ODDS" event_name="${markettype}" fullmarketodds="${b1}" fullfancymarketrate="${b1}">${back_html}</div>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function() {
       ...
       /*  setTimeout(function() { */
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_super_over_2.php',
                dataType: 'json',
                data: {
                    eventId: bet_event_id,
                    eventType: eventType,
