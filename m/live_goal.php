    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                    <div class="casino-title"><span class="casino-name">Goal</span><span class="d-block"><a href="#" onclick="view_rules('goal')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content goal">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".GOAL_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                              ...
                              <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL;
                                                    echo GOAL_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                            ...
                            <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=goal" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?69' defer></script>
<?
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function() {
        ...
        setTimeout(function() {
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_goal.php',
                dataType: 'json',
                data: {
                        ...
                        <div class="row row5 mt-1">
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <input type="number" id="inputStake" class="stakeinput w-100"></div>
