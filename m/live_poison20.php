...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Teenpatti Poison 20-20</span><span class="d-block"><a href="#" onclick="view_rules('poison20')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".POISON20_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
							...
							<!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL; echo POISON20_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                                ...
                                <div class="video-overlay">
                                     <div>
                                        <h5 class="text-orange">POISON</h5>
                                        <div>
                                            <div><img id="card_c1" src="../storage/front/img/cards_new/1.png"> </div>
                                        </div>
                                    </div>
                                    <div>
                                        <h4 class="text-white">PLAYER A</h4>
                                        <div>
                           ...
                           <div class="casino-detail">
                               <div class="casino-table">
                                  <div class="casino-table-box">
                                     <div class="casino-table-left-box">
                                        ...
                                        <div class="casino-table-body">
                                           <div class="casino-table-row">
                                              ...
                                              <div class="casino-odds-box back back-1 market_1_b_btn  market_1_row suspended"><span class="casino-odds market_1_b_val">1.92</span></div>
                                              <div class="casino-odds-box lay lay-1 market_1_l_btn  market_1_row suspended"><span class="casino-odds market_1_l_val">1.95</span></div>
                                           </div>
                                        </div>
                                     </div>
                                     ...
                                     <div class="casino-table-right-box">
                                        ...
                                        <div class="casino-table-body">
                                           <div class="casino-table-row  ">
                                              ...
                                              <div class="casino-odds-box back back-1 market_2_b_btn market_2_row suspended"><span class="casino-odds market_2_b_val">0</span></div>
                                              <div class="casino-odds-box lay lay-1 market_2_l_btn market_2_row suspended"><span class="casino-odds market_2_l_val">0</span></div>
                                           </div>
                                        </div>
                                     </div>
                                    ...
                                    <div class="casino-table-left-box">
                                        <div class="casino-table-header">
                                           <div class="casino-odds-box"></div>
                                           <div class="casino-odds-box">Even</div>
                                           <div class="casino-odds-box">Odd</div>
                                           <div class="casino-odds-box">
                                            <span>Red</span>
                                            <span class="card-icon ms-1">
                                        ...
                                        <div class="casino-table-body">
                                           <div class="casino-table-row ">
                                              <div class="casino-nation-detail1">
                                                 <div class="casino-nation-name">Poison</div>
												 
                                              </div>
                                              <div class="casino-odds-box back back-1 market_3_b_btn market_3_row suspended"><span class="casino-odds market_3_b_val">1.92</span><div class="casino-nation-book text-center market_3_b_exposure market_exposure"></div></div>
                                              <div class="casino-odds-box back back-1 market_4_b_btn market_4_row suspended"><span class="casino-odds market_4_b_val">1.95</span><div class="casino-nation-book text-center market_4_b_exposure market_exposure"></div></div>
                                              <div class="casino-odds-box back back-1 market_5_b_btn market_5_row suspended"><span class="casino-odds market_5_b_val">1.92</span><div class="casino-nation-book text-center market_5_b_exposure market_exposure"></div></div>
                                              <div class="casino-odds-box back back-1 market_6_b_btn market_6_row suspended"><span class="casino-odds market_6_b_val">1.95</span><div class="casino-nation-book text-center market_6_b_exposure market_exposure"></div></div>
                                           </div>
                                        </div>
                                     </div>
                                    <div class="casino-table-left-box">
                                        ...
                                        <div class="casino-table-body">
                                           ...
                                           <div class="casino-odds-box back market_7_b_btn market_7_row back-1 suspended"><span class="casino-odds market_7_b_val">0</span><span class="market_7_b_exposure market_exposure"></span></div>
                                           <div class="casino-odds-box back market_8_b_btn market_8_row back-1 suspended"><span class="casino-odds market_8_b_val">0</span><span class="market_8_b_exposure market_exposure"></span></div>
                                           <div class="casino-odds-box back market_9_b_btn market_9_row back-1 suspended"><span class="casino-odds market_9_b_val">0</span><span class="market_9_b_exposure market_exposure"></span></div>
                                           <div class="casino-odds-box back market_10_b_btn market_10_row back-1 suspended"><span class="casino-odd market_10_b_val">0</span><span class="market_10_b_exposure market_exposure"></span></div>
                                        </div>
                                        </div>
                                     </div>
                               ...
                               <div class="casino-last-result-title">
								...
								<span><a href="casinoresults?game_type=poison20">View All</a></span>
							</div>
...
<script type="text/javascript" src='footer-js.js?61' defer></script>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_poison20.php',
				 dataType: 'json',
