	...
	<div id="app">
		...
		<div>
			...
			<div class="main-content">
				...
				<!---->
				<div>
					<div class="casino-title"><span class="casino-name"> SUPER OVER</span><span class="d-block"><a href="#" onclick="view_rules('superover')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
					<?php
					...
					<div class="tab-content">
						<div id="bhav" class="tab-pane active">
							...
							<div class="casino-video">
								...
								?>
									<iframe src="<?php echo IFRAME_URL . "" . SUPEROVER_CODE; ?>" width="100%" height="250px" style="border: 0px;"></iframe>
								<?php
         ...
         <iframe src="<?php echo IFRAME_URL . SUPEROVER_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>  -->
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name">Common Wicket IND</span>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name">Common Boundry IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over Wicket IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over Zero IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over One IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over Two IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over Three IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
					...
					<div class="fancy-market suspended-row" data-title="SUSPENDED">
						<div class="market-row">
							<div class="market-nation-detail">
								<span class="market-nation-name"> 0.6 Over Boundry IND</span>
								<div class="market-nation-book"></div>
							</div>
							<div class="market-odd-box back "><span class="market-odd">-</span></div>
							<div class="market-odd-box lay "><span class="market-odd">-</span></div>
							<div class="fancy-min-max-box">
								...
								<div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=superover">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?92' defer></script>
				...
				if (data['t3'] != null) {
					...
					for (var f in data['t3']) {
						...
						if ($("#five_fancy_" + selectionid) && $("#five_fancy_" + selectionid).length > 0) {
							...
							var exposure = "";
							var ex_color = "";
							if ($('.market-nation-book').hasClass("market_" + selectionid + "_b_exposure")) {
								exposure = $(".market_" + selectionid + "_b_exposure").html();
								if (exposure != "") {
							...
							fancy_data += `
										...
										<div class="market-row">
											<div class="market-nation-detail">
												...
												<div class="market-nation-book market_${selectionid}_b_exposure market_exposure ${ex_color}">${exposure}</div>
											</div>
											<div class="market-odd-box lay market_${selectionid}_l_btn lay-1" side="Lay" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="FANCY_ODDS" event_name="${markettype}" fullmarketodds="${l1}" fullfancymarketrate="${ls1}">${lay_html}</div>
											<div class="market-odd-box back market_${selectionid}_b_btn back-1" side="Back" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="FANCY_ODDS" event_name="${markettype}" fullmarketodds="${b1}" fullfancymarketrate="${bs1}">${back_html}</div>
											<div class="fancy-min-max-box">
				...
				if (data['t4'] != null) {
					...
					for (var f in data['t4']) {
						 ...
						 */
							...
							fancy_data += `<div class="col-md-6"  id="five_fancy_${selectionid}'">
