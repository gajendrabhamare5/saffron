...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Baccarat</span><span class="d-block"><a href="#" onclick="view_rules('baccarat')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>

<?php
	include("casino_header.php");
?>
                    <div class="tab-content baccarat">
	...
	<?php 
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".BACCARAT_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
	  ...
	  <!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
       <iframe src="<?php echo IFRAME_URL."".BACCARAT_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
    ...
    <div class="casino-container container-fluid-5 baccarat-container">
        <div class="row row5">
            <div class="col-12 statistics-title">
                Statistics<i class="fas ml-2 fa-angle-down"></i><span class="ml-2">Click here for open statistics</span></div>
        ...
        <div class="row row5 mt-1">
            ...
            <div class="col-3">
                <div class="bet-odds suspended market_7_b_btn market_7_row back-1">
                    <p class="mb-1">Big</p>
                    <p class="mb-1">0.54:1</p>
                </div>
                <div class="book market_7_b_exposure market_exposure" style="color: black;">0</div>
            </div>
            <div class="col-3">
                <div class="bet-odds suspended market_8_b_btn market_8_row back-1">
                    <p class="mb-1">Small</p>
                    <p class="mb-1">1.5:1</p>
                </div>
                <div class="book market_8_b_exposure market_exposure" style="color: black;">0</div>
            </div>
            <div class="col-3">
                <div class="bet-odds suspended market_9_b_btn market_9_row back-1">
                    <p class="mb-1">Either Pair</p>
                    <p class="mb-1">5:1</p>
                </div>
                <div class="book market_9_b_exposure market_exposure" style="color: black;">0</div>
            </div>
        </div>
        <div class="row row5 mt-1">
            <div class="col-12">
                <div class="bet-container">
                    <div class="player-pair">
                        ...
                        <div style="color: black;" class="market_4_b_exposure market_exposure">0</div>
                    </div>
                    <div class="player">
                        <div class="suspended market_1_b_btn market_1_row back-1"><b class="text-uppercase">Player</b> <span class="d-block">1:1</span>
                            <div class="player-card">

							   <img id="card_c5" class="lrotate" style="display:none;" src="../storage/front/img/cards_new/1.png">
									<img id="card_c3" src="../storage/front/img/cards_new/1.png">
									<img id="card_c1" src="../storage/front/img/cards_new/1.png">
							   </div>

                        </div>
                        <div style="color: black;" class="market_1_b_exposure market_exposure">0</div>
                    </div>
                    <div class="tie">
                        ...
                        <div style="color: black;" class="market_3_b_exposure market_exposure">0</div>
                    </div>
                    <div class="banker">
                        <div class="suspended market_2_b_btn market_2_row back-1"><b class="text-uppercase">Banker</b> <span class="d-block">1:1</span>
                            <div class="player-card">

									<img id="card_c2" src="../storage/front/img/cards_new/1.png">
									<img id="card_c4" src="../storage/front/img/cards_new/1.png">
							<img id="card_c6" class="lrotate" style="display:none;" src="../storage/front/img/cards_new/1.png">
                            </div>
                        </div>
                        <div style="color: black;" class="market_2_b_exposure market_exposure">0</div>
                    </div>
                    <div class="banker-pair">
                        ...
                        <div style="color: black;" class="market_5_b_exposure market_exposure">0</div>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=baccarat" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?50' defer></script>
<?
		 ...
		 socket.on('game', function(data) {
		  ...
		  if (data && data['t1'] && data['t1'][0]) {
		  	...
		  	oldGameId = data.t1[0].mid;
				...
				if (data.t1[0].C4 != 1) {
						$("#card_c4").attr("src", "../storage/front/img/cards_new/" + data.t1[0].C4 + ".png");
				}
				if (data.t1[0].C5 != 1) {
						$("#card_c5").attr("src", "../storage/front/img/cards_new/" + data.t1[0].C5 + ".png");
						$("#card_c5").show();
				}
				if (data.t1[0].C6 != 1) {
						$("#card_c6").attr("src", "../storage/front/img/cards_new/" + data.t1[0].C6 + ".png");
						$("#card_c6").show();
				}
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_baccarat.php',
				 dataType: 'json',
