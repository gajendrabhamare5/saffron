...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                    <div class="casino-title"><span class="casino-name">Unlimited Joker OneDay</span><span
                            class="d-block"><a href="#" onclick="view_rules('joker1')" data-target="#rules_popup"
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                                <iframe src="<?php echo IFRAME_URL."".JOKER1_CODE;?>" width="100%" height="250px"
                            ...
                            ?>
                               ...
                               <iframe src="<?php echo IFRAME_URL."".JOKER1_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                ...
                                <div class="casino-last-result-title"><span>Last Result</span><span><a
                                            href="casinoresults?game_type=joker1">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?176' defer></script>
