...
?>
   ...
   <div id="bhav" class="tab-pane active">
      ...
      <div class="casino-video">
         <div class="video-box-container">
			...
			<?php 
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".QUEEN_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
		...
		<!--	<iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
				 <iframe src="<?php echo IFRAME_URL."".QUEEN_CODE;?>" width="100%" height="200" style="border: 0px;"></iframe> -->
			</div>
         </div>
		...
		<div class="casino-table">
			<div class="casino-table-box">
				<div class="casino-odd-box-container">
					...
					<div class="casino-odds-box back suspended market_1_row market_1_b_btn back-1"><span class="casino-odds">0</span></div>
					<div class="casino-odds-box lay suspended market_1_row market_1_l_btn lay-1"><span class="casino-odds">0</span></div>
					<div class="casino-nation-book  market_1_b_exposure market_exposure"></div>
				</div>
				<div class="casino-odd-box-container">
					<div class="casino-nation-name">Total 1</div>
					<div class="casino-odds-box back suspended market_2_row market_2_b_btn back-1"><span class="casino-odds">1.32</span></div>
					<div class="casino-odds-box lay suspended market_2_row market_2_l_btn lay-1"><span class="casino-odds">1.35</span></div>
					<div class="casino-nation-book market_2_b_exposure market_exposure"></div>
				</div>
				<div class="casino-odd-box-container">
					<div class="casino-nation-name">Total 2</div>
					<div class="casino-odds-box back suspended market_3_row market_3_b_btn back-1"><span class="casino-odds">6.42</span></div>
					<div class="casino-odds-box lay suspended market_3_row market_3_l_btn lay-1"><span class="casino-odds">6.92</span></div>
					<div class="casino-nation-book market_3_b_exposure market_exposure"></div>
				</div>
				<div class="casino-odd-box-container">
					<div class="casino-nation-name">Total 3</div>
					<div class="casino-odds-box back suspended market_4_row market_4_b_btn back-1"><span class="casino-odds">9.73</span></div>
					<div class="casino-odds-box lay suspended market_4_row market_4_l_btn lay-1"><span class="casino-odds">10.63</span></div>
...
<script type="text/javascript" src='footer-js.js?1' defer></script>
<?
