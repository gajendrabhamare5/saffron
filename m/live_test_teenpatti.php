                                ...
                                <div class="video-overlay">
                                    <div>
                                        <div>
                                            ...
                                            <div>
                                            	<img id="card_c1" src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c4" src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c7"  src="/storage/mobile/img/cards_new/1.png">
                                            </div>
                                        </div>
                                        <div>
                                            <h3 class="text-white">Lion</h3>
                                            <div>
                                            	<img id="card_c2"  src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c5"  src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c8"  src="/storage/mobile/img/cards_new/1.png">
                                            </div>
                                        </div>
                                        <div>
                                            <h3 class="text-white">Dragon</h3>
                                            <div>
                                            	<img id="card_c3" src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c6" src="/storage/mobile/img/cards_new/1.png">
                                            	<img id="card_c9" src="/storage/mobile/img/cards_new/1.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src='footer-js.js?55' defer></script>
...
?>
 ...
 <script type="text/javascript">
	...
	function updateResult(data) {
		console.log("updateResult1",data);
