...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Lucky 6</span><span class="d-block"><a href="#" onclick="view_rules('lucky5')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".LUCKY5_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
						 ...
						 <!--	<iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                               <iframe src="<?php echo IFRAME_URL; echo LUCKY5_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
							   <div class="casino-table">
                                  <div class="casino-table-full-box">
                                        ...
                                        <div class="lucky7"><img src="/storage/front/img/andar_bahar/6.jpg"></div>
                                    ...
                                    <div class="casino-table-full-box lucky7acards mt-3">
                                        ...
                                        <div class="card-odd-box">
                                            <div class="market_7_row back-1 market_7_b_btn"><img src="/storage/front/img/andar_bahar/1.jpg"></div>
                                            <div class="casino-nation-book market_7_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_8_row back-1 market_8_b_btn"><img src="/storage/front/img/andar_bahar/2.jpg"></div>
                                            <div class="casino-nation-book market_8_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_9_row back-1 market_9_b_btn"><img src="/storage/front/img/andar_bahar/3.jpg"></div>
                                            <div class="casino-nation-book market_9_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_10_row back-1 market_10_b_btn"><img src="/storage/front/img/andar_bahar/4.jpg"></div>
                                            <div class="casino-nation-book market_10_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_11_row back-1 market_11_b_btn"><img src="/storage/front/img/andar_bahar/5.jpg"></div>
                                            <div class="casino-nation-book market_11_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_12_row back-1 market_12_b_btn"><img src="/storage/front/img/andar_bahar/6.jpg"></div>
                                            <div class="casino-nation-book market_12_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_13_row back-1 market_13_b_btn"><img src="/storage/front/img/andar_bahar/7.jpg"></div>
                                            <div class="casino-nation-book market_13_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_14_row back-1 market_14_b_btn"><img src="/storage/front/img/andar_bahar/8.jpg"></div>
                                            <div class="casino-nation-book market_14_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_15_row back-1 market_15_b_btn"><img src="/storage/front/img/andar_bahar/9.jpg"></div>
                                            <div class="casino-nation-book market_15_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_16_row back-1 market_16_b_btn"><img src="/storage/front/img/andar_bahar/10.jpg"></div>
                                            <div class="casino-nation-book market_16_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_17_row back-1 market_17_b_btn"><img src="/storage/front/img/andar_bahar/11.jpg"></div>
                                            <div class="casino-nation-book market_17_b_exposure market_exposure"></div>
                                        </div>
                                        <!-- <div class="card-odd-box">
                                            <div class="market_18_row back-1 market_18_b_btn"><img src="/storage/front/img/andar_bahar/12.jpg"></div>
                                            <div class="casino-nation-book market_18_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="card-odd-box">
                                            <div class="market_19_row back-1 market_19_b_btn"><img src="/storage/front/img/andar_bahar/13.jpg"></div>
                                            <div class="casino-nation-book market_19_b_exposure market_exposure"></div>
                                        </div> -->
                                    </div>
                               </div>
							   <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=lucky5">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?107' defer></script>
