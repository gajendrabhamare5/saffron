...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">AUS vs IND 5Five Cricket</span></div>
                      <?php
   ...
   <div id="bhav" class="tab-pane active">
      ...
      <div class="casino-video">
         ...
         <div class="video-overlay">
            ...
            <div><img id="card_c2" src="../storage/front/img/cards/1.png"></div>
            <div><img id="card_c3" src="../storage/front/img/cards/1.png"></div>
            <div><img id="card_c4" src="../storage/front/img/cards/1.png"></div>
            <div><img id="card_c5" src="../storage/front/img/cards/1.png"></div>
            <div><img id="card_c6" src="../storage/front/img/cards/1.png"></div>
         </div>
      </div>
      ...
      <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=cricketv3" class="">View All</a></span></div>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_five_cricket_v2.php',
				 dataType: 'json',
