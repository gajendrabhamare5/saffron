...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">1 CARD ONE-DAY</span><span class="d-block"><a href="#" onclick="view_rules('teen1')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN1_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                          ...
                          <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                <iframe src="<?php echo IFRAME_URL; echo TEEN1_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-container teenpatti-1day">
                                <div class="table-responsive mb-1">
                                    <table class="table table-bordered mb-0" style="    border-left: 1px solid #c7c8ca;border-right: 1px solid #c7c8ca;border-top: 1px solid #c7c8ca;">
                                        <!-- <thead>
                                            <tr>
                                                <th class="box-6">Min:100 Max:500000</th>
                                                <th class="box-2 text-center back">BACK</th>
                                                <th class="box-2 text-center lay">LAY</th>
                                            </tr>
                                        </thead> -->
                                        <tbody>
                                            <tr data-title="SUSPENDED" class="markets">
                                                <td class="box-6"><b>Player</b><div class="casino-nation-book market_1_b_exposure market_exposure"></div></td>
                                                <td class="box-2 back text-center back-1 market_1_b_btn market_1_row"><span class="odds d-block value_b_1"><b>82</b></span></td>
                                                <td class="box-2 lay text-center lay-1 market_1_l_btn market_1_row"><span class="odds d-block value_l_1"><b>86</b></span></td>
                                            </tr>
                                            <tr data-title="SUSPENDED" class="markets">
                                                <td class="box-6"><b>Dealer</b><div class="casino-nation-book market_2_b_exposure market_exposure"></div></td>
                                                <td class="box-2 back text-center back-1 market_2_b_btn market_2_row"><span class="odds d-block value_b_2"><b>0</b></span></td>
                                                <td class="box-2 lay text-center lay-1 market_2_l_btn market_2_row"><span class="odds d-block value_l_2"><b>0</b></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="casino-table-box mt-3 sevenupbox">
                                    <div class="casino-table-left-box">
                                        ...
                                        <div class="seven-up-down-box">
                                            <div class="up-box market_4_b_btn market_4_row suspended">
                                                <div class="up-down-book"><div class="casino-nation-book market_4_b_exposure market_exposure"></div></div>
                                                <div class="text-end">
                                                <div class="up-down-odds value_b_4">0</div>
                                                <span>DOWN</span>
                                                </div>
                                            </div>
                                            <div class="down-box market_3_b_btn market_3_row suspended">
                                                <div class="up-down-book"><div class="casino-nation-book market_3_b_exposure market_exposure"></div></div>
                                    ...
                                    <div class="casino-table-right-box">
                                        ...
                                        <div class="seven-up-down-box">
                                            <div class="up-box market_6_b_btn market_6_row">
                                                <div class="up-down-book"><div class="casino-nation-book market_6_b_exposure market_exposure"></div></div>
                                                <div class="text-end">
                                                <div class="up-down-odds value_b_6">0</div>
                                                <span>DOWN</span>
                                                </div>
                                            </div>
                                            <div class="down-box market_5_b_btn market_5_row">
                                                <div class="up-down-book"><div class="casino-nation-book market_5_b_exposure market_exposure"></div></div>
                                                <div class="text-start">
                                ...
                                <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teen1">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?15' defer></script>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_teen1.php',
				 dataType: 'json',
