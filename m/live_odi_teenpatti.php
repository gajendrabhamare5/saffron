...
.casino-table-box .suspended::after,.casino-table-box .suspended::before {
		width: 40% !important;
	}
</style>
...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Teenpatti 1-day</span><span class="d-block"><a href="#" onclick="view_rules('odi_teenpatti')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".ODITEENPATTI_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
							...
							<!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL; echo ODITEENPATTI_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
							      ...
							      <div class="casino-table-box">
							         <div class="casino-table-left-box">
							            ...
							            <div class="casino-table-body">
							               <div class="casino-table-row suspended  market_1_row">
							               ...
							               <div class="casino-table-row suspended  market_17_row">
							                  <div class="casino-nation-detail">
							                     <div class="casino-nation-name">Consecutive</div> <p class="mb-0"><span style="color: black;" class="market_17_b_exposure market_exposure">0</span> </p>
							                  </div>
							         ...
							         <div class="casino-table-right-box">
							            ...
							            <div class="casino-table-body">
							               <div class="casino-table-row suspended  market_2_row">
							                  <div class="casino-nation-detail">
							                     <div class="casino-nation-name">Main</div> <p class="mb-0"><span style="color: black;" class="market_2_b_exposure market_exposure">0</span> </p>
							                  </div>
							                  <div class="casino-odds-box back back-1 market_2_b_btn"><span class="casino-odds market_2_b_val">0</span></div>
							                  <div class="casino-odds-box lay lay-1 market_2_l_btn"><span class="casino-odds market_2_l_val">0</span></div>
							               </div>
							               <div class="casino-table-row suspended  market_18_row">
							                  <div class="casino-nation-detail">
							                     <div class="casino-nation-name">Consecutive</div> <p class="mb-0"><span style="color: black;" class="market_18_b_exposure market_exposure">0</span> </p>
							                  </div>
							      ...
							      <div class="casino-table-full-box teenpatti1day-other-odds mt-3">
							         ...
							         <div class="casino-table-body">
							            <div class="casino-table-row">
							               ...
							               <div class="casino-odds-box back market_11_row suspended back-1 market_11_1_b_btn"><span class="casino-odds market_11_1_b_val">0</span><div class="casino-nation-book market_11_1_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_12_row suspended back-1 market_12_1_b_btn"><span class="casino-odds market_12_1_b_val">0</span><div class="casino-nation-book market_12_1_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_13_row suspended back-1 market_13_1_b_btn"><span class="casino-odds market_13_1_b_val">0</span><div class="casino-nation-book market_13_1_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_14_row suspended back-1 market_14_1_b_btn"><span class="casino-odds market_14_1_b_val">0</span><div class="casino-nation-book market_14_1_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_15_row suspended back-1 market_15_1_b_btn"><span class="casino-odds market_15_1_b_val">0</span><div class="casino-nation-book market_15_1_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_16_row suspended back-1 market_16_1_b_btn"><span class="casino-odds market_16_1_b_val">1.85</span><div class="casino-nation-book market_16_1_b_exposure market_exposure text-center"></div></div>
							            </div>
							            <div class="casino-table-row">
							               <div class="casino-nation-detail">
							                  <div class="casino-nation-name">Even</div>
							               </div>
							               <div class="casino-odds-box back market_11_row suspended back-1 market_11_2_b_btn"><span class="casino-odds market_11_2_b_val">0</span><div class="casino-nation-book market_11_2_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_12_row suspended back-1 market_12_2_b_btn"><span class="casino-odds market_12_2_b_val">0</span><div class="casino-nation-book market_12_2_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_13_row suspended back-1 market_13_2_b_btn"><span class="casino-odds market_13_2_b_val">0</span><div class="casino-nation-book market_13_2_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_14_row suspended back-1 market_14_2_b_btn"><span class="casino-odds market_14_2_b_val">0</span><div class="casino-nation-book market_14_2_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_15_row suspended back-1 market_15_2_b_btn"><span class="casino-odds market_15_2_b_val">0</span><div class="casino-nation-book market_15_2_b_exposure market_exposure text-center"></div></div>
							               <div class="casino-odds-box back market_16_row suspended back-1 market_16_2_b_btn"><span class="casino-odds market_16_2_b_val">2.1</span><div class="casino-nation-book market_16_2_b_exposure market_exposure text-center"></div></div>
							            </div>
							         </div>
							      </div>
							   </div>
							   <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teen">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?57' defer></script>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_teenpatti_odi.php',
				 dataType: 'json',
                       ...
                       <!--  <div class="row row5 mt-2">
                        ...
                        <div class="mt-1 place-bet-btn-box">
                            ...
                            <button class="btn btn-success placeBet" id="placeBet" disabled>Place Bet</button>
								...
								<div class="mt-1 d-flex"><span>Range: 100 to 100L</span></div>
                </div>
            </div>
            <!---->
        </div>
