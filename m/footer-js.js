                ...
                if (open_bet_data) {
                    ...
                    for (i = 0; i < open_bet_data.length; i++) {
                        ...
                        if(open_bet_data[i].joker_card && open_bet_data[i].joker_card.length > 0){
                            ...
                            console.log("oldGameId=",oldGameId);
                        ...
                        if(event_name == "TEENUNIQUE"){ 
                            ...
                            cards_dis = `<tr class="open_bet"><td colspan="3"><div class="unique-your-card">
                                <span>
                                    <h4>Your Card</h4>
                                    <span>
                                        ${your_cards}
...
$(document).ready(function() {
    ...
    $('#btn_exposure_popup1').on('click', function() {
        console.log("called...");
...
<div class="rules-section">
        ...
        image_url = `<div><style type="text/css">
...
<div class="rules-section">
        ...
        image_url = `<div class="rules-section">
                                                        <div>
                                                            <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/superover.jpg" class="img-fluid">
                                                        </div>
                                                    </div>`;
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/cmeter.jpg" class="img-fluid">
                                            </div>
                                        </div>
                                        <div><div class="rules-section">
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/cricketv3.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/war.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
...
<div class="rules-section">
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/dt202.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
    } else if(gametype == 'dtl20') {
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/dt6.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/poker6.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
...
<li>This casino operates similarly to Sicbo, with the key difference being that each round alternates between two Sicbo machines. For example, the first round will start on the first machine, the second round on the second machine, and this alternating pattern will continue throughout the game.</li>
    ...
    }else if(gametype == "goal2") {
        ruletitle = "Goal 2 Rules";
        image_url = `<div>
                                        <div class="rules-section">
                                            <h6 class="rules-highlight">1. Objective</h6>
                                            <p>The goal of this game is to predict which player or method will result in the next goal, providing players with exciting opportunities to win big.</p>
                                        ...
                                        <div><div class="rules-section">
                                            <h6 class="rules-highlight">C. Method Of Combination Goal</h6>
                                            <h6 class="rules-sub-highlight">Description</h6>
                                            <p>Predict the player who will score the next goal and the method by which the goal will be scored.</p>
                                            <p>Examples:</p>
                                            <ul class="pl-2 pr-2 ">
                                            ...
                                            <h6 class="rules-sub-highlight">Winning Criteria</h6>
                                            <p>Both selections must be correct:</p>
                                            <ul class="pl-2 pr-2">
                                                <li>1. The selected player must score the next goal; and</li>
                                                <li>2. The goal must be scored by the selected method.</li>
                                            </ul>
                                        </div></div>
                                        <div><div class="rules-section">
                                            <h6 class="rules-highlight">Settlement Rules</h6>
                                            <ul class="pl-2 pr-2">
                                                <li>* If the selected player scores the next goal using the selected method, the bet wins.</li>
                                                <li>* If the selected player scores but by a different method, the bet loses.</li>
                                                <li>* If a different player scores using the selected method, the bet loses.</li>
                                                <li>* If a different player scores by a different method, the bet loses.</li>
                                            </ul>
                                        </div></div>
                                        </div>`;
...
<li>A = (One run) X 3 cards</li>
        ...
        image_url = `<div class="rules-section">
                                            <div>
                                                <img src="https://sitethemedata.com/v3/static/front/img/casino-rules/race20.jpg" class="img-fluid">
                                            </div>
                                        </div>`;
        ...
        image_url = `<div class="rules-section">
                                                ...
                                                <p>For Example:</p>
                                                <img src="/storage/front/img/cards_new/joker1.jpg" class="img-fluid">
                                                <p>Player A wins because THE JOKER can act as the highest card.</p>
                                                <img src="/storage/front/img/cards_new/joker2.jpg" class="img-fluid">
         ...
         ruletitle = "Unlimited Joker 20-20 Rules";
         image_url = `<div class="rules-section">        
         ...
         ruletitle = "Teenpatti Poison 20-20 Rules";
         image_url = `<div class="rules-section">        
         ...
         ruletitle = "Teenpatti Poison One Day Rules";
         image_url = `<div class="rules-section">
