...
.poker1day-other-odds .casino-table-left-box, .poker1day-other-odds .casino-table-right-box {
    display: flex
;
    flex-wrap: wrap;
    justify-content: space-between;
...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Poker 1-Day</span><span class="d-block"><a href="#" onclick="view_rules('1day_poker')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".ODIPOKER_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                               ...
                               <div class="casino-table">
                                     ...
                                     <div class="casino-table-left-box">
                                        <div class="casino-table-body">
                                           <div class="casino-table-row ">
                                              ...
                                              <div class="casino-odds-box back market_1_row back-1 market_1_b_btn"><span class="casino-odds market_1_b_value">0</span></div>
                                              <div class="casino-odds-box lay market_1_row lay-1 market_1_l_btn"><span class="casino-odds market_1_l_value">0</span></div>
                                           </div>
                                        </div>
                                     </div>
                                  ...
                                  <div class="poker1day-other-odds">
                                     <div class="casino-table-left-box">
                                        ...
                                        <div class="casino-odds-box back suspended back-1 market_3_b_btn market_3_row">
											<span class="casino-odds">2 Cards Bonus</span>
											<div class="casino-nation-book market_3_b_exposure market_exposure"></div>
										</div>
                                        <div class="casino-odds-box back suspended back-1 market_4_b_btn market_4_row">
                                     ...
                                     <div class="casino-table-right-box">
                                        ...
                                        <div class="casino-odds-box back suspended back-1 market_5_b_btn market_5_row">
											<span class="casino-odds">2 Cards Bonus</span>
											<div class="casino-nation-book market_5_b_exposure market_exposure"></div>
										</div>
                                        <div class="casino-odds-box back suspended back-1 market_6_b_btn market_6_row">
											<span class="casino-odds">7 Cards Bonus</span>
                                  ...
                                  <div class="w-100 mt-1">
                                     <marquee scrollamount="3" class="casino-remark">Play &amp; Win </marquee>
                                  </div>
                               </div>
                               <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=poker">View All</a></span></div>
                               <div class="casino-last-results" id="last-result">
								</div>
                               <div class="sidebar-box my-bet-container mt-2 d-xl-none">
                                  <div class="sidebar-title">
                                     <span style="font-size: initial;">Rules</span>
                                  </div>
                                  <div class="">
                                     <div class="table-responsive">
                                        <table class="table table-bordered">
                                           <thead>
                                              <tr>
                                                 <th colspan="2" class="text-center">Bonus 1 (2 Cards Bonus)</th>
                                              </tr>
                                           </thead>
                                           <tbody>
                                              <tr>
                                     ...
                                     <div class="table-responsive">
                                        <table class="table table-bordered">
                                           <thead>
                                              <tr>
                                                 <th colspan="2" class="text-center">Bonus 2 (7 Cards Bonus)</th>
                                              </tr>
                                           </thead>
                                           <tbody>
                                              <tr>
...
<script type="text/javascript" src='footer-js.js?53' defer></script>
