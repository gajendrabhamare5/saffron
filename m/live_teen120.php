...
<style>
    ...
    .onecard20player, .onecard20dealer, .onecard20pair {
        width: calc(29% - 15px);
    }
...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">1 CARD 20-20</span>
                            <span class="d-block"><a href="#" onclick="view_rules('teen120')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN120_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                          ...
                          <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL."".TEEN120_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                                ...
                                <div class="video-overlay">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div><img id="card_c2" src="../storage/front/img/cards_new/1.png"> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="casino-detail">
                                <div class="casino-table">
                                    <div class="casino-table-full-box">
                                        <div class="onecard20oddbox onecard20player">
                                            <div class="casino-odds text-center market_1_row">0</div>
                                            <div class="casino-odds-box back casino-odds-box-theme back-1 market_1_b_btn"><span class="casino-odds">Player</span></div>
                                            <div class="casino-nation-book text-center market_1_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="onecard20oddbox onecard20tie">
                                            <div class="casino-odds text-center market_3_row">0</div>
                                            <div class="casino-odds-box back casino-odds-box-theme back-1 market_3_b_btn"><span class="casino-odds">Tie</span></div>
                                            <div class="casino-nation-book text-center market_3_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="onecard20oddbox onecard20dealer">
                                            <div class="casino-odds text-center market_2_row">0</div>
                                            <div class="casino-odds-box back casino-odds-box-theme back-1 market_2_b_btn"><span class="casino-odds">Dealer</span></div>
                                            <div class="casino-nation-book text-center market_2_b_exposure market_exposure"></div>
                                        </div>
                                        <div class="onecard20oddbox onecard20pair">
                                            <div class="casino-odds text-center market_4_row">0</div>
                                            <div class="casino-odds-box back casino-odds-box-theme back-1 market_4_b_btn"><span class="casino-odds">Pair</span></div>
                                            <div class="casino-nation-book text-center market_4_b_exposure market_exposure"></div>
                                        </div>
                                    </div>
                                </div>

                                <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teen120">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?16' defer></script>
<?
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
	...
	jQuery(document).on("click", "#placeBet", function () {
		...
		setTimeout(function () {
			$.ajax({
				type: 'POST',
				url: '../ajaxfiles/bet_place_teen120.php',
				dataType: 'json',
				data: {
