    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Ball by Ball</span><span class="d-block"><a href="#" onclick="view_rules('ballbyball')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".BALLBYBALL_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                                                        ...
                                                        <div class="col-12">
                                                            <div class="fancy-market">
                                                                <div class="market-row">
                                                                    ...
                                                                    <small class="box-2 float-center text-right" style="display: flex;">
                                                                        <span class="w-100 pr-2 min-max market_<? echo $val; ?>_min_max">
                                ...
                                <div class="remark text-right pr-2">
                                    <!---->
                                                    ...
                                                    <div class="casino-remark mt-1">
                                                        ...
                                                        <marquee scrollamount="3" class="casino-remark1">Results are based on stream only. Score board may be different or updated later.</marquee>
                                                    </div>
    ...
    function updateResult(data) {
        if (data && data[0]) {
            ...
            data.forEach((runData) => {
                ...
                html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type + ')"  class="last-result ml-1  ' + ab + ' last-result"><b>' + ab1 + '</b></span>';
                ...
                <div class="place-bet1 pt-2 pb-2 back place-bet-modal" id="popup_color">
                       ...
                       <!--  <div class="row row5 mt-2">
                        ...
                        <div class="mt-1 place-bet-btn-box">
                            ...
                            <div class="mt-1 d-flex"><span>Range: 50 to 25K</span></div>
                </div>
            </div>
            <!---->
        </div>
