...
<style>
    ...
    .joker-other-odds .casino-nation-detail, .joker-other-odds .casino-odds-box {
        width: 20%;
    }
...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Teenpatti Joker</span><span class="d-block"><a href="#" onclick="view_rules('teenjoker')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
...
?>
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            ?>
                           <!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL."".TEENJOKER_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                    ...
                                    <div class="casino-table-box">
                                        <div class="casino-table-left-box">
                                            ...
                                            <div class="casino-table-row ">
                                                ...
                                                <div class="casino-odds-box back suspended market_1_row back-1 market_1_b_btn"><span class="casino-odds market_1_b_val">0</span></div>
                                                <div class="casino-odds-box lay suspended market_1_row lay-1 market_1_l_btn"><span class="casino-odds market_1_l_val">0</span></div>
                                            </div>
                                            <div class="casino-table-row">
                                                <div class="casino-nation-detail">
                                                ...
                                                <div class="casino-odds-box back market_2_row suspended back-1 market_2_b_btn"><span class="casino-odds market_2_b_val">0</span></div>
                                                <div class="casino-odds-box lay market_2_row suspended lay-1 market_2_l_btn"><span class="casino-odds market_2_l_val">0</span></div>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="casino-table-right-box joker-other-odds">
                                            <div class="joker-other-odds">
                                            <div class="casino-table-header">
                                                <div class="casino-nation-detail"></div>
                                                <div class="casino-odds-box ">Even</div>
                                                <div class="casino-odds-box ">Odd</div>
                                                <div class="casino-odds-box "><span>Red</span><span class="card-icon ms-1"><span class="card-red ">{</span><span class="card-red ">[</span></span></div>
                                                <div class="casino-odds-box"><span>Black</span><span class="card-icon ms-1"><span class="card-black ">}</span><span class="card-black ">]</span></span></div>
                                            </div>
                                            <div class="casino-table-body">
                                                <div class="casino-table-row">
                                                    <div class="casino-nation-detail">
                                                    ...
                                                    <div class="casino-odds-box back suspended market_3_row back-1 market_3_b_btn"><span class="casino-odds market_3_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended market_4_row back-1 market_4_b_btn"><span class="casino-odds market_4_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended market_5_row back-1 market_5_b_btn"><span class="casino-odds market_5_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended market_6_row back-1 market_6_b_btn"><span class="casino-odds market_6_b_val">0</span></div>
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="casino-table-body">
                                                <div class="casino-table-row ">
                                                    ...
                                                    <div class="casino-odds-box back suspended market_7_row back-1 market_7_b_btn"><span class="casino-odds market_7_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended market_8_row back-1 market_8_b_btn"><span class="casino-odds market_8_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended back-1 market_9_row market_9_b_btn"><span class="casino-odds market_9_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended back-1 market_10_row market_10_b_btn"><span class="casino-odds market_10_b_val">0</span></div>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                ...
                                <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teenjoker">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?201' defer></script>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function () {
        ...
        setTimeout(function () {
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_teenjoker.php',
                dataType: 'json',
                data: {
