...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">20-20 Teenpatti B</span><span class="d-block"><a href="#" onclick="view_rules('teen20b')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
...
?>
			...
			<?php 
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN20B_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                            <!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe> -->
                                <!-- <iframe src="<?php echo IFRAME_URL."".TEEN20B_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                    ...
                                    <div class="casino-table-box">
                                        <div class="casino-table-left-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                <div class="casino-odds-box back back-1 market_1_row market_1_b_btn suspended"><span class="casino-odds market_1_b_val">1.98</span><div class="casino-nation-book market_1_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_5_row market_5_b_btn suspended"><span class="casino-odds market_5_b_val">1.98</span><div class="casino-nation-book market_5_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_11_row market_11_b_btn suspended"><span class="casino-odds market_11_b_val">2</span><div class="casino-nation-book market_11_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_3_row market_3_b_btn suspended"><span class="casino-odds">A</span><div class="casino-nation-book market_3_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-left-box">
                                                ...
                                                <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                <div class=""><span class="casino-odds market_7_b_val">1.98</span><div class="casino-nation-book market_7_b_exposure market_exposure"></div></div>
                                                </div>
                                                <div class="casino-odds-box back back-1 market_8_row market_8_b_btn">
                                                <div><img src="../storage/front/img/cards/heart.png"><img src="../storage/front/img/cards/diamond.png"></div>
                                                <div class=""><span class="casino-odds market_8_b_val">1.98</span><div class="casino-nation-book market_8_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="casino-table-right-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                <div class="casino-odds-box back back-1 market_2_row market_2_b_btn suspended"><span class="casino-odds market_2_b_val">1.98</span><div class="casino-nation-book market_2_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_6_row market_6_b_btn suspended"><span class="casino-odds market_6_b_val">1.98</span><div class="casino-nation-book market_6_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_12_row market_12_b_btn suspended"><span class="casino-odds market_12_b_val">2</span><div class="casino-nation-book market_12_b_exposure market_exposure"></div></div>
                                                <div class="casino-odds-box back back-1 market_4_row market_4_b_btn suspended"><span class="casino-odds">B</span><div class="casino-nation-book market_4_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-right-box">
                                                ...
                                                <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                <div class=""><span class="casino-odds market_9_b_val">1.98</span><div class="casino-nation-book market_9_b_exposure market_exposure"></div></div>
                                                </div>
                                                <div class="casino-odds-box back back-1 market_10_row market_10_b_btn">
                                                <div><img src="../storage/front/img/cards/heart.png"><img src="../storage/front/img/cards/diamond.png"></div>
                                                <div class=""><span class="casino-odds market_10_b_val">1.98</span><div class="casino-nation-book market_10_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=teen20b" class="">View All</a></span></div>
                                ...
                                <div class="table-responsive rules-table">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Straight Flush </td>
...
<script type="text/javascript" src="../storage/front/js/flipclock.js"></script>
<script type="text/javascript" src="../js/bootstrap.min.js"></script>
<script type="text/javascript" src="footer-js.js?20" defer></script>

<?php include("betpopcss.php"); ?>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
	...
	jQuery(document).on("click", "#placeBet", function () {
		...
		setTimeout(function () {
			$.ajax({
				type: 'POST',
				url: '../ajaxfiles/bet_place_teenpatti_20b.php',
				dataType: 'json',
				data: {
