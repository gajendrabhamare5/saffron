	...
	<div id="app">
		...
		<div>
			...
			<div class="main-content">
				...
				<!---->
				<div>
					<div class="casino-title"><span class="casino-name">Teenpatti Open</span><span class="d-block"><a href="#" onclick="view_rules('open_teenpatti')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
					...
					<div class="tab-content">
						<div id="bhav" class="tab-pane active">
							...
							<div class="casino-video">
								...
								?>
									<iframe src="<?php echo IFRAME_URL . "" . OPENTEENPATTI_CODE; ?>" width="100%" height="250px" style="border: 0px;"></iframe>
								<?php
...
<script type="text/javascript" src='footer-js.js?54' defer></script>
