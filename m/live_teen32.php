...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">Instant Teenpatti 2.0</span><span class="d-block"><a href="#" onclick="view_rules('teen32')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN32_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
							...
							<!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL; echo TEEN32_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                                     ...
                                     <div class="casino-table-left-box">
                                        ...
                                        <div class="casino-table-body">
                                           <div class="casino-table-row  market_1_row">
                                              ...
                                              <div class="casino-odds-box back back-1 market_1_b_btn"><span class="casino-odds">1.92</span></div>
                                              <div class="casino-odds-box lay lay-1 market_1_l_btn"><span class="casino-odds">1.95</span></div>
                                           </div>
                                        </div>
                                     </div>
         ...
         <marquee scrollamount="3">
            <p class="mb-0">Play Our New Game Premium Teenpatti 1 Day</p>
         </marquee>
		 </div>
                               <div class="casino-last-result-title">
								<span>Last Result</span>
								<span><a href="casinoresults?game_type=teen32">View All</a></span>
							</div>
