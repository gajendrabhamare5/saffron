		...
		<script type="text/javascript">
			...
			function goLogin(){
				...
				if(username=="" || password==""){
					...
					$("#errorMsgText").text("Please Enter Email and Password");
					...
					$.ajax({
						...
						success: function(response_data) { 
							...
							if(response=="NA"){
								...
								$("#bet-error-class").addClass("b-toast-danger");
								$("#errorMsgText").text("Account is not activated!");
								$("#errorMsg").fadeIn('fast').delay(3000).hide(0);							
							}
							else if(response=="0"){
								$('#logi').html("Login <i class='ml-2 fas fa-sign-in-alt'></i>");	
								$('#logi').attr("disabled",false);
								$("#bet-error-class").addClass("b-toast-danger");
								$("#errorMsgText").text("The password is incorrect or your password updated please ask new password for your agent");
								$("#errorMsg").fadeIn('fast').delay(3000).hide(0);																	
							}
								...
								$('#logi').attr("disabled", false);
								$("#bet-error-class").addClass("b-toast-danger");
								$("#errorMsgText").text(response_data.msg);
								$("#errorMsg").fadeIn('fast').delay(3000).hide(0);	
							}
								...
								$('#logi').attr("disabled",false);	
								$("#bet-error-class").addClass("b-toast-danger");
								$("#errorMsgText").text("Please verify your email from your inbox or spam. </br> <a href='email_resend.php?"+email+"' style='color:blue'>Resend Mail</a>");
								$("#errorMsg").fadeIn('fast').delay(3000).hide(0);																
		...
		<div id="app">
			<div id="load" style="">
				<div id="load-inner" class="logo-login">
					<img src="<? echo WEB_URL .$logo ?>" class="img-fluid logo">
					<i class="fa fa-spinner fa-spin"></i>
				</div>
			</div>
			<div class="login-wrapper">
				<div class="text-center logo-login mb-3" style="margin: 2% 0;">
					<img src="<? echo WEB_URL .$logo ?>">
				</div>
				<div class="login-form">
					<h4 class="text-center">Login <i class="fas fa-hand-point-down"></i></h4>
					<div role="alert" class="alert alert-danger" id="errortext" style="display:none;">
					</div>
