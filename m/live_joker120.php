...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                    <div class="casino-title"><span class="casino-name">Unlimited Joker 20-20</span><span
                            class="d-block"><a href="#" onclick="view_rules('joker120')" data-target="#rules_popup"
                                data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span>
                    </div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                                <iframe src="<?php echo IFRAME_URL."".JOKER120_CODE;?>" width="100%" height="250px"
                            ...
                            ?>
                               ...
                               <iframe src="<?php echo IFRAME_URL."".JOKER120_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                ...
                                <div class="casino-table">
                                    <div class=" mt-1 teen2cards">
                                        <div class="joker1-other-cards">
                                            <h4 class="w-100 text-center mb-2" style="color:white"><b>Select your
                                                    Joker</b></h4>
                                        </div>
                                    <div class="casino-table-full-box aaacards">
                                    ...
                                    <div class="casino-table-box">
                                        <div class="casino-odd-box-container">
                                            <div class="casino-nation-name">
                                                Player A
                                                <div
                                                    class="casino-nation-book d-md-none market_14_b_exposure market_exposure">
                                                </div>
                                            </div>
                                            <div
                                                class="casino-odds-box back back-1 market_14_b_btn market_14_row">
                                                <span class="casino-odds">0</span>
                                            </div>
                                            <div
                                                class="casino-odds-box lay lay-1 market_14_l_btn market_14_row">
                                                <span class="casino-odds">0</span>
                                            </div>
                                        </div>
                                        <div class="casino-odd-box-container">
                                            <div class="casino-nation-name">
                                                Player B
                                                <div
                                                    class="casino-nation-book d-md-none market_140_b_exposure market_exposure">
                                                </div>
                                            </div>
                                            <div
                                                class="casino-odds-box back market_140_row back-1 market_140_b_btn">
                                                <span class="casino-odds">0</span>
                                            </div>
                                            <div
                                                class="casino-odds-box lay market_140_row lay-1 market_140_l_btn">
                                                <span class="casino-odds">0</span>
                                            </div>
                                ...
                                <div class="casino-last-result-title"><span>Last Result</span><span><a
                                            href="casinoresults?game_type=joker120">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?172' defer></script>
    ...
    if (data && data[0]) {
        ...
        data.forEach((runData) => {
            ...
            html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type +
                ')"  class="ball-runs result-b result">R</span>';
        });
...
jQuery(document).on("click", "#placeBet", function() {
    ...
    setTimeout(function() {
        $.ajax({
            type: 'POST',
            url: '../ajaxfiles/bet_place_joker120.php',
            dataType: 'json',
            data: {
            ...
            <div id="__BVID__30___BV_modal_body_" class="modal-body" style="    padding: 0px;">
                <div class="place-bet1 pt-2 pb-2 back place-bet-modal" id="popup_color">
                    <div class="row row5">
                        ...
                        <div class="col-6 text-right pt-1 joker-card"><span><img class="joker-display" src="../storage/front/img/cards_new/14.png"></span></div>
                    </div>
                    <div class="odd-stake-box">
                        ...
                        <div class="row row5 mt-1">
                            <div class="col-6"><input type="text" id="odds_val" class="stakeinput w-100" disabled=""
                                    value="1.7"></div>
                            <div class="col-6">
                                <div class="float-right"><input type="number" id="inputStake" class="stakeinput w-100"
                                        value=""></div>
                                ...
                                <input type='hidden' id='bet_stake_side' value='' /><input type='hidden'
                                    ...
                                    value='' /><input type='hidden' id='bet_event_name' value='' /><input type='hidden'
                                    id='bet_market_name' value='' /><input type='hidden' id='bet_markettype'
                                    value='' /><input type='hidden' id='fullfancymarketrate' value='' /> <input
                                    type='hidden' id='oddsmarketId' value='' /><input type='hidden'
                                    id='market_runner_name' value='' /><input type='hidden' id='market_odd_name'
                                    value='' />
                            </div>
                        </div>
                    </div>
