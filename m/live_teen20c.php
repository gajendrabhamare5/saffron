...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <div>
                <div class="casino-title"><span class="casino-name">20-20 Teenpatti C</span><span class="d-block"><a href="#" onclick="view_rules('teen20c')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEEN20C_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                          ...
                          <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL."".TEEN20C_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                    ...
                                    <div class="casino-table-box">
                                        <div class="casino-table-left-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                <div class="casino-odds-box back suspended market_1_row back-1 market_1_b_btn">
                                                    <span class="casino-odds market_1_b_value">1.98</span> 
                                                    <div class="casino-nation-book text-center market_1_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_5_row back-1 market_5_b_btn">
                                                ...
                                                <div class="casino-odds-box back suspended market_11_row back-1 market_11_b_btn">
                                                    <span class="casino-odds market_11_b_value">1.98</span> 
                                                    <div class="casino-nation-book text-center market_11_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_3_row back-1 market_3_b_btn">
                                        ...
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-left-box">
                                                <div class="casino-odds-box back suspended market_7_row back-1 market_7_b_btn">
                                                <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                <div><span class="casino-odds market_7_b_value">1.98</span><div class="casino-nation-book text-center market_7_b_exposure market_exposure"></div></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_8_row back-1 market_8_b_btn">
                                                <div><img src="../storage/front/img/cards/heart.png"><img src="../storage/front/img/cards/diamond.png"></div>
                                                <div><span class="casino-odds market_8_b_value">1.98</span><div class="casino-nation-book text-center market_8_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="casino-table-right-box">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                <div class="casino-odds-box back suspended market_2_row back-1 market_2_b_btn">
                                                    <span class="casino-odds market_2_b_value">1.98</span> 
                                                    <div class="casino-nation-book text-center market_2_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_6_row back-1 market_6_b_btn">
                                                    <span class="casino-odds market_6_b_value">1.98</span> 
                                                    <div class="casino-nation-book text-center market_6_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_12_row back-1 market_12_b_btn">
                                                    <span class="casino-odds market_12_b_value">1.98</span> 
                                                    <div class="casino-nation-book text-center market_12_b_exposure market_exposure"></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_4_row back-1 market_4_b_btn">
                                        ...
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-right-box">
                                                <div class="casino-odds-box back suspended market_9_row back-1 market_9_b_btn">
                                                <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                <div><span class="casino-odds market_9_b_value">1.98</span><div class="casino-nation-book text-center market_9_b_exposure market_exposure"></div></div>
                                                </div>
                                                <div class="casino-odds-box back suspended market_10_row back-1 market_10_b_btn">
                                                <div><img src="../storage/front/img/cards/heart.png"><img src="../storage/front/img/cards/diamond.png"></div>
                                                <div><span class="casino-odds market_10_b_value">1.98</span><div class="casino-nation-book text-center market_10_b_exposure market_exposure"></div></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=teen20c" class="">View All</a></span></div>
                                ...
                                <div class="sidebar-box my-bet-container mt-2 d-xl-none">
                                    <div class="sidebar-title last-result-tiele" style="height:30px;">
                                        <h4 style="font-size: 14px;font-waight:bold">Rules</h4>
                                    </div>
                                    <div class="">
...
<script type="text/javascript" src='footer-js.js?73' defer></script>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function () {
        ...
        setTimeout(function () {
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_teen20c.php',
                dataType: 'json',
                data: {
