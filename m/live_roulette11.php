                ...
                <div>
                    <div class="casino-title">
                        <div class="row row5">
                            ...
                            <span class="casino-name">Golden Roulette</span>
                            <span class="d-block"><a href="#" onclick="view_rules('roulette11')"
                                    data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1"
                                    role="button">Rules</a></span>
                        </div>
                            ...
                            <div class="position-relative">
                                    ...
                                    <div class="video-box-container">
                                        <div class="casino-video-box">
                                            ...
                                            if (!empty(IFRAME_URL_SET)) {
                                                ?>
                                                <iframe src="<?php echo IFRAME_URL . "" . ROULETTE11_CODE; ?>" width="100%"
                                                    height="250px" style="border: 0px;"></iframe>
                                                <?php
                                    ...
                                    <div class="casino-coins-container">
                                        <div class="casino-coin-box">
                                            ...
                                            foreach ($button_array as $button_value) {
                                                ...
                                                ?>
                                                <div class="casino-coin stackclick <? echo $active_class; ?>"
                                                    data-value="<? echo $button_value; ?>">
                                                    <div class="bet-chip-holder" style="--g-chip-inner-color: #138cf5;">
                                                        <div class="bet-chip">
                                                            ...
                                                            <div class="bet-chip-amount">
                                                                <svg class="bet-chip-amount-in"
                                                                    xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                    viewBox="0 0 108 108">
                                                                    <text class="bet-chip-amount-label" x="50%" y="53.5%"
                                                                        dominant-baseline="middle" text-anchor="middle"
                                                                        fill="#fff" font-size="32"
                                                                        font-weight="700"><?php echo $labelprint; ?></text>
                                                                </svg>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="coin-btns">
                                            <div class="undo_bet"><button class="btn btn-danger btnss" disabled><i
                                                        class="fas fa-undo"></i><span class="d-none d-md-flex">Undo
                                                        Bet</span></button><span class="d-md-none">Undo Bet</span></div>
                                            <div class="repeat_bet"><button class="btn btn-info"><i
                                                        class="fas fa-redo"></i><span
                                                        class="d-none d-md-flex">Repeat</span></button><span
                                                    class="d-md-none">Repeat</span></div>
                                            <div class="clear_bet"><button class="btn btn-warning btnss" disabled><i
                                                        class="fas fa-trash"></i><span
                                                        class="d-none d-md-flex">Clear</span></button><span
                                                    class="d-md-none">Clear</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="casino-detail">
                                                    ...
                                                    <div class="board-right">
                                                        <div class="board-cell yellow market_138_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_138_b_btn back-1"
                                                                    id="138"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_137_row suspended-box">
                                                            <div class="board-cell-in">
                                                                <span class="board-text">2to1</span>
                                                                <div class="bet-chip-area center-center coin-place market_137_b_btn back-1"
                                                                    id="137"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_136_row suspended-box">
                                                            <div class="board-cell-in">
                                                                <span class="board-text">2to1</span>
                                                                <div class="bet-chip-area center-center coin-place market_136_b_btn back-1"
                                                                    id="136"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="board-bottom">
                                                        <div class="board-cell yellow market_133_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_133_b_btn back-1"
                                                                    id="133"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_134_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_134_b_btn back-1"
                                                                    id="134"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_135_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_135_b_btn back-1"
                                                                    id="135"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_139_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_139_b_btn back-1"
                                                                    id="139"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_144_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_144_b_btn back-1"
                                                                    id="144"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_141_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_141_b_btn back-1"
                                                                    id="141"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_142_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_142_b_btn back-1"
                                                                    id="142"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_143_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_143_b_btn back-1"
                                                                    id="143"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell yellow market_140_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_140_b_btn back-1"
                                                                    id="140"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="board-center">
                                                        <div class="board-cell green market_1_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-center coin-place market_1_b_btn back-1"
                                                                    id="1"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_2_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_38_b_btn back-1"
                                                                    id="38"></div>
                                                                <div class="bet-chip-area center-center coin-place market_2_b_btn back-1"
                                                                    id="2"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_110_b_btn back-1"
                                                                    id="110"></div>
                                                                <div class="bet-chip-area top-center coin-place market_74_b_btn back-1"
                                                                    id="74"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_3_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_39_b_btn back-1"
                                                                    id="39"></div>
                                                                <div class="bet-chip-area center-center coin-place market_3_b_btn back-1"
                                                                    id="3"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_145_b_btn back-1"
                                                                    id="145"></div>
                                                                <div class="bet-chip-area top-center coin-place market_75_b_btn back-1"
                                                                    id="75"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_4_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_40_b_btn back-1"
                                                                    id="40"></div>
                                                                <div class="bet-chip-area center-center coin-place market_4_b_btn back-1"
                                                                    id="4"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_146_b_btn back-1"
                                                                    id="146"></div>
                                                                <div class="bet-chip-area top-center coin-place market_98_b_btn back-1"
                                                                    id="98"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_5_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_41_b_btn back-1"
                                                                    id="41"></div>
                                                                <div class="bet-chip-area center-center coin-place market_5_b_btn back-1"
                                                                    id="5"></div>
                                                                <div class="bet-chip-area top-center coin-place market_76_b_btn back-1"
                                                                    id="76"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_6_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_52_b_btn back-1"
                                                                    id="52"></div>
                                                                <div class="bet-chip-area center-center coin-place market_6_b_btn back-1"
                                                                    id="6"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_111_b_btn back-1"
                                                                    id="111"></div>
                                                                <div class="bet-chip-area top-center coin-place market_77_b_btn back-1"
                                                                    id="77"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_7_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_63_b_btn back-1"
                                                                    id="63"></div>
                                                                <div class="bet-chip-area center-center coin-place market_7_b_btn back-1"
                                                                    id="7"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_112_b_btn back-1"
                                                                    id="112"></div>
                                                                <div class="bet-chip-area top-center coin-place market_99_b_btn back-1"
                                                                    id="99"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_8_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_42_b_btn back-1"
                                                                    id="42"></div>
                                                                <div class="bet-chip-area center-center coin-place market_8_b_btn back-1"
                                                                    id="8"></div>
                                                                <div class="bet-chip-area top-center coin-place market_78_b_btn back-1"
                                                                    id="78"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_9_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_53_b_btn back-1"
                                                                    id="53"></div>
                                                                <div class="bet-chip-area center-center coin-place market_9_b_btn back-1"
                                                                    id="9"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_113_b_btn back-1"
                                                                    id="113"></div>
                                                                <div class="bet-chip-area top-center coin-place market_79_b_btn back-1"
                                                                    id="79"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_10_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_64_b_btn back-1"
                                                                    id="64"></div>
                                                                <div class="bet-chip-area center-center coin-place market_10_b_btn back-1"
                                                                    id="10"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_114_b_btn back-1"
                                                                    id="114"></div>
                                                                <div class="bet-chip-area top-center coin-place market_100_b_btn back-1"
                                                                    id="100"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_11_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_43_b_btn back-1"
                                                                    id="43"></div>
                                                                <div class="bet-chip-area center-center coin-place market_11_b_btn back-1"
                                                                    id="11"></div>
                                                                <div class="bet-chip-area top-center coin-place market_80_b_btn back-1"
                                                                    id="80"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_12_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_54_b_btn back-1"
                                                                    id="54"></div>
                                                                <div class="bet-chip-area center-center coin-place market_12_b_btn back-1"
                                                                    id="12"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_115_b_btn back-1"
                                                                    id="115"></div>
                                                                <div class="bet-chip-area top-center coin-place market_81_b_btn back-1"
                                                                    id="81"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_13_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_65_b_btn back-1"
                                                                    id="65"></div>
                                                                <div class="bet-chip-area center-center coin-place market_13_b_btn back-1"
                                                                    id="13"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_116_b_btn back-1"
                                                                    id="116"></div>
                                                                <div class="bet-chip-area top-center coin-place market_101_b_btn back-1"
                                                                    id="101"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_14_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_44_b_btn back-1"
                                                                    id="44"></div>
                                                                <div class="bet-chip-area center-center coin-place market_14_b_btn back-1"
                                                                    id="14"></div>
                                                                <div class="bet-chip-area top-center coin-place market_82_b_btn back-1"
                                                                    id="82"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_15_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_55_b_btn back-1"
                                                                    id="55"></div>
                                                                <div class="bet-chip-area center-center coin-place market_15_b_btn back-1"
                                                                    id="15"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_117_b_btn back-1"
                                                                    id="117"></div>
                                                                <div class="bet-chip-area top-center coin-place market_83_b_btn back-1"
                                                                    id="83"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_16_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_66_b_btn back-1"
                                                                    id="66"></div>
                                                                <div class="bet-chip-area center-center coin-place market_16_b_btn back-1"
                                                                    id="16"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_118_b_btn back-1"
                                                                    id="118"></div>
                                                                <div class="bet-chip-area top-center coin-place market_102_b_btn back-1"
                                                                    id="102"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_17_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_45_b_btn back-1"
                                                                    id="45"></div>
                                                                <div class="bet-chip-area center-center coin-place market_17_b_btn back-1"
                                                                    id="17"></div>
                                                                <div class="bet-chip-area top-center coin-place market_84_b_btn back-1"
                                                                    id="84"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_18_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_56_b_btn back-1"
                                                                    id="56"></div>
                                                                <div class="bet-chip-area center-center coin-place market_18_b_btn back-1"
                                                                    id="18"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_119_b_btn back-1"
                                                                    id="119"></div>
                                                                <div class="bet-chip-area top-center coin-place market_85_b_btn back-1"
                                                                    id="85"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_19_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_67_b_btn back-1"
                                                                    id="67"></div>
                                                                <div class="bet-chip-area center-center coin-place market_19_b_btn back-1"
                                                                    id="19"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_120_b_btn back-1"
                                                                    id="120"></div>
                                                                <div class="bet-chip-area top-center coin-place market_103_b_btn back-1"
                                                                    id="103"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_20_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_19_b_btn back-1"
                                                                    id="46"></div>
                                                                <div class="bet-chip-area center-center coin-place market_20_b_btn back-1"
                                                                    id="20"></div>
                                                                <div class="bet-chip-area top-center coin-place market_86_b_btn back-1"
                                                                    id="86"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_21_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_57_b_btn back-1"
                                                                    id="57"></div>
                                                                <div class="bet-chip-area center-center coin-place market_21_b_btn back-1"
                                                                    id="21"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_121_b_btn back-1"
                                                                    id="121"></div>
                                                                <div class="bet-chip-area top-center coin-place market_87_b_btn back-1"
                                                                    id="87"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_22_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_68_b_btn back-1"
                                                                    id="68"></div>
                                                                <div class="bet-chip-area center-center coin-place market_22_b_btn back-1"
                                                                    id="22"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_122_b_btn back-1"
                                                                    id="122"></div>
                                                                <div class="bet-chip-area top-center coin-place market_104_b_btn back-1"
                                                                    id="104"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_23_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_47_b_btn back-1"
                                                                    id="47"></div>
                                                                <div class="bet-chip-area center-center coin-place market_23_b_btn back-1"
                                                                    id="23"></div>
                                                                <div class="bet-chip-area top-center coin-place market_88_b_btn back-1"
                                                                    id="88"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_24_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_58_b_btn back-1"
                                                                    id="58"></div>
                                                                <div class="bet-chip-area center-center coin-place market_24_b_btn back-1"
                                                                    id="24"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_123_b_btn back-1"
                                                                    id="123"></div>
                                                                <div class="bet-chip-area top-center coin-place market_89_b_btn back-1"
                                                                    id="89"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_25_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_69_b_btn back-1"
                                                                    id="69"></div>
                                                                <div class="bet-chip-area center-center coin-place market_25_b_btn back-1"
                                                                    id="25"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_124_b_btn back-1"
                                                                    id="124"></div>
                                                                <div class="bet-chip-area top-center coin-place market_105_b_btn back-1"
                                                                    id="105"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_26_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_48_b_btn back-1"
                                                                    id="48"></div>
                                                                <div class="bet-chip-area center-center coin-place market_26_b_btn back-1"
                                                                    id="26"></div>
                                                                <div class="bet-chip-area top-center coin-place market_90_b_btn back-1"
                                                                    id="90"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_27_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_59_b_btn back-1"
                                                                    id="59"></div>
                                                                <div class="bet-chip-area center-center coin-place market_27_b_btn back-1"
                                                                    id="27"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_125_b_btn back-1"
                                                                    id="125"></div>
                                                                <div class="bet-chip-area top-center coin-place market_91_b_btn back-1"
                                                                    id="91"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_28_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_70_b_btn back-1"
                                                                    id="70"></div>
                                                                <div class="bet-chip-area center-center coin-place market_28_b_btn back-1"
                                                                    id="28"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_126_b_btn back-1"
                                                                    id="126"></div>
                                                                <div class="bet-chip-area top-center coin-place market_106_b_btn back-1"
                                                                    id="106"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_29_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_49_b_btn back-1"
                                                                    id="49"></div>
                                                                <div class="bet-chip-area center-center coin-place market_29_b_btn back-1"
                                                                    id="29"></div>
                                                                <div class="bet-chip-area top-center coin-place market_92_b_btn back-1"
                                                                    id="92"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_30_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_60_b_btn back-1"
                                                                    id="60"></div>
                                                                <div class="bet-chip-area center-center coin-place market_30_b_btn back-1"
                                                                    id="30"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_127_b_btn back-1"
                                                                    id="127"></div>
                                                                <div class="bet-chip-area top-center coin-place market_93_b_btn back-1"
                                                                    id="93"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_31_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_71_b_btn back-1"
                                                                    id="71"></div>
                                                                <div class="bet-chip-area center-center coin-place market_31_b_btn back-1"
                                                                    id="31"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_128_b_btn back-1"
                                                                    id="128"></div>
                                                                <div class="bet-chip-area top-center coin-place market_107_b_btn back-1"
                                                                    id="107"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_32_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_50_b_btn back-1"
                                                                    id="50"></div>
                                                                <div class="bet-chip-area center-center coin-place market_32_b_btn back-1"
                                                                    id="32"></div>
                                                                <div class="bet-chip-area top-center coin-place market_94_b_btn back-1"
                                                                    id="94"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_33_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_61_b_btn back-1"
                                                                    id="61"></div>
                                                                <div class="bet-chip-area center-center coin-place market_33_b_btn back-1"
                                                                    id="33"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_129_b_btn back-1"
                                                                    id="129"></div>
                                                                <div class="bet-chip-area top-center coin-place market_95_b_btn back-1"
                                                                    id="95"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_34_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_72_b_btn back-1"
                                                                    id="72"></div>
                                                                <div class="bet-chip-area center-center coin-place market_34_b_btn back-1"
                                                                    id="34"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_130_b_btn back-1"
                                                                    id="130"></div>
                                                                <div class="bet-chip-area top-center coin-place market_108_b_btn back-1"
                                                                    id="108"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_35_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_51_b_btn back-1"
                                                                    id="51"></div>
                                                                <div class="bet-chip-area center-center coin-place market_35_b_btn back-1"
                                                                    id="35"></div>
                                                                <div class="bet-chip-area top-center coin-place market_96_b_btn back-1"
                                                                    id="96"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell black market_36_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_62_b_btn back-1"
                                                                    id="62"></div>
                                                                <div class="bet-chip-area center-center coin-place market_36_b_btn back-1"
                                                                    id="36"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_131_b_btn back-1"
                                                                    id="131"></div>
                                                                <div class="bet-chip-area top-center coin-place market_97_b_btn back-1"
                                                                    id="97"></div>
                                                            </div>
                                                        </div>
                                                        <div class="board-cell red market_37_row suspended-box">
                                                            <div class="board-cell-in">
                                                                ...
                                                                <div class="bet-chip-area center-left coin-place market_73_b_btn back-1"
                                                                    id="73"></div>
                                                                <div class="bet-chip-area center-center coin-place market_37_b_btn back-1"
                                                                    id="37"></div>
                                                                <div class="bet-chip-area bottom-left coin-place market_132_b_btn back-1"
                                                                    id="132"></div>
                                                                <div class="bet-chip-area top-center coin-place market_109_b_btn back-1"
                                                                    id="109"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="casino-last-result-title">
                                        ...
                                        <span><a href="casinoresults?game_type=roulette11">View All</a></span>
                                    </div>
...
<script type="text/javascript" src='footer-js.js?106' defer></script>
...
<script type="text/javascript">
    ...
    function updateResult(data) {
        ...
        if (data && data[0]) {
            ...
            html += `<a href="casinoresults?game_type=roulette11">
    ...
    function fetch_bets() {
        $.ajax({
            ...
            dataType: 'json',
            data: { eventId: eventId, eventType: 'ROULETTE11' },
    ...
    function rolette_button_action(action_type) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: { eventId: eventId, eventType: 'ROULETTE11', action_type: action_type, all_old_bet: all_old_bet },
            success: function (response) {
                var message = "";
    ...
    jQuery(document).on("click", ".back-1", function () {
        ...
        if (fullmarketodds != "") {
            ...
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_roulette11',
                dataType: 'json',
