...
.suspended::before {
    background-image: url(/storage/mobile/img/lock.svg);
...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
				<div class="casino-title"><span class="casino-name">3 Cards Judgement</span>
				<span class="d-block">
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".A3CJ_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            <div class="casino-detail">
                               <div class="casino-table">
                                  <div class="threecardjbox back suspended  market_1_row">
                                  ...
                                  <div class="threecardjbox lay suspended market_2_row">
                                     <div class="threecard-title">
                                        No
                                        <div class="casino-odds"></div>
                                     </div>
