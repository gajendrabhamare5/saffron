    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">LUCKY 15</span><span class="d-block"><a href="#" onclick="view_rules('lucky15')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>

<?php
    include("casino_header.php");
?>
                    <div class="tab-content lucky15">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".LUCKY15_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            <!-- <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                <iframe src="<?php echo IFRAME_URL;
                                                echo LUCKY15_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                                                        ...
                                                        <div class="col-12">
                                                            <div class="fancy-market">
                                                                <div class="market-row">
                                                                    ...
                                                                    <small class="box-2 text-right" style="display: flex;">
                                                                        <span class="pr-2 font-weight-bold w-100 market_<? echo $val; ?>_min_max">
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function() {
        ...
        setTimeout(function() {
            $.ajax({
                type: 'POST',
                url: '../ajaxfiles/bet_place_lucky15.php',
                dataType: 'json',
                data: {
