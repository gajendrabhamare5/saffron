...
?>
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                <div class="casino-title"><span class="casino-name">Muflis Teenpatti</span><span class="d-block"><a href="#" onclick="view_rules('teenmuf')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".TEENMUF_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                          ...
                          <!--  <iframe id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                 <iframe src="<?php echo IFRAME_URL."".TEENMUF_CODE;?>" width="100%" height="200px"
                            ...
                            <div class="casino-detail">
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="casino-odds market_5_b_val">1.95</span>
                                            ...
                                            <div class="casino-table-body">
                                                ...
                                                <div class="casino-table-row">
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="casino-odds market_6_b_val">1.95</span>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a
                                            href="casinoresults?game_type=teenmuf" class="">View All</a></span></div>
                                ...
                                <div class="table-responsive rules-table">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="box-10 text-center">Top 9</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Card 9</td>
...
jQuery(document).on("click", "#placeBet", function() {
    ...
    setTimeout(function() {
        $.ajax({
            type: 'POST',
            url: '../ajaxfiles/bet_place_teenmuf.php',
            dataType: 'json',
            data: {
