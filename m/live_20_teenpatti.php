    ...
    <div id="app">
        ...
        <div>
            ...
            <div class="main-content">
                ...
                <!---->
                <div>
                    <div class="casino-title"><span class="casino-name">20-20 Teenpatti</span><span class="d-block"><a href="#" onclick="view_rules('20_teenpatti')" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            ...
                            if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe src="<?php echo IFRAME_URL."".A2020TEENPATTI_CODE;?>" width="100%" height="250px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                              ...
                              <iframe src="<?php echo IFRAME_URL;
                                                    echo A2020TEENPATTI_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe> -->
                            ...
                            <div class="casino-detail">
                                <div class="casino-table">
                                        ...
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-left-box">
                                                <div class="casino-odds-box back suspended market_7_row back-1 market_7_b_btn">
                                                    ...
                                                    <div><span class="casino-odds market_7_b_value">1.98</span>
                                                ...
                                                <div class="casino-odds-box back suspended market_8_row back-1 market_8_b_btn">
                                                    ...
                                                    <div><span class="casino-odds market_8_b_value">1.98</span>
                                        ...
                                        <div class="teenpatti20-other-oods d-md-none">
                                            <div class="casino-table-right-box">
                                                <div class="casino-odds-box back suspended market_9_row back-1 market_9_b_btn">
                                                    <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                    <div><span class="casino-odds market_9_b_value">1.98</span>
                                                ...
                                                <div class="casino-odds-box back suspended market_10_row back-1 market_10_b_btn">
                                                    <div><img src="../storage/front/img/cards/heart.png"><img src="../storage/front/img/cards/diamond.png"></div>
                                                    <div><span class="casino-odds market_10_b_value">1.98</span>
                                    ...
                                    <div class="teenpatti20-other-oods d-none d-md-flex">
                                        <div class="casino-table-left-box">
                                            <div class="casino-odds-box backk suspended market_7_row back-1 market_7_b_btn">
                                                <div><img src="../storage/front/img/cards/spade.png"><img src="../storage/front/img/cards/club.png"></div>
                                                <div><span class="casino-odds market_7_b_value">1.98</span>
                                                    <div class="casino-nation-book text-center market_7_b_exposure market_exposure"></div>
                                                </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=teen20" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?56' defer></script>
