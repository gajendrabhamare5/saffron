...
.btn-success{
    background-color: #086f3f !important;
}
</style>
                        ...
                        <div class="row justify-content-center mt-2 mb-5">
                            <div class="col-12 text-center">
                                ...
                                <div class="setting-box">
                                    ...
                                    <a href="javascript:void(0)" title="Click here to disable secure auth verification" class="btn btn-success disabled_click">Enabled </a>
                                    <!-- <? echo $user_verification_type_show; ?> -->
                                </div>
                                    <div class="text-center mt-3"><!---->
                                       ...
                                       <!--  <h4 class="mb-2">If you haven't downloaded,<br> please download 'Secure Auth Verification App' from below link. </h4>
                                        <h6 class="mb-2">Using this app you will receive auth code during login authentication</h6> <a href="../apk/allpenalexch9_v1.apk" class="btn btn-download btn-lg mt-3">
                                ...
                                ?>
                                 <div class="">
                                    <span class="">Secure Auth Verification Status:</span>
                                    <!-- <span class="badge badge-danger"><? echo $user_verification_status; ?></span> -->
                                    <b class="bg-danger p-2 text-white ms-3" style="margin-left:1rem"><?  echo ucwords(strtolower($user_verification_status)); ?></b>
                                </div>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div>
                                                <div id="radio-group-1" role="radiogroup" tabindex="-1" class="btn-group-toggle btn-group btn-group-lg bv-no-focus-ring">
                                                    <label class="enable_click btn btn-outline-success btn-sm" data-val="mobile_app">
                                                        <b>ANDROID APP</b>
                                                    </label>
                                                    <label class="enable_click btn btn-outline-success btn-sm" data-val="telegram">
                                                        <b>TELEGRAM</b>
                                                    </label>
                                                </div><!----><!----><!---->
                                            </div>
...
<script>
    ...
    jQuery(document).on("click", ".disabled_click", function() {
        ...
        $(".sec_code").html(`<div class="mt-2 mb-3">
                                                            <h3 class="text-center" style="font-size: 22px;">Security Code Verification</h3>
                                                            <div class="mt-3 text-center">Enter 6-digit code to disable Secure Auth</div>
                                                            <form role="form" autocomplete="off" method="post" class="mt-3">
                                                                <div style="display: flex; flex-direction: row; justify-content: space-between;" id="inputs" class="inputs">
        ...
        if (auth_type == "telegram") {
            ...
            $(".otpbox").html(`<div class="text-center mt-3">
                                    ...
                                    <div class="login-password mt-2">
                                        ...
                                        <button class="btn btn-success password-btn enable_click" data-val="telegram_block" disabled="" style="width: 100%;margin: 5px 0 0;">Get Connection ID</button>
                                    </div>
                                </div>`);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (check_status == "ok") {
                        ...
                        $(".otpbox").html(`<div class="mt-3 follow-instruction" style="background: #e4e4e4;">
                                            <h4 class="mb-3">
                ...
                success: function(response) {
                    ...
                    if (check_status == "ok") {
                        ...
                        $(".otpbox").html(`<div class="text-center mt-3"><!---->
                                                    ...
                                                    <div class="mb-2"><b>If you haven't downloaded,<br> please download 'Secure Auth Verification App' from below link. </b></div>
                                                    <div class="mb-2">Using this app you will receive auth code during login authentication</div> <a href="../apk/allpenalexch9_v1.apk" class="btn btn-download btn-lg mt-3">
                                                        <div class="row5 row align-items-center">
                                                            <div class="col-4 text-center"><i class="fab fa-android"></i></div>
                                                            <div class="col-8 text-left">
                                                                <h4 class="mb-0">Download</h4>
