...
.hv-container table td, .hv-container table th {
                       ...
                       <?php
                            ...
                            <div class="row row5">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card hv-container">
                                        <div class="game-heading"><span class="card-header-title">Worli Matka
                        ...
                        <span class="round_no">0</span> </span>
                             ...
                             if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".WORLI_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                                            ...
                                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL."".WORLI_CODE;?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                                    ...
                                                    <div class="card-content m-t-0">
                                                        <div class="table-responsive m-b-10">
                                                            <table class="table table-bordered suspended market_3_row">
                                                                <tbody>
                                                                    <tr>
                                                                        <th colspan="6" class="text-center card-odds"><b>140</b></th>
                                                                    </tr>
                                                                    <tr class="back">
                                                    ...
                                                    <div class="card-content m-t-0">
                                                        <div class="table-responsive m-b-10">
                                                            <table class="table table-bordered suspended market_7_row">
                                                                <tbody>
                                                                    <tr>
                                                                        <th colspan="5" class="text-center card-odds"><b>140</b></th>
                                                                    </tr>
                                                                    <tr class="back">
                                                    ...
                                                    <div class="card-content m-t-0">
                                                        <div class="table-responsive m-b-10">
                                                            <table class="table table-bordered suspended market_8_row">
                                                                <tbody>
                                                                    <tr>
                                                                        <th colspan="6" class=" worli-box-title text-center card-odds"><b>140</b></th>
                                                                    </tr>
                                                                    <tr class="back">
                                        ...
                                        <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=worli">View All</a></span></div>
			...
			eventId = data.t1[0].mid;
				...
				for(var j in data['t2']){
					...
					if(selectionid == 1){
				 	...
				 	gstatus =  data['t2'][j].gstatus.trim();
                    
					if(gstatus == "SUSPENDED"){
						$(".market_"+selectionid+"_row").addClass("suspended");
					}
					else if(gstatus == "OPEN"){
