                                        ...
                                        <div class="col-6">
                                            ...
                                            ?>
                                                ...
                                                <div class="text-center mt-3"><!---->
                                                    ...
                                                    ?>
                                                        ...
                                                        <h6 class="mb-2 mt-1">Using this app you will receive auth code during login authentication</h6> 
                                            ...
                                            ?>
                                                <div class="setting-box">
                                                    ...
                                                    <!-- <span class="badge badge-danger"><? echo ucwords(strtolower($user_verification_status)); ?></span> -->
                                                     <b class="bg-danger p-2 text-white"><? echo ucwords(strtolower($user_verification_status)); ?></b>

                                                </div>
                                                <div class="mt-2 text-center">
                                                    <fieldset class="form-group">
                                                        <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0" style="color: #000000;">Please select below option to enable 'secure auth verification'</legend>
                                                        <div>
    ...
    jQuery(document).on("click", ".enable_click", function() {
        ...
        if (auth_type == "telegram") {
            ...
            $(".otpbox").html(`<div class="text-center mt-3">
                                    <div class="mt-2" style="color: #000000;">Please enter your login password to continue</div>
                ...
                success: function(response) {
                    ...
                    if (check_status == "ok") {
                        ...
                        $(".otpbox").html(`<div class="text-center mt-3">
                                                    ...
                                                    <b>If you haven't downloaded,<br> please download 'Secure Auth Verification App' from below link. </b>
                                                    <h6 class="mb-2 mt-1">Using this app you will receive auth code during login authentication</h6> <a href="apk/allpenalexch9_v1.apk" class="btn btn-download btn-lg mt-3">
                                                        <div class="row5 row align-items-center">
                                                            <div class="col-4 text-center"><i class="fab fa-android"></i></div>
                                                            <div class="col-8 text-left">
                                                                <b>Download</b>
