...
foreach($white_list_data as $white_list_url){
	...
	$url2 = $white_list_url."controller-agent/ajaxfiles/change_result_auto.php?result_event_id=$event_id&result_market_id=$market_id&result_market_runs=$match_odds_result&result_market_type=$result_market_type";
