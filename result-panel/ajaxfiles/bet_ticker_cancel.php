<?php
	...
	$login_type = $_SESSION['CONTROLLER_LOGIN_SESSION_TYPE'];
	 ...
	 if($login_type == 5){
		...
		$get_pnl_report  = $conn->query("select * from bet_details as b left outer join  user_login_master as ulm on ulm.UserID=b.user_id where b.bet_status =2 $search_smdl_name $search_mdl_name $search_dl_name $search_client_name $search_market_name $search_event_name and ulm.parentMDL != 615 ORDER BY b.event_id,b.market_name,b.bet_type");
