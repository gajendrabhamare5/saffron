...
foreach ($white_list_data as $white_list_url) {
    $url = $white_list_url . "controller-agent/ajaxfiles/match_odds_result_apply_auto.php?event_id=$event_id&market_id=$market_id&market_type=$market_type&match_odds_result=$match_odds_result&db_market_type=$db_market_type";
