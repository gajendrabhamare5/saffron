...
$user_password = $fetch_check_current_password['Password2'];
$user_password_salt_key = $fetch_check_current_password['password2_salt_key'];
$user_password_salt = $fetch_check_current_password['password2_salt'];
