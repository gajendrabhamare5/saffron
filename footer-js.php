...
<div id="live_casino_modal" class="modal" role="dialog">
        <div class="modal-dialog modal-fullscreen">
            <div role="document" id="__BVID__51___BV_modal_content_" tabindex="-1" class="modal-content">
                <header id="__BVID__51___BV_modal_header_" class="modal-header">
                    <h5 class="modal-title casino_names"></h5>
                    <button type="button" aria-label="Close" data-dismiss="modal" class="close">&times;</button>
                </header>
                <div id="__BVID__51___BV_modal_body_" class="modal-body1 casinoIframeNew">
                    <div class="">
                ...
                <div class="p-3 position-relative" style="z-index: 10; border-radius: 10px;">
                    <div class="position-relative" style="z-index: 10;">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <button onclick="create_url()" data-dismiss="modal" type="button" class="btn btn-success flex-fill">Accept</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function(response_data) {
                ...
                if (response_data && response_data.status == "ok" && response_data.data) {
                    ...
                    $("#live_casino_modal").modal();

                    var html = "<iframe id='iframebox' src=" + response_data.data.url + " frameborder='0' style='height: 92vh !important;width: 100vw !important;'></iframe>";
                    $(".casinoIframeNew").html(html);
                } else {
