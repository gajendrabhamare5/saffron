...
.fancyTripple .suspended-row::after, .fancyTripple .suspended-table::after {
    width: 19.5%;
}
      ...
      <div class="col-md-9 coupon-card featured-box-detail">
         <div class="coupon-card">
            <div class="game-heading">
			   ...
			   <small role="button" class="teenpatti-rules"  onclick="view_rules('superover')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small>
            ...
            <div class="casino-detail detail-page-container position-relative">
				<div class="game-market market-2 ">
					...
					<div class="market-header">
						<div class="market-nation-detail"><span class="market-nation-name">Min: 100 Max: 5L</span></div>
					...
					<div class="market-body bookmaker-market" data-title="OPEN">
						...
						<div class="market-row suspended-row market_2_row" data-title="ACTIVE">
							...
							<div class="market-odd-box back market_2_b_btn back-1"><span class="market-odd">1.32</span><span class="market-volume">500000.00</span></div>
							<div class="market-odd-box lay market_2_l_btn lay-1"><span class="market-odd">1.35</span><span class="market-volume">500000.00</span></div>
						</div>
					</div>
				</div>
				...
				<div class="casino-last-result-title"><span>Last Result</span><span><a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=superover">View All</a></span></div>
				...
				<!-- <div class="mt-2 w-100">
					<div class="sidebar-box place-bet-container super-over-rule">
						...
						<div class="table-responsive">
							...
							<tbody>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/cardA.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball1.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/card2.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball2.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/card3.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball3.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/card4.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball4.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/card6.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball6.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/card10.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/ball0.png"></td>
								</tr>
								<tr>
									<td><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/cards/cardK.png"><span class="ms-2">X</span></td>
									<td class="text-center">5</td>
									<td class="text-end"><span>Wicket</span><img src="https://versionobj.ecoassetsservice.com/v36/static/front/img/superover/balls/wicket.png"></td>
								</tr>
							</tbody>
							</table>
						</div>
				...
				if(data['t3'] != null){
					...
					for(var f in data['t4']){
						...
						if($("#five_fancy_"+selectionid).length){
							...
							fancy_data1 += `<div class="col-md-6"  id="five_fancy_${selectionid}'">
								<div" data-title="${is_suspended_title}" class="fancy-market ${is_suspended} market_${selectionid}_row">
									<div class="market-row">
										...
										<div class="market-odd-box back market_${selectionid}_b_btn back-1" side="Back" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="FANCY1_ODDS" event_name="${markettype}" fullmarketodds="${b1}" fullfancymarketrate="${b1}">${back_html}</div>
										<div class="market-odd-box lay  market_${selectionid}_l_btn lay-1" side="Lay" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="FANCY1_ODDS" event_name="${markettype}" fullmarketodds="${l1}" fullfancymarketrate="${l1}">${lay_html}</div>
										<div class="fancy-min-max-box">
											<div class="fancy-min-max"><span class="w-100 d-block">Min: 100</span><span class="w-100 d-block">Max: 10K</span></div>
										</div>
									</div>
 ...
 jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBetLoader").addClass('show');
		...
		/* setTimeout(function(){  */
			$.ajax({
				 type: 'POST',
				 url: 'ajaxfiles/bet_place_super_over.php',
				 dataType: 'json',
