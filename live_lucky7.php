                ...
                <div class="container-fluid container-fluid-5">
                    <div class="row row5"> 
                        ...
                        <div class="col-md-10 featured-box">
                            <div class="row row5 lucky7">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Lucky 7 - A
											...
											<!----></span> 
											<small role="button" class="teenpatti-rules"  onclick="view_rules('lucky7')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
										...
										<?php
											if(!empty(IFRAME_URL_SET)){
																		?>
																		<iframe class="iframedesign" src="<?php echo IFRAME_URL."".LUCKY7A_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
																		<?php
																		...
																		?>
											<!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL; echo LUCKY7A_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                            ...
                                            <div class="video-overlay">
                                                <div class="card-inner">
                                                    <h3 class="text-white">Card</h3> <img id="card_c1" src="storage/front/img/cards_new/1.png"></div>
                                            </div>
                                        </div>
                                        <div class="casino-detail">
											<div class="casino-table">
												<div class="casino-table-full-box">
													...
													<div class="lucky7"><img src="storage/front/img/cards_new/7.png"></div>
												...
												<div class="casino-table-box mt-3">
													<div class="lucky7cards">
														...
														<div class="card-odd-box-container suspended-box market_20_row back-1 market_20_b_btn">
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/A.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/2.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/3.png"></div>
														</div>
														</div>
													...
													<div class="lucky7cards">
														...
														<div class="card-odd-box-container suspended-box market_21_row back-1 market_21_b_btn">
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/4.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/5.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/6.png"></div>
														</div>
														</div>
													...
													<div class="lucky7cards">
														...
														<div class="card-odd-box-container suspended-box market_22_row back-1 market_22_b_btn">
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/8.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/9.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/10.png"></div>
														</div>
														</div>
													...
													<div class="lucky7cards">
														...
														<div class="card-odd-box-container suspended-box market_23_row back-1 market_23_b_btn">
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/J.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/Q.png"></div>
														</div>
														<div class="card-odd-box">
															<div class=""><img src="storage/front/img/cards_new/K.png"></div>
														</div>
														</div>
												...
												<div class="casino-table-full-box lucky7acards mt-3">
													...
													<div class="card-odd-box">
														<div class="suspended-box market_7_row back-1 market_7_b_btn"><img src="storage/front/img/cards_new/A.png"></div>
														<div class="casino-nation-book market_7_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_8_row back-1 market_8_b_btn"><img src="storage/front/img/cards_new/2.png"></div>
														<div class="casino-nation-book market_8_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_9_row back-1 market_9_b_btn"><img src="storage/front/img/cards_new/3.png"></div>
														<div class="casino-nation-book market_9_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_10_row back-1 market_10_b_btn"><img src="storage/front/img/cards_new/4.png"></div>
														<div class="casino-nation-book market_10_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_11_row back-1 market_11_b_btn"><img src="storage/front/img/cards_new/5.png"></div>
														<div class="casino-nation-book market_11_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_12_row back-1 market_12_b_btn"><img src="storage/front/img/cards_new/6.png"></div>
														<div class="casino-nation-book market_12_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_13_row back-1 market_13_b_btn"><img src="storage/front/img/cards_new/7.png"></div>
														<div class="casino-nation-book market_13_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_14_row back-1 market_14_b_btn"><img src="storage/front/img/cards_new/8.png"></div>
														<div class="casino-nation-book market_14_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_15_row back-1 market_15_b_btn"><img src="storage/front/img/cards_new/9.png"></div>
														<div class="casino-nation-book market_15_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_16_row back-1 market_16_b_btn"><img src="storage/front/img/cards_new/10.png"></div>
														<div class="casino-nation-book market_16_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_17_row back-1 market_17_b_btn"><img src="storage/front/img/cards_new/J.png"></div>
														<div class="casino-nation-book market_17_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_18_row back-1 market_18_b_btn"><img src="storage/front/img/cards_new/Q.png"></div>
														<div class="casino-nation-book market_18_b_exposure market_exposure"></div>
													</div>
													<div class="card-odd-box">
														<div class="suspended-box market_19_row back-1 market_19_b_btn"><img src="storage/front/img/cards_new/K.png"></div>
														<div class="casino-nation-book market_19_b_exposure market_exposure"></div>
													</div>
												</div>
											</div>
											<div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=lucky7">View All</a></span></div>
											<div class="casino-last-results" id="last-result">
												<!-- <span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-b">H</span> -->
											</div>
										</div>
                                    </div>
                                </div>
			...
			eventId = data.t1[0].mid;
				...
				for(var j in data['t2']){
					...
					if(gstatus == "SUSPENDED" || gstatus == "0"){
						...
						$(".market_"+selectionid+"_b_value").text(parseFloat(b1));
 ...
 jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBetLoader").addClass('show');
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: 'ajaxfiles/bet_place_lucky7_teenpatti.php',
				 dataType: 'json',
