...
<body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
            ...
            <div class="main">
                <div class="container-fluid container-fluid-5">
                    <div class="row row5">
                            ...
                            <div class="row row5 lucky7">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Lucky 7 - B
						...
						<!----></span> 
						<small role="button" class="teenpatti-rules"  onclick="view_rules('lucky7eu')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
  ...
  if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".LUCKY7B_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
											<!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe> -->
                                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL; echo LUCKY7B_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                        ...
                                        <div class="casino-detail">
											...
											<div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=lucky7eu">View All</a></span></div>
											<div class="casino-last-results" id="last-result">
												<!-- <span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-b">H</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result">T</span><span class="result result-b">H</span><span class="result result-b">H</span> -->
											</div>
										</div>
                                    </div>
                                </div>
 ...
 jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBetLoader").addClass('show');
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: 'ajaxfiles/bet_place_lucky7eu_teenpatti.php',
				 dataType: 'json',
