...
$card1_data_arr = $cards->$card_data_1;
$bet_final_result = $card1_data_arr['name'];
$card2_data_arr = $cards->$card_data_2;
$bet_final_result .= $card2_data_arr['name'];
$card3_data_arr = $cards->$card_data_3;
$bet_final_result .= $card3_data_arr['name'];
...
while ($fetch_get_all_bet = mysqli_fetch_assoc($get_all_bet)) {
    ...
    $bet_market_name1 = str_replace("Yes", "", $bet_market_name);
    $bet_market_name2 = str_replace("No", "", $bet_market_name1);




    if ($bet_market_id == 1 and $bet_type == "Back" and ( strpos($bet_market_name2, $card_charcater_1) !== false or strpos($bet_market_name2, $card_charcater_2) !== false or strpos($bet_market_name2, $card_charcater_3) !== false )) {
        set_result($conn, $bet_id, "Win", $mid, $end_date_time,$bet_final_result);
    } else if ($bet_market_id == 2 and $bet_type == "Lay" and ( strpos($bet_market_name2, $card_charcater_1) == "" and strpos($bet_market_name2, $card_charcater_2) == "" and strpos($bet_market_name2, $card_charcater_3) == "")) {
        set_result($conn, $bet_id, "Win", $mid, $end_date_time,$bet_final_result);
    } else {
