...
foreach($cards_list as $key=>$card){
    $card_number=$key + 1;
    $card1_data = $cards->$card;
    $rank_card_1 = $card1_data['name'];
     if ($card_number % 2 === 0) {
                                $rank_card_1 .= "Bahar $rank_card_1";
                            } else {
                                $rank_card_1 .= "Ander $rank_card_1";
                            }
    $results_list[$card_number] = $rank_card_1;
}
...
while ($fetch_get_all_bet = mysqli_fetch_assoc($get_all_bet)) {
    ...
    $bet_market_type = $fetch_get_all_bet['market_type'];
    ...
    if ($results_list[$bet_market_type] == $bet_market_name) {
