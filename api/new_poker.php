...
function is_2_card_jqk_pair($card_1, $card_2, $cards) {
     $card1_data = $cards->$card_1;
    $card2_data = $cards->$card_2;
    $rank_card_1 = $card1_data['rank'];
    $rank_card_2 = $card2_data['rank'];

    if ($rank_card_1 == 12 or $rank_card_1 == 11 or $rank_card_1 == 13) {
        if ($rank_card_1 == $rank_card_2) {
            return true;
        } else {
            return false;
