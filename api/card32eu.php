...
if ($is_10_11 == "10-11") {
	...
	$market_ids[] = 25;
} else if (strtolower($is_10_11) == "tie") {
	...
	while ($fetch_get_all_bet1 = mysqli_fetch_assoc($get_all_bet1)) {
		$bet_id = $fetch_get_all_bet1['bet_id'];
		$update_bet = $conn->query("update bet_teen_details set bet_status=2,bet_result='0',bet_win_amount='0' where bet_id='$bet_id' and bet_status=1 and market_id in (25,26)");
