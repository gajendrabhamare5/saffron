...
$bet_final_result = 'Winner - '.$remark;
...
while ($fetch_get_all_bet = mysqli_fetch_assoc($get_all_bet)) {
    ...
    if (in_array($bet_market_id, $market_id)) {
		...
		$actual_win_amount2=$bet_stack * $bet_times;
		$per_amount=$actual_win_amount2 * 2 / 100;
		$actual_win_amount2=$actual_win_amount2 - $per_amount;
		...
		$bet_stack=$bet_stack * $bet_times;
		$bet_amount=$bet_stack;
