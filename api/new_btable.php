...
$is_odd_even = $rdesc_array[1];
$is_red_black = $rdesc_array[2];
$is_barati = $rdesc_array[3];
$is_current_card = $rdesc_array[4];



if(strtoupper($is_odd_even) == "ODD"){
	$market_id_odd = 7;
...
if(strtoupper($is_red_black) == "RED"){
	 $market_id[] = 8;
...
if(strtoupper($is_barati) == "BARATI"){
	 $market_id[] = 15;
...
$is_current_card = str_replace("Card","",$is_current_card);
$is_current_card = str_replace(" ","",$is_current_card);
