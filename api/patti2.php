...
$tot_card_result=$result_list[2];
$tot_card_result=explode("  |  ",$tot_card_result);
$tot_card_a=explode(" : ",$tot_card_result[0]);
$tot_card_a=$tot_card_a[1];
$tot_card_b=explode(" : ",$tot_card_result[1]);
$tot_card_b=$tot_card_b[1];
...
while ($fetch_get_all_bet = mysqli_fetch_assoc($get_all_bet)) {
    ...
    else if ((int)$bet_market_id == 3) {
		if ($tot_card_a >= 15 and $bet_type == "Back") {
			$winner_flag=true;
		} else if ($tot_card_a < 14 and $bet_type == "Lay") {
			$winner_flag=true;
		}
	}
    else if ((int)$bet_market_id == 4) {
		if ($tot_card_b >= 15 and $bet_type == "Back") {
			$winner_flag=true;
		} else if ($tot_card_b < 14 and $bet_type == "Lay") {
			$winner_flag=true;
		}
	}
    else if ((int)$bet_market_id == 7) {
		if ($result_list[2] != "No") {
			if (strtolower($result_list[2]) == "three card sequence") { 
                $actual_win_amount2 = $actual_win_amount2 * 3;
            }
			else if (strtolower($result_list[2]) == "four card color" || strtolower($result_list[2]) == "four card sequence") { 
                $actual_win_amount2 = $actual_win_amount2 * 9;
            }
			else if (strtolower($result_list[2]) == "three of a kind") { 
                $actual_win_amount2 = $actual_win_amount2 * 12;
            }
			else if (strtolower($result_list[2]) == "three card pure sequence") { 
                $actual_win_amount2 = $actual_win_amount2 * 15;
            }
			else if (strtolower($result_list[2]) == "four card pure sequence") { 
                $actual_win_amount2 = $actual_win_amount2 * 150;
            }
			else if (strtolower($result_list[2]) == "four of a kind") { 
                $actual_win_amount2 = $actual_win_amount2 * 200;
            }
			$winner_flag=true;
		}
	}else{
