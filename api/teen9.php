...
if ($result == 11 || $result == "T") {
    ...
    $conn->query("insert into twenty_teenpatti_result_new (event_id,game_type,result_status,cards,result_time,desc_remakrs) VALUES('$mid','$game_type','$result','$cards3','$result_time','$rdesc')");
 ...
 $check_result_already_insert = $conn->query("select * from twenty_teenpatti_result_new where event_id='$mid' and game_type='$game_type'");
