...
if ($result == "1" || $result == "T") {
    ...
    $conn->query("insert into twenty_teenpatti_result (event_id,game_type,result_status,cards,result_time,desc_remakrs,data) VALUES('$mid','$game_type','$result','$cards3','$result_time','$rdesc','$data_original')");
