...
$is_dulhan = is_dulhan($a_cards[0], $cards);
if ($is_dulhan) {
    $market_id[] = 14;
...
$a_card_arr = $cards->$a_cards[0];
$bet_final_result .= ' | Card '.$a_card_arr['name'];
...
function is_dulhan($card11, $cards) {
    $card1 = $cards->$card11;
    $rank = $card1['rank'];
