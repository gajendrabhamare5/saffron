...
$rdesc_array12 = explode("*",$rdesc);

$rdesc_array_1 = $rdesc_array12[0];
$rdesc_array_dragon = $rdesc_array12[1];
$rdesc_array_tiger = $rdesc_array12[2];


$data_1_array = explode("|",$rdesc_array_1);


$is_tie = $data_1_array[0];
...
$dragon_array = explode("|",$rdesc_array_dragon);
$is_dragon_red_black = $dragon_array[0];
$is_dragon_odd_even = $dragon_array[1];
$is_dragon_card = $dragon_array[2];
...
if(strtoupper($is_dragon_odd_even) == "EVEN"){
	$market_id[] = 5;
...
$is_dragon_card = str_replace("Card","",$is_dragon_card);
$dragon_cards_type_id = cards_type_id($is_dragon_card, 'dragon');
$market_id[] = $dragon_cards_type_id;	
$bet_final_result .= '|Card'.$is_dragon_card;



$tiger_array = explode("|",$rdesc_array_tiger);
$is_tiger_red_black = $tiger_array[0];
$is_tiger_odd_even = $tiger_array[1];
$is_tiger_card = $tiger_array[2];
...
if(strtoupper($is_tiger_odd_even) == "EVEN"){
	$market_id[] = 22;
	$bet_final_result .= '*Even';
}
else{
...
$is_tiger_card = str_replace("Card","",$is_tiger_card);
$tiger_cards_type_id = cards_type_id($is_tiger_card, 'tiger');
$market_id[] = $tiger_cards_type_id;	
$bet_final_result .= '|Card'.$is_tiger_card;
