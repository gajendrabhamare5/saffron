...
$player_a_result = $desc1_array[0]; */
$player_a_result = $desc;
...
if (strpos($player_a_result, 'Straight flush') !== false) {
    ...
    $market_id[] = 22;
} else if (strpos($player_a_result, 'High card') !== false) {
    $market_id[] = 21;
}

$desc = str_replace(",", "-", $desc);

$conn->query("insert into twenty_teenpatti_result (event_id,game_type,result_status,cards,result_time,desc_remakrs,data) VALUES('$mid','$game_type','$result_status','$cards3','$result_time','$desc','$data_original')");
