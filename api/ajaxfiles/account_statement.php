...
$user_id = $_SESSION['CLIENT_LOGIN_ID'];
	...
	if($report_type == 1){
		//all
		$get_account_details = $conn->query("select SUM(amount) as total_pnl,b.event_name,b.event_id,b.event_type,b.market_name,b.bet_final_result,b.market_type,a.account_date_time from accounts as a left outer join bet_details as b on b.bet_id=a.bet_id where a.user_id=$user_id and a.bet_id<>0 and a.game_type=0 and a.account_date_time >='$from_date 00:00:00' and a.account_date_time <='$to_date 23:59:59' and a.entry_type IN(3,4,7) GROUP BY a.account_date_time,a.game_type");
		$accounts = array();
		...
		$get_account_details = $conn->query("select SUM(amount) as total_pnl,b.event_name,b.event_id,b.event_type,b.market_name,b.market_type,b.bet_final_result,a.account_date_time from accounts as a left outer join bet_teen_details as b on b.bet_id=a.bet_id where a.user_id=$user_id and a.bet_id<>0  and a.game_type=1 and a.account_date_time >='$from_date 00:00:00' and a.account_date_time <='$to_date 23:59:59'  GROUP BY a.account_date_time,a.game_type ");
		$accounts = array();
		while($fetch_get_account_details = mysqli_fetch_assoc($get_account_details)){
			$total_pnl = $fetch_get_account_details['total_pnl'];
			$event_name = $fetch_get_account_details['event_name'];
		...
		$get_account_details = $conn->query("select SUM(amount) as total_pnl,b.event_name,b.event_id,b.event_type,b.bet_final_result,b.market_name,b.market_type,a.account_date_time from accounts as a left outer join bet_details as b on b.bet_id=a.bet_id where a.user_id=$user_id and a.bet_id<>0  and a.account_date_time >='$from_date 00:00:00' and a.account_date_time <='$to_date 23:59:59'  and a.game_type=0  and a.entry_type IN(9) GROUP BY a.account_date_time,a.game_type ");
		$accounts = array();
		while($fetch_get_account_details = mysqli_fetch_assoc($get_account_details)){
			$total_pnl = $fetch_get_account_details['total_pnl'];
			$event_name = $fetch_get_account_details['event_name'];
		...
		$get_account_details = $conn->query("select SUM(amount) as total_pnl,b.event_name,b.event_id,b.event_type,b.market_name,b.market_type,b.bet_final_result,a.account_date_time from accounts as a left outer join bet_details as b on b.bet_id=a.bet_id where a.user_id=$user_id and a.bet_id<>0  and a.account_date_time >='$from_date 00:00:00' and a.account_date_time <='$to_date 23:59:59'  and a.game_type=0  and a.entry_type IN(9) GROUP BY a.account_date_time,a.game_type ");
		$accounts = array();
		while($fetch_get_account_details = mysqli_fetch_assoc($get_account_details)){
			$total_pnl = $fetch_get_account_details['total_pnl'];
			$event_name = $fetch_get_account_details['event_name'];
