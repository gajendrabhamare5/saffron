...
/* if($user_id !=4 and $user_id !=284 and $user_id !=408 and $user_id !=810 ){
	 $return = array(
        "status" => 'error',
        "message" => "In Progress",
    );
...
$get_check_result = $conn->query("select * from twenty_teenpatti_result where event_id='$eventId' and game_type='meter'");
