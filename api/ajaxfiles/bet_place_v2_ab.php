<?php
	...
	if($fetch_parent_ids['net_exposure_limit'] < abs($total_exposure)){
	...
	if($maxBet == 1 and $market_type == "MATCH_ODDS" and $user_id != 4){
		$return = array(
			"status" => 'error',
	...
	if($market_exposure > $maxBet and $market_type == "MATCH_ODDS" and $user_id != 4){
		$message = "Check Maximum Bet Limit.";
		$return = array(
				"status" => 'error',
				"message" => $message,
