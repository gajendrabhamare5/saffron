...
?>
	<div class="col br1 text-center">
		<h4>Player A</h4>
		<div class="result-image"><img src="<?php echo $carda1; ?>" class="mr-2"> <img src="<?php echo $carda2; ?>" class="mr-2"> <img src="<?php echo $carda3; ?>" class="mr-2"></div>
		 <?php
			if($result_status == "A"){
		?>
	...
	<div class="col text-center">
		<h4>Player B</h4>
		<div class="result-image"><img src="<?php echo $cardb1; ?>" class="mr-2"> <img src="<?php echo $cardb2; ?>" class="mr-2"> <img src="<?php echo $cardb3; ?>" class="mr-2"></div>
		<?php
			if($result_status == "B"){
		?>
			<div class="winner-icon mt-3"><i class="fas fa-trophy mr-2"></i></div>
...
?>
	<div class="col br1 text-center">
							...
							<div class="col text-center">
                                <h4>Dragon</h4>
                                <div class="result-image"><img src="<?php echo $cardc1; ?>" class="mr-2"> <img src="<?php echo $cardc2; ?>" class="mr-2"> <img src="<?php echo $cardc3; ?>" class="mr-2"></div>
                                <?php
									if($result_status == "D"){
								?>
									<div class="winner-icon mt-3"><i class="fas fa-trophy mr-2"></i></div>
...
<?php
    ...
    <div class="row result-row mt-3">
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 1</h6>
            <div class="text-center"><img src="<?php echo $card1; ?>" /></div>
        ...
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 2</h6>
            <div class="text-center"><img src="<?php echo $card2; ?>" /></div>
           <?php
        ...
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 3</h6>
            <div class="text-center"><img src="<?php echo $card3; ?>" /></div>
           <?php
        ...
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 4</h6>
            <div class="text-center"><img src="<?php echo $card4; ?>" /></div>
            <?php
        ...
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 5</h6>
            <div class="text-center"><img src="<?php echo $card5; ?>" /></div>
           <?php
        ...
        <div class="col-md-2 sixplayer-image">
            <h6 class="text-center">Player 6</h6>
            <div class="text-center"><img src="<?php echo $card6; ?>" /></div>
            <?php
    ...
    <div class="row result-row">
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_1_1; ?>" /> <img src="<?php echo $card_1_2; ?>" /> <img src="<?php echo $card_1_3; ?>" />
            </div>
             <?php
				if(in_array(1,$result_status)){
			?>
        ...
        <div class="col-md-6 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_dealer_1; ?>" /> <img src="<?php echo $card_dealer_2; ?>" /> <img src="<?php echo $card_dealer_3; ?>" />
            </div>
        </div>
        <div class="col-md-3 sixplayer-image">
            <h4 class="text-center">8</h4>
            <div class="text-center">
                <img src="<?php echo $card_8_1; ?>" /> <img src="<?php echo $card_8_2; ?>" /> <img src="<?php echo $card_8_3; ?>" />
            </div>
            <?php
    ...
    <div class="row result-row">
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_2_1; ?>" /> <img src="<?php echo $card_2_2; ?>" /> <img src="<?php echo $card_2_3; ?>" />
            </div>
           <?php
				if(in_array(2,$result_status)){
			?>
        ...
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_7_1; ?>" /> <img src="<?php echo $card_7_2; ?>" /> <img src="<?php echo $card_7_3; ?>" />
            </div>
            <?php
    ...
    <div class="row result-row">
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_3_1; ?>" /> <img src="<?php echo $card_3_2; ?>" /> <img src="<?php echo $card_3_3; ?>" />
            </div>
           <?php
				if(in_array(3,$result_status)){
			?>
        ...
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_4_1; ?>" /> <img src="<?php echo $card_4_2; ?>" /> <img src="<?php echo $card_4_3; ?>" />
            </div>
           <?php
				if(in_array(4,$result_status)){
			?>
        ...
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_5_1; ?>" /> <img src="<?php echo $card_5_2; ?>" /> <img src="<?php echo $card_5_3; ?>" />
            </div>
           <?php
				if(in_array(5,$result_status)){
			?>
        ...
        <div class="col-md-3 sixplayer-image">
            ...
            <div class="text-center">
                <img src="<?php echo $card_6_1; ?>" /> <img src="<?php echo $card_6_2; ?>" /> <img src="<?php echo $card_6_3; ?>" />
            </div>
            <?php
				if(in_array(6,$result_status)){
			?>
	...
	?>
        ...
        <div class="col br1 text-center">
            <h4>Player A</h4>
            <div class="result-image"><img src="<?php echo $card_a_1; ?>" class="mr-2" /> <img src="<?php echo $card_a_2; ?>" class="mr-2" /></div>
            <?php
        ...
        <div class="col text-center">
            <h4>Player B</h4>
            <div class="result-image"><img src="<?php echo $card_b_1; ?>" class="mr-2" /> <img src="<?php echo $card_b_2; ?>" class="mr-2" /></div>
			<?php
    ...
    <div class="row mt-3">
        <div class="col-12 text-center">
            <h4>Table</h4>
            <div class="result-image">
                <img src="<?php echo $card_dealer_1; ?>" class="mr-2" /> <img src="<?php echo $card_dealer_2; ?>" class="mr-2" />
                <img src="<?php echo $card_dealer_3; ?>" class="mr-2" /> <img src="<?php echo $card_dealer_4; ?>" class="mr-2" />
	...
	?>
		...
		<div class="row row5 mt-3">
			<div class="col-12 text-center"><h4>Players Cards</h4></div>
		</div>
		<div class="row row5 mt-3">
			<div class="col-2"></div>
        ...
        <div class="result-image">
            <div id="result-a-cards" class="ab-rtlslider owl-carousel owl-theme owl-rtl owl-loaded owl-drag">
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 588px;">
                        <?php
						$i=0;
   ...
   <div class="col-9">
      <div class="card-inner">
         <div class="row row5">
            ...
            <div class="col-8">
               <div id="result-a-cards" class="ab-rtlslider owl-carousel owl-theme owl-rtl owl-loaded owl-drag" style="width: 100%;">
                  <div class="owl-stage-outer">
      ...
      <div class="card-inner">
         <div class="row row5">
            ...
            <div class="col-8">
               <div id="result-b-cards" class="ab-rtlslider owl-carousel owl-theme owl-rtl owl-loaded owl-drag" style="width: 100%;">
                  <div class="owl-stage-outer">
		...
		<div class="eightplayer">
			<div class="row result-row mt-3">
				<div class="col-md-4 sixplayer-image">
					...
					<div class="text-center"><img src="<?php echo $card_1; ?>" /></div>
					<?php 
				...
				<div class="col-md-4 sixplayer-image">
					...
					<div class="text-center"><img src="<?php echo $card_2; ?>" /></div>
					<?php 
				...
				<div class="col-md-4 sixplayer-image">
					...
					<div class="text-center"><img src="<?php echo $card_3; ?>" /></div>
					<?php 
