<head>
    ...
    <link rel="icon" href="storage/fav-icon.png">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.10/css/all.css">
    <link rel="stylesheet" type="text/css" href="storage/front/vendor/bootstrap/css/bootstrap.min.css">
    <!-- Bootstrap CSS -->
<link
...
/>
    ...
    <link href="storage/front/css/style_darshi.css?16" rel="stylesheet">
    <link href="storage/front/css/custom.css" rel="stylesheet">  
  <link href="storage/front/css/pagination.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="storage/js/plugins/OwlCarousel2/assets/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="storage/js/plugins/OwlCarousel2/assets/owl.theme.default.css">
    <link rel="stylesheet" href="storage/front/css/flipclock.css">
    <script type="text/javascript">
        	var hostname = window.location.hostname;
        window.GUMLET_CONFIG = {
            hosts: [{
                current: hostname,
                gumlet: "trubet365.gumlet.io"
            }],
            lazy_load: true
        };
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-P6KSR6P211"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-P6KSR6P211');
</script>

  
  
    <style type="text/css">
        .mtree-main .text-dark {
            cursor: pointer;
        }
    </style>
    <style type="text/css">
    ...
    <style type="text/css">
        .card32-modal .board-result-inner[data-v-1b65a545] {
            background: #f9f9f9;
            padding: 10px;
            font-size: 17px;
        }
        
        .card32-modal .yellowbx[data-v-1b65a545] {
            color: #caca03;
        }
        
        .card32-modal .player-image-container img[data-v-1b65a545] {
            max-width: 50px;
        }
        
        .card32-modal .c-title[data-v-1b65a545] {
            font-weight: bold;
            font-size: 24px;
            margin-bottom: 6px;
            color: #868686;
        ...
        .card32-modal .eightplayer img[data-v-1b65a545] {
            width: 35px;
            margin-right: 0px;
        }
        
        .card32-modal .result-row[data-v-1b65a545] {
            position: relative;
            margin-bottom: 50px;
        }
        
        .card32-modal .result-row .winner-label[data-v-1b65a545] {
            font-size: 16px;
            position: absolute;
            margin-top: 10px;
            left: 50%;
        ...
        .card32eu .bet-action[data-v-1b65a545] {
            width: 20% !important;
        }
    </style>
    <style type="text/css">
        .featured-box[data-v-3af2cc68] {
            background-image: url("https://dzm0kbaskt4pv.cloudfront.net/img/bcasino/bollywood-bg.png");
            background-repeat: no-repeat;
            background-size: cover;
            background-position: center -80px;
        }
        
        .bollywood-tbl .div-figure[data-v-3af2cc68] {
            padding: 0;
        }
    </style>
    <style type="text/css">
        .selected[data-v-3d692c63] {
            background: green;
            color: #fff;
        }
    </style>
    <style type="text/css">
        .selected[data-v-2442d968] {
            background: green;
            color: #fff;
        }
    </style>
    <style type="text/css">
        .casino-img[data-v-8dfa8940] {
            max-width: 75px;
            cursor: pointer;
        }
    </style>
    <style type="text/css">
        .casino-img[data-v-977392b2] {
            max-width: 75px;
            cursor: pointer;
        }
    </style>
    <style type="text/css">
        .casino-img[data-v-99f0c352] {
            max-width: 100%px;
            cursor: pointer;
        }
    </style>
    ...
    <style type="text/css">
        .casino-img[data-v-c5fce684] {
            max-width: 75px;
            cursor: pointer;
        }
    </style>
    <style type="text/css">
        .game-icon[data-v-ca6c2cde] {
            width: 20px;
        }
        
        .game-col a[data-v-ca6c2cde] {
            cursor: pointer;
            width: 16%;
        }
    </style>
