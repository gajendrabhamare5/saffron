...
<html>
    <head>
        ...
        <script src="https://casinovideoapi.com:5443/LiveApp/js/fetch.js"></script>
        <script src="https://casinovideoapi.com:5443/LiveApp/js/promise.min.js"></script>
        <script src="https://casinovideoapi.com:5443/LiveApp/js/fetch.stream.js"></script>
        <script src="https://casinovideoapi.com:5443/LiveApp/js/webrtc_adaptor.js"></script>
        <script src="https://webrtc.github.io/adapter/adapter-latest.js"></script>
		
        <link href="https://casinovideoapi.com:5443/LiveApp/css/player.css" rel="stylesheet">
        <style>
            .mCS_img_loaded{
...
-->
    ...
    <body>
        ...
        <div id="video_info">
            <div class="loading"><img src="/storage/front/img/player-loading.png" alt="" class="mCS_img_loaded" style="margin-top: 164%;"></div>
        </div>

        <!-- HLS Player -->
        <div id="video_container">
            <video id="video-player" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" muted>
                <p class="vjs-no-js">
...
<!--         <img id="play_button" src="https://casinovideoapi.com:5443/LiveApp/images/play.png" onclick="playWebRTCVideo()" style="position: absolute; top: 30px; left: 30px; display: none;" /> -->
...
//            var name = "105840546160274169587574";
            var token = "null";
            var pAutoplay = "true";
            var autoPlay = true;
            ...
            {
                document.getElementById("video_info").innerHTML = '<div class="loading"><img src="http://11starexch.org/storage/front/img/player-loading.png" alt="" class="mCS_img_loaded" style="margin-top: 164%;"></div>';
                setTimeout(function ()
                {
            ...
            function initializeWebRTCPlayer(name, token, noStreamCallback) {
                ...
                var path = 'casinovideoapi.com:5443/LiveApp/websocket';
