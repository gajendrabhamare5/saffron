                                ...
                                <div class="col-md-9 andar-bahar coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading">
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('ab204')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                            <!-- <small role="button" class="teenpatti-rules"  onclick="view_rules('tt_cards_rule.jpg')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small> --> <span class="float-right">
                                                Round ID:
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . AB4_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
