                                    ...
                                    <div class="report-form">
                                        <div class="row row5">
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="react-datepicker-wrapper">
                                                    <div class="react-datepicker__input-container">
                                                        <div class="mb-2 custom-datepicker date-container"><input
                                            ...
                                            <div class="col-lg-2 col-md-3 col-6">
                                                <div class="react-datepicker-wrapper">
                                                    <div class="react-datepicker__input-container">
                                                        <div class="mb-2 custom-datepicker"><input type="date"
                                            ...
                                            <div class="col-lg-2 col-md-2 d-grid"><button
                                                    class="btn btn-primary btn-block"
                                                    onclick="get_account_statement();">Submit</button></div>
                                        </div>
                                        ...
                                        <div class="mt-2 table-responsive">
                                            <table role="table" class="table table-bordered" id="account_history_table">
                                                <thead>
                                                    <tr role="row">
                                                        <th colspan="1" role="columnheader" class="report-date">Date
                                                        </th>
                                                        <th colspan="1" role="columnheader" class="report-sr text-end">
                                                            Sr no</th>
                                                        <th colspan="1" role="columnheader"
                                                            class="report-amount text-end">Credit</th>
                                                        <th colspan="1" role="columnheader"
                                                            class="report-amount text-end">Debit</th>
                                                        <th colspan="1" role="columnheader"
                                                            class="report-amount text-end">Pts</th>
                                            ...
                                            <div class="pagination-container" style="display:none;">
                                                ...
                                                <ul class="pagination mb-0 d-flex align-items-center">
                                                    <li><span class="me-2">Page <b><span id="currentpage">1</span> of
                                                                <span id="totalPages">1</span></b></span> | Go to Page
                                                        <input type="text" id="pageNumber"
                                                            class="page-input form-control d-inline-block ms-2"
                                                            value="1"></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12 text-center">
                                <div id="match_delete" role="radiogroup" tabindex="-1">
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input id="matched" type="radio" name="match_delete" autocomplete="off"
                                            checked='checked' value="1" class="custom-control-input">
                                        <label for="matched" class="custom-control-label"><span>Matched</span></label>
                                    </div>
                                    <div class="custom-control custom-control-inline custom-radio">
                                        <input id="deleteed" type="radio" name="match_delete" autocomplete="off"
                        ...
                        <div class="row row5">
                            <div class="col-12">
                                ...
                                <div class="table-responsive">
                                    <table role="table" aria-busy="false" aria-colcount="8"
                                        class="table b-table table-bordered" id="__BVID__886">
                                        <!---->
                                        <!---->
