        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <form action="bet_history_new.php" method="get">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control" name="smdl_name" id="smdl_name"
                                                    value="<?php if ($_REQUEST['smdl_name']) {
                                                        echo $_REQUEST['smdl_name'];
                                                    } ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control" name="mdl_name" id="mdl_name"
                                                    value="<?php if ($_REQUEST['mdl_name']) {
                                                        echo $_REQUEST['mdl_name'];
                                                    } ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control" name="dl_name" id="dl_name"
                                                    value="<?php if ($_REQUEST['dl_name']) {
                                                        echo $_REQUEST['dl_name'];
                                                    } ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <select class="form-control" name="event_type[]" id="event_type"
                                                    ...
                                                    <option value="9999999999" <?php echo $casino_selected; ?>>Casino
                                                    </option>
                                                </select>
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control" name="event_name"
                                                    id="event_name"
                                                    value="<?php if ($_REQUEST['event_name']) {
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control" name="market_name"
                                                    id="market_name"
                                                    value="<?php if ($_REQUEST['market_name']) {
                                                        echo $_REQUEST['market_name'];
                                                    } ?>">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                ...
                                                <input type="text" class="form-control has-feedback-left"
                                                    name="start_date" id="single_cal1" placeholder="Start Date"
                                                    aria-describedby="inputSuccess2Status"
                                                    value="<?php if ($_REQUEST['start_date']) {
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                ...
                                                <input type="text" class="form-control has-feedback-left"
                                                    name="end_date" id="single_cal2" placeholder="End Date"
                                                    aria-describedby="inputSuccess2Status"
                                                    value="<?php if ($_REQUEST['end_date']) {
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                ...
                                                <a href="javascript:void(0);" onclick="get_bet_history()"
                                                    class="btn btn-success">Submit</a>
                                                <a href="bet_history_new.php" class="btn btn-success">Reset</a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="form-group" style="display:none;">
            ...
            <input type="text" class="form-control" id="net_exposure_limit" name="net_exposure_limit" value="2000000" autocomplete="off">
                    ...
                    <button type="button" class="btn btn-default " id="otp_verify"
                        onclick="otp_verify()">Submit</button>
        ...
        $(document).ready(function () {
            ...
            $("#market_name").autocomplete({
                source: function (request, response) {
                    $.getJSON("ajaxfiles/ajax_autocomplete_market_name.php", {
            ...
            $('#modal-delete_otp').on('show.bs.modal', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (status == "ok") {
                            ...
                            if (betTable) {
                                betTable.ajax.reload(null, false);
                            }
                            $(".myLoading").hide();
                        } else {
                            // jQuery(".myLoading").hide();
        ...
        function get_bet_history() {
          ...
          if ($.fn.DataTable.isDataTable('#example')) {
            ...
            var formData = {
                ...
                login_type: "<?php echo $login_type; ?>",
                site_name: "<?php echo SITE_NAME; ?>",


            }

            betTable = $('#example').DataTable({
                processing: true,
                serverSide: true,
                serverMethod: 'post',
                ajax: {
                    url: "ajaxfiles/view_bet_history.php",
                    type: "POST",
                    data: formData,
                },
