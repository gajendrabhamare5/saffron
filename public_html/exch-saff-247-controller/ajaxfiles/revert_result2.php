<?php
	...
	$event_id = $_REQUEST['event_id'];
	 if($login_type == 5){
		$get_pnl_report  = $conn->query("select * from bet_details as b left outer join  user_login_master as ulm on ulm.UserID=b.user_id where b.event_name ='$event_id' and bet_status=0 order by b.event_id, b.market_type , b.market_id, b.bet_type");
	}else{
