                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Bollywood Casino 2
                                                ...
                                                <!---->
                                            </span> <small role="button" class="teenpatti-rules"  onclick="view_rules('btable2')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> <span class="float-right">
                                                Round ID:
                                        ...
                                        <?php
                                            if(!empty(IFRAME_URL_SET)){
                                                                        ?>
                                                                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".BTABLE2_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                                                        <?php
                                        ...
                                        <div class="casino-table">
                                            ...
                                            <div class="casino-table-box mt-3">
                                                ...
                                                <div class="casino-table-right-box right-cards">
                                                    <h4 class="w-100 text-center mb-2"><b class=" market_10_b_value">0</b></h4>
                                            ...
                                            <div class="casino-last-result-title last-result-tiele"><span>Last Result</span><span><a href="casinoresults?game_type=btable2">View All</a></span></div>
