                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Teenpatti - 2.0
                                                ...
                                                <small role="button" class="teenpatti-rules"  onclick="view_rules('teen6')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                            <iframe class="iframedesign" src="<?php echo IFRAME_URL."".TEEN6_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
