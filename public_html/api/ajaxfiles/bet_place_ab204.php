...
$get_check_result = $conn->query("select * from twenty_teenpatti_result where event_id='$eventId' and game_type='ab204'");
...
$url = CASINO_DATA_URL ."?type=ab204";
$ch = curl_init();
...
if($fetch_min_max_stake['net_exposure_limit'] < abs($total_exposure)){
