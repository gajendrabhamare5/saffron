...
$mid = $_REQUEST['mid'];
$cards = $_REQUEST['a_cards'];
$cards2 = $_REQUEST['a_cards'];
$cards3 = $_REQUEST['a_cards'];
$cards4 = $_REQUEST['b_cards'];

$mid = str_replace("14.", "", $mid);
$event_type = "AB20";
...
$b_cards = $_REQUEST['b_cards'];
$cards2 = json_decode($b_cards);
...
$conn->query("insert into twenty_teenpatti_result (event_id,game_type,result_status,cards,b_cards,result_time) VALUES('$mid','$game_type','$result_status','$cards3','$cards4','$result_time')");
/* if($row_count > 0){
  echo "ok";
  exit();
  } */
