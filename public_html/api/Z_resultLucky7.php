...
$is_tie = is_tie($a_cards[0], $cards);
if($is_tie)
    $result_status = 'T';
    
$temp_card_arr = $cards->$a_cards[0];
$bet_final_result .= '|| Card '.$temp_card_arr['name'];
