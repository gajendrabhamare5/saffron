...
$data_original = '{"t1":{"rid":"9013426871","mtime":"8/14/2025 6:28:26 PM","rdesc":"IND : 11 | AUS : 13","winnat":"AUS","win":"2","score":[{"cid":13767439,"nat":"IND","gmid":9013426871,"mid":8705567596818,"sid":1,"run":3,"card":"3SS","wkt":false,"ing":1,"oc":1},{"cid":13767440,"nat":"IND","gmid":9013426871,"mid":8705567596818,"sid":1,"run":0,"card":"10SS","wkt":false,"ing":1,"oc":1},{"cid":13767441,"nat":"IND","gmid":9013426871,"mid":8705567596818,"sid":1,"run":2,"card":"2SS","wkt":false,"ing":1,"oc":1},{"cid":13767442,"nat":"IND","gmid":9013426871,"mid":8705567596818,"sid":1,"run":6,"card":"6SS","wkt":false,"ing":1,"oc":1},{"cid":13767443,"nat":"AUS","gmid":9013426871,"mid":8705567596818,"sid":2,"run":3,"card":"3SS","wkt":false,"ing":2,"oc":1},{"cid":13767444,"nat":"AUS","gmid":9013426871,"mid":8705567596818,"sid":2,"run":4,"card":"4SS","wkt":false,"ing":2,"oc":1},{"cid":13767445,"nat":"AUS","gmid":9013426871,"mid":8705567596818,"sid":2,"run":6,"card":"6SS","wkt":false,"ing":2,"oc":1}],"gtype":"cricketv3"},"t2":null}';
	...
	if ($market_type == "FANCY_ODDS" || $market_type == "FANCY1_ODDS") {
		...
		if(strpos($bet_market_name, 'Tie') !== false){
			...
			if (strpos($bet_market_name, 'IND') !== false) {
				...
				//rsa
				$over_run = $all_scorebaord['AUS'][$over_market]['over'];
				$over_wkt = $all_scorebaord['AUS'][$over_market]['wkt'];
				if ($over_wkt == 1 and strpos($bet_market_name, 'Wicket') !== false) {
					set_result($conn, $bet_id, 'Win', $mid, $end_date_time, $bet_final_result);
				} else {
					if ($over_wkt == 0 and $over_run == 0 and strpos($bet_market_name, 'Zero') !== false) {
