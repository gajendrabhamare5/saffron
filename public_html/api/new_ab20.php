...
$cards3123 = '["'.$cards3.'"]';
$cards3123 = str_replace(',','","',$cards3123);

$cards2 = '["'.$cards2.'"]';
$cards2 = str_replace(',','","',$cards2);

$result_status=$result;
$conn->query("insert into twenty_teenpatti_result (event_id,game_type,result_status,cards,b_cards,result_time,desc_remakrs,data) VALUES('$mid','$game_type','$result_status','$cards3123','$cards2','$result_time','$rdesc','$data_original')");
