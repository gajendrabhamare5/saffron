...
$spit_list=explode("  ",$result_list[2]);
...
while ($fetch_get_all_bet = mysqli_fetch_assoc($get_all_bet)) {
    ...
    else if ((int)$bet_market_id == 17 || (int)$bet_market_id == 18) {
        $consecutive_result = $result_list[3];
       /* $consecutive_player=explode("  |  ",$consecutive_result); */
        if (strpos($consecutive_result, "A : Yes") !== false and $bet_type == "Back" and (int)$bet_market_id == 17) { 
            $winner_flag=true;
        }
        if (strpos($consecutive_result, "A : No") !== false and $bet_type == "Lay" and (int)$bet_market_id == 17) { 
            $winner_flag=true;
        }
        if (strpos($consecutive_result, "B : Yes") !== false and $bet_type == "Back" and (int)$bet_market_id == 18) { 
            $winner_flag=true;
        }
        if (strpos($consecutive_result, "B : No") !== false and $bet_type == "Lay" and (int)$bet_market_id == 18) { 
            $winner_flag=true;
        }
	}
    else{
