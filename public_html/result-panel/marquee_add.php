...
<title><?php echo SITE_NAME; ?> | Marquee Details</title>
<?php 
				...
				<div class="x_content">
					...
					<form method="post" class="form-horizontal form-label-left" novalidate>
						<div class="item form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Marquee<span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea rows="4" cols="50" id="marquee" name="marquee"required="required" class="form-control col-md-7 col-xs-12"><?php echo $marquee ?></textarea>
