							...
							<div class="row row5 andarbahar-module">
								<div class="col-md-9 andar-bahar coupon-card featured-box-detail">
									<div class="coupon-card">
										<div class="game-heading"><span class="card-header-title">Andar Bahar</span>
										...
										<div class="video-container">
											...
											if (!empty(IFRAME_URL_SET)) {
												...
												<iframe class="iframedesign"
													src="<?php echo IFRAME_URL . "" . ANDARBAHAR_CODE; ?>" width="100%"
											...
											<div class="casino-table">
												<div class="casino-table-box">
													<div class="andar-box">
														...
														<div class="ab-cards">
															<div class="card-odd-box">
																<div class="back-1 market_1_b_btn"><img id="ab_cards_1"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_1_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_2_b_btn"><img id="ab_cards_2"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_2_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_3_b_btn"><img id="ab_cards_3"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_3_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_4_b_btn"><img id="ab_cards_4"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_4_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_5_b_btn"><img id="ab_cards_5"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_5_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_6_b_btn"><img id="ab_cards_6"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_6_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_7_b_btn"><img id="ab_cards_7"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_7_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_8_b_btn"><img id="ab_cards_8"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_8_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_9_b_btn"><img id="ab_cards_9"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_9_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_10_b_btn"><img
																		id="ab_cards_10"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_10_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_11_b_btn"><img
																		id="ab_cards_11"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_12_b_btn"><img
																		id="ab_cards_12"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_13_b_btn"><img
																		id="ab_cards_13"
													...
													<div class="bahar-box">
														...
														<div class="ab-cards">
															<div class="card-odd-box">
																<div class="back-1 market_21_b_btn"><img
																		id="ab_cards_21"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_22_b_btn"><img
																		id="ab_cards_22"
																		src="storage/front/img/andar_bahar/0.jpg">
																</div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_23_b_btn"><img
																		id="ab_cards_23"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_24_b_btn"><img
																		id="ab_cards_24"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_25_b_btn"><img
																		id="ab_cards_25"
																		src="storage/front/img/andar_bahar/0.jpg">
																</div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_26_b_btn"><img
																		id="ab_cards_26"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_27_b_btn"><img
																		id="ab_cards_27"
																		src="storage/front/img/andar_bahar/0.jpg">
																</div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_28_b_btn"><img
																		id="ab_cards_28"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_29_b_btn"><img
																		id="ab_cards_29"
																		src="storage/front/img/andar_bahar/0.jpg">
																</div>
																<div
															...
															<div class="card-odd-box">
																<div class="back-1 market_30_b_btn"><img
																		id="ab_cards_30"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_30_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_31_b_btn"><img
																		id="ab_cards_31"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_31_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_32_b_btn"><img
																		id="ab_cards_32"
																		src="storage/front/img/andar_bahar/0.jpg">
																</div>
																<div
																	class="casino-nation-book market_32_b_exposure market_exposure">
																</div>
															</div>
															<div class="card-odd-box">
																<div class="back-1 market_33_b_btn"><img
																		id="ab_cards_33"
																		src="storage/front/img/andar_bahar/0.jpg"></div>
																<div
																	class="casino-nation-book market_33_b_exposure market_exposure">
																</div>
															</div>
														</div>
													</div>
												...
												<div class="casino-remark-div mt-1">
													<marquee class="casino-remark" scrollamount="3">Payout : Bahar 1st
														Card 25% and All Other Andar-Bahar Cards 100%.</marquee>
												</div>
											</div>
											<div class="casino-last-result-title"><span>Last Result</span><span><a
														href="casinoresults?game_type=ab20">View All</a></span></div>
				...
				if (data && data['t1'] && data['t1'][0]) {
					...
					for (var j in data['t2']) {
						...
						if (gstatus == "SUSPENDED" || gstatus == "0" || gstatus == "CLOSED") {
							//if ($(".market_" + selectionid + "_b_btn").hasClass("back-1")) {
