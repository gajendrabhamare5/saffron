...
<html lang="en">
 ...
 <script type="text/javascript">
    ...
    <body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
        <div id="app">
            <div id="load">
                <div id="load-inner"><img src="storage/logo.png" class="logo-login"> <i class="fa fa-spinner fa-spin"></i></div>
            </div>
            <div class="login">
                <div class="wrapper">
                        ...
                        <div class=" row">
                            <div class="col-md-12">
                                <div class="loginInner1">
                                    <div class="log-logo m-b-20 text-center"><img src="storage/logo.png" class="logo-login"></div>
