                            ...
                            <div class="row row5 teenpatti-1day">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Roulette
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('roulette13')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ROULETTE13_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                            ...
                                            <div class="video-overlay">
                                                ...
                                                <div class="coin-btns">
                                                    <div class=""><button class="btn btn-danger btnss undo_bet" disabled><i class="fas fa-undo"></i><span class="d-none d-md-flex">Undo Bet</span></button><span class="d-md-none">Undo Bet</span></div>
                                                    <div class=""><button class="btn btn-info repeat_bet"><i class="fas fa-redo"></i><span class="d-none d-md-flex">Repeat</span></button><span class="d-md-none">Repeat</span></div>
                                                    <div class=""><button class="btn btn-warning btnss clear_bet" disabled><i class="fas fa-trash"></i><span class="d-none d-md-flex">Clear</span></button><span class="d-md-none">Clear</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="casino-detail">
                                        ...
                                        <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=roulette13">View All</a></span></div>
