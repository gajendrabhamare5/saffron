								...
								<div class="col-md-9 featured-box-detail sports-wrapper m-b-10">
									...
									<div class="markets">
										...
										<div class="market-row">
											<p class="market-remark">"The King of All MATKA Market Open And Close Every Hour! LIVE RESULTS,100% TRUSTED.”</p>
										</div>
	...
	socket.on('eventGetLiveEventsFancyData', function(args) {
		if (args && args.body) {
			...
			if (args.body.cricketcasino) {
				console.log("num data",args.body.cricketcasino);
