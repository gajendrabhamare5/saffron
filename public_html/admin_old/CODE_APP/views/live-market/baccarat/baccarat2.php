            ...
            <div class="col-md-8 main-content baccarat">
                <div class="coupon-card">
                    ...
                    <div class="game-heading">
                        <span class="card-header-title">Baccarat 2 &nbsp; 
...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                       <!--  <iframe width="100%" height="400" src="<?php echo IFRAME_URL."".BACCARAT2_CODE; ?>" style="border: 0px;"></iframe> -->
                        ...
                        <div class="baccarat-container">
                            <div class="row row5">
                                <div class="col-12">
                                    <div class="row row5">
                                        <div class="col">
                                            <div class="bet-odds suspended market_6_b_btn market_6_row">Score 1-4 7.5:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_6_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bet-odds suspended market_7_b_btn market_7_row"> Score 5-6 4:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_7_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bet-odds suspended market_8_b_btn market_8_row"> Score 7 4.5:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_8_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bet-odds suspended market_9_b_btn market_9_row"> Score 8 3:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_9_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bet-odds suspended market_10_b_btn market_10_row"> Score 9 2.5:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_10_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=baccarat2" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
