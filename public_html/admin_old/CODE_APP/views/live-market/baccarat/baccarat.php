            ...
            <div class="col-md-8 main-content baccarat">
                <div class="coupon-card">
                    ...
                    <div class="game-heading">
                        <span class="card-header-title">Baccarat &nbsp; 
...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                       <!--  <iframe width="100%" height="400" src="<?php echo IFRAME_URL."".BACCARAT_CODE; ?>" style="border: 0px;"></iframe> -->
                        <div class="clock clock2digit flip-clock-wrapper"></div>
                    </div>

                    <div class="casino-container baccarat">
                        <div class="baccarat-container">
                            <div class="row row5">
                                <div class="col-12">
                                    <div class="row row5">
                                        <div class="col-3">
                                            <div class="bet-odds suspended market_6_b_btn market_6_row">Perferct Pair 25:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_6_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="bet-odds suspended market_7_b_btn market_7_row"> Big 0.54:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_7_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="bet-odds suspended market_8_b_btn market_8_row"> Small 1.5:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_8_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="bet-odds suspended market_9_b_btn market_9_row"> Either Pair 5:1</div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_9_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="bet-container">
                                        <div class="player-pair">
                                            <div class="suspended market_4_b_btn market_4_row"> Player Pair
                                                <br>11:1 </div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_4_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="player">
                                            <div class="suspended market_1_b_btn market_1_row"><b class="text-uppercase">Player</b> <span class="d-block">1:1</span>
                                                <div class="player-card">
                                                    <img id="card_c5" class="lrotate" style="display:none;" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png">
                                            ...
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_1_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="tie">
                                            <div class="suspended market_3_b_btn market_3_row">
                                                <div><b class="text-uppercase">Tie</b></div>
                                                <div class="mt-2">8:1</div>
                                            </div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_3_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="banker">
                                            <div class="suspended market_2_b_btn market_2_row"><b class="text-uppercase">Banker</b> <span class="d-block">1:1</span>
                                                <div class="player-card second">
                                                    <img id="card_c2" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png">
                                                    <img id="card_c4" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png">
                                                    <img id="card_c6" class="lrotate" style="display:none;" src="storage/front/img/cards/1.png">
                                                </div>
                                            </div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_2_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class="banker-pair">
                                            <div class="suspended market_5_b_btn market_5_row"> Banker Pair
                                                <br>11:1 </div>
                                            <div class="book">
                                                <div class="ubook m-t-5 text-danger"><b class="book market_5_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row row5 mt-1">
                                <div class="col-12 text-right"><span> 
                                        Min: <span>100</span> Max: <span>300000</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=baccarat" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
