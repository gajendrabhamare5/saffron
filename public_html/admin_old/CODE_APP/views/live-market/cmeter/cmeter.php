                    ...
                    <div>
                        <div class="cards_rows">
                            <div class="meter-lh-card-container mt-1">
                                <h5 class="d-inline-block mb-0"><b>Low</b> <span class="text-primary ml-1" id="card_c1">0</span></h5>
                        ...
                        <div class="cards_rows">
                            <div class="meter-lh-card-container mt-1">
                                <h5 class="d-inline-block mb-0"><b>High</b> <span class="text-primary ml-1" id="card_c2">0</span></h5>
...
//                        $(".cards_rows").hide();
                    ...
                    for (var c in cards) {
                        ...
                        if (cards_value == "A" || (cards_value >= 2 && cards_value <= 9)) {
                            //low
                            if (cards[c] != 1) {
                                low_cards += '<img src="' + site_url + 'storage/mobile/img/cards/' + cards[c] + '.png">';
                            }
                        } else {
                            //high
                            if (cards[c] != 1) {
                                high_cards += '<img src="' + site_url + 'storage/mobile/img/cards/' + cards[c] + '.png">';
                            }
                        }
...
<script>
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/meter/' + event_id,
            dataType: 'json',
