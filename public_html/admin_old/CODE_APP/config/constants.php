...
defined('MASTER_URL') OR define('MASTER_URL', '/admin_old');
defined('MASTER_DIR') OR define('MASTER_DIR', 'admin_old');
...
defined('SITE_IP') OR define('SITE_IP', 'https://dataservicedetails.com:2053/');
...
$game_list_new=array(
	...
	"super_over3"=>"Mini SUPER OVER",
	"goal"=>"Goal",
	"ab204"=>"Andar Bahar 150 Cards",
	"lucky15"=>"LUCKY 15",
	"super_over2"=>"SUPER OVER 2",
	...
	"odi_teenpatti"=>"Teenpatti 1-day",
	"2020teenpatti"=>"20-20 Teenpatti",
	"testteenpatti"=>"Test Teenpatti",
	"openteenpatti"=>"Teenpatti Open",
	...
	"worli_matka"=>"Worli Matka",
	"instant_worli"=>"Instant Worli",
	"amar_akbar_anthony"=>"Amar Akbar Anthony",
	"b_table"=>"Bollywood Table",
	"b_table2"=>"Bollywood Table 2",
	"lottcard"=>"Lottery",
	"five_5_cricket"=>"AUS vs IND 5Five Cricket",
	"2020_cricket_match"=>"20-20 Cricket Match",
	"casino_meter"=>"Casino Meter",
	"teen6"=>"Teenpatti - 2.0",
	"queen"=>"Queen",
	"race_20"=>"Race 20-20",
	"lucky7c"=>"Lucky 7 c",
	"super_over"=>"ENG VS RSA SUPER OVER",
	"trap"=>"The Trap",
	...
	"teen1"=>"1 CARD ONE-DAY1 CARD ONE-DAY",
	"ab3"=>"ANDAR BAHAR 50 CARDS",
	"amar_akbar_anthony2"=>"Amar Akbar Anthony 2",
	"race2"=>"Race to 2nd",
...
defined('GAME_LIST') OR define('GAME_LIST', serialize($game_list_new));
