...
<body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
                            ...
                            <div class="row row5 teenpatti-1day">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Teenpatti Poison One Day
                                                
                                                <!---->
                                            </span> <small role="button" class="teenpatti-rules"  onclick="view_rules('poison')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> <span class="float-right">
                                                Round ID:
  ...
  if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".POISON_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
                                            ...
                                            <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                            echo POISON_CODE; ?>" width="100%" height="400"
                                            ...
                                            <div class="video-overlay">
                                                <div class="videoCards">
                                                    <div>
                                                        <h3 class="text-white text-playerb">POISON</h3>
                                                        <div>
                                        ...
                                        <div class="casino-detail">
                                                ...
                                                <div class="casino-table-box">
                                                    <div class="casino-table-left-box">
                                                        ...
                                                        <div class="casino-table-row ">
                                                            ...
                                                            <div class="casino-odds-box back-1 market_1_b_btn suspended-box">
                                                                <span class="casino-odds market_1_b_val">2.57</span>
                                                            </div>
                                                            <div class="casino-odds-box lay-1 market_1_l_btn suspended-box">
                                                                <span class="casino-odds market_1_l_val">2.81</span>
                                                            </div>
                                                        </div>
                                                        <div class="casino-table-row">
                                                            <div class="casino-nation-detail">
                                                            ...
                                                            <div class="casino-odds-box back-1 market_2_b_btn suspended-box">
                                                                <span class="casino-odds market_2_b_val">1.56</span>
                                                            </div>
                                                            <div class="casino-odds-box lay-1 market_2_l_btn suspended-box">
                                                                <span class="casino-odds market_2_l_val">1.63</span>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="casino-table-right-box joker-other-odds">
                                                        ...
                                                        <div class="casino-table-body">
                                                            <div class="casino-table-row">
                                                                ...
                                                                <div class="casino-odds-box back-1 market_3_b_btn suspended-box">
                                                                    <span class="casino-odds market_3_b_val">0</span>
                                                                    <div class="casino-nation-book market_3_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_4_b_btn suspended-box">
                                                                    <span class="casino-odds market_4_b_val">0</span>
                                                                    <div class="casino-nation-book market_4_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_5_b_btn suspended-box">
                                                                    <span class="casino-odds market_5_b_val">0</span>
                                                                    <div class="casino-nation-book market_5_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_6_b_btn suspended-box">
                                                                    <span class="casino-odds market_6_b_val">0</span>
                                                        ...
                                                        <div class="casino-table-body">
                                                            <div class="casino-table-row ">
                                                                ...
                                                                <div class="casino-odds-box back-1 market_7_b_btn suspended-box">
                                                                    <span class="casino-odds market_7_b_val">0</span>
                                                                    <div class="casino-nation-book market_7_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_8_b_btn suspended-box">
                                                                    <span class="casino-odds market_8_b_val">0</span>
                                                                    <div class="casino-nation-book market_8_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_9_b_btn suspended-box">
                                                                    <span class="casino-odds market_9_b_val">0</span>
                                                                    <div class="casino-nation-book market_9_b_exposure market_exposure"></div>
                                                                </div>
                                                                <div class="casino-odds-box back-1 market_10_b_btn suspended-box">
                                                                    <span class="casino-odds market_10_b_val">0</span>
                                            ...
                                            <div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a
                                                     href="casinoresults?game_type=poison" class="">View All</a></span></div>
...
<script type="text/javascript" src='footer-js.js?6'></script>
