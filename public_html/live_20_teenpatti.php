                ...
                <div class="container-fluid container-fluid-5">
                    <div class="row row5">
                        ...
                        <div class="col-md-10 featured-box">
                            <div class="row row5 teen20-container teenpatti-20">
                                <div class="col-md-9 casino-container coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">20-20 Teenpatti
											...
											<!----></span>
											<small role="button" class="teenpatti-rules"  onclick="view_rules('20_teenpatti')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
                                        ...
                                        <div class="video-container">
												...
												?>
												<iframe class="iframedesign" src="<?php echo IFRAME_URL."".A2020TEENPATTI_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
												<?php
											...
											<!--	<iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                             <iframe class="iframedesign" src="<?php echo IFRAME_URL; echo A2020TEENPATTI_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                        ...
                                        <div class="casino-detail">
												...
												<div class="casino-table-box">
													<div class="casino-table-left-box">
														...
														<div class="casino-table-row">
															...
															<div class="casino-odds-box back suspended-box market_11_row back-1 market_11_b_btn">
															...
															<div class="casino-odds-box back suspended-box market_3_row back-1 market_3_b_btn">
											...
											<div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teen20">View All</a></span></div>
