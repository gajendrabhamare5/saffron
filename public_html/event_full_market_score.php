            ...
            Max: <span id="bookmaker_max">1</span></b></div>
                                    ...
                                    <?php if($eventType == 4 || $eventType == 8){ ?>
										...
										<ul class="nav nav-tabs mt-1">
											...
											<li class="nav-item"><a data-toggle="tab" href="#ball" class="nav-link">Ball</a></li>
		...
		if(args.body.cricket){
			if(args.body.cricket[0]){
				if(!args.body.cricket[0][0]){
					args.body.cricket[0] = [args.body.cricket[0]];
				}
...
jQuery(document).on("input", "#inputStake", function () {
	...
	if(bet_markettype != "FANCY_ODDS" && bet_markettype != "BOOKMAKER_ODDS" && bet_markettype != "BOOKMAKERSMALL_ODDS"){
