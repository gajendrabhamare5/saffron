...
$casino_lis_db=array_column($casino_maintanance_list_data, 0);
	...
	$get_blockeventdata = $conn->query("SELECT * FROM `block_event` WHERE UserId='$user_id' and casino_name='ab3';");
...
$get_check_result = $conn->query("select * from twenty_teenpatti_result where event_id='$eventId' and game_type='ab3'");
...
if($get_data->odds->t2[0]->gstatus != 'ACTIVE' and $get_data->odds->t2[0]->gstatus != 'OPEN'){
	$return = array(
		"status"=>'error',
		"message"=>'Bet Suspended',
	);
