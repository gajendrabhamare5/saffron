    ...
    <div class="listing-grid casino-grid">
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">Lucky 7 - C
                            <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('lucky7-rules.jpg')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>  -->
                            <!---->
                        </span>
                        <!-- <small role="button" class="teenpatti-rules" onclick="view_rules('lucky7eu2')"
                    ...
                    <div class="video-container">
                        ...
                        if (!empty(IFRAME_URL_SET)) {
                            ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . LUCKY7EU2_CODE; ?>" width="100%"
                        ...
                        echo LUCKY7EU2_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                        ...
                        <div class="video-overlay">
                            <div class="card-inner">
                                <h3 class="text-white">Cards</h3> <img id="card_c1" src="/storage/front/img/cards/1.png">
                            </div>
                        </div>
                    ...
                    <div class="casino-detail">
                        <div class="casino-table">
                            <!-- <div class="casino-table-full-box">
                                                    <div class=" lucky7low">
                                                        <div class="casino-odds text-center market_1_b_value">0</div>
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_1_row back-1 market_1_b_btn"><span class="casino-odds">Low Card</span></div>
                                                        <div class="casino-nation-book text-center market_1_b_exposure market_exposure"></div>
                                                    </div>
                                                    <div class="lucky7"><img src="/storage/front/img/cards/7.png"></div>
                                                    <div class=" lucky7high">
                                                        <div class="casino-odds text-center market_2_b_value">0</div>
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_2_row back-1 market_2_b_btn"><span class="casino-odds">High Card</span></div>
                            ...
                            <!-- <div class="casino-table-box mt-3">
                                                    <div class="casino-table-left-box">
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_3_row back-1 market_3_b_btn"><span class="casino-odds">Even</span></div>
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_4_row back-1 market_4_b_btn"><span class="casino-odds">Odd</span></div>
                                                    ...
                                                    <div class="casino-table-right-box">
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_5_row back-1 market_5_b_btn"><span class="casino-odds"><span class="card-icon ms-1"><span class="card-red ">{</span></span><span class="card-icon ms-1"><span class="card-red ">[</span></span></span></div>
                                                        ...
                                                        <div class="casino-odds-box back casino-odds-box-theme suspended-box market_6_row back-1 market_6_b_btn"><span class="casino-odds"><span class="card-icon ms-1"><span class="card-black ">}</span></span><span class="card-icon ms-1"><span class="card-black ">]</span></span></span></div>
                                                        <div class="casino-nation-book text-center market_6_b_exposure market_exposure"></div>
                                                        </div>
                                                    </div>
                                                </div> -->
                            <div class="card-content lucky-seven-content m-t-10" style="width:100%">
                                    ...
                                    <div class="d-flex" style="gap: 7px;width: 40%;">
                                        <div class="text-center" style="width: 40%;">
                                            <button class="low-high-btn showbet-action market_1_row market_1_b_btn b1"
                                                ...
                                                <div class="text-center"> <b>2</b> </div><b>Low Card</b>
                                            </button>
                                        ...
                                        <div class="text-center" style="width: 40%;">
                                            <button class="low-high-btn showbet-action market_2_row market_2_b_btn b2"
                                                ...
                                                eventid="251507130035" markettype="LUCKY7B" event_name="LUCKY7B"
                                                fullmarketodds="2.00" fullfancymarketrate="2.00">
                                                <div class="text-center"> <b>2</b> </div><b>High Card</b>
                                            </button>
                                ...
                                R:<span>100</span>-<span>1L</span></div> 
                                    ...
                                    <div class="d-flex" style=" gap: 5px;width: 55%;">
                                        <div class="text-center" style="width: 25%;">
                                            <button class="low-high-btn showbet-action market_3_row market_3_b_btn"
                                                data-index="2">
                                                <div class="text-center"> <b>2.1</b> </div><b>Even</b>
                                            </button>
                                        ...
                                        <div class="text-center" style="width: 25%;">
                                            <button class="low-high-btn showbet-action market_4_row market_4_b_btn"
                                                data-index="3">
                                                <div class="text-center"> <b>1.79</b> </div><b>Odd</b>
                                            </button>
                                        ...
                                        <div class="text-center" style="width: 25%;">
                                            <button class="text-uppercase btn-theme market_6_row market_6_b_btn"
                                                data-index="5">
                                        ...
                                        <div class="text-center" style="width: 25%;">
                                            <button class="text-uppercase btn-theme market_5_row market_5_b_btn"
                                                data-index="4">
                                                <div class="text-center" style="color: #fff;"> <b>1.95</b> </div>
                                                <div class="color-card"></div> <span class="card-icon"><span
                            ...
                            <div class="casino-table-box mt-3">
                                <div class="lucky7cards">
                                    <div class="casino-odds w-100 text-center market_20_b_value">0</div>
                                    <div
                                        class="card-odd-box-container suspended-box market_20_row back-1 market_20_b_btn">
                                    ...
                                    <div
                                        class="casino-nation-book text-center w-100 market_20_b_exposure market_exposure text-danger">
                                    </div>
                                     <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                                </div>
                                <div class="lucky7cards">
                                    <div class="casino-odds w-100 text-center market_21_b_value">0</div>
                                    <div
                                        class="card-odd-box-container suspended-box market_21_row back-1 market_21_b_btn">
                                        <div class="card-odd-box">
                                    ...
                                    <div
                                        class="casino-nation-book text-center w-100 market_21_b_exposure market_exposure text-danger">
                                    </div>
                                     <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                                </div>
                                <div class="lucky7cards">
                                    <div class="casino-odds w-100 text-center market_22_b_value">0</div>
                                    <div
                                        class="card-odd-box-container suspended-box market_22_row back-1 market_22_b_btn">
                                        <div class="card-odd-box">
                                    ...
                                    <div
                                        class="casino-nation-book text-center w-100 market_22_b_exposure market_exposure text-danger">
                                    </div>
                                     <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                                </div>
                                <div class="lucky7cards">
                                    <div class="casino-odds w-100 text-center market_23_b_value">0</div>
                                    <div
                                        class="card-odd-box-container suspended-box market_23_row back-1 market_23_b_btn">
                                        <div class="card-odd-box">
                                    ...
                                    <div
                                        class="casino-nation-book text-center w-100 market_23_b_exposure market_exposure text-danger">
                                    </div>
                                     <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                                </div>
                            ...
                            <div class="casino-table-full-box lucky7acards mt-3">
                                <div class="casino-odds w-100 text-center market_7_b_value">0</div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_7_row back-1 market_7_b_btn"><img
                                            src="/storage/front/img/cards/A.png"></div>
                                    <div class="casino-nation-book market_7_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_8_row back-1 market_8_b_btn"><img
                                            src="/storage/front/img/cards/2.png"></div>
                                    <div class="casino-nation-book market_8_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_9_row back-1 market_9_b_btn"><img
                                            src="/storage/front/img/cards/3.png"></div>
                                    <div class="casino-nation-book market_9_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_10_row back-1 market_10_b_btn"><img
                                            src="/storage/front/img/cards/4.png"></div>
                                    <div class="casino-nation-book market_10_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_11_row back-1 market_11_b_btn"><img
                                            src="/storage/front/img/cards/5.png"></div>
                                    <div class="casino-nation-book market_11_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_12_row back-1 market_12_b_btn"><img
                                            src="/storage/front/img/cards/6.png"></div>
                                    <div class="casino-nation-book market_12_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_13_row back-1 market_13_b_btn"><img
                                            src="/storage/front/img/cards/7.png"></div>
                                    <div class="casino-nation-book market_13_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_14_row back-1 market_14_b_btn"><img
                                            src="/storage/front/img/cards/8.png"></div>
                                    <div class="casino-nation-book market_14_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_15_row back-1 market_15_b_btn"><img
                                            src="/storage/front/img/cards/9.png"></div>
                                    <div class="casino-nation-book market_15_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_16_row back-1 market_16_b_btn"><img
                                            src="/storage/front/img/cards/10.png"></div>
                                    <div class="casino-nation-book market_16_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_17_row back-1 market_17_b_btn"><img
                                            src="/storage/front/img/cards/J.png"></div>
                                    <div class="casino-nation-book market_17_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_18_row back-1 market_18_b_btn"><img
                                            src="/storage/front/img/cards/Q.png"></div>
                                    <div class="casino-nation-book market_18_b_exposure market_exposure text-danger">
                                    </div>
                                </div>
                                <div class="card-odd-box">
                                    <div class="suspended-box market_19_row back-1 market_19_b_btn"><img
                                            src="/storage/front/img/cards/K.png"></div>
                                    <div class="casino-nation-book market_19_b_exposure market_exposure text-danger">
                                    </div>
                                     <div class="casino-min-max text-right">
                                        R:<span>100</span>-<span>5K</span></div>
                                </div>
                        ...
                        <div class="fancy-marker-title">
                            <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=lucky7"
                                    class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a>
                            </h4>
                        </div>
                        <div class="m-b-10">
                            <p class="text-right" id="last-result">0</p>
                        </div>

                        <!-- <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=lucky7eu2">View
                                    All</a></span></div>
                        <div class="casino-last-results" id="last-result">
                             <span class="result result-a">L</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-a">L</span><span class="result result-a">L</span><span class="result result-b">H</span><span class="result result-a">L</span><span class="result result-a">L</span><span class="result">T</span>
                        </div> -->
                    </div>
                </div>
            </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Lucky 7 - C Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
        ...
        if (data && data['t1'] && data['t1'][0]) {
            ...
            for (var j in data['t2']) {
                ...
                if (selectionid == 1 || selectionid == 3 || selectionid == 5 || selectionid == 7) {
                    $(".market_" + selectionid + "_min_max").html("Min:" + data['t2'][j].min + " Max:" + data[
                        't2'][j].max + "");
...
function updateResult(data) {
    ...
    if (data && data[0]) {
        ...
        data.forEach((runData) => {
            ...
            eventId = runData.mid == 0 ? 0 : String(runData.mid).split(".")[1];
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/lucky7eu2/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    ...
    if (xhr && xhr.readyState != 4)
        xhr.abort();
    xhr = $.ajax({
        url: MASTER_URL + '/live-market/lucky7/active_bets/lucky7eu2/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_view_more_bets() {
    ...
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/lucky7/view_more_matched/lucky7eu2/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    ...
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/lucky7/market_analysis/lucky7eu2/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
