            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    ...
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ROULLETE11; ?>" width="100%"
            ...
            <div class="modal-dialog" style="min-width: 1000px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">ROULLETE11 </h4>
...
<script>
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/roullete11/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
