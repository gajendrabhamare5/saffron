        ...
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">1 CARD 20-20
                        ...
                        <span class="float-right">
                            Round ID:
                            <span
                                class="round_no">0</span><!--   | Min: <span>100</span> | Max: <span>500000</span> --></span>
                    </div>
                    <!---->
                    <div class="video-container">
                        ...
                        ?>
                            <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEEN120_CODE; ?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                                echo TEEN120_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
...
<div class="rules-section">
                    ...
                    <div class="casino-table">
                        <div class="dtobx-top">
                            <div class="dragon-box market_1_b_btn">
                                <div class="flex-book"><b>Player</b> <span class="d-block book-red  market_1_b_exposure market_exposure text-danger">0</span></div>
                                <div class="text-center flex-odds"><span class="d-block market_1_row"><b>2</b></span></div>
                            </div>
                            <div class="tiebox market_3_b_btn">
                                <div class=""><b>Tie</b></div>
                                <div class="text-center flex-odds"><span class="d-block market_3_row"><b>50</b></span> <span class="d-block book-red market_3_b_exposure market_exposure text-danger ">0</span></div>
                            </div>
                            <div class="tiger-box market_2_b_btn">
                                <div class="flex-book"><b>Dealer</b> <span class="d-block book-red market_2_b_exposure market_exposure text-danger">0</span></div>
                                <div class="text-center flex-odds market_2_row"><span class="d-block"><b>2</b></span></div>
                            </div>
                            <div class="pair-box market_4_b_btn">
                                <div class=""><b>Pair</b></div>
                                <div class="text-center flex-odds"><span class="d-block market_4_row"><b>12</b></span> <span class="d-block book-red  market_4_b_exposure market_exposure text-danger ">0</span></div>
                            </div>
                        </div>
                    </div>

                    <div class="casino-last-result-title"><span>Last Result</span><span><a
                                href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen120">View All</a></span>
                    </div>
            ...
            <div class="modal-dialog" style="min-width: 650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">1 CARD 20-20 Result</h4>
        ...
        socket.on('game', function(data) {
            ...
            if (data && data1.t1) {
                ...
                for (var j in data.t2) {
                    ...
                    $(".market_" + selectionid + "_row").html(b1);
...
<script>
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen120/' + event_id,
            dataType: 'json',
            data: {
                event_id: event_id,
    ...
    function call_active_bets() {
        ...
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/others/active_bets/teen120/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_view_more_bets() {
        ...
        if (xhr_vm && xhr_vm.readyState != 4)
            xhr_vm.abort();
        xhr_vm = $.ajax({
            url: MASTER_URL + '/live-market/others/view_more_matched/teen120/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
    ...
    function call_analysis() {
        ...
        if (xhr_analysis && xhr_analysis.readyState != 4)
            xhr_analysis.abort();
        xhr_analysis = $.ajax({
            url: MASTER_URL + '/live-market/others/market_analysis/teen120/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.results == 0) {
