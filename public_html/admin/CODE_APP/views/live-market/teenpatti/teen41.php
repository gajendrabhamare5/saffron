    ...
    <div class="listing-grid casino-grid">
        <div class="coupon-card row">
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading"><span class="card-header-title">Queen Top Open Teenpatti
                        ...
                        <!-- <small role="button" class="teenpatti-rules"  onclick="view_rules('teen41')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small>   -->
                    ...
                    <div class="video-container">
                        ...
                        <?php
                                            if(!empty(IFRAME_URL_SET)){
                                                                        ?>
                        <iframe class="iframedesign" src="<?php echo IFRAME_URL."".TEEN41_CODE;?>" width="100%"
                        ...
                        <!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                          <iframe class="iframedesign" src="<?php echo IFRAME_URL;
                                                            echo TEEN41_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                                            ...
                                            <div>
                                                ...
                                                <div class="rules-section">
                                                    <ul class="pl-4 pr-4 list-style">
                                                        <li>Queen top teenpatti is a unique version of Indian origin
                                                            game teenpatti (Flush).</li>
                                                        <li>This game is played with a regular 52 cards deck between
                                                            player A and player B.</li>
                                                        <li>In Queen top open teenpatti all three cards of player A will
                                                        ...
                                                        <li>Queen top open teenpatti is a three-card game. Three cards
                    ...
                    <div class="casino-detail">
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row ">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                ...
                                                <div
                                                    class="casino-nation-book text-center market_1_b_exposure market_exposure text-danger">
                                                </div>
                                    ...
                                    <div class="casino-table-body">
                                        <div class="casino-table-row">
                                            <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                <div class="casino-nation-name  d-flex justify-content-between vertical-align: baseline;" style="width: 100%;">Main
                                                <div
                                                    class="casino-nation-book text-center market_2_b_exposure market_exposure text-danger">
                                                </div>
                                                <div class="info-block m-t-5" style="position: relative; display: inline-block;">
                                        ...
                                        <div class="casino-table-row under-over-row">
                                            <div class="uo-box">
                                                <div class="casino-nation-detail" style="display: flex;text-align: center;vertical-align: baseline;">
                                                    ...
                                                    <span style="width: 100%;text-align: end;">
                                                        <b class="casino-nation-book text-center market_3_b_exposure market_exposure text-danger"></b>
                                            ...
                                            <div class="uo-box">
                                                <div class="casino-nation-detail"  style="display: flex;text-align: center;vertical-align: baseline;">
                                                    ...
                                                    <span style="width: 100%;text-align: end;">
                                                        <b class="casino-nation-book text-center market_4_b_exposure market_exposure text-danger"></b>
                        ...
                        <div class="casino-last-result-title"><span>Last Result</span><span><a
                                    href="<?php echo MASTER_URL; ?>/reports/casino-results?q=teen41">View All</a></span>
                        </div>
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Queen Top Open Teenpatti Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
function view_casiono_result(event_id, casino_type) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/teen41/' + event_id,
        dataType: 'json',
        data: {
            event_id: event_id,
...
function call_active_bets() {
    if (get_round_no() > 0) {
        if (xhr && xhr.readyState != 4)
            xhr.abort();
        xhr = $.ajax({
            url: MASTER_URL + '/live-market/teenpatti/active_bets/teen41/' + get_round_no(),
            type: 'POST',
            dataType: 'json',
...
function call_view_more_bets() {
    if (xhr_vm && xhr_vm.readyState != 4)
        xhr_vm.abort();
    xhr_vm = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/view_more_matched/teen41/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
...
function call_analysis() {
    if (xhr_analysis && xhr_analysis.readyState != 4)
        xhr_analysis.abort();
    xhr_analysis = $.ajax({
        url: MASTER_URL + '/live-market/teenpatti/market_analysis/teen41/' + get_round_no(),
        type: 'POST',
        dataType: 'json',
        success: function(data) {
            if (data.results == 0) {
