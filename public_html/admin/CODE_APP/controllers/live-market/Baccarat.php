...
class Baccarat extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Baccarat';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/baccarat/baccarat', array('handler' => $this));
    ...
    public function listing() {
        ...
        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/baccarat/list', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function teensin() {
        $this->load->library('users', $this);
        ...
        $this->layout['title'] = PROJECTNAME . ' - 29 Card Baccarat';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/baccarat/teensin', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'baccarat', $event_id = '') {
        ...
        $shortcodeArr = array('baccarat' => 'BACCARAT','teensin' => 'TEENSIN');
    ...
    public function view_more_matched($game = 'baccarat', $event_id = '') {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'baccarat', $event_id = '') {
