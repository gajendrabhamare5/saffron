...
class Race20 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->layout['title'] = PROJECTNAME . ' Race 20-20';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/race20/race20', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }

    public function active_bets($type = 'race20', $event_id = '')
    {
        ...
        $shortcodeArr = array('race20' => 'RACE_20');
    ...
    public function view_more_matched($game = 'race20', $event_id = '')
    {
        $this->load->database();
        $this->load->library('users', $this);
    ...
    public function market_analysis($type = 'race20', $event_id = '')
    {
