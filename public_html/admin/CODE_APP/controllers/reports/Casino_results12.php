...
class Casino_results extends CI_Controller {
    ...
    public function get_casino_results($offset = 0) {
        ...
        if (count($casino_results_data) > 0) {
            ...
            foreach ($casino_results_data as $key => $cr) {
                ...
                if (in_array($cr['game_type'], array('teen20', 'teenOdi', 'poker', 'poker20', 'poker9'))) {
                    if ($result == '0')
    ...
    public function get_result($game_type = '', $round_id = 0) {
        ...
        if ($result_data) {
            ...
            if (in_array($result_data['game_type'], array('teen20', 'teen9', 'teenOdi'))) {
                $m_body_html .= '
                ...
                $card_3_arr = array_chunk($cards_arr, 3);
            ...
            <div class="container-fluid">
               ...
               <div class="eightplayer">
                        ...
                        <div class="row board-result m-t-10">
                            <div class="col-md-12 ">
                                <div class="board-result-inner">
                                    <div class="m-b-5">
                                        <span class="greenbx">Winner:</span> ' . $descArr[0] . '
                                    </div>
                                    <div class="m-b-5">
                                        <span class="redbx">PLAYER A:</span> ' . $descArr[1] . '
                                    </div>
                                    <div class="m-b-5">
                                        <span class="yellowbx">PLAYER B:</span> ' . $descArr[2] . '
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            else if ($result_data['game_type'] == 'war') {
            ...
            } else if ($result_data['game_type'] == 'meter') {
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row player-container m-t-10">
                            <div class="player-number">
                                ...
                                <div class="player-image-container row">
                                    <div class="col-md-12 text-center">
                                        ' . (($cards[5] != 1) ? '<img src="' . WEB_URL . 'storage/front/img/cards/' . $cards[5] . '.png" class="lrotate mr-2 m-r-15">' : '') . '
                                    ...
                                    <div class="col-md-12 text-center win-cup-pos">
                                        ' . (($result_status == 'P') ? '<div class="winner-icon mt-3"><i class="fas fa-trophy"></i></div>' : '') . '
                                    </div>
                                </div>
                            </div>
                            <div class="player-number">
                                ...
                                <div class="player-image-container row">
                                    <div class="col-md-12 text-center">
                                        ...
                                        ' . (($cards[6] != 1) ? '<img src="' . WEB_URL . 'storage/front/img/cards/' . $cards[6] . '.png" class="rrotate mr-2 m-r-15">' : '') . '
                                    </div>
                                    <div class="col-md-12 text-center win-cup-pos">
                                        ' . (($result_status == 'B') ? '<div class="winner-icon mt-3"><i class="fas fa-trophy"></i></div>' : '') . '
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $m_body_html .= '
                    <div class="container-fluid">
                        <div class="row m-t-10">
                            <div class="col-md-12"> <span class="float-right round-id"><b>Round ID:</b> 202007142948</span> </div>
                        </div>
                        <div class="row player-container m-t-10">
                            <div class="player-number">
                                <div class="player-image-container row">
