                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">1 CARD ONE-DAY
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('teen1')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                            ...
                                            <div class="casino-table-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row markets" data-title="SUSPENDED">
                                                            <div class="casino-nation-detail">
                                                                <div class="casino-nation-name">Player</div>
                                                ...
                                                <div class="casino-table-right-box">
                                                    ...
                                                    <div class="casino-table-body">
                                                        <div class="casino-table-row markets" data-title="SUSPENDED">
                                                            <div class="casino-nation-detail">
                                                                <div class="casino-nation-name">Dealer</div>
