                                ...
                                <div class="col-md-9 casino-container coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">
                                                ...
                                                <small role="button" class="teenpatti-rules"  onclick="view_rules('goal')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small>
                                                ...
                                                <span>500000</span></span> -->
                                                 ...
                                                 <div class="video-container">
                                                    ...
                                                    if(!empty(IFRAME_URL_SET)){
                                                                                ?>
                                                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL."".GOAL_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                                                                <?php
                                        ...
                                        <div class="casino-detail detail-page-container position-relative">
                                            ...
                                            <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=goal">View All</a></span></div>
