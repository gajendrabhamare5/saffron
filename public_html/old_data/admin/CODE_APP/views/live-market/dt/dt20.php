                                ...
                                <div class="row">
                                    ...
                                    <div class="card-dt col-md-12 text-center m-t-10">
                                        ...
                                        <div class=" m-r-5 card-image showbet-action" data-index="10">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_28_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="11">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_29_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="12">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_30_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="13">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_31_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="14">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_32_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="15">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_33_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="16">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_34_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="17">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_35_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="18">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_36_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="19">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_37_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                        <div class=" m-r-5 card-image showbet-action" data-index="20">
                                            ...
                                            <div class="ubook m-t-5 text-danger">
                                                <div class="ubook m-t-5 text-danger"><b class="market_38_b_exposure market_exposure">0</b></div>
                                            </div>
                                        </div>
                                    </div>
