...
class Common1_model extends CI_Model {
    ...
    function get_my_partnership($user_data = array(), $betting_data = array(),$return_type = 'my') {
		...
		if(WHTELABEL_PER < 100){
			$cn_per = 100;
			$level_per_arr[CONTROLLER_ID] = $cn_per - WHTELABEL_PER;	
		}
		/*	Controller	*/
    ...
    function get_partnership_with_power($user_data = array(), $betting_data = array(),$return_type = 'my') {
		...
		if(WHTELABEL_PER < 100){
			$cn_per = 100;
			$level_per_arr[CONTROLLER_ID]['per'] = $cn_per - WHTELABEL_PER;
			$level_per_arr[CONTROLLER_ID]['power'] = CONTROLLER_POWER;
			$level_per_arr[CONTROLLER_ID]['Email_ID'] = CONTROLLER_EMAIL_ID;
