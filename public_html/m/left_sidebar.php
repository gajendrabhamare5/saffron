    ...
    <ul class="nav flex-column">
      <li class="nav-item">
        ...
        <ul id="PoliticsNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#PoliticsNested2" class="nav-link toggle-nested" data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
      ...
      <li class="nav-item">
        ...
        <ul id="cricketNested" class="collapse flex-column nested-nav">
          <li class="nav-item">
            <a href="#cricketNested2" class="nav-link toggle-nested" data-bs-toggle="collapse"
              role="button"
              aria-expanded="false"
