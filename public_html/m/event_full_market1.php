...
<style>
	...
	.bookmaker-market .suspended:before, .bookmaker-tied-market .suspended:before, .fancy-market .suspended:before {
		background-image: unset !important;
	}
	.custbold {
		pointer-events: all !important;
	}
	.fancy-market-number .suspended:before,.fancy-market-number .suspended:after {
    	width: 20%;
	}
									...
									<div class="tab-content">
											...
											<div class="fancy-market">
												<div id="fancy_odds_market" style="display:none;">
													...
													<div class="table-header">
														<div class="market-title1 float-left country-name box-4"><!-- <span>Normal</span>
															<p class="float-right mb-0" data-target="#view_fancy_rules" data-toggle="modal"><i class="fas fa-info-circle"></i></p> -->
														</div>
														<div class="box-1 float-left lay text-center lablesize"><b>No</b></div>
														<div class="back box-1 float-left back text-center lablesize"><b>Yes</b></div>
													</div>
                                                ...
                                                <div class='market-title mt-1'>Over By Over Session</div>
													<div class="table-header">
                                        ...
                                        <div id="oddeven" class="tab-pane active">
											...
											<div class="fancy-market">
                                                ...
                                                <div class='market-title mt-1'>Odd Even</div>
										...
										if (args.body1.body.cricket) {
											if (args.body1.body.cricket[0]) {
												...
												if (args.body1.body.cricket[0].bookmaker && args.body1.body.cricket[0].bookmaker != null) {
													...
													html_bookmaker_odds += "<div id='bookmaker_market_div_0'><div class='market-title mt-1'>Bookmaker market<p class='float-right mb-0' data-target='#view_bookmaker_rules' data-toggle='modal'><i class='fas fa-info-circle'></i></p></div><div class='"+classdesignbook+"'><div class='table-header'><div class='float-left country-name box-6 min-max'><b>Min:  <span id='bookmaker_min'></span> Max: <span id='bookmaker_max'></span> </b></div><div class='back box-1 float-left text-center lablesize'><b>Back</b></div><div class='lay box-1 float-left text-center lablesize'><b>Lay</b></div></div>";
													var xc = 0;
						...
						if (args.body1.body.cricket) {
							if (args.body1.body.cricket[0]) {
								...
								if (args.body1.body.cricket[0].bookmaker && args.body1.body.cricket[0].bookmaker != null) {
									...
									html_bookmaker_odds = "";
									html_bookmaker_odds += "<div id='bookmaker_market_div_0'><div class='market-title mt-1 cashout'>Bookmaker market<button class='btn btn-success btn-sm' disabled=''>Cashout</button></div><div class='bookmaker-market'><div class='table-header'><div class='float-left country-name box-6 min-max'><b>Min:  <span id='bookmaker_min'></span> Max: <span id='bookmaker_max'></span> </b></div><div class='back box-1 float-left text-center lablesize'><b>Back</b></div><div class='lay box-1 float-left text-center lablesize'><b>Lay</b></div></div>";
									var xc = 0;
									for (z = 0; z < args.body1.body.cricket[0].bookmaker.length; z++) {
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#fancyBetMarket_" + last_event_id + "_" + last_market_id;
									...
									if (marketId == "" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {} else {
										...
										if (true) {
											...
											if (m1) {
												...
												back_attribute = " event_name='" + event_name + "' fullmarketodds='" + runsYes + "' side='Lay' marketid='" + marketId + "' eventid='" + eventId + "'  selectionid='" + marketId + "' market_odd_name='' runner='" + marketName + "' marketname='" + marketName + "' markettype='FANCY_ODDS' inplay='1' fullfancymarketrate='" + oddsYes + "'";
												lay_attribute = " event_name='" + event_name + "' fullmarketodds='" + runsNo + "' side='Lay' marketid='" + marketId + "' eventid='" + eventId + "' selectionid='" + marketId + "' market_odd_name='' runner='" + marketName + "' marketname='" + marketName + "' markettype='FANCY_ODDS' inplay='1' fullfancymarketrate='" + oddsNo + "'";
												html_fancy_market_new += "<div id='fancyOverBetMarket_" + eventId + "_" + marketId + "'><div class='fancy-tripple' > <div data-title='SUSPENDED' class='table-row suspended fancy-over-suspend-tr_" + marketId + "'><div class='float-left country-name custbold box-4'><span onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'><b>" + marketName + "</b></span> <div class='float-right'> <div class='info-block'> <a href='javascript:void(0);' data-toggle='collapse' data-target='#min-max-" + marketId + "' aria-expanded='false' class='info-icon collapsed'> <i class='fas fa-info-circle m-l-10'></i> </a> <div id='min-max-" + marketId + "' class='min-max-info collapse'> <span><b>Min:</b> " + min_stack + " </span> <span><b>Max:</b> " + max_stack + " </span> </div> </div> </div> <p class='live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span class='float-left' style='color: black;'>0</span></p></div><div class='box-1 lay float-left text-center lay-1' id='fancy_market_lay_btn_" + marketId + "' " + lay_attribute + "><button><span class='odd d-block'>" + runsNo + "</span> <span class='d-block'>" + oddsNo + "</span></button></div><div class='box-1 back float-left text-center back-1' id='fancy_market_back_btn_" + marketId + "' " + back_attribute + "><button><span class='odd d-block'>" + runsYes + "</span> <span class='d-block'>" + oddsYes + "</span></button></div></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#fancyOverBetMarket_" + last_event_id + "_" + last_market_id;
													$(id_to_place_after).after(html_fancy_market_new);
												}
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#fancy1BetMarket_" + last_event_id + "_" + last_market_id;
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#khadoBetMarket_" + last_event_id + "_" + last_market_id;
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#ballBetMarket_" + last_event_id + "_" + last_market_id;
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#oddevenBetMarket_" + last_event_id + "_" + last_market_id;
										...
										if (true) {
											...
											if (m1) {
												...
												if(!last_market_id || !last_event_id){
													...
													var id_to_place_after = "#meterBetMarket_" + last_event_id + "_" + last_market_id;
					...
					if (response.data) {
						...
						if (!response.data['MATCH_ODDS']) {
							...
							while (selectorIdCasinoArray[ij]) {
								$("#live_match_points_" + selectorIdCasinoArray[ij]).text(0);
