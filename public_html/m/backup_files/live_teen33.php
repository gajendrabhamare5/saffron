                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            <div class="casino-title"><span class="casino-name">Instant Teenpatti 3.0</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                            ...
                            <div class="casino-video">
                                <iframe src="<?php echo IFRAME_URL; echo TEEN33_CODE; ?>" width="100%" height="200" style="border: 0px;"></iframe>
                            ...
                            <div class="casino-container teenpatti-1day">
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            <tr data-title="SUSPENDED" class="market_2_row">
                                                ...
                                                <td class="box-2 back text-center back-1 market_2_b_btn"><span class="odds d-block"><b>82</b></span> <span>1000000</span></td>
                                                <td class="box-2 lay text-center lay-1 market_2_l_btn"><span class="odds d-block"><b>86</b></span> <span>1000000</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=teen33" class="">View All</a></span></div>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_teen33.php',
				 dataType: 'json',
