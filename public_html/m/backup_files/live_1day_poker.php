                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div id="bhav" class="tab-pane active">
                            <div class="casino-title"><span class="casino-name">1-Day Poker</span><span class="d-block"><a href="#" onclick="view_rules()" data-target="#rules_popup" data-toggle="modal" id="rules_popup_btn" class="ml-1" role="button">Rules</a></span></div>
                            ...
                            <div class="casino-video">
                                <iframe src="<?php echo IFRAME_URL; echo ODIPOKER_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                            ...
                            <div class="casino-container poker-1day">
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            <tr class="suspended market_1_row">
                                                <td class="box-4"><b>Player A</b>
                                                    <p class="mb-0 market_1_b_exposure market_exposure" style="color: black;">0</p>
                                                </td>
                                                <td class="box-3 back back-1 market_1_b_btn text-center"><span class="odds d-block"><b class="market_1_b_value">0.00</b></span> <span>100000</span></td>
                                                <td class="box-3 lay lay-1 market_1_l_btn text-center"><span class="odds d-block"><b class="market_1_l_value">0.00</b></span> <span>100000</span></td>
                                            </tr>
                                            <tr class="suspended market_2_row">
                                                <td class="box-4"><b>Player B</b>
                                                    <p class="mb-0 market_2_b_exposure market_exposure" style="color: black;">0</p>
                                                </td>
                                                <td class="box-3 back back-1 market_2_b_btn text-center"><span class="odds d-block"><b class="market_2_b_value">0.00</b></span> <span>100000</span></td>
                                                <td class="box-3 lay lay-1 market_2_l_btn text-center"><span class="odds d-block"><b class="market_2_l_value">0.00</b></span> <span>100000</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="casino-title"><span class="casino-name">Bonus Bet</span></div>
                                <div class="table-responsive mb-1">
                                    <table class="table table-bordered mb-0">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr class="suspended market_3_row market_4_row">
                                                <td class="box-4"><b>Player A</b></td>
                                                <td class="box-3 back back-1 market_3_b_btn text-center"><span class="odds d-block"><b>Player A 2 card Bonus</b></span> <span style="color: black;" class="market_3_b_exposure market_exposure">0</span></td>
                                                <td class="box-3 back back-1 market_4_b_btn text-center"><span class="odds d-block"><b>Player A 7 card bonus</b></span> <span style="color: black;" class="market_4_b_exposure market_exposure">0</span></td>
                                            </tr>
                                            <tr class="suspended market_5_row market_6_row">
                                                <td class="box-4"><b>Player B</b></td>
                                                <td class="box-3 back back-1 market_5_b_btn text-center"><span class="odds d-block"><b>Player B 2 card Bonus</b></span> <span style="color: black;" class="market_5_b_exposure market_exposure">0</span></td>
                                                <td class="box-3 back back-1 market_6_b_btn text-center"><span class="odds d-block"><b>Player B 7 card bonus</b></span> <span style="color: black;" class="market_6_b_exposure market_exposure">0</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="last-result-tiele"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=poker" class="">View All</a></span></div>
                                ...
                                <div class="table-responsive rules-table">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="box-10 text-center">Bonus 1 (2 Cards Bonus)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Pair (2-10)</td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">A/Q or A/J Off Suited</td>
                                                <td class="box-3">1 To 5</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Pair (JQK)</td>
                                                <td class="box-3">1 To 10</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">A/K Off Suited</td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">A/Q or A/J Suited</td>
                                                <td class="box-3">1 To 20</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">A/K Suited</td>
                                                <td class="box-3">1 To 25</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="box-10 text-center">Bonus 2 (7 Cards Bonus)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Full House</td>
                                                <td class="box-3">1 To 8</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table table-bordered">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-7">Royal Flush</td>
                                                <td class="box-3">1 To 100</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
jQuery(document).on("click", "#placeBet", function () {
	 ...
	 $(".placeBet").removeAttr("id","placeBet");
		...
		setTimeout(function(){ 
			$.ajax({
				 type: 'POST',
				 url: '../ajaxfiles/bet_place_odi_poker.php',
				 dataType: 'json',
