 ...
 */
					...
					for (k = 0; k < args.body.data.length; k++) {
						...
						if (market_type_name == "Tied Match") {
							...
							html_match_odds += "<div class='market-title cashout mt-1'>" + market_type_name + "<button class='btn btn-success btn-sm' disabled=''>Cashout</button></div><div class='"+classdesign+"'><div class='table-header'><div class='float-left country-name box-6 min-max'><b>Max:<span id='match_odds_max_bet_" + k + "'>1</span></b></div> <div class='back box-1 float-left text-center lablesize'><b>Back</b></div> <div class='lay box-1 float-left text-center lablesize'><b>Lay</b></div></div>";
							if (market_type_name == "Match Odds") {
								marketType = "MATCH_ODDS";
							} else if (market_type_name == "Tied Match") {
								marketType = "TIED_MATCH";
										...
										if (args.body1.body.cricket) {
											if (args.body1.body.cricket[0]) {
												...
												if (args.body1.body.cricket[0].bookmaker_tied && args.body1.body.cricket[0].bookmaker_tied != null) {
													...
													/* var classdesign="fancy-market";
													if(parseInt(eventTypeId) == 4){
														classdesign="bookmaker-tied-market";
													} */

													html_bookmaker_tied_odds = "";
													html_bookmaker_tied_odds += "<div id='bookmaker_tied_market_div_0'><div class='market-title mt-1'>Tied Match<p class='float-right mb-0' data-target='#view_bookmaker_tied_rules' data-toggle='modal'><i class='fas fa-info-circle'></i></p></div><div class='fancy-market'><div class='table-header'><div class='float-left country-name box-6 min-max'><b>Min:  <span id='bookmaker_tied_min'></span> Max: <span id='bookmaker_tied_max'></span> </b></div><div class='back box-1 float-left text-center lablesize'><b>Back</b></div><div class='lay box-1 float-left text-center lablesize'><b>Lay</b></div></div>";
													var xc = 0;
							...
							if (args.body.cricketcasino[0].value.session) {
								...
								$.each(args.body.cricketcasino[0].value.session, function(key, val) {
									...
									for (z = 0; z < args.body.cricketcasino[0].value.session[key].length; z++) {
											...
											match_odds_numbers_markets += "<div class='table-body' id='match_odds_numbers_market_" + z + "'>";
												...
												<div class='fancy-tripple' > 
													<div data-title='${bet_suspended}' class='table-row ${cricketcasino_suspended} cricketcasino-suspend-tr_${common_key}'>
														<div class='float-left country-name custbold box-8'><span><b>${marketName}</b></span> 
															...
															<p class='live_match_points' id='live_match_points_${common_key}'>
										${exposure}
															</p>
															</div>
