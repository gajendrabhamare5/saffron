			...
			<div class="main-content">
				...
				<ul class="nav nav-tabs game-nav-bar">
					...
					<li class="nav-item"><a href="slot"
							class="nav-link router-link-exact-active router-link-active active newclass"> Our Casino
						</a></li>
				...
				<ul class="nav nav-tabs slot-nav-bar">
					...
					<li class="nav-item">
						<a data-toggle="tab" data-id="vartual" class="tabshow nav-link">Our Virtual</a>
					</li>
				</ul>
						...
						<div class="tab-content">
							<div id="casino" class="tab-pane active casino-tables">
								<ul class="nav nav-tabs slot-nav-bar2">
									<li class="nav-item active">
										<a data-toggle="tab" data-id="all_casino" class="tabshow2 nav-link active">All
											Casino</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="roulette" class="tabshow2 nav-link">Roulette</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="teenpatti" class="tabshow2 nav-link">Teenpatti</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="poker" class="tabshow2 nav-link">Poker</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="baccarat" class="tabshow2 nav-link">Baccarat</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="dragontiger" class="tabshow2 nav-link">Dragon
											Tiger</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="32cards" class="tabshow2 nav-link">32 Cards</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="andar-bahar" class="tabshow2 nav-link">Andar Bahar</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="lucky-7" class="tabshow2 nav-link">Lucky 7</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="3card-judgement" class="tabshow2 nav-link">3 Card
											Judgement</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="casino-war" class="tabshow2 nav-link">Casino War</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="worli" class="tabshow2 nav-link">Worli</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="sports" class="tabshow2 nav-link">Sports</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="bollywood" class="tabshow2 nav-link">Bollywood</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="lottery" class="tabshow2 nav-link">Lottery</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="queen" class="tabshow2 nav-link">Queen</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="race" class="tabshow2 nav-link">Race</a>
									</li>
									<li class="nav-item">
										<a data-toggle="tab" data-id="others" class="tabshow2 nav-link">Others</a>
									</li>
								</ul>
								<div class="tab-content">
									<div id="all_casino" class="tab-pane2 active casino-tables">
											...
											<div class="row row5 ">
												<!-- <div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teenjoker">
															<img src="../storage/mobile/img/casinoicons/teenjoker.jpg"
																class="img-fluid">
														</a>
													</div>
												</div> -->
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen20c">
															<img src="../storage/mobile/img/casinoicons/teen20c.jpg"
																class="img-fluid">
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_btable2">
															<img src="../storage/mobile/img/casinoicons/btable2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_ourroullete">
															<img src="../storage/mobile/img/casinoicons/ourroullete.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_superover3">
															<img src="../storage/mobile/img/casinoicons/superover3.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_goal">
															<img src="../storage/mobile/img/casinoicons/goal.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/ab4.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_lucky15" class=""><img
																src="../storage/mobile/img/casinoicons/lucky15.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_superover2" class=""><img
																src="../storage/mobile/img/casinoicons/superover2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen41" class=""><img
																src="../storage/mobile/img/casinoicons/teen41.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen42" class=""><img
																src="../storage/mobile/img/casinoicons/teen42.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/roulette3.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_sicbo2" class=""><img
																src="../storage/mobile/img/casinoicons/sicbo2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/roulette2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen33" class=""><img
																src="../storage/mobile/img/casinoicons/teen33.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_sicbo" class=""><img
																src="../storage/mobile/img/casinoicons/sicbo.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen32" class=""><img
																src="../storage/mobile/img/casinoicons/teen32.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/roulette1.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/teen.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/teen20.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/teen9.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/teen8.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_baccarat" class=""><img
																src="../storage/mobile/img/casinoicons/baccarat.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_dt202" class=""><img
																src="../storage/mobile/img/casinoicons/dt20.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/dt6.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_dtl20" class=""><img
																src="../storage/mobile/img/casinoicons/dtl20.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_dt202" class=""><img
																src="../storage/mobile/img/casinoicons/dt202.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_ab20" class=""><img
																src="../storage/mobile/img/casinoicons/ab20.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/abj.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_lucky7eu" class=""><img
																src="../storage/mobile/img/casinoicons/lucky7eu.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/warr.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_aaa" class=""><img
																src="../storage/mobile/img/casinoicons/aaa.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/btable.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/cricketv3.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen6" class=""><img
																src="../storage/mobile/img/casinoicons/teen6.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_queen" class=""><img
																src="../storage/mobile/img/casinoicons/queen.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_race20" class=""><img
																src="../storage/mobile/img/casinoicons/race20.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_lucky7eu2" class=""><img
																src="../storage/mobile/img/casinoicons/lucky7eu2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												...
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_thetrap" class=""><img
																src="../storage/mobile/img/casinoicons/trap.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_patti2" class=""><img
																src="../storage/mobile/img/casinoicons/patti2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teensin" class=""><img
																src="../storage/mobile/img/casinoicons/teensin.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teenmuf" class=""><img
																src="../storage/mobile/img/casinoicons/teenmuf.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_race17" class=""><img
																src="../storage/mobile/img/casinoicons/race17.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen20b" class=""><img
																src="../storage/mobile/img/casinoicons/teen20b.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_trio" class=""><img
																src="../storage/mobile/img/casinoicons/trio.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_notenum" class=""><img
																src="../storage/mobile/img/casinoicons/notenum.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_kbc" class=""><img
																src="../storage/mobile/img/casinoicons/kbc.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen120" class=""><img
																src="../storage/mobile/img/casinoicons/teen120.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen1" class=""><img
																src="../storage/mobile/img/casinoicons/teen1.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="javascript:void(0);" class=""><img
																src="../storage/mobile/img/casinoicons/roulette.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_ab3" class=""><img
																src="../storage/mobile/img/casinoicons/ab3.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_aaa2" class=""><img
																src="../storage/mobile/img/casinoicons/aaa2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_race2" class=""><img
																src="../storage/mobile/img/casinoicons/race2.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_teen3" class=""><img
																src="../storage/mobile/img/casinoicons/teen3.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_dum10" class=""><img
																src="../storage/mobile/img/casinoicons/dum10.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
												<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_cmeter1" class=""><img
																src="../storage/mobile/img/casinoicons/cmeter1.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>
									...
									<div id="roulette" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
											...
											<div class="col-4 text-center">
													<div class="casinoicons">
														<a href="live_ourroullete" class=""><img
																src="../storage/mobile/img/casinoicons/ourroullete.jpg"
																class="img-fluid">
														</a>
													</div>
												</div>	
									...
									<div id="teenpatti" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
											<div class="col-4 text-center">
													<div class="casinoicons">
									...
									<div id="poker" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
											<div class="col-4 text-center">
													<div class="casinoicons">
									...
									<div id="baccarat" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
											<div class="col-4 text-center">
													<div class="casinoicons">
									...
									<div id="dragontiger" class="tab-pane2 casino-tables">
									...
									<div id="32cards" class="tab-pane2 casino-tables">
									...
									<div id="andar-bahar" class="tab-pane2 casino-tables">
									...
									<div id="lucky-7" class="tab-pane2 casino-tables">
									...
									<div id="3card-judgement" class="tab-pane2 casino-tables">
									...
									<div id="casino-war" class="tab-pane2 casino-tables">
									...
									<div id="worli" class="tab-pane2 casino-tables">
									...
									<div id="sports" class="tab-pane2 casino-tables">
									...
									<div id="bollywood" class="tab-pane2 casino-tables">
									...
									<div id="lottery" class="tab-pane2 casino-tables">
									...
									<div id="queen" class="tab-pane2 casino-tables">
									...
									<div id="race" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
									...
									<div id="others" class="tab-pane2 casino-tables">
									<div class="container-fluid">
											<div class="row row5 ">
							...
							<div id="tembo_casino" class="tab-pane container">
								<div class="container-fluid">
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/tembo1.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/tembo2.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/lucky72.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/baccarat2.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/baccaratb2.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/dragontiger2.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/teenpattioneday.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/dragontiger.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/baccarat.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/teenpatti2020.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/lucky7.jpg"
													class="img-fluid"></a></div>
									</div>
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" data-target='#games_modal'
											data-toggle='modal'><a href="javascript:void(0);"><img
													src="../storage/casinotab/tembo_casino/baccaratb.jpg"
													class="img-fluid"></a></div>
									</div> <!---->
								</div>
							</div>
							<div id="live_casino" class="tab-pane container">
								<div class="container-fluid live_csino_div">
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" style="position: relative;"
											data-target='#games_modal' data-toggle='modal'><a
												href="javascript:void(0);"><img
													src="../storage/casinotab/livecasino/livecasino1.jpg" class="img-fluid">
									...
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" style="position: relative;"
											data-target='#games_modal' data-toggle='modal'><a
												href="javascript:void(0);"><img
													src="../storage/casinotab/livecasino/livecasino2.png" class="img-fluid">
									...
									<div class="row">
										<div class="ml-2 mr-2 mt-2 casino-icon" style="position: relative;"
											data-target='#games_modal' data-toggle='modal'><a
												href="javascript:void(0);"><img
													src="../storage/casinotab/livecasino/livecasino3.png" class="img-fluid">
							...
							<div id="slot-0" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										...
										for ($i = 1; $i <= 66; $i++) {
											?>
											<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
													class="img-fluid mt-1"
													data-src="../storage/casinotab/slot/<? echo $i; ?>.png"
													src="../storage/casinotab/slot/<? echo $i; ?>.png" lazy="loaded"></div>
											<?
										}
										?>
								...
								<div class="container-fluid mt-3">
									<div class="row">
										...
										for ($i = 1; $i <= 49; $i++) {
											?>
											<div class="col-3">
												<img class="img-fluid mt-1" data-target='#games_modal' data-toggle='modal'
													data-src="../storage/casinotab/slot1/<? echo $i; ?>.png"
													src="../storage/casinotab/slot1/<? echo $i; ?>.png" lazy="loaded">
											</div>
											<?
										}
										?>
							...
							<div id="slot-2" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										...
										for ($i = 1; $i <= 393; $i++) {
											?>
											<div class="col-3"><img class="img-fluid mt-1" data-target='#games_modal'
													data-toggle='modal' data-src="../storage/casinotab/slot1/1.png"
													src="../storage/casinotab/slot2/<? echo $i; ?>.png" lazy="loaded"></div>
											<?php
										}
										?>
									</div>
								...
								<div class="container-fluid mt-3">
									<div class="row">
										...
										for ($j = 1; $j <= 29; $j++) {
											...
											<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
													class="img-fluid mt-1"
													data-src="../storage/casinotab/slot3/<? echo $j; ?>.png"
													src="../storage/casinotab/slot3/<? echo $j; ?>.png" lazy="loaded"></div>
											<?php
										}
										?>
									</div>
							...
							<div id="slot-4" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot4/1.png"
												src="../storage/casinotab/slot4/1.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot4/2.png"
												src="../storage/casinotab/slot4/2.png" lazy="loaded"></div>
									</div>
								</div>
							</div>
							<div id="slot-5" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/1.png"
												src="../storage/casinotab/slot5/1.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/2.png"
												src="../storage/casinotab/slot5/2.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/3.png"
												src="../storage/casinotab/slot5/3.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/4.png"
												src="../storage/casinotab/slot5/4.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/5.png"
												src="../storage/casinotab/slot5/5.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/6.png"
												src="../storage/casinotab/slot5/6.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot5/7.png"
												src="../storage/casinotab/slot5/7.png" lazy="loaded"></div>
									</div>
								</div>
							</div>
							<div id="slot-6" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/1.png"
												src="../storage/casinotab/slot6/1.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/2.png"
												src="../storage/casinotab/slot6/2.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/3.png"
												src="../storage/casinotab/slot6/3.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/4.png"
												src="../storage/casinotab/slot6/4.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/5.png"
												src="../storage/casinotab/slot6/5.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/6.png"
												src="../storage/casinotab/slot6/6.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/7.png"
												src="../storage/casinotab/slot6/7.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/8.png"
												src="../storage/casinotab/slot6/8.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/9.png"
												src="../storage/casinotab/slot6/9.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/10.png"
												src="../storage/casinotab/slot6/10.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot6/11.png"
												src="../storage/casinotab/slot6/11.png" lazy="loaded"></div>
									</div>
								</div>
							</div>
							<div id="slot-7" class="tab-pane container">
								<div class="container-fluid mt-3">
									<div class="row">
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/1.png"
												src="../storage/casinotab/slot7/1.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/2.png"
												src="../storage/casinotab/slot7/2.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/3.png"
												src="../storage/casinotab/slot7/3.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/4.png"
												src="../storage/casinotab/slot7/4.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/5.png"
												src="../storage/casinotab/slot7/5.png" lazy="loaded"></div>
										<div class="col-3"><img data-target='#games_modal' data-toggle='modal'
												class="img-fluid mt-1" data-src="../storage/casinotab/slot7/6.png"
												src="../storage/casinotab/slot7/6.png" lazy="loaded"></div>
									</div>
								</div>
							</div>
						</div>
