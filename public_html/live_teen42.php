                            ...
                            <div class="row row5 teenpatti-1day">
                                ...
                                <div class="coupon-card">
                                        ...
                                        if(!empty(IFRAME_URL_SET)){
                                                                    ?>
                                                                    <iframe class="iframedesign" src="<?php echo IFRAME_URL."".TEEN42_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                                                    <?php
                                        ...
                                        <div class="casino-detail">
                                            <div class="casino-table">
                                                <div class="casino-table-box">
                                                    <div class="casino-table-left-box">
                                                        ...
                                                        <div class="casino-table-row ">
                                                            ...
                                                            <div class="casino-odds-box back back-1 market_1_b_btn suspended-box"><span class="casino-odds">0</span></div>
                                                            <div class="casino-odds-box lay lay-1 market_1_l_btn suspended-box"><span class="casino-odds">0</span></div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="casino-table-right-box">
                                                        ...
                                                        <div class="casino-table-row">
                                                            ...
                                                            <div class="casino-odds-box back back-1 market_2_b_btn suspended-box"><span class="casino-odds">1.9</span></div>
                                                            <div class="casino-odds-box lay lay-1 market_2_l_btn suspended-box"><span class="casino-odds">1.93</span></div>
                                                        </div>
                                                        <div class="casino-table-row under-over-row">
                                                            <div class="uo-box">
                                                                <div class="casino-nation-detail">
                                                                    <div class="casino-nation-name">Player B Under 21</div>
                                                                    <p class="mb-0"><span style="color: black;" class="market_3_b_exposure market_exposure">0</span> </p>
                                                                </div>
                                                                <div class="casino-odds-box back back-1 market_3_b_btn suspended-box"><span class="casino-odds">1.52</span></div>
                                                            </div>
                                                            <div class="uo-box">
                                                                <div class="casino-nation-detail">
                                                                    <div class="casino-nation-name">Player B Over 21</div>
                                                                    <p class="mb-0"><span style="color: black;" class="market_4_b_exposure market_exposure">0</span> </p>
                                                                </div>
                                                                <div class="casino-odds-box back back-1 market_4_b_btn suspended-box"><span class="casino-odds">2.93</span></div>
                                                            </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                             ...
                                             <div class="mt-1 casino-remark-div">
                                                 <marquee style="color: #097c93;">Play Our New Premium Teenpatti 1 Day</marquee>
                                                 </div>
                                            <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teen42">View All</a></span></div>
   ...
   var currentStake = parseFloat($("#inputStake").val()) || 0;
    ...
    jQuery(document).on("click", "#placeBet", function() {
        ...
        setTimeout(function(){
            $.ajax({
                type: 'POST',
                url: 'ajaxfiles/bet_place_teen42.php',
                dataType: 'json',
                data: {
