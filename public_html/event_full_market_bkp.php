    ...
    <div id="app">
        ...
        <div class="wrapper">
            ...
            Max: <span id="bookmaker_max">1</span></b></div>
                                                    ...
                                                    <div class="table-body" id="match_odds_bookmaker_market">
...
//				var eventName = args.body.cricket[0][0].matchName;
            //var eventName = args.body.cricket[0][0].runners[1].name + ' V ' +args.body.cricket[0][0].runners[0].name;
        ...
        if(args.body.khado[0]){
                ...
                if(!n1 && !n2 && !n3){
                        ...
                        if(m1){
                                ...
                                $("#khado_market_back_btn_" + marketId).attr("fullfancymarketrate", oddsYes);							$("#khado_market_back_btn_" + marketId).attr("winnig_zone", winning_zone);
...
jQuery(document).on("input", "#inputStake", function () {
	...
	if(bet_markettype != "FANCY_ODDS" && bet_markettype != "BOOKMAKER_ODDS"){
