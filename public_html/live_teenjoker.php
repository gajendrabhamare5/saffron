                            ...
                            <div class="row row5 teenpatti-1day">
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Teenpatti Joker
                                                
                                                <!---->
                                            </span> <small role="button" class="teenpatti-rules"  onclick="view_rules('teenjoker')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> <span class="float-right">
                                                Round ID:
                                        ...
                                        <div class="casino-detail">
                                            <div class="casino-table">
                                                ...
                                                <div class="casino-odds-box lay market_2_row suspended-box lay-1 market_2_l_btn"><span class="casino-odds market_2_l_val">0</span></div>
                                                    ...
                                                    <div class="casino-odds-box back suspended-box market_4_row back-1 market_4_b_btn"><span class="casino-odds market_4_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended-box market_5_row back-1 market_5_b_btn"><span class="casino-odds market_5_b_val">0</span></div>
                                                    <div class="casino-odds-box back suspended-box market_6_row back-1 market_6_b_btn"><span class="casino-odds market_6_b_val">0</span></div>
                                                </div>
                                                        </div>
                                                        </div>
