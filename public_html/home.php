                                ...
                                <?php if ($fetch_access['video_access'] == 1) { ?>
                                    <div class="home-products-container">
                                        <div class="row row5">
                                            <div class="col-md-12">
                                                <!-- /////////////////////// -->
                                                <!-- <a href="live_teenjoker" class="">
                                                <div class="d-inline-block casinoicons"><img
                                                        src="storage/front/img/casinoicons/teenjoker.jpg"
                                                        class="img-fluid">
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0">
                                <img src="../<?php echo $row['image'] . '?' . time(); ?>" class="img-fluid"
            ...
            if (data.sport) {
                if (data.sport.body) {
                    ...
                    if (result > 0) {
                        ...
                        if (eventType == 1) {
                            football_html += "<tr><td> <div class='game-name'><a href='live_goal' class='text-dark'>Goal</a></div><div class='game-icons'><span class='game-icon'><span class='active'></span></span> <span class='game-icon'><i class='fas fa-tv v-m icon-tv'></i></span></div></td> <td> <button class='back'><span class='odd'> - </span></button></td> <td> <button class='lay'><span class='odd'> - </span></button></td> <td> <button class='back'><span class='odd'> - </span></button></td><td> <button class='lay'><span class='odd'> - </span></button></td><td> <button class='back'><span class='odd'> - </span></button></td> <td> <button class='lay'><span class='odd'> - </span></button></td></tr>";
                        }
