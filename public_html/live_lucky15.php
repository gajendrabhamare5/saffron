                                ...
                                <div class="col-md-9 casino-container coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">
                                                ...
                                                <small role="button" class="teenpatti-rules"  onclick="view_rules('lucky15')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
                                        ...
                                        <div class="video-container">
                                                ...
                                                if(!empty(IFRAME_URL_SET)){
                                                                            ?>
                                                                            <iframe class="iframedesign" src="<?php echo IFRAME_URL."".LUCKY15_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                                                            <?php
