                                        ...
                                        <div class="video-container">
                                            <?php
												if(!empty(IFRAME_URL_SET)){
													?>
																	<iframe class="iframedesign" src="<?php echo IFRAME_URL."".CRICKET5_CODE;?>"
                                        ...
                                        <div class="casino-detail detail-page-container position-relative">
                                            <div class="game-market market-2 ">
                                                ...
                                                <div class="market-header">
                                                    <div class="market-nation-detail"><span
                                                            class="market-nation-name">Min: 100 Max: 3L</span></div>
                                                ...
                                                <div class="market-body bookmaker-market" data-title="OPEN">
                                                    <div class="market-row suspended-box market_1_row"
                                                        data-title="SUSPENDED">
                                                        <div class="market-nation-detail">
                                                            <span class="market-nation-name">AUS</span>
                                                            <div
                                                                class="market-nation-book market_1_b_exposure market_exposure">
                                                            </div>
                                                        </div>
                                                        <div class="market-odd-box back market_1_b_btn back-1"><span
                                                                class="market-odd">-</span><span
                                                                class="market-volume">0.00</span></div>
                                                        <div class="market-odd-box lay market_1_l_btn lay-1"><span
                                                                class="market-odd">-</span><span
                                                                class="market-volume">0.00</span></div>
                                                    </div>
                                                    <div class="market-row suspended-box market_2_row"
                                                        data-title="SUSPENDED">
                                                        <div class="market-nation-detail">
                                                            <span class="market-nation-name">IND</span>
                                                            <div
                                                                class="market-nation-book market_2_b_exposure market_exposure">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="fancy-market suspended-box" data-title="SUSPENDED">
                                                            <div class="market-row">
                                                                ...
                                                                <div class="market-odd-box lay "><span
                                                                        class="market-odd">-</span></div>
                                                                <div class="market-odd-box back "><span
                                                                        class="market-odd">-</span></div>
                                                                <div class="fancy-min-max-box">
                                                                    <div class="fancy-min-max"><span
                                                                            class="w-100 d-block">Min: 100</span><span
                                                                            class="w-100 d-block">Max: 1L</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="casino-last-result-title"><span>Last Result</span><span><a
                                                        href="casinoresults?game_type=cricketv3">View All</a></span>
                                            </div>
            ...
            if (data && data['t1'] && data['t1'][0]) {
                ...
                for (var j in data['t2']) {
                    ...
                    back_html = '<span class="market-odd d-block">' + b1 +
                        '</span><span class="market-volumn d-block">' + bs1 + '</span>';
                    ...
                    lay_html = '<span class="market-odd d-block">' + l1 +
                        '</span><span class="market-volumn d-block">' + ls1 + '</span>';
