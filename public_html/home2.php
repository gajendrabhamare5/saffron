									...
									<div class="home-products-container">
										<div class="row row5">
											...
											<div class="col-md-12">
												...
												$get_casino_list = $conn->query("SELECT * FROM `casino_list` WHERE is_live = 1 ORDER BY priority");

												while ($fetch_casino_list = mysqli_fetch_assoc($get_casino_list)) {
													$game_name = $fetch_casino_list["game_name"];
													$game_url = $fetch_casino_list["game_url"];
													$game_image = $fetch_casino_list["game_image"];
													$game_status = $fetch_casino_list["status"];
													$className = "";
												...
												?>
													...
													<a href="<?php echo $game_url ?>" class="<?php echo $className; ?>">
														<div class="d-inline-block casinoicons"><img
																src="<?php echo $game_image ?>"
																class="img-fluid">
															<div class="casino-name"><?php echo $game_name ?></div>
														</div>
													</a>
