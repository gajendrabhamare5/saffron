...
<style>
	...
	.main-market-full .box-1 {
		width: 55px;
		max-width: unset;
	}

	.main-market-full .country-name {
						...
						<div class="col-md-10 featured-box load game-page">
							<div class="row row5">
								<div class="col-md-9 featured-box-detail sports-wrapper m-b-10">
									<!---->
									<div class="game-heading"><span
											class="card-header-title event_name_heading uppercase"><?php echo $event_name; ?></span>
									...
									<div class="markets">
										...
										<div class="col-xl-12" style="padding: 0px;">
											...
											<div id="scoreboard-box" style="background: black;">
												...
												?>
												<!-- <iframe style="    width: 100%;" src="" id="scoreboard_iframe"></iframe> -->
											</div>


										</div>
										<div class="main-market main-market-full" id="match_odds_all_full_markets">
										</div>

										<div class="row row5 bookmaker-market mt-1" id="bookmaker_market_div"
											style="display:none;">
											<div class="bm1 col-xl-12" id="bm1-head">
												<div>
													<div class="market-title mt-1">
														<span>Bookmaker</span>
														<button markettype='BOOKMAKER_ODDS' class="btn btn-success btn-sm       cashoutClick BOOKMAKER_ODDS_dis hideBtn" disabled="">Cashout</button>
													</div>
													<div class="table-header">
														<div class="float-left country-name box-4 text-info"><b>Min:
																<span class="bookmaker_min">1</span>
																Max: <span class="bookmaker_max">1</span></b></div>
											...
											<div class="bm2 col-4" id="bm2-head" style="display:none;">
												<div>
													<div class="market-title mt-1">
														Bookmaker 2
														<button markettype='BOOKMAKERSMALL_ODDS' class="btn btn-success btn-sm cashoutClick BOOKMAKERSMALL_ODDS_dis  hideBtn" disabled="">Cashout1</button>
										...
										<div class="market-row">
											<p class="market-remark"></p>
										</div>

										<div class="row row5 bookmaker-tied-market mt-1" id="bookmaker_tied_market_div"
											style="display:none;">
											<div class="bm1 col-xl-12" id="bm1-head">
												<div>
													<div class="market-title mt-1">
														...
														<button markettype='BOOKMAKER_TIED_ODDS' class='btn btn-success btn-sm cashoutClick BOOKMAKER_TIED_ODDS_dis' disabled=''>Cashout</button>
														<a href="javascript:void(0)" data-toggle="modal"
															data-target="#view_bookmaker_tied_rules"
															class="m-r-5 game-rules-icon"><span><i
																	class="fa fa-info-circle float-right"></i></span></a>
													</div>
													<div class="table-header">
														<div class="float-left country-name box-4 text-info"><b>Min:
																<span class="bookmaker_tied_min">1</span>
																Max: <span class="bookmaker_tied_max">1</span></b></div>
														<div class="box-1 float-left"></div>
														<div class="box-1 float-left"></div>
														<div class="back box-1 float-left text-center"><b>BACK</b></div>
														<div class="lay box-1 float-left text-center"><b>LAY</b></div>
													...
													<div class="table-body" id="match_odds_bookmaker_tied_market"></div>
													<div class="table-remark text-right remark"
														id="bookmaker-tied-remakrs">
													</div>
													<div>
													</div>
												</div>
											...
											<div class="bm2 col-4" id="bm2-head" style="display:none;">
												<div>
													...
													<div class="table-body" id="bookmakersmall1_tied_market_div_secure">
									...
									<?php if ($eventType == 4 || $eventType == 8) { ?>
											...
											<div class="col-12">
												<div class="" id="fancy_odds_market" style="display:none;">
													<div>
														<div class="market-title mt-1">
															Normal
															<a href="javascript:void(0)" data-target="#view_fancy_rules"
																data-toggle="modal" class="m-r-5 game-rules-icon"><span><i
																		class="fa fa-info-circle float-right"></i></span></a>
														</div>
														<div class="market-header">
															<div class="col-6">
																<div class="table-header">
																	...
																	<div class="box-1 float-left lay text-center"><b>No</b>
																	</div>
										...
										<ul class="nav nav-tabs mt-1">
											<li class="nav-item"><a data-toggle="tab" href="#fancy1"
													class="nav-link active">Fancy1</a></li>
											<li class="nav-item"><a data-toggle="tab" href="#meter"
													class="nav-link">Meter</a></li>
											<li class="nav-item"><a data-toggle="tab" href="#khado"
													class="nav-link">Khado</a></li>
											<li class="nav-item"><a data-toggle="tab" href="#oddeven"
													class="nav-link">Oddeven</a></li>
											<li class="nav-item"><a data-toggle="tab" href="#wicket"
													class="nav-link">Wicket</a></li>
											<li class="nav-item"><a data-toggle="tab" href="#four" class="nav-link">Four</a>
											</li>
											<li class="nav-item"><a data-toggle="tab" href="#six" class="nav-link">Six</a>
											</li>
											<li class="nav-item"><a data-toggle="tab" href="#cc" class="nav-link">Cricket
													Casino</a></li>
										</ul>
										<div class="tab-content fancy-tab">
												...
												<div class=" row row5">
													<div class="col-12">
														<div class="fancy-market">
															<div class="fancy-message col-12 mt-1">No real-time records
																found</div>
																...
																<div class="market-header">
																	<div class="col-6">
																		<div class="table-header">
																			...
																			<div
																				class="back box-1 float-left back text-center">
																				<b>BACK</b>
																			</div>
											...
											<div id="oddeven" class="tab-pane">
												<div class=" row row5">
													<div class="col-12">
														<div class="fancy-market">
															<div class="fancy-message col-12 mt-1" style="">No real-time
																records found</div>
											...
											<div id="wicket" class="tab-pane">
												<div class="fancy-market">
													<div class="fancy-message col-12 mt-1" style="">No real-time records
														found</div>
												</div>
											</div>
									...
									<?php } ?>
									<div class="main-market" id="match_odds_numbers_markets"></div>
									<div class="main-market" id="match_odds_all_tie_markets"></div>
								</div>
								<?php
...
<script type="text/javascript">
	var ipAddress;
	console.log("BERFOR HERE");
	var argsTv = "<? echo tv_url; ?>&sportid=<?php echo $eventType; ?>&gmid=<? echo $event_id; ?>";
	$("#matchDate1").append('<div data-v-68a8f00a="" id="collapseTV" style="display : none;"><iframe data-v-68a8f00a="" src="' + argsTv + '" width="100%" style="height: 204px;" class="video-iframe"></iframe></div>');
	...
	socket.on('liveURLForMatch', function(args) {
		if (args) {
			...
			//$("#matchDate1").append('<div data-v-68a8f00a="" id="collapseTV" style="display : none;"><iframe data-v-68a8f00a="" src="'+args+'" width="100%" style="height: 204px;" class="video-iframe"></iframe></div>');	
		}
	});
	$(function() {
		...
		if (args.body == undefined) {
			...
			if (args.body.data) {
				if (args.body.data[0]) {
					...
					betfairGameId = args.body.data[0].eventId || oldGameId;
					GAME_ID = oldGameId;
...
var disableCashout = marketType + "_dis";
						...
						if (market_type_name == "Tied Match") {
							// Min: <span id='match_odds_tied_min_bet_" + k + "'></span>
							/* <a href='javascript:void(0)' class='m-r-5 game-rules-icon' data-toggle='modal' data-target='#view_match_rules'><span><i class='fa fa-info-circle float-right'></i></span></a> */
							html_match_tie_odds += "<div class='market-title cashout mt-1'> " + marketType + "<button markettype='" + marketType + "' class='btn btn-success btn-sm  cashoutClick " + disableCashout + "' " + hideBtn + " disabled=''>Cashout</button> </div><div class='table-header'><div class='float-left country-name box-4 min-max'><span class='float-left m-r-10'> Max: <span id='match_odds_tied_max_bet_" + k + "'>1</span></span><b></b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div><div class='back box-1 float-left text-center'><b>BACK</b></div><div class='lay box-1 float-left text-center'><b>LAY</b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div></div><div data-title='OPEN' class='table-body'>";
							if (market_type_name == "Match Odds") {
								marketType = "MATCH_ODDS";
							} else if (market_type_name == "Tied Match") {
								marketType = "TIED_MATCH";
							...
							if (args.body.data[k].runners) {
								for (j = 0; j < args.body.data[k].runners.length; j++) {
									...
									if (args.body.data[k].runners[j].back[2]) {
										...
										console.log("match-tied-odds size", args.body.data[k].runners[j].back[2].size);
										/* 
								...
								/* 	if(one_size_1 == 0){
									...
									display_cashProfit[marketType][selectionId]['runnerName'] = runnerName;
									...
									html_match_tie_odds += "<div data-title='" + bet_suspended + "' class='11 table-row " + is_suspended + "' id='fullSelection_" + selectionId + "_" + market_marketid + "'  eventtype='4' eventid='" + eventId + "' marketid='" + market_market_id + "' selectionid='" + selectionId + "' eventname='" + runnerName + "' status='" + status + "'><div class='float-left country-name box-4'><span class='team-name'>" + runnerName + "</span><p><span class='float-left live_match_points' style='color: black;' id='live_match_points_" + selectionId + "_" + market_marketid + "'>0</span> <span class='float-right' style='display: none; color: black;'>0</span></p></div>" +
										...
										"</div>";
										$("." + marketType + "_dis").show();
									if (args.body.data[k].runners.length != 2) {
										$("." + marketType + "_dis").hide();
								}
								}
							}
							...
							/* <a href='javascript:void(0)' class='m-r-5 game-rules-icon' data-toggle='modal' data-target='#view_match_rules'><span><i class='fa fa-info-circle float-right'></i></span></a> */
							html_match_odds += "<div class='game-market'><div class='market-title cashout mt-1'> <span> " + marketType + " </span><button markettype='" + marketType + "' class='btn btn-success btn-sm cashoutClick " + disableCashout + "' " + hideBtn + " disabled=''>Cashout</button>  </div><div class='table-header'><div class='float-left country-name box-4 min-max'><b><span class='m-r-10'>Max: <span id='match_odds_max_bet_" + k + "'>1</span></span></b></div><div class='back box-1 float-left text-center'><b>BACK</b></div><div class='lay box-1 float-left text-center'><b>LAY</b></div></div><div data-title='OPEN' class='table-body'>";
							...
							if (args.body.data[k].runners) {
								for (j = 0; j < args.body.data[k].runners.length; j++) {
									...
									html_match_odds += "<div data-title='" + bet_suspended + "' class='11 table-row " + is_suspended + "' id='fullSelection_" + selectionId + "_" + market_marketid + "'  eventtype='4' eventid='" + eventId + "' marketid='" + market_market_id + "' selectionid='" + selectionId + "' eventname='" + runnerName + "' status='" + status + "'><div class='float-left country-name box-4'><span class='team-name'>" + runnerName + "</span><p><span class='float-left live_match_points' style='color: black;' id='live_match_points_" + selectionId + "_" + market_marketid + "'>0</span> <span class='float-right' style='display: none; color: black;'>0</span></p></div>" +
										"<div class='box-1 back float-left back back-1 lock text-center'  id='back_1_" + selectionId + "_" + market_marketid + "' side='Back'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + one_price_3 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "' other_fancy='" + other_fancy + "'><span class='odd d-block'>" + one_price_3 + "</span> <span class='d-block'>" + one_size_3 + "</span></div>" +
										"<div class='box-1 lay-1 lay float-left text-center' id='lay_1_" + selectionId + "_" + market_marketid + "' side='Lay' selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + lay_one_price_1 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "' other_fancy='" + other_fancy + "'><span class='odd d-block'>" + lay_one_price_1 + "</span> <span class='d-block'>" + lay_one_size_1 + "</span></div>" +
										"</div>";
											...
											if (args.body1.body.cricket[0]) {
												...
												if (args.body1.body.cricket[0].bookmaker && args.body1.body.cricket[0].bookmaker != null) {
													...
													if (args.body1.body.cricket[0].bookmaker) {
														console.log("Bookmaker data:", args.body1.body.cricket[0]);
													...
													if (html_bookmaker_odds != "") {
														...
														var hideBtn = "";
														if (args.body1.body.cricket[0].runners && args.body1.body.cricket[0].runners.length > 2) {
															hideBtn = "style= display:none;";
														}

														var html_bookmaker_odds_div = ` <div class="row row5 bookmaker-market mt-1">
														<div class="bm1 col-xl-12">
														<div>
														<div class="market-title cashout mt-1">
														Bookmaker market
														 <button markettype='` + marketType + `' class='btn btn-success btn-sm  cashoutClick' ` + disableCashout + ` ` + hideBtn + ` disabled=''>Cashout</button> 
														...
														<div class="table-header">
														<div class="float-left country-name box-4 text-info"><b>Min: <span class="bookmaker_min">1</span> 
														Max: <span class="bookmaker_max">1</span></b></div>
														<div class="box-1 float-left"></div>
														<div class="box-1 float-left"></div>
														<div class="back box-1 float-left text-center"><b>BACK</b></div>
													...
													<div class="table-body">${html_bookmaker_odds}</div>
													<div class="table-remark text-right remark">${bookmaker_remarks}
													</div>
													<div>
													</div>
												</div>
														...
														html_match_odds += html_bookmaker_odds_div;
													}
												}
												...
												if (args.body1.body.cricket[0].bookmaker_tied && args.body1.body.cricket[0].bookmaker_tied != null) {
													z = 0;
													if (args.body1.body.cricket[0].bookmaker_tied) {
														var bookmaker1_tied_data = args.body1.body.cricket[0].bookmaker_tied;
														bookmaker_tied_remarks = args.body1.body.cricket[0].bookmaker_tied_remark;
														for (var b in bookmaker1_tied_data) {
															marketType = "BOOKMAKER_TIED_ODDS";
															selectionId = bookmaker1_tied_data[b].selectionId
															selectorIdBookmakerTiedArray.push(selectionId);
															runnerName = bookmaker1_tied_data[b].name;
															book_status = bookmaker1_tied_data[b].status;

															marketName = runnerName;
															var bet_suspended = "";
															if (bookmaker1_tied_data[b]['back'][0].price) {
																bookmaker1_tied_back_rate = bookmaker1_tied_data[b]['back'][0].price || "";
															} else {
																bookmaker1_tied_back_rate = "-";
															}
															if (bookmaker1_tied_data[b]['back'][0].size) {
																bookmaker1_tied_back_size = bookmaker1_tied_data[b]['back'][0].size || "";
															} else {
																bookmaker1_tied_back_size = "";
															}
															if (bookmaker1_tied_data[b]['back'][1].price) {
																bookmaker1_tied_back_2_rate = bookmaker1_tied_data[b]['back'][1].price || "";
															} else {
																bookmaker1_tied_back_2_rate = "-";
															}

															if (bookmaker1_tied_data[b]['back'][1].size) {
																bookmaker1_tied_back_2_size = bookmaker1_tied_data[b]['back'][1].size || "";
															} else {
																bookmaker1_tied_back_2_size = "";
															}

															if (bookmaker1_tied_data[b]['back'][2].price) {
																bookmaker1_tied_back_3_rate = bookmaker1_tied_data[b]['back'][2].price || "";
															} else {
																bookmaker1_tied_back_3_rate = "-";
															}

															if (bookmaker1_tied_data[b]['back'][2].size) {
																bookmaker1_tied_back_3_size = bookmaker1_tied_data[b]['back'][2].size || "";
															} else {
																bookmaker1_tied_back_3_size = "";
															}

															if (bookmaker1_tied_data[b]['lay'][0].price) {
																bookmaker1_tied_lay_rate = bookmaker1_tied_data[b]['lay'][0].price || "";
															} else {
																bookmaker1_tied_lay_rate = "-";
															}


															if (bookmaker1_tied_data[b]['lay'][0].size) {
																bookmaker1_tied_lay_size = bookmaker1_tied_data[b]['lay'][0].size || "";
															} else {
																bookmaker1_tied_lay_size = "";
															}

															if (bookmaker1_tied_data[b]['lay'][1].price) {
																bookmaker1_tied_lay_2_rate = bookmaker1_tied_data[b]['lay'][1].price || "";
															} else {
																bookmaker1_tied_lay_2_rate = "-";
															}


															if (bookmaker1_tied_data[b]['lay'][1].size) {
																bookmaker1_tied_lay_2_size = bookmaker1_tied_data[b]['lay'][1].size || "";
															} else {
																bookmaker1_tied_lay_2_size = "";
															}

															if (bookmaker1_tied_data[b]['lay'][2].price) {
																bookmaker1_tied_lay_3_rate = bookmaker1_tied_data[b]['lay'][2].price || "";
															} else {
																bookmaker1_tied_lay_3_rate = "-";
															}


															if (bookmaker1_tied_data[b]['lay'][2].size) {
																bookmaker1_tied_lay_3_size = bookmaker1_tied_data[b]['lay'][2].size || "";
															} else {
...
temp_selectionId = temp_selectionId.replace(/[^a-zA-Z ]/g, "");
															...
															html_bookmaker_tied_odds += "<div data-title='" + book_status + "' class='table-row " + bookmaker_tied_suspended + "' id='bookmaker_tied_row_" + temp_selectionId + "'><div class='float-left country-name box-4'><span class='team-name'>" + runnerName + "</span><p><span class='float-left live_match_points' style='color: black;' id='live_match_points_" + selectionId + "_BOOKMAKER_TIED_ODDS'>0</span> <span class='float-right' style='display: none; color: black;'>0</span></p></div><div class='box-1 back2 float-left text-center betting-disabled' id='back_3_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' ><span class='odd d-block'>" + bookmaker1_tied_back_3_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_3_size + "</span></div><div class='box-1 back1 float-left back-2 text-center betting-disabled' id='back_2_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' ><span class='odd d-block'>" + bookmaker1_tied_back_2_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_2_size + "</span></div><div class='box-1 back back-1 float-left back lock text-center'  id='back_1_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' side='Back'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + bookmaker1_tied_back_rate + "'  oddsmarketId=" + oddsmarketId + " event_name='" + eventName + "' market_odd_name='BOOKMAKER_TIED_ODDS' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='1'><span class='odd d-block'>" + bookmaker1_tied_back_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_size + "</span></div><div class='box-1 lay float-left text-center lay-1' id='lay_1_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' side='Lay'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + bookmaker1_tied_lay_rate + "'  oddsmarketId=" + oddsmarketId + " event_name='" + eventName + "' market_odd_name='BOOKMAKER_TIED_ODDS' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='1'><span class='odd d-block'>" + bookmaker1_tied_lay_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_size + "</span></div><div class='box-1 lay1 float-left text-center betting-disabled' id='lay_2_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' ><span class='odd d-block'>" + bookmaker1_tied_lay_2_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_2_size + "</span></div><div class='box-1 lay2 float-left text-center betting-disabled' id='lay_3_" + temp_selectionId + "_BOOKMAKER_TIED_ODDS' ><span class='odd d-block'>" + bookmaker1_tied_lay_3_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_3_size + "</span></div></div>";


}
														$(".BOOKMAKER_ODDS_dis").show();
														if (args.body.data[0].bookmaker.length != 2) {
															$(".BOOKMAKER_ODDS_dis").hide();
														}
													}
													if (html_bookmaker_tied_odds != "") {
														var html_bookmaker_tied_odds_div = ` <div class="row row5 bookmaker-tied-market mt-1">
														<div class="bm1 col-xl-12">
														<div>
														<div class="market-title mt-1">
														Tied Match
														<a href="javascript:void(0)"  data-toggle="modal" data-target="#view_bookmaker_tied_rules" class="m-r-5 game-rules-icon"><span><i class="fa fa-info-circle float-right"></i></span></a></div>
														<div class="table-header">
														<div class="float-left country-name box-4 text-info"><b>Min: <span class="bookmaker_tied_min">1</span> 
														Max: <span class="bookmaker_tied_max">1</span></b></div>
														<div class="box-1 float-left"></div>
														<div class="box-1 float-left"></div>
														<div class="back box-1 float-left text-center"><b>BACK</b></div>
													...
													<div class="table-body">${html_bookmaker_tied_odds}</div>
													<div class="table-remark text-right remark">${bookmaker_tied_remarks}
													</div>
													<div>
													</div>
												</div>
														...
														html_match_odds += html_bookmaker_tied_odds_div;
													}
												}
									...
									if (args.body1.body) {
										if (args.body1.body.bm1) {
											...
											if (args.body1.body.bm1[0]) {
												var hideBtn = "";
												if (args.body1.body.bm1 && args.body1.body.bm1.length > 2) {
													hideBtn = "style= display:none;";
												}
												bookmaker_remarks = "";
												html_bookmaker_odds = "";
			...
			<?php if ($eventType == 4) { ?>
				...
				if (args.body.data[0]) {
					...
					if (args.body.data[0].bookmaker && args.body.data[0].bookmaker != null) {
						z = 0;
						if (args.body.data[0].bookmaker) {


							var bookmaker1_data = args.body.data[0].bookmaker;
					...
					if (args.body.data[0].bookmaker_tied && args.body.data[0].bookmaker_tied != null) {
						z = 0;
						if (args.body.data[0].bookmaker_tied) {
							var bookmaker1_tied_data = args.body.data[0].bookmaker_tied;
							bookmaker_tied_remarks = args.body.data[0].bookmaker_tied_remark;
							for (var b in bookmaker1_tied_data) {
								marketType = "BOOKMAKER_TIED_ODDS";
								selectionId = bookmaker1_tied_data[b].selectionId
								selectorIdBookmakerTiedArray.push(selectionId);
								...
								/* $("#bookmaker_tied_min").html(bookmaker1_tied_data[b].min);
								$("#bookmaker_tied_max").html(bookmaker1_tied_data[b].max); */
								/* $("#bookmaker_tied_min").html('<?php echo $bookmaker_tied_min; ?>');
											$("#bookmaker_tied_max").html('<?php echo $bookmaker_tied_max; ?>'); */
							...
							$(".BOOKMAKER_TIED_ODDS_dis").show();
							if (args.body.data[0].bookmaker_tied.length != 2) {
								$(".BOOKMAKER_TIED_ODDS_dis").hide();
							}
						}
						if (html_bookmaker_tied_odds != "") {
							$("#bookmaker_tied_market_div").show();
							$("#match_odds_bookmaker_tied_market").html(html_bookmaker_tied_odds);
							$("#bookmaker-tied-remakrs").html(bookmaker_tied_remarks);
						}
						/* } */
			...
			if (args.body.cricket) {
				if (args.body.cricket[0]) {
					...
					for (k = 0; k < args.body.cricket[0].length; k++) {
						...
						if (args.body.cricket[0][k].bookmaker) {
							bookmaker_min = args.body.cricket[0][k].min;
							bookmaker_max = args.body.cricket[0][k].max;
							bookmaker_max1 = parseFloat(bookmaker_max) >= 100000 ? parseInt(parseInt(bookmaker_max) / 100000) + "L" : bookmaker_max;
							$(".bookmaker_min").html(bookmaker_min);
							$(".bookmaker_max").html(bookmaker_max);
						}
						if (args.body.cricket[0][k].bookmaker_tied) {
							bookmaker_tied_min = args.body.cricket[0][k].min_tied;
							bookmaker_tied_max = args.body.cricket[0][k].max_tied;
						...
						if (market_type_name == "Match Odds") {
							...
							marketType = "TIED_MATCH";
							$('#match_odds_tied_max_bet_' + k).text(max_bet);
							$('#match_odds_tied_min_bet_' + k).text(max_bet == 1 ? 0 : 100);
						} else if (market_type_name == "To Win the Toss") {
							marketType = "TOSS_ODDS";
						} else {
							if (market_type_name) {
						...
						if (args.body.cricket[0][k].runners) {
							...
							for (j = 0; j < args.body.cricket[0][k].runners.length; j++) {
								...
								if (args.body.cricket[0][k].runners[j].back[2]) {
									...
									one_size_1 = args.body.cricket[0][k].runners[j].back[2].size || "";
								} else {
									one_price_1 = "-";
									one_size_1 = "";
								}
								if (args.body.cricket[0][k].runners[j].back[1]) {
									...
									one_size_2 = args.body.cricket[0][k].runners[j].back[1].size || "";
								} else {
									one_price_2 = "-";
									one_size_2 = "";
								}
								if (args.body.cricket[0][k].runners[j].back[0]) {
									...
									one_size_3 = args.body.cricket[0][k].runners[j].back[0].size || "";
								} else {
									one_price_3 = "-";
									one_size_3 = "";
								}
								if (args.body.cricket[0][k].runners[j].lay[0]) {
									...
									lay_one_size_1 = args.body.cricket[0][k].runners[j].lay[0].size || "";
								} else {
									lay_one_size_1 = "";
									lay_one_price_1 = "-";
								}
								if (args.body.cricket[0][k].runners[j].lay[1]) {
									...
									lay_one_size_2 = args.body.cricket[0][k].runners[j].lay[1].size || "";
								} else {
									lay_one_size_2 = "";
									lay_one_price_2 = "-";
								}
								if (args.body.cricket[0][k].runners[j].lay[2]) {
									...
									lay_one_size_3 = args.body.cricket[0][k].runners[j].lay[2].size || "";
								} else {
									lay_one_price_3 = "-";
									lay_one_size_3 = "";
								}
								...
								one_size_2 = one_size_2.toFixed(2);
								one_size_3 = one_size_3.toFixed(2);
								lay_one_size_1 = lay_one_size_1 ? lay_one_size_1.toFixed(2) : lay_one_size_1;
								lay_one_size_2 = lay_one_size_2 ? lay_one_size_2.toFixed(2) : lay_one_size_2;
								lay_one_size_3 = lay_one_size_3 ? lay_one_size_3.toFixed(2) : lay_one_size_3;
						...
						if (args.body.cricket[0][k].bookmaker_tied && args.body.cricket[0][k].bookmaker_tied != null) {
							for (z = 0; z < args.body.cricket[0][k].bookmaker_tied.length; z++) {
								var bookmaker1_tied_data = args.body.cricket[0][k].bookmaker_tied;
								for (var b in bookmaker1_tied_data) {
									...
									runnerName = bookmaker1_tied_data[b].name;
									book_status = bookmaker1_tied_data[b].status;
									bookmaker_tied_remarks = bookmaker1_tied_data[b].bookmaker_tied_remarks;
									/* $("#bookmaker_tied_min").html('<?php echo $bookmaker_tied_min; ?>');
									$("#bookmaker_tied_max").html('<?php echo $bookmaker_tied_max; ?>'); */
									var temp_selectionId;
									temp_selectionId = runnerName.split(" ").join('_');
									...
									back_1_html = "<span class='odd d-block'>" + bookmaker1_tied_back_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_size + "</span>";
									back_2_html = "<span class='odd d-block'>" + bookmaker1_tied_back_2_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_2_size + "</span>";
									back_3_html = "<span class='odd d-block'>" + bookmaker1_tied_back_3_rate + "</span> <span class='d-block'>" + bookmaker1_tied_back_3_size + "</span>";
									lay_1_html = "<span class='odd d-block'>" + bookmaker1_tied_lay_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_size + "</span>";
									lay_2_html = "<span class='odd d-block'>" + bookmaker1_tied_lay_2_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_2_size + "</span>";
									lay_3_html = "<span class='odd d-block'>" + bookmaker1_tied_lay_3_rate + "</span> <span class='d-block'>" + bookmaker1_tied_lay_3_size + "</span>";
							...
							if (args.body.session[0].value.session) {
								...
								for (i = args.body.session[0].value.session.length - 1; i >= 0; i--) {
									...
									if (marketId == "" || args.body.session[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.session[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {} else {
										...
										if (parseFloat(max_stack) >= 100000) {
											max_stack = parseInt(max_stack / 100000) + "L";
										} else if (parseFloat(max_stack) >= 1000) {
											max_stack = parseInt(max_stack / 1000) + "K";
										}
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												html_fancy_market_new += "<div class='col-6'  id='fancyBetMarket_" + eventId + "_" + marketId + "'><div class='fancy-tripple'><div data-title='SUSPENDED' class='table-row suspended fancy-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)' onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'>0</span></p></div><div class='box-1 lay float-left text-center lay-1' id='fancy_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-1 back float-left text-center back-1' id='fancy_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
									...
									if (marketId == "" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.overByOver[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {} else {
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												back_attribute = " event_name='" + event_name + "' fullmarketodds='" + runsYes + "' side='Lay' marketid='" + oddsmarketId + "' eventid='" + eventId + "'  selectionid='" + marketId + "' market_odd_name='' runner='" + marketName + "' marketname='" + marketName + "' markettype='FANCY_ODDS' inplay='1' fullfancymarketrate='" + oddsYes + "'";
												lay_attribute = " event_name='" + event_name + "' fullmarketodds='" + runsNo + "' side='Lay' marketid='" + oddsmarketId + "' eventid='" + eventId + "' selectionid='" + marketId + "' market_odd_name='' runner='" + marketName + "' marketname='" + marketName + "' markettype='FANCY_ODDS' inplay='1' fullfancymarketrate='" + oddsNo + "'";
												html_fancy_market_new += "<div class='col-6' id='fancyOverBetMarket_" + eventId + "_" + marketId + "'> <div class='fancy-tripple'><div data-title='SUSPENDED' class='table-row suspended fancy_over_by_over-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)' onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'>0</span></p></div><div class='box-1 lay float-left text-center lay-1' id='fancy_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-1 back float-left text-center back-1' id='fancy_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
									...
									if (marketId == "" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												if (runsNo == 0 || runsNo == "null" || runsNo == "") {
													runsNo = "-";
													oddsNo = "";
												}
												if (runsYes == 0 || runsYes == "null" || runsYes == "") {
													runsYes = "-";
													oddsYes = "";
												}
												lay_runs_info = "<span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span>";
												...
												html_fancy_market_new1 += "<div class='fancy-tripple col-6' id='fancy1BetMarket_" + eventId + "_" + marketId + "'><div data-title='SUSPENDED' class='table-row suspended fancy1-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)' onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'>0</span></p></div><div class='box-1 back float-left text-center back-1' id='fancy1_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-1 lay float-left text-center lay-1' id='fancy1_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
							...
							if (args.body.khado[0].value.session) {
								...
								for (i = 0; i < args.body.khado[0].value.session.length; i++) {
									...
									if (marketId == "" || args.body.khado[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.khado[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
										...
										if (oddsNo == null || oddsNo == "") {
											oddsNo = "-";
										}
										if (oddsYes == null || oddsYes == "") {
											oddsYes = "-";
										}
										check_runsNo_interger = isNaN(runsNo);
										check_oddsNo_interger = isNaN(oddsNo);
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												html_khado_market_new += "<div class='fancy-tripple col-6' id='khadoBetMarket_" + eventId + "_" + marketId + "'><div data-title='SUSPENDED' class='table-row suspended khado-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)'> " + marketName + ' - ' + runsNo + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_KHADO_ODDS'><span style='color: black;'>0</span></p></div><div class='box-1 back float-left text-center back-1' id='khado_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div>";
												/* <div class='box-1 lay float-left text-center' id='khado_market_lay_btn_" + marketId + "' " + lay_attribute + " ></div> */
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
									...
									if (marketId == "" || args.body.ballByBall[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.ballByBall[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												html_ball_market_new += "<div class='col-6' id='ballBetMarket_" + eventId + "_" + marketId + "'><div class='fancy-tripple'><div data-title='SUSPENDED' class='table-row suspended ballByBall-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'>0</span></p></div><div class='box-1 lay float-left text-center lay-1' id='ball_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-1 back float-left text-center back-1' id='ball_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
									...
									if (marketId == "" || args.body.oddEven[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.oddEven[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
										...
										if (!n1 && !n2 && !n3) {
											...
											if (m1) {
												...
												html_oddeven_market_new += "<div class='fancy-tripple col-6' id='oddevenBetMarket_" + eventId + "_" + marketId + "'>	<div data-title='SUSPENDED' class='table-row suspended oddeven-suspend-tr_" + marketId + "'> <div class='float-left country-name box-6' style='border-bottom: 0px;'> 	<p class='m-b-0'>  <a href='javascript:void(0)'> " + marketName + " </a> 	</p> 	<p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'>  <span style='color: black;'>0</span> 	</p> </div> <div class='box-1 back float-left text-center back-1' id='oddeven_market_back_btn_" + marketId + "' " + odd_attribute + "> 	<span class='odd d-block'>" + runsYes + "</span> 	<span>" + oddsYes + "</span> </div> <div class='box-1 back float-left text-center lay-1' id='oddeven_market_lay_btn_" + marketId + "' " + even_attribute + " > 	<span class='odd d-block'>" + runsNo + "</span> 	<span>" + oddsNo + "</span> </div> <div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'> 	<span class='d-block'>Min: <span>" + min_stack + "</span></span>  	<span class='d-block'>Max: <span>" + max_stack + "</span></span> </div>	</div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div>";
												lastrunsNo = runsNo;
												lastrunsYes = runsYes;
						...
						$.each(args.body.cricketcasino[0].value.session, function(key, val) {
							...
							match_odds_numbers_markets += `<div class="fancy-market-number">
												<div class='market-title mt-1'>${market_odd_name}</div>
													<div class="table-header">
														<div class="market-title1 float-left country-name box-8">Min: ${min_stack} Max: ${max_stack}
														</div>
							...
							for (z = 0; z < args.body.cricketcasino[0].value.session[key].length; z++) {
								...
								if (bet_suspended == "Suspended") {
									cricketcasino_suspended = 'suspended-box';
								}
							...
							match_odds_numbers_markets += "</div></div><div></div>";
						});
			...
			success: function(response) {
				...
				if (status == 'ok') {
					if (response.data) {
						...
						if (!response.data['MATCH_ODDS']) {
							$('.MATCH_ODDS_dis').prop('disabled', true);
							var ij = 0;
							while (selectorIdArray[ij]) {
								if (display_cashProfit['MATCH_ODDS'] && display_cashProfit['MATCH_ODDS'][selectorIdArray[ij]]) {
									display_cashProfit['MATCH_ODDS'][selectorIdArray[ij]]['exposure'] = 0;
								}
							...
							while (selectorIdBookmakerArray[ij]) {
								$('.BOOKMAKER_ODDS_dis').prop('disabled', true);
								$('.BOOKMAKERSMALL_ODDS_dis').prop('disabled', true);
								if (display_cashProfit['BOOKMAKER_ODDS'] && display_cashProfit['BOOKMAKER_ODDS'][selectorIdBookmakerArray[ij]]) {
									display_cashProfit['BOOKMAKER_ODDS'][selectorIdBookmakerArray[ij]]['exposure'] = 0;
								}
								if (display_cashProfit['BOOKMAKERSMALL_ODDS'] && display_cashProfit['BOOKMAKERSMALL_ODDS'][selectorIdBookmakerArray[ij]]) {
									display_cashProfit['BOOKMAKERSMALL_ODDS'][selectorIdBookmakerArray[ij]]['exposure'] = 0;
								}
							...
							while (selectorIdBookmakerTiedArray[ij]) {
								$('.BOOKMAKER_TIED_ODDS_dis').prop('disabled', true);
								if (display_cashProfit['BOOKMAKER_TIED_ODDS'] && display_cashProfit['BOOKMAKER_TIED_ODDS'][selectorIdBookmakerTiedArray[ij]]) {
									display_cashProfit['BOOKMAKER_TIED_ODDS'][selectorIdBookmakerTiedArray[ij]]['exposure'] = 0;
								}
						...
						for (var i in response.data) {
							if (i == "BOOKMAKER_ODDS" || i == "BOOKMAKER_TIED_ODDS") {
								for (var ij = 1; ij <= Object.keys(response.data[i].market_ids).length; ij++) {
									$('.' + i + '_dis').prop('disabled', false);
									var team = "team_" + ij;
									var market_1 = parseInt(response.data[i].market_ids[team]);
									var team_1_exposure = parseFloat(response.data[i].exposure[team]).toFixed(2);
									...
									if (market_1 != "") {
										if (display_cashProfit[i] && display_cashProfit[i][market_1]) {
								...
								var market_1 = "";
								var market_2 = "";
								if (response.data[i].market_ids.team_1) {

									market_1 = parseInt(response.data[i].market_ids.team_1);
								}
								if (response.data[i].market_ids.team_2) {
									market_2 = parseInt(response.data[i].market_ids.team_2);
								}
								var market_3 = "";
								if (response.data[i].market_ids.team_3) {
									market_3 = parseInt(response.data[i].market_ids.team_3);
								}
								var team_1_exposure = 0;
								var team_2_exposure = 0;
								if (response.data[i].exposure.team_1) {
									team_1_exposure = parseFloat(response.data[i].exposure.team_1).toFixed(2);
								}
								if (response.data[i].exposure.team_2) {
									team_2_exposure = parseFloat(response.data[i].exposure.team_2).toFixed(2);
								}
								var team_3_exposure = 0;
								if (response.data[i].exposure.team_3) {
									team_3_exposure = parseFloat(response.data[i].exposure.team_3).toFixed(2);
								}
								...
								if (market_1 == NaN && market_2 == NaN && market_3 == NaN) {
									...
									display_cashProfit[i][added_team_1]['exposure'] = 0;
									display_cashProfit[i][added_team_2]['exposure'] = 0;
									display_cashProfit[i][added_team_3]['exposure'] = 0;
								}
								if (market_1 != "") {
									if (display_cashProfit[i] && display_cashProfit[i][market_1]) {
										display_cashProfit[i][market_1]['exposure'] = team_1_exposure;
								...
								if (market_2 != "") {
									if (display_cashProfit[i] && display_cashProfit[i][market_2]) {
								...
								for (j in response.data[i]) {
									...
									$.each(fancy_market_idsnew, function(key, val) {
										...
										if (fancy_market_ids != "") {
											if (display_cashProfit[i] && display_cashProfit[i][fancy_market_ids]) {
												display_cashProfit[i][fancy_market_ids]['exposure'] = fancy_exposure;
											}
										}
									});
...
<script>
	...
	console.log("fdgfdgbfg=", iframe_score_url);
	if (iframe_score_url != "") {
...
<script>
	jQuery(document).on("click", ".back-1", function() {
		...
		if (fullmarketodds != "") {
			...
			return_html = "";
			return_html += "<div class='bet-slip-data'><div><div class='table-responsive back'><table class='coupon-table table table-borderedless'><thead><tr><th class='place-bet-for'>(Bet for)</th><th class='place-bet-odds'>Odds</th><th class='place-bet-stake'>Stake</th><th class='place-bet-profit'>Profit</th></tr></thead><tbody>";
			// <a href='javascript:void(0);' class='text-danger close-bet-slip'><i class='fa fa-times'></i></a>
			return_html += "<tr><td class='text-center place-bet-for'> <span>" + runner + "</span> </td><td class='bet-odds place-bet-odds'><div class='form-group'> <input placeholder='0' value='" + fullmarketodds + "' id='odds_val' disabled readonly type='text' required='required' maxlength='4' readonly='readonly' class='amountint' style='width: 45px; vertical-align: middle;'></div></td><td class='bet-stakes place-bet-stake'><div class='form-group bet-stake'><input type='hidden' id='bet_stake_side' value='Back'/><input type='hidden' id='bet_event_id' value='" + eventId + "'/><input type='hidden' id='bet_marketId' value='" + selectionid + "'/><input type='hidden' id='bet_event_name' value='" + event_name + "'/><input type='hidden' id='bet_market_name' value='" + marketname + "'/><input type='hidden' id='bet_markettype' value='" + markettype + "'/><input type='hidden' id='fullfancymarketrate' value='" + fullfancymarketrate + "'/> <input type='hidden' id='oddsmarketId' value='" + marketId + "'/><input type='hidden' id='market_runner_name' value='" + market_runner_name + "'/><input type='hidden' id='market_odd_name' value='" + market_odd_name + "'/><input type='hidden' id='other_fancy' value='" + other_fancy + "'/> <input maxlength='10' name='inputStake' id='inputStake' required='required' type='text' ></div></td><td class='text-right bet-profit place-bet-profit' id='profitLiability'>" + winnig_zone + "</td></tr>";
			...
			?>
				return_html += " <button type='button' stake='<?php echo $button_value; ?>' class='btn btn-secondary m-l-5 m-b-5 label_stake btn-place-bet'> +<?php echo $labelprint; ?>k </button>";
			<?php
			}
			?>
			return_html += "<div class='btn btn-sm btn-link text-dark flex-fill text-end place-bet-clear-btn'>clear</div>";
			return_html += "</td></tr></tbody></table><div class='col-md-12 place-bet-action-buttons'> <div> <button type='button' class='btn btn-sm btn-info float-left btn-edit' data-target='#set_btn_value' data-toggle='modal'> Edit </button> </div><div><button type='button' class='btn btn-sm btn-danger float-left close-bet-slip'> Reset </button> <button type='button' class='btn btn-sm btn-success float-right m-b-5 placeBet' id='placeBet'> Submit </button></div></div></div></div></div>"
	...
	jQuery(document).on("click", ".lay-1", function() {
		...
		if (fullmarketodds != "") {
			...
			$(this).addClass("select");
			return_html = "";
			return_html += "<div class='bet-slip-data'><div><div class='table-responsive lay'><table class='coupon-table table table-borderedless'><thead><tr><th class='place-bet-for'>(Bet for)</th><th class='place-bet-odds'>Odds</th><th class='place-bet-stake'>Stake</th><th class='place-bet-profit'>Liability</th></tr></thead><tbody>";
			// <a href='javascript:void(0);' class='text-danger close-bet-slip'><i class='fa fa-times'></i></a>
			return_html += "<tr><td class='text-center place-bet-for'> <span>" + runner + "</span> </td><td class='bet-odds place-bet-odds'><div class='form-group'> <input placeholder='0' value='" + fullmarketodds + "' id='odds_val' disabled readonly type='text' required='required' maxlength='4' readonly='readonly' class='amountint' style='width: 45px; vertical-align: middle;'></div></td><td class='bet-stakes place-bet-stake'><div class='form-group bet-stake'><input type='hidden' id='bet_stake_side' value='Lay'/><input type='hidden' id='bet_event_id' value='" + eventId + "'/><input type='hidden' id='bet_marketId' value='" + selectionid + "'/><input type='hidden' id='bet_event_name' value='" + event_name + "'/><input type='hidden' id='bet_market_name' value='" + marketname + "'/><input type='hidden' id='bet_markettype' value='" + markettype + "'/><input type='hidden' id='fullfancymarketrate' value='" + fullfancymarketrate + "'/> <input type='hidden' id='oddsmarketId' value='" + marketId + "'/><input type='hidden' id='market_runner_name' value='" + market_runner_name + "'/><input type='hidden' id='market_odd_name' value='" + market_odd_name + "'/><input type='hidden' id='other_fancy' value='" + other_fancy + "'/> <input maxlength='10' name='inputStake' id='inputStake' required='required' type='text' ></div></td><td class='text-right bet-profit place-bet-profit' id='profitLiability'>0</td></tr>";
			return_html += "<tr><td colspan='5' class='value-buttons' style='padding: 5px;'>";
			<?php
			$get_button_value = $conn->query("select * from user_master where id=$user_id and (button_value <> '' and button_value IS NOT NULL)");
			$num_rows = $get_button_value->num_rows;
	...
	function getCashoutBet(pA, pB, marketA, marketB, mtypeNew) {
		...
		// ---------- Back A ----------
		{
			var odds = marketA.back;
			if (mtypeNew == "BOOKMAKER_ODDS" || mtypeNew == "BOOKMAKER_TIED_ODDS" || mtypeNew == "BOOKMAKERSMALL_ODDS" || mtypeNew.indexOf('BM_') !== -1) {
				odds = (odds / 100) + 1;
			}
			var stake = (pB - pA) / odds;
			stake = parseFloat(stake.toFixed(2));
			if (stake > 0) {
				const newPA = pA + stake * (odds - 1);
				const newPB = pB - stake;
				pushResult(marketA.selectionId, "Back", odds, stake, newPA, newPB);
			}
		...
		// ---------- Lay A ----------
		{
			var odds = marketA.lay;
			if (mtypeNew == "BOOKMAKER_ODDS" || mtypeNew == "BOOKMAKER_TIED_ODDS" || mtypeNew == "BOOKMAKERSMALL_ODDS" || mtypeNew.indexOf('BM_') !== -1) {
				odds = (odds / 100) + 1;
			}
			var stake = (pA - pB) / odds;
			stake = parseFloat(stake.toFixed(2));
			if (stake > 0) {
				const newPA = pA - stake * (odds - 1);
				const newPB = pB + stake;
				pushResult(marketA.selectionId, "Lay", odds, stake, newPA, newPB);
			}
		...
		// ---------- Back B ----------
		{
			...
			stake = parseFloat(stake.toFixed(2));
			if (stake > 0) {
				const newPA = pA - stake;
				const newPB = pB + stake * (odds - 1);
				pushResult(marketB.selectionId, "Back", odds, stake, newPA, newPB);
			}
		...
		// ---------- Lay B ----------
		{
			...
			if (stake > 0) {
				const newPA = pA + stake;
				const newPB = pB - stake * (odds - 1);
				pushResult(marketB.selectionId, "Lay", odds, stake, newPA, newPB);
			}
		...
		if (results[0]) {
			if (mtypeNew == "BOOKMAKER_ODDS" || mtypeNew == "BOOKMAKER_TIED_ODDS" || mtypeNew == "BOOKMAKERSMALL_ODDS" || mtypeNew.indexOf('BM_') !== -1) {
				results[0].odds = (results[0].odds * 100) - 100;
				results[0].odds = parseFloat(Math.round(results[0].odds, 2));
			}
		}
		console.log({
			best: results[0],
		...
		/* if (results[0] == undefined || !results[0].odds || isNaN(results[0].odds) || results[0].odds <= 1 || results[0].odds == "-") {
			return {
	...
	jQuery(document).on("click", ".cashoutClick", function() {
		...
		if (ids.length === 2) {
			...
			if (A.exposure <= 0 && B.exposure <= 0) {
				toastr.clear();
				toastr.warning("You are not eligible for cashout", "", {
					"timeOut": "3000",
			...
			if (fullmarketodds == "" || fullmarketodds == "-" || isNaN(fullmarketodds)) {
			...
			if (fullmarketodds != "") {
				...
				runner = display_cashProfit[market_typeee][result.team]['runnerName'];

				market_runner_name = runner;
				marketname = runner;
				markettype = market_typeee;
				other_fancy = "";
				...
				return_html = "";
				return_html += "<div class='bet-slip-data'><div><div class='table-responsive' id='popup_color'><table class='coupon-table table table-borderedless'><thead><tr><th class='place-bet-for'>(Bet for)</th><th class='place-bet-odds'>Odds</th><th class='place-bet-stake'>Stake</th><th class='place-bet-profit'>Profit</th></tr></thead><tbody></tbody> </table></div></div></div>";
	...
	jQuery(document).on("input", "#inputStake", function() {
		...
		if (bet_markettype != "FANCY_ODDS") {
			...
			if (display_cashProfit[bet_markettype]) {
				for (var market_id in display_cashProfit[bet_markettype]) {
					...
					$("#last_data_" + market_id + "_" + bet_markettype).removeClass("text-success");
					$("#last_data_" + market_id + "_" + bet_markettype).removeClass("text-danger");
					$("#last_data_" + market_id + "_" + bet_markettype).addClass(index.exposure > 0 ? "text-success" : "text-danger");
				}
			}
	...
	jQuery(document).on("click", ".label_stake", function() {
		...
		if (bet_markettype == "MATCH_ODDS" || bet_markettype == "BOOKMAKER_ODDS" || bet_markettype == "BOOKMAKER_TIED_ODDS" || bet_markettype.indexOf('BM_') !== -1) {
			$("#profitLiability").text(profit.toFixed(2));
		}
		$("#placeBet").removeAttr('disabled');
	});
