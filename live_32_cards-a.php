...
<body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
    <div id="app">
       <?php
        ...
        <div class="wrapper">
			...
			<!----></span> 
			<small role="button" class="teenpatti-rules"  onclick="view_rules('32cards_a')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
  ...
  if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".A32CARDSA_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
                            ...
                            ?>
												<!-- <iframe class="iframedesign" id="casinoIframe" src="" width="100%" height="200" style="border: 0px;"></iframe>
                                            <iframe class="iframedesign" src="<?php echo IFRAME_URL; echo A32CARDSA_CODE; ?>" width="100%" height="400" style="border: 0px;"></iframe> -->
                      ...
                      <span class="text-warning" id="card_4_value"></span></b></p>
                                        ...
                                        <div class="casino-detail">
												...
												<div class="casino-table-box">
													<div class="casino-table-left-box">
														...
														<div class="casino-table-row ">
															...
															<div class="casino-odds-box back suspended-box market_1_row  back-1 market_1_b_btn"><span class="casino-odds">0</span></div>
															<div class="casino-odds-box lay suspended-box market_1_row lay-1 market_1_l_btn"><span class="casino-odds">0</span></div>
														</div>
														<div class="casino-table-row">
															<div class="casino-nation-detail">
											...
											<div class="casino-last-results" id="last-result">
												<!-- <span class="result result-b">10</span><span class="result result-b">10</span><span class="result result-b">9</span><span class="result result-b">11</span><span class="result result-b">9</span><span class="result result-b">9</span><span class="result result-b">10</span><span class="result result-b">11</span><span class="result result-b">10</span><span class="result result-b">10</span> -->
											</div>
										</div>
                                    </div>
                                </div>
