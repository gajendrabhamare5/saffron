...
function view_casiono_result(event_id, casino_type) {
    ...
    if (casino_type == "teen20") {
        ...
        result_title = "Teenpatti Test Result";
        ...
        result_title = "Teenpatti Poison One Day Result";
    }
...
<div id="rules_popup" class="modal rules_popup_modal" role="dialog">
