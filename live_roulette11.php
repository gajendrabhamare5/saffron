                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">Golden Roulette
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('roulette11')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . ROULETTE11_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                    ...
                                    <div class="casino-detail">
                                        <div class="casino-table">
                                            <div class="transfer-board">
                                                ...
                                                <h5 class="d-block d-lg-none"><a href="/casino/roulette11">Statistics</a></h5>
                                            </div>
