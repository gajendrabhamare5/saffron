...
<html lang="en">
 ...
 <script type="text/javascript">
        ...
        if (check == true) {
            window.location.assign('<?php echo MOBILE_URL; ?>');
        }
    </script>
    <?php
    ...
    <body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
        <div id="app">
            <div id="load">
                <div id="load-inner"><img src="<? echo WEB_URL .$logo ?>" class="logo-login"> <i class="fa fa-spinner fa-spin"></i></div>
            </div>
            <div class="login">
                <div class="wrapper">
                        ...
                        <div class=" row">
                            <div class="col-md-12">
                                <div class="loginInner1">
                                    <div class="log-logo m-b-20 text-center"><img src="<? echo WEB_URL .$logo ?>" class="logo-login"></div>
                                    <div class="featured-box-login featured-box-secundary default">
                                        ...
                                        <div class="form-group m-b-20">
                                            <input name="User Name" placeholder="User Name" id="email" type="text" class="form-control" aria-required="true" aria-invalid="false"> <i class="fas fa-user"></i>
                                            <!----><small class="text-danger" style="display: none;"></small></div>
                                        <div class="form-group m-b-20">
                                            <input name="Password" placeholder="Password" id="pass" type="password" class="form-control" aria-required="true" aria-invalid="false"> <i class="fas fa-key"></i>
                                            <!----><small class="text-danger" style="display: none;"></small></div>
                                        <div class="form-group text-center mb-0">
                                            <button type="submit" class="btn btn-submit btn-login" id="logi" onclick="goLogin()">
                                                Login
                                                <i class="ml-2 fas fa-sign-in-alt"></i>
                                            </button>
                                        </div>
                                        <div class="form-group text-center mt-2">
                                            <button type="submit" class="btn btn-submit btn-login" id="logid" onclick="goDemoLogin()">
											Login with demo ID
                                                <i class=" ml-2 fas fa-sign-in-alt"></i></button>
                                        </div>
   ...
   <?
    ...
    <div id="view_auth_pop" class="modal" role="dialog">
           ...
           var auth_login_id = "";
            ...
            function goLogin() {
                ...
                else
                {
                    ...
                    $('#logi').html("Loading <i class='fa fa-spinner fa-spin' id='loading'></i>");
        ...
        <div id="b-toaster-top-center" class="b-toaster b-toaster-top-center">
            <div class="b-toaster-slot vue-portal-target"></div>
        </div>
    </body>
