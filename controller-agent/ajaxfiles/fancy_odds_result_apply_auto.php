...
if ($market_type == "Over") {
	...
	if ($match_odds_result == "CAN") {
		$delete_bet_details  = $conn->query("update bet_details set bet_status=2 where $condition event_id='$event_id' and market_id='$market_id' and market_type='FANCY_ODDS'");
	...
	$get_win_bet_details = $conn->query("select * from bet_details where $condition event_id='$event_id' and market_id='$market_id' and market_type='FANCY_ODDS'");
	...
	if ($match_odds_result == "CAN") {
		$delete_bet_details = $conn->query("update bet_details set bet_status=2 where $condition event_id='$event_id' and market_id='$market_id' and market_type='$market_type'");
	...
	$get_win_bet_details = $conn->query("select * from bet_details where $condition event_id='$event_id' and market_id='$market_id' and market_type='$market_type' and bet_status=1");
	while ($fetch_get_win_bet_details = mysqli_fetch_assoc($get_win_bet_details)) {
		$bet_id = $fetch_get_win_bet_details['bet_id'];
		$bet_type = $fetch_get_win_bet_details['bet_type'];
	...
	$get_win_bet_details = $conn->query("select * from bet_details where $condition event_id='$event_id' and market_id='$market_id' and market_type='METER_ODDS'  and bet_status=1");
	while ($fetch_get_win_bet_details = mysqli_fetch_assoc($get_win_bet_details)) {
		$bet_id = $fetch_get_win_bet_details['bet_id'];
		$bet_type = $fetch_get_win_bet_details['bet_type'];
		$bet_runs = $fetch_get_win_bet_details['bet_runs'];
	...
	$get_win_bet_details = $conn->query("select * from bet_details where $condition event_id='$event_id' and market_id='$market_id' and market_type='FANCY_ODDS'  and bet_status=1");
	while ($fetch_get_win_bet_details = mysqli_fetch_assoc($get_win_bet_details)) {
		$bet_id = $fetch_get_win_bet_details['bet_id'];
		$bet_type = $fetch_get_win_bet_details['bet_type'];
		$bet_runs = $fetch_get_win_bet_details['bet_runs'];
