...
$event_id = realescape_string($conn, $_REQUEST['event_id']);
$market_id = realescape_string($conn, $_REQUEST['market_id']);
$market_type = realescape_string($conn, $_REQUEST['market_type']);
$match_odds_result = realescape_string($conn, $_REQUEST['match_odds_result']);
