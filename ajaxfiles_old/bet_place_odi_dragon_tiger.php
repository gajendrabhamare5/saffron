...
$casino_lis_db=array_column($casino_maintanance_list_data, 0);
	...
	if(in_array("ODI_DRAGON_TIGER", $casino_lis_db)){
		$return = array(
		"status" => 'error',
	...
	$get_blockeventdata = $conn->query("SELECT * FROM `block_event` WHERE UserId='$user_id' and casino_name='dt6';");
...
$get_check_result = $conn->query("select * from twenty_teenpatti_result where event_id='$eventId' and game_type='dt6'");
...
$api_event_id = str_replace("28.","",$api_event_id);
...
/* else if($marketId == 3){
	...
	$bet_market_name = "DRAGON_CARD_TYPE";
}else if($marketId == 9){
	$bet_market_name = "DRAGON_CARD_TYPE_1";
}else if($marketId == 10){
	$bet_market_name = "DRAGON_CARD_TYPE_2";
}else if($marketId == 11){
	$bet_market_name = "DRAGON_CARD_TYPE_3";
}else if($marketId == 12){
	...
	$bet_market_name = "TIGER_CARD_TYPE";
}else if($marketId == 17){
	$bet_market_name = "TIGER_CARD_TYPE_1";
}else if($marketId == 18){
	$bet_market_name = "TIGER_CARD_TYPE_2";
}else if($marketId == 19){
	$bet_market_name = "TIGER_CARD_TYPE_3";
} */
