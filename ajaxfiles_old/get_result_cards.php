...
if ($casino_type == "teen20OLD" or $casino_type == "teenOLD") {
...
?>
	<div class="col br1 text-center">
		<h4>Player A</h4>
		<div class="result-image"><img src="<?php echo $carda1; ?>" class="mr-2"> <img src="<?php echo $carda2; ?>"
				class="mr-2"> <img src="<?php echo $carda3; ?>" class="mr-2"></div>
		<?php
		if ($result_status == "A") {
		?>
	...
	<div class="col text-center">
		<h4>Player B</h4>
		<div class="result-image"><img src="<?php echo $cardb1; ?>" class="mr-2"> <img src="<?php echo $cardb2; ?>"
				class="mr-2"> <img src="<?php echo $cardb3; ?>" class="mr-2"></div>
		<?php
		if ($result_status == "B") {
		?>
			<div class="winner-icon mt-3"><i class="fas fa-trophy mr-2"></i></div>
...
<?php
} else if ($casino_type == "teen41" || $casino_type == "teen42" || $casino_type == "teen33" || $casino_type == "teen32" || $casino_type == "teen6" || $casino_type == "teen3" || $casino_type == "teen" || $casino_type == "teen62") {
	...
	<div class="d-flex justify-content-between">
		<div class="d-flex flex-column text-center">
			...
			<div class="result-image d-flex align-items-center  gap-2">
				...
				if ($result_status == "1") {
				?>
					<div class="winner-icon mt-3" style="position: unset;"><i class="fas fa-trophy mr-2"></i></div>
				<?php
				}
				?>
				<img src="<?php echo $carda1; ?>" class="mr-2">
				<img src="<?php echo $carda2; ?>" class="mr-2">
				<img src="<?php echo $carda3; ?>" class="mr-2">
		...
		<div class="d-flex flex-column text-center">
			...
			<div class="result-image d-flex align-items-center  gap-2">
				...
				<img src="<?php echo $cardb1; ?>" class="mr-2">
				<img src="<?php echo $cardb2; ?>" class="mr-2">
				<img src="<?php echo $cardb3; ?>" class="mr-2">
				<?php
				if ($result_status == "2") {
				?>
					<div class="winner-icon mt-3" style="position: unset;"><i class="fas fa-trophy mr-2"></i></div>
			...
			<div class="col-md-6">
				<div class="casino-result-desc"
					...
					<div class="casino-result-desc-item" style="display: flex;justify-content: center;width: 100%; flex-wrap: wrap;">
						<div><span style="color:gray">Winner: </span><? echo $rdesc_array[0]; ?></div>
						<div><span style="color:gray">Odd/Even: </span><? echo $rdesc_array[2]; ?></div>
						<div><span style="color:gray">Consecutive: </span><? echo $rdesc_array[3]; ?></div>
					</div>
				</div>
			</div>
		</div>
	<? } ?>
	<? if ($casino_type == "teen33" || $casino_type == "teen32") { ?>
		<div class="row mt-2 justify-content-center">
			<div class="col-md-6">
				<div class="casino-result-desc"
					style="display: -webkit-flex;flex-wrap: wrap;padding: 6px;box-shadow: 0 0 4px -1px;margin-top:10px">
					<div class="casino-result-desc-item" style="display: flex;justify-content: center;width: 100%;">
	...
	?>
		<div class="d-flex justify-content-between">
			<div class="d-flex flex-column text-center">
				<h4>Player A</h4>
				<div class="result-image  d-flex align-items-center  gap-2">
					<img src="<?php echo $card1; ?>" class="mr-2">
			...
			<div class="d-flex flex-column text-center">
				<h4>Player B</h4>
				<div class="result-image d-flex align-items-center  gap-2">
					<img src="<?php echo $card2; ?>" class="mr-2">
			...
			<div class="d-flex flex-column text-center">
				<h4>Player C</h4>
				<div class="result-image  d-flex align-items-center  gap-2">
					<img src="<?php echo $card3; ?>" class="mr-2">
			...
			<div class="d-flex flex-column text-center">
				<h4>Player D</h4>
				<div class="result-image  d-flex align-items-center  gap-2">
					<img src="<?php echo $cardb4; ?>" class="mr-2">
...
?>
	...
	<div class="row abj-result">
		...
		<div class="row mt-2 text-center">
			...
			<div class="col-md-2">
				<div class="result-image mt-1"><img src="<?php echo $a_image; ?>" style="width: 40px;"> </div>
			</div>
...
?>
	<div class="d-flex justify-content-between">
		<div class="d-flex flex-column text-center">
			<h4>Player A - (<? echo $player_a_rank ?>)</h4>
			<div class="result-image d-flex align-items-center  gap-2">
		...
		<div class="d-flex flex-column text-center">
			<h4>Player B - (<? echo $player_b_rank ?>)</h4>
			<div class="result-image d-flex align-items-center  gap-2">
				<?
				echo $player_b;
				?>
		...
		<div class="col-md-6">
			<div class="casino-result-desc"
				...
				<div class="casino-result-desc-item  flex-column text-center"
					...
					<div><span style="color:gray">Big Card
							: </span>
						<? echo $rdesc_array[1]; ?>
					</div>
					<div><span style="color:gray">Zero Card
							: </span>
						<? echo $rdesc_array[2]; ?>
					</div>
					<div><span style="color:gray">One Zero Card
							: </span>
						<? echo $rdesc_array[3]; ?>
					</div>
...
?>
	<div class="row row5 align-items-center cmeter">
		<div class="col-10">
	...
	<div class="d-flex justify-content-between">
		...
		<div class="d-flex flex-column text-center">
			...
			<div class="result-image d-flex align-items-center  gap-2">
				...
				<img src="<?php echo $cardc1; ?>" class="mr-2">
				<img src="<?php echo $cardc2; ?>" class="mr-2">
				<img src="<?php echo $cardc3; ?>" class="mr-2">
				<?php
				if ($result_status == "D") {
				?>
					<div class="winner-icon mt-3" style="position: unset;"><i class="fas fa-trophy mr-2"></i></div>
...
?>
	<div class="eightplayer">
		<div class="row result-row">
			<div class="col-md-12 sixplayer-image">
				<h6 class="text-center">Dealer</h6>
				<div class="text-center"><img src="<?php echo $card_delear; ?>" /></div>
			</div>
		</div>
		<div class="row result-row mt-3">
			<div class="col-md-2 sixplayer-image">
				<h6 class="text-center"> 1</h6>
				<div class="text-center  d-flex justify-content-center gap-2"><img src="<?php echo $card1; ?>" />

					<?php
					if (in_array(1, $result_status)) {
					?>
						<div class="text-center">
							<div class="winner-icon"><i class="fas fa-trophy mr-2"></i></div>
						</div>
					<?php
					}
					?>
			...
			<div class="col-md-2 sixplayer-image">
				...
				<div class="text-center  d-flex justify-content-center  gap-2"><img src="<?php echo $card2; ?>" />
					<?php
			...
			<div class="col-md-2 sixplayer-image">
				...
				<div class="text-center  d-flex justify-content-center  gap-2"><img src="<?php echo $card3; ?>" />
					<?php
			...
			<div class="col-md-2 sixplayer-image">
				...
				<div class="text-center  d-flex justify-content-center  gap-2"><img src="<?php echo $card4; ?>" />
					<?php
			...
			<div class="col-md-2 sixplayer-image">
				...
				<div class="text-center  d-flex justify-content-center  gap-2"><img src="<?php echo $card5; ?>" />
					<?php
			...
			<div class="col-md-2 sixplayer-image">
				...
				<div class="text-center  d-flex justify-content-center  gap-2"><img src="<?php echo $card6; ?>" />
					<?php
...
?>
	<div class="eightplayer">
		...
		<div class="row result-row">
			...
			<div class="col-md-6 sixplayer-image"></div>
			<div class="col-md-3 sixplayer-image">
...
?>
	...
	<div class="row">
		<div class="col text-center">
			<h4>Player A</h4>
			<div class="result-image d-flex justify-content-center  gap-2">
				...
				?>
				<img src="<?php echo $card_a_1; ?>" class="mr-2" />
				<img src="<?php echo $card_a_2; ?>" class="mr-2" />
		...
		<div class="col text-center">
			<h4>Player B</h4>
			<div class="result-image d-flex justify-content-center  gap-2">
				<img src="<?php echo $card_b_1; ?>" class="mr-2" />
				<img src="<?php echo $card_b_2; ?>" class="mr-2" />
	...
	<div class="row mt-3">
		<div class="col-12 text-center">
			<h4>Board</h4>
			<div class="result-image">
				<img src="<?php echo $card_dealer_1; ?>" class="mr-2" /> <img src="<?php echo $card_dealer_2; ?>"
					class="mr-2" />
				<img src="<?php echo $card_dealer_3; ?>" class="mr-2" /> <img src="<?php echo $card_dealer_4; ?>"
					class="mr-2" />
				<img src="<?php echo $card_dealer_5; ?>" class="mr-2" />
			</div>
		</div>
	</div>
			...
			<div class="col-md-6">
				<div class="casino-result-desc"
					...
					<div class="casino-result-desc-item  flex-column text-center"
						...
						<div>
							<span style="color:gray">Winner </span>
							<span><? echo $rdesc_array[0]; ?></span>
						</div>
						<div><span style="color:gray">2 Card </span>
							<span><? echo $rdesc_array[1]; ?></span>
						</div>
						<div><span style="color:gray">7 Card </span>
							<span><? echo $rdesc_array[2]; ?></span>
						</div>
...
?>
	<div class="row row5">
		<div class="col-12 text-center">
			<h4>Board</h4>
			<div class="result-image">
				<img src="<?php echo $card_dealer_1; ?>" class="mr-2" />
				<img src="<?php echo $card_dealer_2; ?>" class="mr-2" />
				<img src="<?php echo $card_dealer_3; ?>" class="mr-2" />
				<img src="<?php echo $card_dealer_4; ?>" class="mr-2" />
				<img src="<?php echo $card_dealer_5; ?>" class="mr-2" />
			</div>
		</div>
	</div>
	...
	<div class="row row5 mt-3">
		...
		<div class="col-4 text-center">
			<h4>1</h4>
			<div class="result-image d-flex justify-content-center  gap-2">
				<img src="<?php echo $player_1_1; ?>" class="mr-2" />
				<img src="<?php echo $player_1_2; ?>" class="mr-2" />
		...
		<div class="col-4 text-center">
			<h4>6</h4>
			<div class="result-image d-flex justify-content-center  gap-2">
				<img src="<?php echo $player_6_1; ?>" class="mr-2" />
				<img src="<?php echo $player_6_2; ?>" class="mr-2" />
	...
	<div class="row row5 mt-3">
		...
		<div class="col-4 text-center">
			...
			<div class="result-image d-flex justify-content-center  gap-2">
				...
				<img src="<?php echo $player_2_1; ?>" class="mr-2" />
				<img src="<?php echo $player_2_2; ?>" class="mr-2" />
		...
		<div class="col-4 text-center">
			...
			<div class="result-image d-flex justify-content-center  gap-2">
				...
				<img src="<?php echo $player_5_1; ?>" class="mr-2" />
				<img src="<?php echo $player_5_2; ?>" class="mr-2" />
	...
	<div class="row row5 mt-3">
		...
		<div class="col-4 text-center">
			...
			<div class="result-image d-flex justify-content-center gap-2">
				...
				<img src="<?php echo $player_3_1; ?>" class="mr-2" />
				<img src="<?php echo $player_3_2; ?>" class="mr-2" />
		...
		<div class="col-4 text-center">
			...
			<div class="result-image d-flex justify-content-center gap-2">
				...
				<img src="<?php echo $player_4_1; ?>" class="mr-2" />
				<img src="<?php echo $player_4_2; ?>" class="mr-2" />
...
?>
	...
	<div class="row  abj-result">
		<div class="col-12 text-center">
			<!-- <h4>Andar</h4> -->
			<div class="result-image">
				<div id="result-a-cards" class="ab-rtlslider owl-carousel owl-theme owl-ltr owl-loaded owl-drag">
					<div class="owl-stage-outer">
						<div class="owl-stage"
							style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 588px;">
							<?php
							$i = 0;
							foreach ($cards as $a_cards) {
				...
				<div class="row row5">
					...
					<div class="col-8">
						<div id="result-a-cards" class="ab-rtlslider owl-carousel owl-theme owl-rtl owl-loaded owl-drag"
							...
							<div class="owl-stage-outer">
								<div class="owl-stage"
									style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 190px;">
	...
	<div class="row mt-2 justify-content-center">
		<div class="col-md-6">
			<div class="casino-result-desc"
				...
				<div class="casino-result-desc-item  flex-column text-center"
					style="display: flex;justify-content: center;width: 100%;gap:8px;">
					<div><span style="color:gray">Winner: </span><? echo $desc_remakrs[0]; ?></div>
					<div><span style="color:gray">Suit: </span><? echo $desc_remakrs[1]; ?></div>
					<div><span style="color:gray">Odd/Even: </span><? echo $desc_remakrs[2]; ?></div>
					<div><span style="color:gray">Joker: </span><? echo $desc_remakrs[3]; ?></div>
		...
		<div class="col-9">
			...
			<div class="card-inner">
				<div class="row row5">
					<!-- <div class="col-2"><img src="<?php echo $card_1st_bahat_image; ?>" class="mb-1"></div> -->
					<div class="col-12">
						<div id="result-b-cards" class="ab-ltrlider owl-carousel owl-theme owl-ltr owl-loaded owl-drag"
							style="width: 100%;">
							<div class="owl-stage-outer">
								<div class="owl-stage"
									style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 228px;">
...
?>
	...
	<div class="row">
		<div class="col-12 text-center">
			<div class="result-image">
				<img src="<?php echo $card_1; ?>" class="mr-2" />
				<img src="<?php echo $card_2; ?>" class="mr-2" />
...
<?php
	...
	$cards = $fetch_get_casino_result['cards'];
	$result_status = $fetch_get_casino_result['result_status'];
	$desc_remakrs1 = $fetch_get_casino_result['desc_remakrs'];
	$desc_remakrs = $fetch_get_casino_result['desc_remakrs'];
	$desc_remakrs = explode("#", $desc_remakrs);
	$cards = json_decode($cards);
...
?>
	...
	<div class="row mt-2">
		...
		<div class="col-md-3 text-center">
			<h4>Player 8 - <span class="text-warning"> <? echo $player_8_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				<?php
				foreach ($player_8 as $card_8) {
					if ($card_8 != WEB_URL . "/storage/front/img/cards_new/1.png") {
				?>
						<img src="<?php echo $card_8; ?>" class="mr-2" />
				<?php
					}
				}
				?>
		...
		<div class="col-md-3 text-center">
			<h4>Player 9 - <span class="text-warning"> <? echo $player_9_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				<?php
				foreach ($player_9 as $card_9) {
					if ($card_9 != WEB_URL . "/storage/front/img/cards_new/1.png") {
				?>
						<img src="<?php echo $card_9; ?>" class="mr-2" />
				<?php
					}
				}
				?>
		...
		<div class="col-md-3 text-center">
			<h4>Player 10 - <span class="text-warning"> <? echo $player_10_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				<?php
				foreach ($player_10 as $card_10) {
					if ($card_10 != WEB_URL . "/storage/front/img/cards_new/1.png") {
				?>
						<img src="<?php echo $card_10; ?>" class="mr-2" />
				<?php
					}
				}
				?>
		...
		<div class="col-md-3 text-center">
			<h4>Player 11 - <span class="text-warning"> <? echo $player_11_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				<?php
				foreach ($player_11 as $card_11) {
					if ($card_11 != WEB_URL . "/storage/front/img/cards_new/1.png") {
				?>
						<img src="<?php echo $card_11; ?>" class="mr-2" />
				<?php
					}
				}
				?>
			...
			<div class="col-md-6">
				<div class="casino-result-desc"
					...
					<div class="casino-result-desc-item" style="display: flex;justify-content: center;width: 100%;">
						...
						<div><span style="color:gray">Black/Red: </span>
							<? echo $desc_remakrs[2]; ?>
						</div>
						<div><span style="color:gray">Total: </span>
							<? echo $desc_remakrs[3]; ?>
						</div>
						<div><span style="color:gray">Single: </span>
							<? echo $desc_remakrs[4]; ?>
						</div>
...
?>
	...
	<div class="row mt-2">
		...
		<div class="col-md-3 text-center">
			<h4>Total 0 - <span class="badge bg-success abc"> <? echo $player_8_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				
						 <?php echo $player_8_img; ?>
		...
		<div class="col-md-3 text-center">
			<h4>Total 1 - <span class="badge bg-success abc"> <? echo $player_9_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">

				<?php echo $player_9_img; ?>
		...
		<div class="col-md-3 text-center">
			<h4>Total 2 - <span class="badge bg-success abc"> <? echo $player_10_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				
			<?php echo $player_10_img; ?>
		...
		<div class="col-md-3 text-center">
			<h4>Total 3 - <span class="badge bg-success abc"> <? echo $player_11_rank; ?></span></h4>
			<div class="result-image d-flex justify-content-center align-items-center gap-2">
				
			<?php echo $player_11_img; ?>
...
?>
	<div class="row">
		<div class="col-12 text-center">
			...
			<!-- <div class="winner-label bg-success m-t-20">
				<?php echo $card_1_value . $card_2_value . $card_3_value; ?> - <?php echo $result_status; ?>
			</div> -->
		</div>
	</div>
			...
			<div class="casino-result-desc"
				...
				<div class="casino-result-desc-item  flex-column text-center"
					...
					<div>
						...
						<span><? echo $card_1_value . $card_2_value . $card_3_value; ?></span>
					</div>
					<div><span style="color:gray">Ocada: </span>
						<span><? echo $result_status; ?></span>
					</div>
...
<?php
	...
	if ($casino_type == "lucky5") {
		$rdesc_array = explode('#', $desc_remakrs);
		$last_value = trim(end($rdesc_array));
...
?>
	...
	<div class="row mt-2 justify-content-center">
		<div class="col-md-6">
			...
			<div><span style="color:gray">Color: </span>
				<span><? echo $rdesc_array[3]; ?></span>
			</div>
			
			<?php
			if($casino_type == "dt6"){ ?>
				<div><span style="color:gray">Suit: </span>
				<span><? echo $rdesc_array[4]; ?></span>
			</div> 
			<?php }
			?>
			<?php
			if($casino_type == "dt202" || $casino_type == "dt20"){ ?>
				<div><span style="color:gray">Card: </span>
				<span><? echo $rdesc_array[4]; ?></span>
			</div> 
			<?php }
...
?>
	...
	<!-- <div class="row mt-3">
		<div class="col-12 text-center">
			<div class="winner-board">
				...
				<div class="mb-1"><span> <?php echo $red_black; ?> | <?php echo $odd_even; ?> |
						<?php echo $is_under_over; ?> | Card <?php echo $card_1_value; ?></span></div>
			</div>
		</div>
	</div> -->
	...
	<!-- <div class="row mt-3">
		<div class="col-12 text-center">
			<div class="winner-board">
				<div class="mb-1"><span class="text-success">Result:</span> <span><?php echo $result_text; ?> </span></div>
				<div class="mb-1"><span> <?php echo $red_black; ?> | <?php echo $odd_even; ?> | <?php echo $dulha_barati; ?>
						| Card <?php echo $card_1_value; ?></span></div>
			</div>
		</div>
	</div> -->
...
?> <style>
	...
	<div class="eightplayer">
		<div class="row result-row mt-3">
			<div class="col-md-4 sixplayer-image">
			...
			<div class="col-md-4 sixplayer-image">
				<h6 class="text-center">Tiger</h6>
				<div class="text-center d-flex justify-content-center align-items-center gap-2">
					<img src="<?php echo $card_2; ?>" />
					<?php
					if ($result_status == "21" or $result_status == "T") {
					?>
						<div class="text-center">
							<div class="winner-icon"><i class="fas fa-trophy mr-2"></i></div>
						</div>
			...
			<div class="col-md-4 sixplayer-image">
				<h6 class="text-center">Lion</h6>
				<div class="text-center d-flex justify-content-center align-items-center gap-2">
					<img src="<?php echo $card_3; ?>" />
					<?php
					if ($result_status == "41" or $result_status == "L") {
					?>
						<div class="text-center">
							<div class="winner-icon"><i class="fas fa-trophy mr-2"></i></div>
						</div>
	...
	<div class="row">
		<div class="col text-center">
			...
			<div class="result-image d-flex justify-content-center  gap-2">
				...
				?>
					<img src="<?php echo $card_5; ?>" class="mr-2 lrotate" />
				<?php
				}
				?>
				<img src="<?php echo $card_3; ?>" class="mr-2" />
		...
		<div class="col text-center">
			...
			<div class="result-image d-flex justify-content-center  gap-2">
				...
				<img src="<?php echo $card_2; ?>" class="mr-2" />
				<img src="<?php echo $card_4; ?>" class="mr-2" />
				<?php
				if ($card_6 != WEB_URL . "/storage/front/img/cards_new/1.png") {
				?>
					<img src="<?php echo $card_6; ?>" class="mr-2 rrotate" />
				<?php
				}
				?>
...
?>
	...
	<style>
		...
		.table-bordered td,
		.table-bordered th {
			border: 0px solid #DEE2EA !important;
		}
	...
	<div>
		...
		<div class="table-responsive">
			...
			<table class="table table-bordered">
				<tr class="grey-row">
					<th class="text-center"><b>Australia</b></th>
				...
				?>
					<tr class="grey-row">
						...
						?>
							<td class="text-center"><span class="<? echo $ball_value === 'ww' ? 'text-danger' : '' ?>"><?php echo $ball_value; ?></span></td>
						<?php
						}
						?>
		...
		<div class="table-responsive mt-3">
			...
			<table class="table table-bordered">
				<tr class="grey-row">
					<th class="text-center"><b>INDIA</b></th>
					<th class="text-center"><b>1</b></th>
					<th class="text-center"><b>2</b></th>
					<th class="text-center"><b>3</b></th>
					<th class="text-center"><b>4</b></th>
...
?>
	<div class="row">
		<div class="col-12 text-center">
			<div class="goal-result goalresult"><img src="storage/img/soccer-ball.png" style="height: 250px;"><span>
...
?>
	...
	<div class="row">
		<div class="col-12 text-center">
			<div class="result-image">
				<img data-v-73ba2763="" src="storage/img/ball-blank.png" style="width: 130px;">
				<span data-v-73ba2763="" class="lucky15result">
					<? echo $desc_remakrs ?>
				</span>
...
<?php
	...
	$desc_remakrs = $fetch_get_casino_result['desc_remakrs'];
	$cards = json_decode($cards);
	// WEB_URL . "/storage/front/img/cards_new/
...
?>
	...
	<div class="row">
		<div class="col-12 text-center">
			<div class="result-image">
				<img data-v-73ba2763="" src="<? echo $card_1; ?>" style="width: 130px;">
...
.unique-teen20-cardpopup img {
	...
	$get_account_data = $conn->query("select * from bet_teen_details where event_id=$event_id and user_id=$user_id and bet_status='0' ");
	// echo "select * from bet_teen_details where event_id=$event_id and user_id=$user_id and bet_status='1' ";
	if ($get_account_data->num_rows > 0) {
	?>
