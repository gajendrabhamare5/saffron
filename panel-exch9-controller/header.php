...
<li><a href="manageevents.php"><i class="fa fa-clock"></i> Limit </a>
<li><a href="bet_history_new.php"><i class="fa fa-clock"></i> Bet History </a>
<li><a href="view_casino_bet.php"><i class="fa fa-clock"></i> View Casino </a>
<li><a href="home_panel.php"><i class="fa fa-clock"></i> Home Custom Event </a>
</li>
...
<li><a href="live_casino"><i class="fa fa-home"></i> Live Casino </a>
</li>
<li><a href="logo_update"><i class="fa fa-home"></i> Logo Upload </a></li>
<li><a href="exposure_remove.php"><i class="fa fa-home"></i> Exposure Remove </a></li>
<li><a href="theme_color.php"><i class="fa fa-home"></i> Theme Color Update </a></li>
