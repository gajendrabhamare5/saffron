<?php
	...
	$conn->query("insert into result (eventType,eventId,marketId,runs,marketName,date_time) values('4','$event_id','$market_id','$match_odds_result','fancy','$date_time')");	
	...
	function set_result($conn,$bet_id,$result_status,$match_odds_result){
