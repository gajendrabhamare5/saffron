  ...
  <strong></strong>
				...
				<div class="col-md-4">
					<div class="control-group">
							...
							<div class="controls">
							<label class="form-group ">Sport Name:</label>
				...
				<div class="col-md-2">
					<div class="control-group">
							...
							<div class="controls">
							<label class="form-group ">Yes Run:</label>
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
						<input type="text" name="yes_run" id="yes_run" placeholder="Yes Run" class="form-control" />
				...
				<div class="col-md-2">
					<div class="control-group">
							...
							<div class="controls">
							<label class="form-group ">No Run:</label>
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
						<input type="text" name="no_run" id="no_run" placeholder="No Run"  class="form-control" />
				...
				<div class="col-md-4">
					<div class="control-group">
							...
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
						<input type="datetime-local" name="start_date_time" id="start_date_time" class="form-control" step="1"/>
				...
				<div class="col-md-4">
					<div class="control-group">
							...
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
						<input type="datetime-local" name="end_date_time" id="end_date_time" class="form-control" step="1"/>
				...
				<div class="control-group">
							...
							<div class="controls">
							<label class="form-group ">Result</label>
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
					<a href="javascript:void(0);" class="btn btn-success btn-xs" onclick="action_cancel_result()">Submit Result</a>
				</div>
				</div>
				</div>
				</div>
							...
							<table class="table table-striped jambo_table bulk_action" id="">
								<thead>
									...
									<?php
										...
										if($login_type == 5){
											$get_pnl_report  = $conn->query("select * from bet_details as b left outer join  user_login_master as ulm on ulm.UserID=b.user_id where b.bet_status =1 order by b.bet_time DESC limit 1");
										...
										?>
											<tr>
												...
												<td><?php echo $fetch_pnrl_report['market_type']; ?></td>
												...
												<td><?php echo $fetch_pnrl_report['bet_margin_used']; ?></td>
												<td><?php echo $fetch_pnrl_report['bet_runs']; ?></td>
												<td><?php echo $fetch_pnrl_report['bet_odds']; ?></td>
												
												<td>
												<?php
												$market_type = $fetch_pnrl_report['market_type'];
												$bet_type = $fetch_pnrl_report['bet_type'];
												$bet_odds = $fetch_pnrl_report['bet_odds'];
												$bet_stack = $fetch_pnrl_report['bet_stack'];
												$bet_margin_used = $fetch_pnrl_report['bet_margin_used'];
												
												if($market_type == "MATCH_ODDS"){
													if($bet_type == 'Yes'){
														echo $win = $bet_odds * $bet_stack;
													}else{
														echo $win = $bet_stack;
													}
												}else{
												...
												<td><?php echo $fetch_pnrl_report['bet_time']; ?></td>
...
function action_cancel_result(){
	var sport_name = $("#sport_name").val();
	var event_name = $("#event_name").val();
	var market_name = $("#market_name").val();
	var yes_run = $("#yes_run").val();
	var no_run = $("#no_run").val();
	...
	$.ajax({
		 type: 'POST',
		 url: 'ajaxfiles/set_apply_cancel_result.php',
		 dataType: 'JSON',
		 data: {sport_name:sport_name,event_name:event_name,market_name:market_name,yes_run:yes_run,no_run:no_run,start_date_time:start_date_time,end_date_time:end_date_time},
		 success: function(response) {
