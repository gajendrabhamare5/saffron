...
<title><?php echo SITE_NAME; ?> | King Admin list</title>
<?php 
							...
							<table class="table table-striped jambo_table bulk_action dataTable no-footer nowrap display" id="example">
								<thead>
									<tr class="headings">
											...
											<th class="column-title" style="display: table-cell;">Credit / Debit </th>
											...
											<th class="column-title" style="display: table-cell;">Change Password</th>
...
$(document).ready(function() {
    var table = $('#example').DataTable( {
        ...
        serverMethod: 'post',
		ajax:{
			url :"ajaxfiles/view_user_king_admin.php", // json datasource
       },
	   columns: [
         { data: 'Email_ID' },
         { data: 'Email_ID2' },
