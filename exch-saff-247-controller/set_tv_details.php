...
<title><?php echo SITE_NAME; ?> | Enter Tv Details</title>
<?php 
...
<div class="item form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="event_end_time">HDMI Id <span class="required">*</span>
</label>
<div class="col-md-6 col-sm-6 col-xs-12">
<input id="hdmi_id" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" data-validate-words="1" name="event_id" placeholder="Enter HDMI ID" required="required" type="text">
</div>
</div>
...
function doInsertTime(){
	...
	if(hdmi_id == ""){
	 ...
	 $.ajax({
		 type: 'POST',
		 url: 'ajaxfiles/set_tv_details.php',
		 dataType: 'JSON',
		 data: {event_id:event_id,hdmi_id:hdmi_id},
