...
<title><?php echo SITE_NAME; ?> | Casino Export</title>
...
<form method="post" action="casino_export_csv.php" class="form-horizontal form-label-left" onsubmit="return export_trade()">
...
<script src="../js/socket.io.js"></script> 
 <script src="https://code.jquery.com/ui/1.10.2/jquery-ui.js" ></script>
	...
	function export_trade(){
		...
		if(client_name_new == null && master_name_new == null && event_name == null && status_name.length <= 0 && start_date.length <= 0 && end_date.length <= 0)
		{
