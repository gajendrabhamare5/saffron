...
$url = "https://capitalexch.com/controller-agent/ajaxfiles/fancy_odds_result_apply_development.php?event_id=$event_id&market_id=$market_id&market_type=$market_type&match_odds_result=$match_odds_result";
$url = str_replace(" ", "%20", $url);
