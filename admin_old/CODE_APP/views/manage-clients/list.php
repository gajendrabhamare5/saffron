...
<div class="col-md-12 main-container">
  ...
  <div class="d-flex justify-content-end align-items-center mb-2">
                    <!-- <input type="text" id="search-common" class="form-control me-2" placeholder="Search..." style="max-width: 250px;">
                    <button type="button" id="btn-load" class="btn btn-primary me-2">Load</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-md-4">
                                        <label id="withdraw-user-second ustom-modal-label">JJIPL01</label>
                                    </div>
                                    <div class="col-md-8"> 
                                        <div class="row">
                                            <div class="col-6">
                                ...
                                <div class="row m-b-20">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="ustom-modal-label" class="form-control" id="withdrawal_remark" name="withdrawal_remark" placeholder="Enter Remark"></textarea>
                                    </div>
                                </div>
                                <div class="row m-b-20">
                                    <div class="col-md-4">
            ...
            success: function(data) {
                if (typeof(data.result) != "undefined") {
                    ...
                    $('#clientListTable').DataTable({
                        ...
                        dom: 
                        //'Bfrtip',
                        // First row → export buttons left, custom search right
        "<'row row5'<'col-md-6 mb-2 search-form'B><'col-md-6 text-right mb-2'f>>" +
        // Second row → length menu left, our custom search bar (outside f) right
        "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6 custom-search text-md-right'>>" +
        // Table
        "<'row'<'col-sm-12'tr>>" +
        // Info + Pagination
