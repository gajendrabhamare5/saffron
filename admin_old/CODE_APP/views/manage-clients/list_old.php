...
<style>
    ...
    #manage_user_tbody td {
      font-weight: bold;
    }

    #clientListTable td, #clientListTable th {
    ...
    #clientListTable td:nth-child(2),
    #clientListTable td:nth-child(3),
    #clientListTable td:nth-child(4),
    #clientListTable td:nth-child(5),
    #clientListTable td:nth-child(6),
    #clientListTable td:nth-child(12),
    #clientListTable td:nth-child(13) {
    text-align: right;
    }

    #clientListTable .action-btn {
        ...
        <button class="action-btn">D</button>
        <button class="action-btn">W</button>
        <!-- and so on -->

        input[type="checkbox"] {
        width: 18px;
        height: 18px;
        accent-color: #000; /* Or use a custom image if needed */
        }
                ...
                if (typeof(data.result) != "undefined") {
                    ...
                    $('#clientListTable').DataTable({
                        ...
                        initComplete: function () {
                            ...
                            // Move search below tabs
                            $('.dataTables_filter').insertAfter($('.nav-tabs')).addClass('mt-3 mb-3');

                            // Style search + buttons
                            let $searchWrapper = $('.dataTables_filter');
                            $searchWrapper.css({ display: 'flex', gap: '10px', alignItems: 'center' });
                            $searchWrapper.append(`
                                <button class="btn btn-diamond" id="loadButton">Load</button>
