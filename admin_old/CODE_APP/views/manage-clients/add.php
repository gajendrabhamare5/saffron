                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12" id="div-exposure_limit">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user-exposure_limit" id="user-exposure_limit" class="form-control" placeholder="Exposure Limit" value="0" required="required" autocomplete="off"/>
                                </div>
                            </div>
                        </div>
                    </div>
