...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo MASTER_URL; ?>/assets/css/style.css?12345">
...
.customeclass{
    ...
    <body>
        ...
        <div class="wrapper">
                    ...
                    <div class="container-fluid">
                                ...
                                <ul class="list-unstyled navbar-nav">
                                    <li class="nav-item">
										...
										<!--<li class="nav-item newlacunch-menu">
											<a class="" href="javscript:void();">
												<span><b>IPL 2021</b></span>
											</a>
										</li>-->
                                    ...
                                    <?php  if(ELECTION_EVENT_ID != ''){ ?>
										<li class="nav-item newlacunch-menu">
											<a class="" href="<?php echo MASTER_URL; ?>/events-analysis?eventType=<?php echo ELECTION_EVENT_TYPE_ID;?>&eventId=<?php echo ELECTION_EVENT_ID;?>&marketId=<?php echo ELECTION_MARKET_ID;?>">
                        ...
                        <ul class="user-search list-unstyled">
                            <li class="username">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo MASTER_URL; ?>/account"><b>Change Password</b></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo MASTER_URL; ?>/SecurityAuth"><b>Security Auth</b></a>
                                    </li>
                                    <li>
            ...
            <div class="main">
                <div class="container-fluid">
                    <?php if (isset($handler->layout['summary'])) { ?>
