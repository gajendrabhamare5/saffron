            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">20-20 DRAGON TIGER LION &nbsp; 
...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    ...
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info0" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info0" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_21_row market_21_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_21_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_41_row market_41_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_41_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    ...
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info1" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                ...
                                                <td class="box-2 back market_42_row market_42_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_42_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="box-2 back market_43_row market_43_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_43_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="box-2 back market_44_row market_44_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_44_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <b>Even</b>
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info4" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                ...
                                                <td class="box-2 back market_45_row market_45_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_45_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/1.jpg">
                                                    <div class="info-block float-right">
                                                ...
                                                <td class="box-2 back market_26_row market_26_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_26_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_46_row market_46_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_46_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/2.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info6" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                ...
                                                <td class="box-2 back market_27_row market_27_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_27_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_47_row market_47_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_47_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/3.jpg">
                                                    <div class="info-block float-right">
                                                ...
                                                <td class="box-2 back market_48_row market_48_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_48_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/4.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info8" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                ...
                                                <td class="box-2 back market_29_row market_29_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_29_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_49_row market_49_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_49_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                ...
                                <div class="main-market">
                                    <table class="table coupon-table table table-bordered ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/5.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info9" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info9" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back  market_30_row market_30_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_30_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_50_row market_50_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_50_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/6.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info10" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info10" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_31_row market_31_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_31_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_51_row market_51_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_51_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/7.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info11" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info11" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_32_row market_32_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_32_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_52_row market_52_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_52_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/8.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info12" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info12" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_33_row market_33_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_33_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_53_row market_53_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_53_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/9.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info13" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info13" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_54_row market_54_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_54_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/10.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info14" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info14" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_35_row market_35_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_35_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_55_row market_55_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_55_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/11.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info15" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info15" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_36_row market_36_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_36_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_56_row market_56_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_56_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/12.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info16" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info16" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_37_row market_37_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_37_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_57_row market_57_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_57_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="box-4 card-type-icon">
                                                    <img src="<?php echo WEB_URL; ?>/storage/front/img/andar_bahar/13.jpg">
                                                    <div class="info-block float-right">
                                                        <a href="#" data-toggle="collapse" data-target="#min-max-info17" aria-expanded="false" class="info-icon collapsed">
                                                            <i class="fas fa-info-circle m-l-10"></i>
                                                        </a>
                                                        <div id="min-max-info17" class="min-max-info collapse">
                                                            <span class="m-r-5">
                                                                <b>Min:</b>100
                                                            </span>
                                                            <span class="m-r-5">
                                                ...
                                                <td class="box-2 back market_38_row market_38_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_38_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                                                <td class="box-2 back market_58_row market_58_b_btn">
                                                    <button>
                                                        ...
                                                        <span class="d-block">
                                                            <div class="ubook m-t-5 text-danger">
                                                                <b class="market_58_b_exposure market_exposure">0</b>
                                                            </div>
                                                        </span>
                                                    </button>
                                                </td>
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=dtl20" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog modal-md modal-dialog-centered" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">20-20 DRAGON TIGER LION Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
    ...
    function updateResult(data) {
        ...
        data.forEach(function (runData) {
            if (parseInt(runData.result) == 1) {
                ...
                ab = "playera";
                ab1 = "T";
            } else if (parseInt(runData.result) == 41) {
                ab = "playera";
                ab1 = "L";
            } else {
                ab = "playertie";
