...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                        <!-- <iframe width="100%" height="400" src="<?php echo IFRAME_URL . SUPEROVER_CODE; ?>" style="border:0px;display: none;"></iframe> -->
                        ...
                        <div class="video-overlay">
                            <div><img id="card_c1" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                            <div><img id="card_c2" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                            <div><img id="card_c3" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                            <div><img id="card_c4" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                            <div><img id="card_c5" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                            <div><img id="card_c6" src="<?php echo WEB_URL; ?>storage/front/img/cards/1.png" style="display: none;"></div>
                        </div>
                    ...
                    <div class="markets">
                        <div class="bookmaker-market">
                            ...
                            <div class="table-body">
                                <div class="table-row suspended market_1_row" data-title="SUSPENDED">
                                ...
                                <div class="table-row suspended market_2_row" data-title="SUSPENDED">
                                    <div class="float-left country-name box-4">
                    ...
                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=superover" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
