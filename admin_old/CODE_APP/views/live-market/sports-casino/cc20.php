            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">20-20 Cricket Match &nbsp; 
...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                       <!--  <iframe width="100%" height="400" src="<?php echo IFRAME_URL."".CRICKET20_CODE; ?>" style="border:0px"></iframe> -->
                    ...
                    <div class="row row5">
                        <div class="col-6">
                            <div class="score-box btn-theme suspended market_1_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball2.png" class="img-fluid ball-image">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_1_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_1_b_btn"><span class="odds d-block market_1_b_value">0.00</span></div>
                                <div class="lay laybox market_1_l_btn"><span class="odds d-block market_1_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_2_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball3.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_2_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_2_b_btn"><span class="odds d-block market_2_b_value">0.00</span></div>
                                <div class="lay laybox market_2_l_btn"><span class="odds d-block market_2_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_3_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball4.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_3_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_3_b_btn"><span class="odds d-block market_3_b_value">0.00</span></div>
                                <div class="lay laybox market_3_l_btn"><span class="odds d-block market_3_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_4_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball5.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_4_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_4_b_btn"><span class="odds d-block market_4_b_value">0.00</span></div>
                                <div class="lay laybox market_4_l_btn"><span class="odds d-block market_4_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_5_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball6.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_5_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_5_b_btn"><span class="odds d-block market_5_b_value">0.00</span></div>
                                <div class="lay laybox market_5_l_btn"><span class="odds d-block market_5_l_value">0.00</span></div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="score-box btn-theme suspended market_6_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball7.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_6_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_6_b_btn"><span class="odds d-block market_6_b_value">0.00</span></div>
                                <div class="lay laybox market_6_l_btn"><span class="odds d-block market_6_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_7_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball8.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_7_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_7_b_btn"><span class="odds d-block market_7_b_value">0.00</span></div>
                                <div class="lay laybox market_7_l_btn"><span class="odds d-block market_7_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_8_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball9.png" class="img-fluid ball-image"> 
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                    <div class="ubook m-t-5"><b class="market_8_b_exposure market_exposure">0</b></div>
                                </div>
                                <div class="min-max"><span>Min:<span>100</span> Max:<span>300K</span></span>
                                </div>
                                <div class="back backbox market_8_b_btn"><span class="odds d-block market_8_b_value">0.00</span></div>
                                <div class="lay laybox market_8_l_btn"><span class="odds d-block market_8_l_value">0.00</span></div>
                            </div>
                            <div class="score-box btn-theme suspended market_9_row">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/ball10.png" class="img-fluid ball-image">
                                <img src="<?php echo WEB_URL; ?>storage/img/balls/score-bat-icon.png" class="score-img">
                                <div class="book">
                                ...
                                <div class="back backbox market_9_b_btn"><span class="odds d-block market_9_b_value">0.00</span></div>
                                <div class="lay laybox market_9_l_btn"><span class="odds d-block market_9_l_value">0.00</span></div>
                            </div>
                        </div>
                        <marquee scrollamount="3" class="casino-remark m-b-10"> Team B Need 12 Runs to WIN Match. If The Score is Tie Team B will WIN. </marquee>
                    </div>

                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=cc20" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
                    </div>
                    <div class="m-b-10">
        ...
        <div id="modalpokerresult" class="modal fade show" tabindex="-1">
            <div class="modal-dialog modal-md modal-dialog-centered" style="min-width: 650px">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">20-20 Cricket Match Result</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
<script type="text/javascript">
    ...
    function updateResult(data) {
        ...
        var html = "";
        casino_type = "'cricket20'";
        data.forEach(function (runData) {

            ball_result = parseInt(runData.result);

            eventId = runData.mid == 0 ? 0 : runData.mid.split(".")[1];
            html += '<span onclick="view_casiono_result(' + eventId + ',' + casino_type + ')"  class=" last-result"><img src="' + site_url + 'storage/img/balls/ball' + ball_result + '.png" class="balls m-l-5"></span>';
        });
...
<script>
    ...
    function view_casiono_result(event_id, casino_type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo MASTER_URL; ?>/reports/Casino_results/get_result/cricket20/' + event_id,
            dataType: 'json',
