            ...
            <div class="col-md-8 main-content">
                <div class="coupon-card">
                    <div class="game-heading">
                        <span class="card-header-title">1 Day Live Poker &nbsp; 
...
<iframe id="casinoIframe" src="" width="100%" height="400" style="border: 0px;"></iframe>
                       <!--  <iframe width="100%" height="400" src="<?php echo IFRAME_URL."".ODIPOKER_CODE; ?>" style="border:0px"></iframe> -->
                    ...
                    <div class="card-content m-t-5">
                            ...
                            <div class="table-responsive col-md-6 m-b-10 main-market p-r-5">
                                <div class="live-poker">
                                    <table class="table coupon-table table table-bordered ">
                                        ...
                                        <tbody class="" id="pokerTbody1">
                                        <tbody class="">
                                            <tr class="bet-info suspended market_1_row" data-title="SUSPENDED">
                                                <td class="w-33">Player A
                                                    <p>
                                                        <span class="market_1_b_exposure market_exposure">0</span>
                                                    </p>
                                                </td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="11" data-rate="1.98" data-nation="Winner">
                                                    <button class="back market_1_b_btn">
                                                        <span class="odd market_1_b_value">0.00</span>
                                                        <span>0</span>
                                                    </button>
                                                </td>
                                                <td class=" box-w2 lay w-33 teen-section" data-sid="21" data-rate="1.98" data-nation="Winner">
                                            ...
                                            <tr class="bet-info suspended market_2_row"data-title="SUSPENDED">
                                                <td class="w-33">Player B
                                                    <p><span class="market_2_b_exposure market_exposure">0</span></p>
                                                </td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="11" data-rate="1.98" data-nation="Winner">
                                                    <button class="back market_2_b_btn">
                                                        <span class="odd market_2_b_value">0.00</span>
                                                        <span>0</span>
                                                    </button>
                                                </td>
                                                <td class=" box-w2 lay w-33 teen-section" data-sid="21" data-rate="1.98" data-nation="Winner">
                                                    <button class="lay market_2_l_btn">
                                                        <span class="odd market_2_l_value">0.00</span>
                                                        <span>0</span>
                                                    </button>
                                                </td>
                                            </tr>
                            ...
                            <div class="table-responsive col-md-6 m-b-10 main-market p-l-5">
                                <div class="live-poker">
                                    <table class="table coupon-table table table-bordered ">
                                        ...
                                        <tbody class="" id="pokerTbody2">
                                        <tbody class="">
                                            <tr class="bet-info suspended market_3_row market_4_row" data-title="SUSPENDED">
                                                <td class="w-33">Player A</td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="3" data-rate="undefined" data-nation="Player A 2 card Bonus">
                                                    <button class="back market_3_b_btn">
                                                        <span class="odd">Player A 2 card Bonus</span>
                                                        <span class="market_3_b_exposure market_exposure">0</span>
                                                    </button>
                                                </td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="4" data-rate="undefined" data-nation="Player A 7 card bonus">
                                                    <button class="back market_4_b_btn">
                                                        <span class="odd">Player A 7 card bonus</span>
                                                        <span class="market_4_b_exposure market_exposure">0</span>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr class="bet-info suspended market_5_row market_6_row" data-title="SUSPENDED">
                                                <td class="w-33">Player B</td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="5" data-rate="undefined" data-nation="Player B 2 card Bonus">
                                                    <button class="back market_5_b_btn">
                                                        <span class="odd">Player B 2 card Bonus</span>
                                                        <span class="market_5_b_exposure market_exposure">0</span>
                                                    </button>
                                                </td>
                                                <td class=" box-w2 back w-33 teen-section" data-sid="6" data-rate="undefined" data-nation="Player B 7 card bonus">
                                                    <button class="back market_6_b_btn">
                                                        <span class="odd">Player B 7 card bonus</span>
                                                        <span class="market_6_b_exposure market_exposure">0</span>
                                                    </button>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div id="commetry" class="text-right text-info" scrollamount="3">Tie round will be considered as a cancel round</div>
                    </div>

                    <div class="fancy-marker-title">
                        <h4>Last Result <a href="<?php echo MASTER_URL; ?>/reports/casino-results?q=poker" class="text-right" style="font-size: 14px; float: right; color: #fff">View All</a></h4>
