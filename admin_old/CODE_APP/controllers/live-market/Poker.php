...
class Poker extends CI_Controller {
    ...
    public function index() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Live Poker';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/poker/list', array('handler' => $this));
    ...
    public function t20() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 2020 Live Poker';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/poker/t20', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function oneday() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - Oneday Live Poker';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/poker/oneday', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function player6() {
        ...
        $this->layout['title'] = PROJECTNAME . ' - 6 Player Live Poker';

        $this->load->view('header', array('handler' => $this));
        $this->load->view('live-market/poker/6player', array('handler' => $this));
        $this->load->view('footer', array('handler' => $this));
    }
    ...
    public function active_bets($type = 't20', $event_id = '') {
        ...
        $shortcodeArr = array('t20' => '2020_POKER', 'oneday' => 'ODI_POKER', 'player6' => '6_PLAYER_POKER');
        $html = '';
