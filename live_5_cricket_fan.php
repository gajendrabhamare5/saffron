...
<body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
  ...
  if(!empty(IFRAME_URL_SET)){
                               ?>
                               <iframe class="iframedesign" src="<?php echo IFRAME_URL."".CRICKET5_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
                               <?php
            ...
            <div class="fancy-marker-title m-t-10">
               <h4>
                  Last Result
                  <a href="casinoresults?game_type=cricketv3" class="result-view-all">View
                  All</a>
               </h4>
            </div>
            <div class="m-b-10">
			...
			eventId = data.t1[0].mid == 0 ? 0 : data.t1[0].mid.split(".")[1];
				...
				if(data['t4'] != null){
					...
					for(var f in data['t4']){
						...
						bs1 = bs1 == 0 ? "" : parseFloat(bs1);
						
						l1 = l1 == 0 ? "" : parseFloat(l1);
						ls1 = ls1 == 0 ? "" : parseFloat(ls1);
