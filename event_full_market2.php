...
<body cz-shortcut-listen="true" class="" data-modal-open-count="0" style="">
    <div id="app">
        ...
        <div class="wrapper">
            ...
            <div class="loader_page" style="display:none;"><i class="fa fa-spinner fa-spin" style="font-size: 38px;"></i></div>
            <div class="main">
                        ...
                        <div class="col-md-10 featured-box load game-page">
                            <div class="row row5">
                                <div class="col-md-9 featured-box-detail sports-wrapper m-b-10">
                                    <!---->
                                    <div class="game-heading"><span class="card-header-title event_name_heading uppercase"><?php echo $event_name; ?></span> <span class="float-right" id="matchdate"></span></div>
                                    <div class="markets">
                                        <!---->
                                        ...
                                        <div class="main-market main-market-full" id="match_odds_all_full_markets"></div>
                                        ...
                                        <div class="row row5 bookmaker-tied-market mt-1" id="bookmaker_tied_market_div" style="display:none;">
                                            <div class="bm1 col-xl-12" id="bm1-head">
                                                <div>
                                                    <div class="market-title mt-1">
                                                        Tied Match
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#view_bookmaker_tied_rules" class="m-r-5 game-rules-icon"><span><i class="fa fa-info-circle float-right"></i></span></a>
                                                    </div>
                                                    <div class="table-header">
                                                    ...
                                                    <div class="table-remark text-right remark" id="bookmaker-tied-remakrs">
                                                    </div>
                                                    <div>
                                                    </div>
                                                </div>
                                    ...
                                    <?php if ($eventType == 4 || $eventType == 8) { ?>
                                            ...
                                            <div class="col-12">
                                                <div class="" id="fancy_odds_market" style="display:none;">
                                                    <div>
                                                        <div class="market-title mt-1">
                                                            Session Market
                                                            <a href="javascript:void(0)" data-target="#view_fancy_rules" data-toggle="modal" class="m-r-5 game-rules-icon"><span><i class="fa fa-info-circle float-right"></i></span></a>
                                                        </div>
                                        ...
                                        <ul class="nav nav-tabs mt-1">
                                            ...
                                            <li class="nav-item"><a data-toggle="tab" href="#oddeven" class="nav-link">Oddeven</a></li>
...
var scoreboardStr = "";
scoreboardStr += "<div class=\"scorecard scorecard-mobile\">";
scoreboardStr += "<div class='score-inner'>";
scoreboardStr += "<div class='row'>";

/* ================= COLUMN 1 (Team Names) ================= */
scoreboardStr += "<div class='col-3'>";
scoreboardStr += "<div class='mb-2 team-name'>" + data.spnnation1 + "</div>";
scoreboardStr += "<div class='team-name'>" + data.spnnation2 + "</div>";
scoreboardStr += "</div>";

/* ================= COLUMN 2 (Scores + Run Rates) ================= */
scoreboardStr += "<div class='col-4'>";

// Team 1
scoreboardStr += "<div class='mb-2 score'>";
scoreboardStr += data.score1;
...
// Team 2
scoreboardStr += "<div class='score'>";
scoreboardStr += data.score2;
...
/* ================= COLUMN 3 (Status + Balls) ================= */
scoreboardStr += "<div class='col-5'>";

// Match Status / Message
scoreboardStr += "<div class='mb-2'>";
...
// Ball by Ball
scoreboardStr += "<div class='ball-runs-container'>";
scoreboardStr += "<p class='text-end ball-by-ball'>";
...
scoreboardStr += "</div>"; // end col-5

scoreboardStr += "</div>"; // end row
                ...
                if (args.body.data[0]) {
                    ...
                    for (k = 0; k < args.body.data.length; k++) {
                        ...
                        if (market_type_name == "Tied Match") {
                            ...
                            html_match_tie_odds += "<div class='market-title mt-1'> " + market_type_name + " <a href='javascript:void(0)' class='m-r-5 game-rules-icon' data-toggle='modal' data-target='#view_match_rules'><span><i class='fa fa-info-circle float-right'></i></span></a></div><div class='table-header'><div class='float-left country-name box-4 min-max'><b><span class='m-r-10'>Min: <span id='match_odds_tied_min_bet_" + k + "'></span> Max: <span id='match_odds_tied_max_bet_" + k + "'>1</span></span></b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div><div class='back box-1 float-left text-center'><b>BACK</b></div><div class='lay box-1 float-left text-center'><b>LAY</b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div></div><div data-title='OPEN' class='table-body'>";
                            ...
                            html_match_odds += "<div class='game-market'><div class='market-title mt-1'> <span> " + market_type_name + " </span> <a href='javascript:void(0)' class='m-r-5 game-rules-icon' data-toggle='modal' data-target='#view_match_rules'><span><i class='fa fa-info-circle float-right'></i></span></a> </div><div class='table-header'><div class='float-left country-name box-4 min-max'><b><span class='m-r-10'>Max: <span id='match_odds_max_bet_" + k + "'>1</span></span></b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div><div class='back box-1 float-left text-center'><b>BACK</b></div><div class='lay box-1 float-left text-center'><b>LAY</b></div><div class='box-1 float-left'></div><div class='box-1 float-left'></div></div><div data-title='OPEN' class='table-body'>";
                            if (market_type_name == "Match Odds") {
                                marketType = "MATCH_ODDS";
                            } else if (market_type_name == "Tied Match") {
                                marketType = "TIED_MATCH";
                            ...
                            if (args.body.data[k].runners) {
                                for (j = 0; j < args.body.data[k].runners.length; j++) {
                                    ...
                                    html_match_odds += "<div data-title='" + bet_suspended + "' class='11 table-row " + is_suspended + "' id='fullSelection_" + selectionId + "_" + market_marketid + "'  eventtype='4' eventid='" + eventId + "' marketid='" + market_market_id + "' selectionid='" + selectionId + "' eventname='" + runnerName + "' status='" + status + "'><div class='float-left country-name box-4'><span class='team-name'>" + runnerName + "</span><p><span class='float-left live_match_points' style='color: black;' id='live_match_points_" + selectionId + "_" + market_marketid + "'></span> <span class='float-right' style='display: none; color: black;'>0</span></p></div>" +
                                        "<div id='back_3_" + selectionId + "_" + market_marketid + "' class='box-1 back2 float-left back-1 text-center' side='Back'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + one_price_1 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "' ><span class='odd d-block'>" + one_price_1 + "</span> <span class='d-block'>" + one_size_1 + "</span></div><div class='box-1 back1 float-left back-1 text-center' id='back_2_" + selectionId + "_" + market_marketid + "' side='Back'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + one_price_2 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "'><span class='odd d-block'>" + one_price_2 + "</span> <span class='d-block'>" + one_size_2 + "</span></div><div class='box-1 back float-left back back-1 lock text-center'  id='back_1_" + selectionId + "_" + market_marketid + "' side='Back'  selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + one_price_3 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "' other_fancy='" + other_fancy + "'><span class='odd d-block'>" + one_price_3 + "</span> <span class='d-block'>" + one_size_3 + "</span></div>" +
                                        "<div class='box-1 lay-1 lay float-left text-center' id='lay_1_" + selectionId + "_" + market_marketid + "' side='Lay' selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + lay_one_price_1 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "' other_fancy='" + other_fancy + "'><span class='odd d-block'>" + lay_one_price_1 + "</span> <span class='d-block'>" + lay_one_size_1 + "</span></div><div class='box-1 lay1 lay-1 float-left text-center' id='lay_2_" + selectionId + "_" + market_marketid + "' side='Lay' selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + lay_one_price_2 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "'><span class='odd d-block'>" + lay_one_price_2 + "</span> <span class='d-block'>" + lay_one_size_2 + "</span></div><div class='box-1 lay2 float-left lay-1 text-center' id='lay_3_" + selectionId + "_" + market_marketid + "'><span class='odd d-block' side='Lay' selectionid='" + selectionId + "' runner='" + runnerName + "' marketname='" + runnerName + "' markettype='" + marketType + "' fullmarketodds='" + lay_one_price_3 + "' oddsmarketId=" + oddsmarketId + " event_name='" + eventName2 + "' market_odd_name='" + market_odd_name + "' marketId='" + selectionId + "' eventId='" + eventId + "'   inplay='" + inPlay + "'>" + lay_one_price_3 + "</span> <span class='d-block'>" + lay_one_size_3 + "</span></div>" +
                                        "</div>";
                                }
                            }
                ...
                if (args.body.cricket[0]) {
                    ...
                    for (k = 0; k < args.body.cricket[0].length; k++) {
                        ...
                        if (args.body.cricket[0][k].bookmaker_tied) {
                            ...
                            bookmaker_tied_display = (bookmaker_tied_max / 100000) + 'L';
                            $(".bookmaker_tied_min").html(bookmaker_tied_min);
                            $(".bookmaker_tied_max").html(bookmaker_tied_display);
                        }
                        ...
                        if (args.body.cricket[0][k].runners) {
                            ...
                            for (j = 0; j < args.body.cricket[0][k].runners.length; j++) {
                                ...
                                // lay_one_size_2 = parseFloat(lay_one_size_2);
                                // lay_one_size_3 = parseFloat(lay_one_size_3);
                                one_size_1 = one_size_1 ? Number(one_size_1).toFixed(2) : one_size_1;
                                one_size_2 = one_size_2 ? Number(one_size_2).toFixed(2) : one_size_2;
                                one_size_3 = one_size_3 ? Number(one_size_3).toFixed(2) : one_size_3;
                                lay_one_size_1 = lay_one_size_1 ? Number(lay_one_size_1).toFixed(2) : lay_one_size_1;
                                lay_one_size_2 = lay_one_size_2 ? Number(lay_one_size_2).toFixed(2) : lay_one_size_2;
                                lay_one_size_3 = lay_one_size_3 ? Number(lay_one_size_3).toFixed(2) : lay_one_size_3;
                                    ...
                                    if (marketId == "" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.session1[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                html_fancy_market_new1 += "<div class='fancy-tripple col-6' id='fancy1BetMarket_" + eventId + "_" + marketId + "'><div data-title='SUSPENDED' class='table-row suspended fancy1-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)' onclick='view_fancy_bet_book(" + eventId + "," + marketId + ")'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'></span></p></div><div class='box-1 back float-left text-center back-1' id='fancy1_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-1 lay float-left text-center lay-1' id='fancy1_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
                                                lastrunsNo = runsNo;
                                                lastrunsYes = runsYes;
                                    ...
                                    if (marketId == "" || args.body.ballByBall[0].value.session[i].GameStatus.toUpperCase() == "OFFLINE" || args.body.ballByBall[0].value.session[i].GameStatus.toUpperCase() == "CLOSED") {
                                        ...
                                        if (!n1 && !n2 && !n3) {
                                            ...
                                            if (m1) {
                                                ...
                                                html_ball_market_new += "<div class='col-6' id='ballBetMarket_" + eventId + "_" + marketId + "'><div class='fancy-tripple'><div data-title='SUSPENDED' class='table-row suspended ballByBall-suspend-tr_" + marketId + "'><div class='float-left country-name box-6' style='border-bottom: 0px;'><p class='m-b-0'><a href='javascript:void(0)'> " + marketName + " </a></p><p class='m-b-0 live_match_points' id='live_match_points_" + marketId + "_FANCY_ODDS'><span style='color: black;'></span></p></div><div class='box-1 lay float-left text-center lay-1' id='ball_market_lay_btn_" + marketId + "' " + lay_attribute + " ><span class='odd d-block'>" + runsNo + "</span> <span>" + oddsNo + "</span></div><div class='box-1 back float-left text-center back-1' id='ball_market_back_btn_" + marketId + "' " + back_attribute + "><span class='odd d-block'>" + runsYes + "</span> <span>" + oddsYes + "</span></div><div class='box-2 float-left text-right min-max' style='border-bottom: 0px;'><span class='d-block'>Min: <span>" + min_stack + "</span></span> <span class='d-block'>Max: <span>" + max_stack + "</span></span></div></div></div><div class='table-remark text-right remark' style='display:none;' id='remakrs_" + marketId + "'></div></div>";
                                                lastrunsNo = runsNo;
                                                lastrunsYes = runsYes;
...
<script>
    ...
    jQuery(document).on("click", ".lay-1", function() {
        ...
        if (fullmarketodds != "") {
            ...
            $(this).addClass("select");
            return_html = "";
            return_html += "<div class='bet-slip-data'><div><div class='table-responsive lay'><table class='coupon-table table table-borderedless'><thead><tr><th class='place-bet-for'>(Bet for)</th><th class='place-bet-odds'>Odds</th><th class='place-bet-stake'>Stake</th><th class='place-bet-profit'>Profit</th></tr></thead><tbody>";
            // <a href='javascript:void(0);' class='text-danger close-bet-slip'><i class='fa fa-times'></i></a>
