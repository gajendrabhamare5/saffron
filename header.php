        ...
        <div class="row">
            <div class="header-top col-md-12">
                <div class="float-left">
                    <a href="home" class="logo"><img src="<?php echo WEB_URL . $logo ?>"></a>
                </div>
                <ul class="float-right">
                    ...
                    <li class="float-left download-apklink">
                        <div><a href="javascript:void(0)" data-target="#rulesPopup" data-toggle="modal" class="rules-link m-r-5"><b>Rules</b></a></div>
...
<style>
    ...
    .custom-position-modal [type=button]:not(:disabled),
    ...
    .custom-position-modal .nav-pills .nav-link1.active,
    .custom-position-modal .nav-pills .show>.nav-link1 {
        color: #fff;
