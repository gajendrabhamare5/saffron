                                ...
                                <div class="card-body container-fluid container-fluid-5">
                                    <div class="report-form">
                                        <div class="row row5">
                                            ...
                                            <div class="col-lg-2 col-md-2 d-grid"><button type="submit"
                                        ...
                                        <div class="mt-2 table-responsive">
                                            <table role="table" aria-busy="false" aria-colcount="6"
                                                class="table table-bordered" id="account_history_table">
                                                <thead>
                                                    <tr role="row">
                                                        <th colspan="1" role="columnheader" class="report-sport common">
                                                            Sports</th>
                                                        <th colspan="1" role="columnheader">Event Name</th>
                                                        <th colspan="1" role="columnheader" class="common">Market Name
                                                        </th>
                                                        <th colspan="1" role="columnheader">Nation</th>
                                                        <th colspan="1" role="columnheader"
                                                            class="report-amount text-end">User Rate</th>
                                                        <th colspan="1" role="columnheader"
                                                            class="report-amount text-end">Amount</th>
                                                        <th colspan="1" role="columnheader" class="report-date">Place
                                                            Date</th>
