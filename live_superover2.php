								...
								<div class="col-md-9 coupon-card featured-box-detail">
									<div class="coupon-card">
										<div class="game-heading">
											...
											<small role="button" class="teenpatti-rules"  onclick="view_rules('superover2')" data-target="#rules_popup" data-toggle="modal"  tabindex="0"><u>Rules</u></small> 
										...
										if(!empty(IFRAME_URL_SET)){
																?>
																<iframe class="iframedesign" src="<?php echo IFRAME_URL."".SUPEROVER2_CODE;?>" width="100%" height="200px" style="border: 0px;"></iframe>
																<?php
										...
										<div class="casino-detail detail-page-container position-relative">
											...
											<div class="game-market market-6 fancy-market fancyMarket bookmaker-market" style="display:none;">
											...
											<div class="game-market market-6 fancy-market fancyTieMarket bookmaker-market" style="display:none;">
											...
											<div class="game-market market-6 fancy-market fancyMarket1 bookmaker-market" style="display:none;">
											...
											<div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=superover2">View All</a></span></div>
			...
			socket.on('game', function(data) {
				...
				if (data && data['t1'] && data['t1'][0]) {
					...
					for (var j in data['t2']) {
						...
						back_html = '<span class="odd d-block" style="font-weight: bold;">' + b1 + '</span><span class="d-block">' + bs1 + '</span>';
						...
						lay_html = '<span class="odd d-block" style="font-weight: bold;">' + l1 + '</span><span class="d-block">' + ls1 + '</span>';
								...
								fancy_data+= `<div>
												<div class="fancy-market " data-title="ACTIVE">
													<div id="five_fancy_'${selectionid}'" data-title="${is_suspended_title}" class="table-row ${is_suspended} market_${selectionid}_row market-row">
														...
														<div class="market-odd-box lay betting-disabled market_'${selectionid}'_l_btn '${lay_class}'" side="Lay" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="${markettype}" event_name="${markettype}" fullmarketodds="${l1}" fullfancymarketrate="${l1}">${lay_html}</div>
														<div class="market-odd-box back betting-disabled market_'${selectionid}'_b_btn '${back_class}'" side="Back" selectionid="${selectionid}" marketid="${selectionid}" runner="${runner}" marketname="${runner}" eventid="${eventId}" markettype="${markettype}" event_name="${markettype}" fullmarketodds="${b1}" fullfancymarketrate="${b1}">${back_html}</div>
