                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">2 Cards Teenpatti
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('patti2')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . PATTI2_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                        ...
                                        <div class="casino-last-result-title"><span>Last Result</span> <span class="float-right"><a href="casinoresults?game_type=patti2" class="">View All</a></span></div>
