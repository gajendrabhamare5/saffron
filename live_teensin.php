                                ...
                                <div class="col-md-9 coupon-card featured-box-detail">
                                    <div class="coupon-card">
                                        <div class="game-heading"><span class="card-header-title">29Card Baccarat
                                            ...
                                            <small role="button" class="teenpatti-rules" onclick="view_rules('teensin')" data-target="#rules_popup" data-toggle="modal" tabindex="0"><u>Rules</u></small>
                                        ...
                                        <div class="video-container">
                                            ...
                                            ?>
                                                <iframe class="iframedesign" src="<?php echo IFRAME_URL . "" . TEENSIN_CODE; ?>" width="100%" height="200px" style="border: 0px;"></iframe>
                                            <?php
                                        ...
                                        <div class="casino-table">
                                            ...
                                            <div class="casino-table-full-box mt-3">
                                                ...
                                                <div class="casino-odd-box-container">
                                                    <div
                                                        class="casino-odds-box back back-1 market_9_row market_9_b_btn suspended-box">
                                                        <span class="casino-odds">4.7</span>
                                                    </div>
                                                    <div
                                                        class="casino-odds-box lay lay-1 market_9_row market_9_l_btn suspended-box">
                                                        <span class="casino-odds">5.1</span>
                                                    </div>
                                                    <div class="casino-nation-book market_9_b_exposure market_exposure text-center w-100"></div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="casino-last-result-title"><span>Last Result</span><span><a href="casinoresults?game_type=teensin">View All</a></span></div>
